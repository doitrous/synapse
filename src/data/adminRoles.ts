...
export type StoredRole = 'student' | 'mcq_validator' | 'reviewer' | 'admin' | 'editor'
...
export const STORED_ROLES: StoredRole[] = ['student', 'mcq_validator', 'reviewer', 'admin', 'editor']
