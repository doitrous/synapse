import { NOTE_HEIGHT, NOTE_WIDTH, type Point } from '@/lib/whiteboardGeometry'
 ...
 */
export interface BoardImage { id: string; x: number; y: number; width: number; height: number; src: string; alt: string }
