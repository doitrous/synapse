...
export const AR: Record<string, string> = {
  ...
  'Histology Lab': 'مختبر الأنسجة',
  'Anatomy Atlas': 'أطلس التشريح',
  'Anatomy Atlas is coming soon.': 'أطلس التشريح قادم قريبًا.',
  'A visual reference for anatomical structures and their relationships.': 'مرجع بصري للتراكيب التشريحية والعلاقات بينها.',
  'Find a reference, make it your own, and keep it in memory.': 'ابحث عن مرجع، ودوّن فهمك له، وثبّته في ذاكرتك.',
  'Rehearse oral questions, build clinical skills, and follow your progress.': 'تدرّب على الأسئلة الشفوية، وطوّر مهاراتك السريرية، وتابع تقدّمك.',
  'Adaptive Study will build each session from your own mastery ledger, spacing a concept further out every time you get it right and pulling it forward when you do not. It is coming soon.': 'ستبني الدراسة التكيّفية كل جلسة وفق مدى إتقانك، فتباعد مراجعة المفهوم كلما أجبت بشكل صحيح وتقرّبها عندما تخطئ. قادمة قريبًا.',
  'Histology will mark what you name on a slide, the way the question bank marks an answer, and carry it into your record. It is coming soon.': 'سيقيّم مختبر الأنسجة ما تحدّده على الشرائح، كما يقيّم بنك الأسئلة إجاباتك، ويضيف النتيجة إلى سجلك. قادم قريبًا.',
  'Performance will bring your study record and progress together in one place.': 'ستجمع صفحة الأداء سجل دراستك وتقدّمك في مكان واحد.',
  Dashboard: 'الرئيسية',
  Learn: 'التعلّم',
  Calendar: 'التقويم',
  Study: 'الدراسة',
  ...
  // ---- Dashboard hero — today's target ------------------------------------
  'more to hit your mark': 'سؤالًا لتصل إلى هدفك',
  ...
  'One recent answer went wrong. Nishany will check this again — this is not a weakness label.':
    'إجابة حديثة واحدة كانت خاطئة. سيتحقق نيشاني من هذا مرة أخرى — وهذا ليس وصفًا بالضعف.',
  ...
  'Nishany keeps finding what you are most likely to forget or misunderstand, revisits it at the right time, and keeps your practice aligned with your exam blueprint.':
    'يواصل نيشاني اكتشاف ما يُرجَّح أن تنساه أو تسيء فهمه، ويعيده إليك في الوقت المناسب، ويُبقي تدريبك متوافقًا مع مخطط امتحانك.',
