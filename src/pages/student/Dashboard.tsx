 ...
 * it is the quick-access layer: what's next on the calendar, today's single
 * question, the three headline meters, and the study-rhythm heatmap — each
 * one click away rather than pinned open whether it is needed today or not.
 */
