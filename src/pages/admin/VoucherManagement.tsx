    ...
    <PageContainer>
      ...
      <div className="grid items-start gap-4 xl:grid-cols-[minmax(0,1fr)_23rem]">
        <Panel className="overflow-hidden">
          ...
          <Table>
            <thead><tr><Th className="pl-4">Voucher</Th><Th>Discount</Th><Th>Audience</Th><Th>Redemptions</Th><Th>Expires</Th><Th>Status</Th><Th align="end" className="pr-4">Actions</Th></tr></thead>
            <tbody>
        ...
        <Panel className="overflow-hidden xl:sticky xl:top-20">
          ...
          {editing ? <div className="space-y-4 p-4">
            ...
            <Button variant="primary" className="w-full" onClick={save} disabled={!editing.code.trim() || !editing.name.trim() || (!isTrialVoucher(editing) && editing.amount <= 0 && !editing.periodPrices?.month && !editing.periodPrices?.term)}>Save voucher</Button>
