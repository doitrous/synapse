            ...
            <div className="border-t border-line">
              <Table>
                <thead>
                  <tr>
                    <Th>Plan</Th>
                    <Th align="right">Messages / day</Th>
                ...
                <Table>
                  ...
                  <tbody>
                    {usage.byPlan.map((row) => (
                      <Tr key={row.plan}>
                        <Td>{row.plan}</Td>
                        <Td align="right" className="tnum">{row.messages.toLocaleString()}</Td>
                        <Td align="right" className="tnum">{row.students.toLocaleString()}</Td>
                      </Tr>
                    ))}
                  </tbody>
                </Table>
