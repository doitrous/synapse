  ...
  return (
    <Panel className="overflow-hidden">
      <div className="flex flex-wrap items-center gap-2 border-b border-line px-4 py-3">
        ...
        <span className="rounded-md border border-primary-line bg-primary-tint px-2 py-0.5 font-mono text-[10.5px] font-bold text-primary-strong">{year.id}</span>
        {internship && (
                          ...
                          <td className="px-4 py-2">
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                aria-expanded={open}
                              >
                                <Icon icon={ChevronRight} size={13} className={cn('chevron-turn')} open={open} />
                              </button>
                              <SystemMark moduleId={course.moduleId ?? defaultModuleId(course.name, year.courses.indexOf(course) + 1)} size="sm" />
                              <Link to="/admin/academic" className="min-w-0 truncate text-[13px] font-medium text-ink hover:text-primary-strong" title="Edit this module's marks in Academic Setup">
                                {course.name}
                              </Link>
