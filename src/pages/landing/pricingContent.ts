 ...
 * page argues that Synapse is worth using; this page is read by somebody who
...
export const EN_PRICING: PricingContent = {
  ...
  sub:
    'Every plan opens the library, the verified sources behind it and the PDF reader. What changes higher up is how much of your revision Synapse plans for you.',
  assurances: [
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'No. Synapse is a study tool for undergraduate medical education. Nothing in the library, question bank or practicals is clinical guidance, and none of it should be used to make a decision about a patient.',
    },
    {
...
export const AR_PRICING: PricingContent = {
  ...
  sub:
    'كل خطة تفتح المكتبة والمصادر الموثّقة خلفها وقارئ الـ PDF. ما يتغيّر في الخطط الأعلى هو مقدار ما يخطّطه Synapse لمذاكرتك بدلًا عنك.',
  assurances: [
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'لا. Synapse أداة مذاكرة للتعليم الطبي الجامعي. لا شيء في المكتبة أو بنك الأسئلة أو العملي يُعدّ إرشادًا سريريًا، ولا يصحّ الاعتماد على أي منه في قرار يخص مريضًا.',
    },
    {
