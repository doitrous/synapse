          ...
          {stats.attempts === 0 ? (
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-ink-3">
                {t('Last attempted')} {stats.lastAt ? relativeTime(stats.lastAt) : ''}
              </p>
 ...
 * panel is purely a join: nothing here is written, only read and laid out.
 *
 * It is a panel rather than a page because the notes belong *in* the Notebook,
 * as its third tab, next to the notes the student typed by hand. `/app/question-notes`
 * still resolves — it redirects to that tab — and `QuestionNotes` renders this
 * same panel, so nothing that linked to the old page lost its destination.
 */
