...
export function MarkNotePopover({
  ...
  return (
    <Popover anchor={anchor} onClose={onClose} placement="bottom-start" label={t('Your note')} className="w-[min(22rem,90vw)] p-3">
      <p className="border-s-2 border-accent-line ps-2.5 text-[12px] italic leading-relaxed text-ink-3">
        “{mark.anchor.exact}”
      </p>
      <Textarea
        autoFocus
...
export function MarkedPhrase({
  ...
  return (
    <button
      ...
      className={cn(
        'mx-px inline rounded-sm px-0.5 text-start underline decoration-2 underline-offset-[3px] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40',
    ...
    <section className="overflow-hidden rounded-xl border border-line bg-surface shadow-panel">
      <div className="border-b border-line px-4 py-3">
        <div className="flex items-center gap-2">
          <Icon icon={Highlighter} size={15} className="text-accent" />
