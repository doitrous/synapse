  ...
  return (
    <>
      ...
      {!open && (
        ...
        >
          <Icon icon={Bot} size={17} className="text-accent-strong" />
          {t('Study assistant')}
        </button>
      )}
      ...
      {open && (
        ...
        >
          <header className="flex items-center gap-3 border-b border-line px-4 py-3">
            <Icon icon={Bot} size={17} className="shrink-0 text-accent-strong" />
            ...
            {turns.length === 0 && (
              <div>
                <p className="text-[13px] leading-relaxed text-ink-2">
                  {t('Ask about anything you are studying, or about how Synapse works.')}
                </p>
          ...
          <div className="border-t border-line px-3 py-3">
            <div className="flex items-end gap-2">
              <textarea
                ...
                className="max-h-32 min-h-11 w-full resize-none rounded-lg border border-line bg-surface px-3 py-2.5 text-[13px] text-ink placeholder:text-ink-3 focus:border-accent focus:outline-none focus:ring-2 focus:ring-[color-mix(in_srgb,var(--color-accent)_18%,transparent)] disabled:opacity-60"
              />
              <button
                type="button"
                onClick={submit}
                ...
                aria-label={t('Send')}
                className="grid size-11 shrink-0 place-items-center rounded-lg bg-accent text-on-accent transition-colors hover:bg-accent-strong disabled:opacity-40"
              >
