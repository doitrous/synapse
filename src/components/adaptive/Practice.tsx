              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    position === index && 'ring-2 ring-accent ring-offset-1 ring-offset-surface',
                    state ? 'border-accent bg-accent-tint text-accent-strong' : 'border-line text-ink-3 hover:border-line-2',
                  )}
                >
                  {position + 1}
                </button>
