            ...
            <div className="space-y-4">
              ...
              <Section title="Question tags and blueprint" hint="Mastery evidence is awarded only to explicitly linked concepts." icon={Tags}>
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <Field label="Intended difficulty" htmlFor="tag-intended"><Select id="tag-intended" value={data.tags.intendedDifficulty} onChange={(event) => updateData((current) => ({ ...current, tags: { ...current.tags, intendedDifficulty: event.target.value as QuestionAuthoringData['tags']['intendedDifficulty'] } }))}><option>Easy</option><option>Moderate</option><option>Hard</option></Select></Field>
