...
const BAND = [
  'var(--color-primary)',
  'color-mix(in oklab, var(--color-primary) 62%, white)',
  'color-mix(in oklab, var(--color-primary) 38%, white)',
  ...
  return (
    <li className="px-5 py-4">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <span className="tnum w-20 text-end font-mono text-[12.5px] font-semibold text-primary-strong">
    ...
    <Dialog onClose={onClose} label={`Marks and exams for ${course.name}`} size="xl">
      <div className="sticky top-0 z-10 border-b border-line bg-surface px-5 py-4">
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <span className="tnum rounded-md border border-primary-line bg-primary-tint px-2.5 py-1 font-mono text-[13px] font-bold text-primary-strong">
