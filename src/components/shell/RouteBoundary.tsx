    ...
    return (
      <div className="mx-auto w-full max-w-lg px-4 py-16 text-center" role="alert">
        <h1 className="font-serif text-[22px] font-semibold text-ink">
          {stale ? 'Synapse has been updated' : 'This screen could not be opened'}
        </h1>
        ...
        <button
          ...
          className="mt-5 inline-flex min-h-11 items-center rounded-lg bg-accent px-4 text-[13.5px] font-semibold text-on-accent transition-colors hover:bg-accent-strong sm:min-h-9"
        >
          Reload the page
        </button>
