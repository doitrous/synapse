...
export function MenuToggle({
  ...
  return (
    <button
      ...
      title={text}
      className={cn(
        'inline-flex items-center rounded-md text-ink-2 transition-colors hover:bg-inset hover:text-ink focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)]',
    ...
    >
      ...
      {direction && (
        <Icon
          ...
          size={14}
          className={cn(
            'text-ink-3 transition-transform duration-200 ease-out motion-reduce:transition-none',
