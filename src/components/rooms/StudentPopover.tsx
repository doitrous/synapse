...
export function StudentPopover({person,index,self,onClose,onCustomise,onInvite}:{onInvite?:()=>void;person:StudyPresence;index:number;self:boolean;onClose:()=>void;onCustomise:()=>void}){
