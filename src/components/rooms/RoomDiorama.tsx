...
export function RoomDiorama({world,seats,selfId='',onSeat,selected=null,preview=false,bubbles}:{
  world:StudyRoomDefinition;seats:(StudyPresence|null)[];selfId?:string;onSeat?:(index:number)=>void;selected?:number|null;preview?:boolean;paused?:boolean;bubbles?:Map<number,{id:string;text:string}>
}){
