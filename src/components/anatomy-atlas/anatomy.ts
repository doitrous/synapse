...
export const SYSTEMS: {id:SystemId;name:string;color:string;description:string}[] = [
 ...
 {id:'reproductive',name:'Reproductive',color:'#bda098',description:'Reproductive structures differ between the male and female reference atlases and support the production, transport, and function of reproductive cells and hormones.'},
 ...
 {id:'pregnancy',name:'Pregnancy reference',color:'#b88380',description:'The placenta and umbilical cord support exchange between maternal and fetal circulations during pregnancy. These reference structures are available in the female atlas.'},
...
export const EXPLANATIONS:Record<string,string> = {
 'breast':'The breast contains glandular lobes supported by adipose and connective tissue, draining through lactiferous ducts to the nipple.',
 'left breast':'The left mammary gland complex includes glandular lobes, ducts, adipose tissue, and the nipple-areolar complex.',
 'right breast':'The right mammary gland complex includes glandular lobes, ducts, adipose tissue, and the nipple-areolar complex.',
 'mammary gland':'Glandular tissue specialized for milk production during lactation.',
 ...
 'vagina':'A muscular canal connecting the cervix of the uterus to the outside of the body.',
 'ovary':'An organ that contains developing oocytes and produces hormones including estrogen and progesterone.',
 'uterine tube':'Also called the fallopian tube, a paired conduit that transports ova toward the uterus and is the typical site of fertilization.',
 'placenta':'A temporary organ that develops during pregnancy to exchange oxygen, nutrients, and waste between maternal and fetal circulations.',
 'umbilical cord':'A flexible structure connecting the fetus to the placenta and carrying the fetal blood vessels.',
