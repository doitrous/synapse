...
import com.nishany.android.core.calendar.AgendaSnapshotItem
 ...
 * because [com.nishany.android.core.cache.CortexDatabase] permits only one
 * instance over its file and [com.nishany.android.AppGraph] already holds it.
 * So the app precomputes the next few agenda entries whenever the calendar
 * data changes (see [com.nishany.android.AppGraph]'s snapshot collector) and
