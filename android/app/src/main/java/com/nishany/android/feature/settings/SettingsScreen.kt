...
import com.nishany.android.core.notifications.NotificationRationaleDialog
import com.nishany.android.core.notifications.hasNotificationPermission
import com.nishany.android.core.notifications.rememberNotificationPermissionRequester
...
import com.nishany.android.feature.root.AiDisclaimerDialog
...
/** A single row into [com.nishany.android.feature.billing.BillingScreen] -- plan status, pricing, and vouchers live on that pushed screen, not inline here, matching iOS's own "More -> Billing" link. */
@Composable
