 ...
 * app into [com.synapse.android.feature.focus.CalendarWidgetStore] so the
 * home-screen calendar widget can render without opening Room from its own
 * `provideGlance` -- see that store's and
 * [com.synapse.android.feature.focus.FocusCalendarWidget]'s docs for why the
 ...
 * the exact same inputs [com.synapse.android.feature.calendar.CalendarViewModel]
