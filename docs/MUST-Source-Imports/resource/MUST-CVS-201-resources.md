...
## description
MUST CVS-201's module-wide EOM (End of Module) written-question compilation, Fall 2024 sitting — 11 short-answer questions spanning Anatomy, Pathology, Pharmacology and Physiology, with printed model answers on pp.2-3. By Absalam101, Hamza & Rehab. Native-text PDF, no OCR needed.
