...
**`checkpointed-incomplete`.** The completed read-only sources yield 3621 questions, 3354 prompt-matched recovered answers, and 456 tested concepts (66 live-hit / 84 pending-hit / 306 new, all placement TBD). The newly closed 17-page `QUESTION ON EPITHELIUM by DR.KANDEEL.pdf` source contains 158 prompts and 158 printed key tokens across two epithelium banks and one nervous-tissue bank. A duplicated nervous-key label `15` leaves Q17 unmatched, so only 157 source answers are recovered without inference. Thirty-three source-first handles replay 132 searches; all epithelium scope is prior-FHB reuse, while six nervous-tissue scopes survive exact deduplication. The remaining source set is 56 inventory rows and 54 SHA-256 values, checksum `05371a25dda0d2f9b6b6ae508b59d8784053537827fdeb2ae56b84ca5f764c69`; debt is 13 substantive-text, 37 empty-text and 6 sparse-text rows.
