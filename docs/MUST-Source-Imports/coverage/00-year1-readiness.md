...
**`checkpointed-incomplete`.** The completed read-only sources yield 1922 questions, 1658 printed keys/answers, and 396 tested concepts (66 live-hit / 79 pending-hit / 251 new, all placement TBD). The newly closed nine-page `MCQs - Epithelium.pdf` bank contributes 40 complete prompt occurrences, 40 directly printed answers and 17 concepts (one pending, 16 new) after source-first and prior-FHB deduplication. The remaining source set is 67 inventory rows and 65 SHA-256 values, checksum `85c4248a937c59ca45623227f8b92c94e7cc9daa21903994c97e9ff7cee719ae`; debt is 24 substantive-text, 37 empty-text and 6 sparse-text rows.
