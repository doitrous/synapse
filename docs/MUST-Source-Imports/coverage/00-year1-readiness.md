...
**`checkpointed-incomplete`.** The completed read-only sources yield 1844 questions, 1580 printed keys/answers, and 376 tested concepts (66 live-hit / 78 pending-hit / 232 new, all placement TBD). The newly closed 21-page `[MedStudy] General Anatomy ➡️ Midterm.pdf` source is an introductory teaching handout rather than an assessment: it contributes 0 complete prompt occurrences, 0 directly printed answers and 0 tested concepts after the source-first assessment boundary is applied. The remaining source set is 69 inventory rows and 67 SHA-256 values, checksum `f832f2c15a384a3f6529436012ac8c8695cc4be40e351ada437bfe6427b72597`; debt is 26 substantive-text, 37 empty-text and 6 sparse-text rows.
