...
**`checkpointed-incomplete`.** The completed read-only sources yield 7306 questions, 6891 prompt-matched recovered answers, and 489 tested concepts (66 live-hit / 90 pending-hit / 333 new, all placement TBD). The newly closed 31-page `General anatomy (FHB 101).pdf` is a Youssef BenAhmed/Mucize Doctors Team student-authored 2024/25 MUST revision bank, not an official examination or key. Its exact assessment boundary is 150 four-option MCQs and 150 printed footer keys across 12 named general-anatomy sections; 14 source-first handles received 56 searches, and all handles collapse to completed prior-FHB assignments, so the concept delta is zero. The remaining source set is 10 inventory rows and 10 SHA-256 values, checksum `a3a83bcd375ec452e045303e061a821ba196190eee2ffd31a5471e4cd2c650e9`; debt is 0 substantive-text, 7 empty-text and 3 sparse-text rows.
