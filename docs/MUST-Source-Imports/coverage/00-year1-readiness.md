...
**`checkpointed-incomplete`.** The completed read-only sources yield 3796 questions, 3522 prompt-matched recovered answers, and 456 tested concepts (66 live-hit / 84 pending-hit / 306 new, all placement TBD). The newly closed 19-page `Important Ques Histo.pdf` source contains 99 answered-MCQ prompt occurrences and 99 visibly selected or inline prompt-matched answers. Its irregular labels (two unnumbered prompts, repeated numbers and one mislabelled item) are preserved without silently repairing the source. Twenty-three source-first handles replay 92 searches, and every handle is exact prior-FHB cytology, cytogenetics or epithelium reuse. The remaining source set is 54 inventory rows and 52 SHA-256 values, checksum `e5edd224ab687355b7fa7be3d5265fa45a4e144e7a7b1c2eaa1e56cbe1f7241b`; debt is 11 substantive-text, 37 empty-text and 6 sparse-text rows.
