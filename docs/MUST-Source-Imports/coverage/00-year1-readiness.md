...
**`checkpointed-incomplete`.** The completed read-only sources yield 1844 questions, 1580 printed keys/answers, and 376 tested concepts (66 live-hit / 78 pending-hit / 232 new, all placement TBD). The newly closed 52-page `G.Anatomy MCQ till Midterm by Absalam101.pdf` bank contributes 190 complete MCQ prompt occurrences and 190 directly printed answers; source-first and prior-FHB deduplication leave 17 concept additions (0 live / 0 pending / 17 new). The remaining source set is 70 inventory rows and 68 SHA-256 values, checksum `ed27bb5e8aa86a2c8a8204e3ac1fd61947ee15a8b6e335da350403e42dbc9ef3`; debt is 27 substantive-text, 37 empty-text and 6 sparse-text rows.
