...
**`checkpointed-incomplete`.** The completed read-only sources yield 5571 questions, 5263 prompt-matched recovered answers, and 485 tested concepts (66 live-hit / 90 pending-hit / 329 new, all placement TBD). The newly closed 110-page `Physiology MCQ.pdf` is a Cairo University professor-authored external revision compendium, not a MUST examination: pages 7–72 contain seven MCQ chapters with 453 prompts and complete chapter-end keys, while pages 74–109 contain 95 explicit written/essay prompts each followed by a model answer; pages 1–6 and 110 are front matter/blanks and page 73 is the essay divider. Its exact boundary is 548 prompts / 548 prompt-matched recovered answers. Forty-nine source-first handles replay 196 searches; after prior-FHB collapse, 29 concepts survive (0 live / 6 pending / 23 new). The remaining source set is 37 inventory rows and 37 SHA-256 values, checksum `8abffbe5a1d523562d28908f71f5a8833a9171e8c43b9659d8e9dae3de599b9b`; debt is 8 substantive-text, 24 empty-text and 5 sparse-text rows.
