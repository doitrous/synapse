...
**`checkpointed-incomplete`.** The completed read-only sources yield 1882 questions, 1618 printed keys/answers, and 379 tested concepts (66 live-hit / 78 pending-hit / 235 new, all placement TBD). The newly closed eight-page `solo mcq anatomy fhb mid.pdf` bank contributes 38 complete MCQ prompt occurrences, 38 directly highlighted answers and three new concepts after source-first and prior-FHB deduplication. The remaining source set is 68 inventory rows and 66 SHA-256 values, checksum `a4b7afc68554d0453044a6ef0eb9fa4d48fcbeb53f67004439082f60f014882d`; debt is 25 substantive-text, 37 empty-text and 6 sparse-text rows.
