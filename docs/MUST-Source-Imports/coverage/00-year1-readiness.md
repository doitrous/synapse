...
**`checkpointed-incomplete`.** The completed read-only sources yield 3272 questions, 3006 printed keys/answers, and 432 tested concepts (66 live-hit / 84 pending-hit / 282 new, all placement TBD). The newly closed eight-page `MCQs - Cases.pdf` source contains 20 problem-solving MCQs and three complete keyed tables. Its 15 source-first handles replay 60 searches; exact prior-FHB deduplication leaves three new clinical scopes: intermediate-filament tumour typing, peroxisomal enzyme deficiency with fatty-liver/renal manifestations, and lysosomal sulfatase deficiency with neurologic manifestations. The remaining source set is 61 inventory rows and 59 SHA-256 values, checksum `693541bd105075b6a0608d48f357ff5aba86dd4b652d1abbdc1138c01a715398`; debt is 18 substantive-text, 37 empty-text and 6 sparse-text rows.
