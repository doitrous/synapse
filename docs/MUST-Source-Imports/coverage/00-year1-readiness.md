...
**`checkpointed-incomplete`.** The completed read-only sources yield 4594 questions, 4313 prompt-matched recovered answers, and 456 tested concepts (66 live-hit / 84 pending-hit / 306 new, all placement TBD). The newly closed 14-page `FHB 1 MCQ FINAL.pdf` slice contains a cover/index, 40 completely keyed General Anatomy MCQs and 40 completely keyed Physiology–Body Fluids MCQs. Its index describes sections from a larger booklet that are absent from this local slice; those references do not inflate the exact 80-prompt/80-answer boundary. The MEDGUIDE study compilation prints no institution, author, sitting, marks or official key authority. Eighteen source-first handles replay 72 searches, and every handle is exact prior-FHB reuse. The remaining source set is 45 inventory rows and 45 SHA-256 values, checksum `44fbeee2500c67d8f337898a2d1dcc18d08bd8a00f958c8b24bee16fb7b28485`; debt is 9 substantive-text, 31 empty-text and 5 sparse-text rows.
