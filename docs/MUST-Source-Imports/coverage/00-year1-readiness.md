...
**`checkpointed-incomplete`.** The completed read-only sources yield 7156 questions, 6741 prompt-matched recovered answers, and 489 tested concepts (66 live-hit / 90 pending-hit / 333 new, all placement TBD). The newly closed two-page `Stains.pdf` is an image-only handwritten teaching table pairing organelles and inclusions with stains, not an official paper or key. Its declarative rows contain no question stem, practical-identification task, blanks or answer convention, so the exact boundary is zero prompts, zero answers and zero handles/searches. The remaining source set is 12 inventory rows and 12 SHA-256 values, checksum `d6278135049c99f3d95310e9c70141393e1cca7783b2114e7e14d235602a14a6`; debt is 0 substantive-text, 8 empty-text and 4 sparse-text rows.
