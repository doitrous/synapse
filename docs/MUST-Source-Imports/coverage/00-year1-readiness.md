...
**`checkpointed-incomplete`.** The completed read-only sources yield 6523 questions, 6159 prompt-matched recovered answers, and 485 tested concepts (66 live-hit / 90 pending-hit / 329 new, all placement TBD). The newly closed 14-page `FHB Histo MCQs Ziad Ashraf.pdf` is a named student/peer-authored revision bank for the 2024/2025 midterm scope, not an official MUST paper or key. It contains 24 four-option MCQs plus seven one-to-one matching prompts, with 31 printed answers; Q1–Q24 also receive answer explanations. Fifteen source-first handles replay 60 searches and all collapse to exact prior-FHB reuse, so the cumulative concept delta is zero. The remaining source set is 30 inventory rows and 30 SHA-256 values, checksum `b731aa087c0a234d3c17c817aeaa34c9e0126a587035f5c74ee58a9fbfcfc697`; debt is 4 substantive-text, 21 empty-text and 5 sparse-text rows.
