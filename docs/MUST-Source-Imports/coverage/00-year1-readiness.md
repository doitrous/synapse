...
**`checkpointed-incomplete`.** The completed read-only sources yield 7908 questions, 7491 prompt-matched recovered answers, and 489 tested concepts (66 live-hit / 90 pending-hit / 333 new, all placement TBD). The newly closed 51-page `Physiology FHB101 Questions (Midterm).pdf` is a Word 365 / Absalam101 student revision compilation, not an official MUST examination or key. Its exact boundary is three independently numbered 50-question MCQ parts, yielding 150 prompts and 150 inline printed, prompt-matched answers. Three exact stem pairs and the broader differently worded repetitions were collapsed under eight source-first handles; 32 searches found no external corpus match, and every handle reproduces completed prior-FHB blood assignments, so the concept delta is zero. The remaining source set is 6 inventory rows and 6 SHA-256 values, checksum `db98a57b90f11fc2d3fcf66064325bf005aefa349669ad51c89122591363f2e2`; debt is 0 substantive-text, 6 empty-text and 0 sparse-text rows.
