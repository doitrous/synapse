...
**`checkpointed-incomplete`.** The completed read-only sources yield 980 questions, 789 printed keys, and 272 tested concepts (61 live-hit / 65 pending-hit / 146 new, all placement TBD). Detailed completed-family totals and source-first evidence are pinned in `FHB-101-TRIAGE.md`. The two-page Physiology Blood midterm contributes ten prompts and no printed key: inconsistent red handwritten marks were excluded; five concepts remain after prior-FHB deduplication (one live, four new). The remaining source set is 84 inventory rows and 80 SHA-256 values. Its sorted-newline set checksum is `61cd0a41df2974cadaa800df96f68c373089fa8ce010c0360445d5d8e0b61cdb`; extraction debt within the remaining rows is 37 empty-text plus 6 sparse-text rows.
...
Additional completed source-family hash: `6ce0f81b5a2ab455d7194a47cb0833680b3dedfeb8840fbae72332a4afb8c206`.
