...
**`checkpointed-incomplete`.** The completed read-only sources yield 4467 questions, 4186 prompt-matched recovered answers, and 456 tested concepts (66 live-hit / 84 pending-hit / 306 new, all placement TBD). The newly closed three-path `FHB exam 101 2020_compressed-1.pdf` family is one exact-byte 37-page source stored under Anatomy, Histology and Physiology. Its Qorrect live-attempt screenshots show the title `FHB 101 Final Online Theoretical Exam`, a 39-question/78-mark sitting and timer, but the PDF contains 37 prompts because Q26 and Q35 are absent. Thirty-six prompts have visible student selections and Q17 is unselected; the attempt choices are preserved as recovered observations, not official or validated key authority. Twenty-two source-first handles replay 88 searches, and every handle is exact prior-FHB reuse. The remaining source set is 49 inventory rows and 49 SHA-256 values, checksum `37d0784fdc15acf2bfedd9346d0133b846a95b4ce6fb8140b2d12be824d7acd3`; debt is 9 substantive-text, 34 empty-text and 6 sparse-text rows.
