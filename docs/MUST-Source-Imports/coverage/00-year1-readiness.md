...
**`checkpointed-incomplete`.** The completed read-only sources yield 970 questions, 789 printed keys, and 267 tested concepts (60 live-hit / 65 pending-hit / 142 new, all placement TBD). Detailed completed-family totals and source-first evidence are pinned in `FHB-101-TRIAGE.md`. The two-page Histology Cytology (Nucleus) midterm paper contributes nine prompts and nine printed answer letters; its four source concepts collapse to one pending after prior-FHB deduplication. The paired three-page Physiology written-exercise question and answer family is three inventory paths but two byte-distinct files; it contributes 16 distinct printed prompts, 16 directly printed answers, and two after-deduplication concepts (one pending, one new). The three-page Anatomy Embryology written-practice sheet contributes 21 printed prompts and 21 directly aligned printed answers; its 11 source-distinct assignments are all prior-FHB duplicates. The two-page Anatomy Embryology written-final sheet contributes three printed prompts, no key, and no new concept because its three named assignments are all prior-FHB duplicates. The fully read 101-page Histology final-revision-question paper contributes 111 printed prompts, no key, and no source-named tested concept because every target remains image-dependent or covered. The practical-teaching decks remain source debt: titles, image labels, and figure callouts—including white-covered label areas—are not treated as inferred assessment prompts, answers, or concepts. The remaining source set is 85 inventory rows and 81 SHA-256 values. Its sorted-newline set checksum is `ffc15dff857e2661d95076a9a55ea123cdf8f5e9308629ad7d28cf35ac372835`; extraction debt within the remaining rows is 37 empty-text plus 6 sparse-text rows.
