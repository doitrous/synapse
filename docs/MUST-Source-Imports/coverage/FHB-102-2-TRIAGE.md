...
## Completed source — `Pharmacology FHB102-2 Exam Night Questions & Notes (Final)`

| Source path | SHA-256 | Pages | Audit class | Full visual read | Provenance / authority |
|---|---|---:|---|---|---|
| `Year 1/Semester 102/FHB 102-2/Pharmacology/06 EOM Exams/EOM MCQs - Pharmacology FHB102-2 Exam Night Questions & Notes (Final).pdf` | `cb110e4f11346fa2b531a29a7617ff9dd5c0c91f714d9efcd332826dee5c8fca` | 8 | substantive-text | pages 1–8 rendered and read | Microsoft Word-authored personal revision carrier titled `Pharmacology FHB102-2 Exam Night Questions & Notes (Final)`, labelled `Dr. Ahmed Isa’s questions`, bearing `200057470-Abdel Salam Muhammad Abdel Salam Mahmoud` author metadata and an `Absalam101 & Shahd` footer credit. No authenticated MUST platform, institution, department, examiner, sitting, marks scheme or faculty-key declaration appears. |

### Exact boundary and answer state

Pages 1–6 contain Q1–Q23. Page 7 contains Q24 and a complete Q1–Q24 answer-letter table. Page 8 is a revealed `Important Notes & Topics` teaching list. The exact boundary is **24 ordinary objective MCQs / 24 prompt-matched printed answer observations / 0 source-absent / 0 written / 0 practical or image-dependent / 1 teaching-reference page**. The terminal table is retained as a personal revision-source observation rather than promoted to an authenticated faculty key, and page 8's topic labels are not reverse-engineered into prompts.

### Replay and exactly-four-search gate

Normalized stem screening and complete prompt-plus-option comparison against all seventy-eight prior processed families maps current Q4 to the earlier PentaGram Chemo 1 antifungal field and current Q7 to the earlier Mohamed Farid fluoroquinolone-interaction field. Both prior answers agree with the current printed `A` observations, so **2 prompts / 2 answers** collapse once. Same-stem candidates for current Q6 and Q13 are rejected because their option fields differ. The governed delta is therefore **+22 questions / +22 answers**.

Five source-first handles cover protein-synthesis inhibitors, clinical uses and toxicities; fluoroquinolones, rifampicin, mechanisms and interactions; tuberculosis prophylaxis, isoniazid and adverse effects; antifungal mechanisms, uses and toxicities; and antimicrobial selection, surgical prophylaxis and pregnancy safety. All five collapse to prior FHB-102-2 evidence. Search arithmetic is **5 source-first − 5 prior-collapsed = 0 accepted; 0 × 4 = 0 searches**. Post-prior disposition is **0 live / 0 pending / 0 new**.

Malformed wording and pronoun shifts in Q12, the malformed exception stem in Q14, and printed terminology or academically questionable answer claims remain literal source truth without correction.

### Delta, cumulative totals and next source

This seventy-ninth one-path hash is now `sourceProcessed=true`, adding **+22 questions / +22 answers / +0 concepts**. Cumulative triage is **5,309 questions / 5,076 answers / 62 concepts**.

Removing the seventy-nine processed hashes leaves **15 selected inventory paths / 15 unique SHA-256s**. Their sorted-newline checksum is `8bfe0c676471b135eabdbbb9ca5e736012a601a99345d02d9cbde23f2cbdb81f`. Remaining audit-review debt is **4 substantive-text / 0 sparse-text / 0 empty-text / 11 audit-not-found / 0 audit-extract-failed rows**. Unique-hash accounting is **`79 + 15 = 94`** and path accounting is **`81 + 15 = 96`**.
...
## Completed source — `B-Lactam and Vancomycin`

| Source path | SHA-256 | Pages | Audit class | Full visual read | Provenance / authority |
|---|---|---:|---|---|---|
| `Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/B-Lactam and Vancomycin.pdf` | `100c06013545f596ed39d298f3f9e8b2ec782c5dfdb42ddf8e5eb21c033c1fd4` | 29 | audit-not-found | pages 1–29 rendered and read | Anonymous metadata-silent PDF 1.7 teaching deck. The visible slides identify no authenticated MUST platform, institution, department, module, lecturer, examiner, sitting, marks scheme or faculty-key declaration. |

### Exact boundary and answer state

Page 1 is an `Individual Groups` antibiotics word-cloud cover. Pages 2–9 cover cell-wall inhibitors, beta-lactam classes, mechanism, important points and spectrum. Pages 10–16 cover penicillin classes, preparations, spectrum and adverse effects. Pages 17–20 cover cephalosporin generations and pharmacology; pages 21–22 cover monobactam; pages 23–24 cover carbapenems; pages 25–28 cover glycopeptides, vancomycin, pseudomembranous colitis and adverse effects. Page 29 is a multilingual thank-you closer. The exact boundary is **0 objective MCQs / 0 written prompts / 0 practical or image-dependent prompts / 0 printed answer observations / 0 source-absent answers / 27 teaching-reference pages / 1 non-assessment cover / 1 non-assessment closing page**.

The page-20 heading `What about fourth generation cephalosporins?` is immediately answered teaching content rather than an assessment field. Section-title slides, numbered drug classes, diagrams, product images and highlighted facts are declarative teaching structure. No answer is inferred and no diagram, table or teaching statement is reverse-engineered into a question. Printed spelling, grammar, terminology and medically or academically questionable claims remain literal source truth without correction.
...
This eighty-seventh one-path hash is now `sourceProcessed=true`, adding **+0 questions / +0 answers / +0 concepts**. Cumulative triage remains **5,444 questions / 5,211 answers / 62 concepts**.

Removing the eighty-seven processed hashes leaves **7 selected inventory paths / 7 unique SHA-256s**. Their sorted-newline checksum is `45bad029e35e90125fa8970e1980ae1894f384c6f08efb6346e5dbf0254fa037`. Remaining audit-review debt is **0 substantive-text / 0 sparse-text / 0 empty-text / 7 audit-not-found / 0 audit-extract-failed rows**. Unique-hash accounting is **`87 + 7 = 94`** and path accounting is **`89 + 7 = 96`**.
...
## Completed source — `cell wall`

| Source path | SHA-256 | Pages | Audit class | Full visual read | Provenance / authority |
|---|---|---:|---|---|---|
| `Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/cell wall.pdf` | `be89e24f14a2b580bbd8a4ba954f4bdfa482fa054e5ebc791e82001b60eead6e` | 9 | audit-not-found | pages 1–9 rendered and read | Metadata-silent PDF 1.7 teaching excerpt with creation and modification timestamps but no title or author metadata. The visible slides identify no authenticated MUST platform, institution, department, module, lecturer, examiner, sitting, marks scheme or faculty-key declaration. |

### Exact boundary and answer state

Page 1 covers monobactams and aztreonam. Pages 2–4 cover carbapenems, imipenem-cilastatin and meropenem. Pages 5–8 cover vancomycin mechanism, formulations, uses and adverse effects. Page 9 covers bacitracin. The file begins directly with monobactam content and ends directly with bacitracin content, so there is no separate cover or closing page. The exact boundary is **0 objective MCQs / 0 written prompts / 0 practical or image-dependent prompts / 0 printed answer observations / 0 source-absent answers / 9 teaching-reference pages**.

Numbered drug classes, mechanisms, uses, adverse effects and product images are declarative teaching structure rather than assessment fields. No answer is inferred and no teaching statement is reverse-engineered into a question. Printed spelling, grammar, terminology and medically or academically questionable claims remain literal source truth without correction. Metadata silence is retained without inventing lecturer, institution or authority.
...
This ninety-second one-path hash is now `sourceProcessed=true`, adding **+0 questions / +0 answers / +0 concepts**. Cumulative triage remains **5,444 questions / 5,211 answers / 62 concepts**.

Removing the ninety-two processed hashes leaves **2 selected inventory paths / 2 unique SHA-256s**. Their sorted-newline checksum is `e03f959551db115e3fddceac5a191788dbb99e71e2d7e64c8d7ca456778bc123`. Remaining audit-review debt is **0 substantive-text / 0 sparse-text / 0 empty-text / 2 audit-not-found / 0 audit-extract-failed rows**. Unique-hash accounting is **`92 + 2 = 94`** and path accounting is **`94 + 2 = 96`**.

The next evidence-ranked source is `Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/general antibacterial 1.pdf`, SHA-256 `160f09412500534a71cec2241c8b9d35ab03a8de5ed39409a84e529f87900c78`, 29 pages, with an audit-not-found sample state.

**BLOCKED — S1 cannot be approved:** 2 selected inventory paths / 2 unique hashes remain untriaged.

## Completed source — `general antibacterial 1`

| Source path | SHA-256 | Pages | Audit class | Full visual read | Provenance / authority |
|---|---|---:|---|---|---|
| `Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/general antibacterial 1.pdf` | `160f09412500534a71cec2241c8b9d35ab03a8de5ed39409a84e529f87900c78` | 29 | audit-not-found | pages 1–29 rendered and read | Metadata-silent PDF 1.7 teaching deck whose visible cover names Dr Mohamed Abdel Aziz. No authenticated MUST platform, institution, department, module, examiner, sitting, marks scheme or faculty-key declaration appears. |

### Exact boundary and answer state

Page 1 is the `Antimicrobials (chemotherapy)` title-and-lecturer cover. Pages 2–9 cover antimicrobial principles, spectrum, uses and general adverse effects. Pages 10–13 cover cell-wall classes and penicillin mechanisms. Pages 14–20 cover penicillin preparations and beta-lactamase inhibitors. Pages 21–25 cover penicillin uses and adverse effects, including clinical-image references. Pages 26–29 cover cephalosporin generations, resistance and adverse effects. The exact boundary is **0 objective MCQs / 0 written prompts / 0 practical or image-dependent prompts / 0 printed answer observations / 0 source-absent answers / 28 teaching-reference pages / 1 non-assessment cover page**.
...
This ninety-third one-path hash is now `sourceProcessed=true`, adding **+0 questions / +0 answers / +0 concepts**. Cumulative triage remains **5,444 questions / 5,211 answers / 62 concepts**.

Removing the ninety-three processed hashes leaves **1 selected inventory path / 1 unique SHA-256**. Its sorted-newline checksum is `b2e50f0a114d59ba4937cbb94bfb577a3f9f96f06061dd924a646569eab53b7d`. Remaining audit-review debt is **0 substantive-text / 0 sparse-text / 0 empty-text / 1 audit-not-found / 0 audit-extract-failed row**. Unique-hash accounting is **`93 + 1 = 94`** and path accounting is **`95 + 1 = 96`**.
