...
| Claims | 98 | verified against local curriculum citations; independent review still owed |
| Citations | 103 | local curriculum |
| Article spans | 98 | linked to the clean-key claims |
| Concepts | 89 | under review / needs evidence |
| Articles | 30 | Draft |
| Questions | 98 | Draft |
| Question authoring holds | 113 | no student-facing record authored |
...
- Governed prompt observations: 5,444 total; 98 authored; **5,346 raw prompt observations remain**, including 113 explicit holds and one source-absent opening-family prompt.
- Governed answer observations: 5,211 total; 98 clean source-keyed prompts authored; **5,113 raw answer observations remain**, including the 113 held printed-key observations; Q32 contributes no answer observation.
