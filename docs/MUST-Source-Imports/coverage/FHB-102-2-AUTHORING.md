...
| Kind | Created | Status |
|---|---:|---|
| Evidence resources | 32 | local-only source records; Q24–Q31 lecture records retain explicit bounded visual-read pages |
| Claims | 273 | verified against local curriculum citations; independent review still owed |
| Citations | 278 | local curriculum |
| Article spans | 273 | linked to the clean-key claims |
| Concepts | 195 | under review / needs evidence |
| Articles | 47 | Draft |
| Questions | 273 | Draft |
| Question authoring holds | 337 | no student-facing record authored |
...
- Governed answer observations: 5,211 total; 273 clean source-keyed prompts authored; **4,938 raw answer observations remain**, including the 337 held printed-key observations; opening-bank Q32 and Mucize Q25 contribute no answer observations.
