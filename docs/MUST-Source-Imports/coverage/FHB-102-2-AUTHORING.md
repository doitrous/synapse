...
| Kind | Created | Status |
|---|---:|---|
| Evidence resources | 24 | local-only source records; Q24–Q31 lecture records retain explicit bounded visual-read pages |
| Claims | 76 | verified against local curriculum citations; independent review still owed |
| Citations | 81 | local curriculum |
| Article spans | 76 | linked to the clean-key claims |
| Concepts | 69 | under review / needs evidence |
| Articles | 27 | Draft |
| Questions | 76 | Draft |
| Question authoring holds | 105 | no student-facing record authored |
...
- Governed prompt observations: 5,444 total; 76 authored; **5,368 raw prompt observations remain**, including 105 explicit holds and one source-absent opening-family prompt.
- Governed answer observations: 5,211 total; 76 clean source-keyed prompts authored; **5,135 raw answer observations remain**, including the 105 held printed-key observations; Q32 contributes no answer observation.
