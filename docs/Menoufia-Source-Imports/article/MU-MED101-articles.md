<!--
  MU-MED101 (Foundation 1) - lane-1 teaching articles for the 32 new concepts
  in concept/MU-MED101-concepts.md, plus one article ('genetics') that
  teaches the two Kasr concepts reused as sparse overlays in
  pending-live/MU-MED101-concepts-overlay.md. Each article names its
  concepts in ## related_concepts and teaches them in ## sections, per the
  teach-before-test rule. All six use TPL-CONCEPT.

  Import: Admin > Library > Import. Must land with/after
  concept/MU-MED101-concepts.md (gate --with).
-->
...
## title
Anatomical movement terminology: girdle, thumb, forearm, foot and wrist
...
## title
Bone growth and long-bone classification
...
## title
Joint classification, circumduction, the endocrine system and portal circulation
...
## title
Cell inclusions, pigments, histochemical stains and the lysosome-study cell
...
## title
Organelle biogenesis, the cell cycle, and membrane composition
...
## id
ART-MU101-GENETICS-0D8B290F

## title
Ciliary ultrastructure and sex-chromosome syndromes
