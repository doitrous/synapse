...
- HELWAN DOWNSTREAM READINESS (2026-08-31): terminal readiness, claims, index and `HU-Y1-TRIAGE-GATES.md` are committed; the deterministic checker reports aggregate inventory `COMPLETE`, authoring release `APPROVED_THREE_MODULES_PSY_HOLD`, and S1 `READY_FOR_SCOPED_AUTHORING`. The source index covers all 946 manifest paths / 888 content-addressed IDs. BMS-101 is complete; BMS-102 now includes the Family 5 routine closure, Family 6 Parts 1–2, closed routine Family 7, and Family 8 Part 1; LCS-103 Families 77, 96, 97, 98, all 38 importer-valid Family 99 records, and Family 101 Q1–Q11 are authored without PSY content. Seven guarded live imports passed and were uploaded as Draft. Preserve article -> question -> practical/written ordering.
- STUDENT-FACING / LIVE: the current Helwan Draft release is 46 substantive articles / 475 exact keyed MCQs / 8 marked written records / 2 practical records with 5 practical questions / 344 module-linked concept rows. Per module: HU-BMS-101 = 4 articles / 224 MCQs / 8 written / 0 practical; HU-BMS-102 = 27 articles / 131 MCQs / 0 written / 2 practical records with 5 questions; HU-LCS-103 = 15 articles / 120 MCQs / 0 written / 0 practical; HU-PSY-104 = HOLD / 0 released. The latest live read-back is 689 total articles / 4,335 questions / 101 practicals / 3,422 concepts. All 531 Helwan content records remain `Draft`, so students cannot see them until explicit publication approval.
