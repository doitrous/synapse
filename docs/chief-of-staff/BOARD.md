...
- CURRENT EVIDENCE CHECKPOINT (2026-08-31): Helwan Year 1 = 7,318 accepted prompts / 5,777 answers / 2,435 concepts. Recent BMS virtual-lab evidence totals 15 image MCQs + 40 practical case/image written operations + 6 drawing/written operations (31 source-supplied answers), plus LCS practical evidence (94 prompts / 526 teaching plates / 3,039 mappings / 173 unresolved residues / 87 keys). BMS is durably checkpointed through Family 291 with 4 paths / 4 unique hashes remaining; Family 290 closes a teaching-only pharmacodynamics handout at zero assessment delta, and Family 291 adds four unkeyed pharmacodynamics MCQs plus three new concepts after 16 searches. LCS source triage is exhausted at Family 230 with 0 paths / 0 hashes remaining and literal `TRIAGE APPROVED`; its external ledger closes at 7,635 prompts / 7,349 answers / 221 concepts. PSY-104 local inventory and full local authority search are exhausted, but its sole tier-9 study bank lacks institutional/sitting/key authority and contains a conflicting repeat key; PSY remains explicit HOLD pending an official Helwan/Capital paper or department bank with a matched official key, while a scope-qualified BMS101/BMS102/LCS103 release remains defensible. MUST FHB-101 = 8,044 questions / 7,626 answers / 489 concepts; all 115 selected paths / 106 hashes are processed and literal `TRIAGE APPROVED` is recorded. MUST MSK-101-1 = 7,165 questions / 6,960 answers / 36 concepts; all 103 selected paths / 101 unique hashes are reconciled and literal `TRIAGE APPROVED` is recorded. MUST FHB 102-2 is at 5,022 questions / 4,789 answers / 62 concepts, with 27 selected paths / 27 unique hashes remaining; its full later-source read-ahead ledger is closed at a projected 5,444 questions / 5,217 answers / 62 concepts with zero remaining source-review debt, pending governed sequential commits.
