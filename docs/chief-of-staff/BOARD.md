...
- HELWAN DOWNSTREAM READINESS (2026-08-31): terminal readiness, claims, index and `HU-Y1-TRIAGE-GATES.md` are committed; the deterministic checker reports aggregate inventory `COMPLETE`, authoring release `APPROVED_THREE_MODULES_PSY_HOLD`, and S1 `READY_FOR_SCOPED_AUTHORING`. The source index covers all 946 manifest paths / 888 content-addressed IDs. BMS-101 is complete; BMS-102 now includes the Family 5 routine closure, Family 6 Parts 1–2, closed routine Family 7, and Family 8 Parts 1–3; LCS-103 Families 77, 96, 97, 98, all 38 importer-valid Family 99 records, and 19/21 Family 101 records are authored without PSY content. Eight guarded live imports passed and were uploaded as Draft. Preserve article -> question -> practical/written ordering.
- STUDENT-FACING / LIVE: the current Helwan Draft release is 51 substantive articles / 507 exact keyed MCQs / 8 marked written records / 2 practical records with 5 practical questions / 365 module-linked concept rows. Per module: HU-BMS-101 = 4 articles / 224 MCQs / 8 written / 0 practical; HU-BMS-102 = 31 articles / 155 MCQs / 0 written / 2 practical records with 5 questions; HU-LCS-103 = 16 articles / 128 MCQs / 0 written / 0 practical; HU-PSY-104 = HOLD / 0 released. The latest live read-back is 694 total articles / 4,367 questions / 101 practicals / 3,439 concepts. All 568 Helwan content records remain `Draft`, so students cannot see them until explicit publication approval.
