...
- STUDENT-FACING / LIVE: HU-BMS-101 is committed at `4d05f8b0` with 4 substantive articles / 179 concepts / 224 exact source-released MCQs / 8 marked written records / 0 practicals; governed holds are 9 unresolved MCQs and 19 unmarked written prompts. Its generator assertions, every per-file batch, full simulation, content-depth audit, authoring validator, taxonomy validator and owned-ID duplicate check are clean. HU-BMS-102 has two committed Pathology slices at `54ebfe5a` and `56250dd3`, totalling 10 concepts / 3 articles / 10 exact keyed MCQs / 2 virtual labs with 5 practical questions / 0 written, with full simulation and audit clean. Nothing is uploaded yet because the approved Helwan package must pass the combined release gate; HU-LCS-103 is the remaining active authoring lane.
