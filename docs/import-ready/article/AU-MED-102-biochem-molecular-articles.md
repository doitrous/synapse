...
or for RNA.
Base excision, nucleotide excision and mismatch repair each answer a different kind of DNA
damage — matching the pathway to the lesion is the tested skill, not just naming "DNA repair".
...
carries.
A frameshift mutation (insertion/deletion not a multiple of three) shifts every downstream
codon; a point substitution changes only the one codon it hits.
