...
## section_id
art-fnd-au-med-102-cho-chemistry-definition

## text
An asymmetric carbon atom — one bonded to four different groups — is what gives a monosaccharide its stereochemistry, and with it, four distinct kinds of relationship between two sugars that share a molecular formula.
...
## section_id
art-fnd-au-med-102-cho-chemistry-mechanism

## text
Maltose and lactose each retain one free anomeric carbon and so reduce Benedict's or Fehling's reagent; sucrose's bond consumes both anomeric carbons, leaving none free, which is why it is the sole non-reducing sugar among the three.

## claim_ids
CLM-FND-CHO-ECB218660B15FE-01 | CLM-FND-CHO-02FBBE4CD4CAC1-01

## citation_ids
CIT-FND-CHO-ECB218660B15FE-01 | CIT-FND-CHO-02FBBE4CD4CAC1-01
...
## text
Inulin breaks the pattern the department tests directly: it is a homopolysaccharide, but of fructose, making it a fructosan, not a glucosan.
...
## text
Hyaluronic acid (glucuronic acid + N-acetylglucosamine) is the only sulfate-free GAG, and acts as a lubricant and shock absorber in synovial fluid.
