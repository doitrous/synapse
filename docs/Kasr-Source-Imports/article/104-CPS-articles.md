...
microtopic: The canonical placement and the module-subject path are already finer than any microtopic in the overlay would be.
nanotopic: The microtopic level is unused here; a nanotopic beneath it would be finer than anything the department book distinguishes.
