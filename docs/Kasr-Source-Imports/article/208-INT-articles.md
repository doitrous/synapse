...
## title
Acute and chronic inflammation: cellular events, suppurative patterns, and macrophage biology
## subject
fnd
## status
Draft
...
208 INT
## module_subject
208 INT > Chapter 1 Inflammation
## subtopic
...
## title
Healing by regeneration and fibrosis, granulation tissue, and the complications of wound repair
## subject
fnd
## status
Draft
...
Pathology
## summary
Healing replaces injured tissue either by regeneration (the same cell type, restoring normal structure) or by fibrosis (scar formation), and which one occurs depends on the tissue's proliferative class and whether the supporting framework survived the injury — a distinction the liver makes vivid, since hepatocyte-only injury regenerates but framework-destroying injury produces cirrhosis. Granulation tissue, formed of new capillaries and fibroblasts, is the vascular, moist, red early stage of fibrosis-based healing that later matures into pale, avascular scar. Repair itself, done badly or too well, produces its own recognised complications distinct from the disease that caused the wound.
## sections
### Definition
Regeneration replaces damaged cells with the same cell type, restoring normal tissue structure; it follows damage to rapidly dividing labile cells (surface epithelium, hematopoietic cells) or to minimally damaged stable parenchyma, such as the liver, which has strong regenerative capacity despite normally dividing slowly. Fibrosis replaces damaged tissue with fibrous scar; it follows damage to permanent, non-dividing cells (cardiac muscle, nerve cells) or to tissue where the supporting connective-tissue framework itself, not just the parenchymal cells, has been destroyed.

Granulation tissue is the early stage of fibrosis-based repair: proliferating capillaries and fibroblasts (some becoming myofibroblasts), moist, red, and bleeding easily — the name comes from the granular look these new capillaries give the base of a healing ulcer. As repair matures, proliferating endothelial cells and fibroblasts decrease while collagen type I increases, converting granulation tissue into the pale, nearly avascular final scar.

### Mechanism
The liver is the clearest worked example of the regeneration-versus-fibrosis rule. Hepatocyte loss alone (the parenchymal cells only) is followed by regeneration and complete restitution. But when chronic injury destroys both the hepatocytes and the connective-tissue architecture around them — as in chronic hepatitis — the hepatocytes still regenerate, but they cannot rebuild the original architecture: they form disorganised nodules walled off by fibrous scar. That is cirrhosis, and it is fibrosis, not regeneration, precisely because the framework, not just the cells, was destroyed.
...
### Clinical significance
Recognising which injuries a given organ can regenerate from, and which force it into fibrosis, predicts long-term outcome directly — a laceration confined to hepatocytes has a genuinely different prognosis from one that also disrupts portal architecture. Keloid risk and Marjolin's ulcer are both reasons a chronic wound or old burn scar needs ongoing clinical attention rather than being considered fully resolved once the surface has closed.

### Common misconceptions
Assuming any liver injury heals by simple regeneration because the liver is known to regenerate — regeneration only restores normal architecture when the framework survives; once it does not, disorganised regenerating nodules are what get walled off into cirrhosis. Describing granulation tissue as avascular or dry — that description belongs to the mature scar it becomes, not to granulation tissue itself.
## universities
kau
## years
KAU_Y2
...
208 INT
## module_subject
208 INT > Chapter 2 Healing and Repair
## subtopic
Inflammation and repair
## microtopic
...
## title
Disorders of growth and the basics of neoplasia: adaptation, carcinogenesis, tumor markers and grading
## subject
fnd
## status
Draft
...
Named carcinogens each pair with a specific cancer in this teaching: aflatoxin (from Aspergillus flavus, a fungal food contaminant) causes hepatocellular carcinoma; Epstein-Barr virus causes Burkitt's lymphoma, nasopharyngeal carcinoma and other B-cell lymphomas; hepatitis B causes hepatocellular carcinoma by a different, viral route; and human papilloma virus causes cervical and some skin carcinomas.
...
208 INT
## module_subject
208 INT > Chapter 3 Disorders of Growth and Neoplasia
## subtopic
Neoplasia
## microtopic
