...
| bank Protozoology MCQ (Q1-46 of 84, answer table p.21) | 42 | 4 | 0 | Q47-84 | 84 |
| **bank Trematoda + Cestoda + Nematoda + Protozoology clusters total** | **144** | **16** | **0** | Protozoology Q47-84 + Entomology | — |
| 309 INF module (Microbiology + Parasitology sub-corpora) | 144 | 16 | 0 | Protozoology Q47-84 p.18-20, Entomology p.22 | — |
...
**Protozoology remainder** (Q47-84, pp.18-20; same 'Answers of Protozoology' table p.21), appending to
`question/309-INF-protozoa-mcq.md` and `ART-INF-309-PROTOZOA` — hold the in-source duplicates (Q52=Q41, Q54=Q48, Q57=Q50,
Q58=Q51, Q59=Q8, Q84=Q11, Q78≈Q2) as their first-occurrence originals are already authored. Then **Entomology** (p.22, answers
p.23) as a new section, and after parasitology is fully mined, the **Microbiology MCQ portion** of the same bank. Recover each
