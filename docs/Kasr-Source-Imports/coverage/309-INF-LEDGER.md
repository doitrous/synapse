...
| bank Nematoda MCQ (Q1-20 of 67, answer table p.13) | 18 | 2 | 0 | Q21-67 | 67 |
| **bank Trematoda + Cestoda + Nematoda clusters total** | **61** | **6** | **0** | Q21-67 Nematoda | — |
| 309 INF module (Microbiology + Parasitology sub-corpora) | 61 | 6 | 0 | Nematoda Q21-67 p.9-12, Protozoology p.14-20, Entomology p.22 | — |
...
Author the remaining **Nematoda MCQ** (Q21-67, pp.9-12; same answer table p.13); then Protozoology (answers
p.21) and Entomology (answers p.23). Recover each section's keys from its own printed answer table before
authoring.
