...
- **Q76-108 physiology** — next cluster: cerebellum, sleep/EEG, vision, hearing physiology
  (pages 11-13, OCR/render-legible via the same green-highlight signal). Reuse the physiology
  concepts minted here where they recur.
- **Q109-115 + Section B** — figure-dependent (labelled diagrams / matching table) → hold for
  image attachment.
