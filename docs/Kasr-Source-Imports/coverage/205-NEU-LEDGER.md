...
| 2024-eom-physiology-b | 31 | 2 | 0 | 33 |
...
- **Q109-111 physiology (text-only)** — next cluster: corneal-graft immune privilege (Q109.D),
  corneal epithelium histology (Q110.A), iris histology (Q111.A). Keys already render-confirmed
  this pass (see triage-keys). Earlier assumed figure-dependent, but they carry NO figure and are
  authorable now; keys D/A/A.
- **Q112-115 + Section B** — figure-dependent: Q112-113 reference the labelled "Figure (A)"
  spinal-cord cross-section; Q114-115 + Section B (matching table) also figure/table-dependent →
  hold for image attachment.
