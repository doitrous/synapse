...
74 of 75 source files have been read (76 manifest rows: 1 file is indexed twice under different names). They yielded
...
| `concept/101-ISK-mcq-concepts.md` | 88 |
| `concept/101-ISK-practical-concepts.md` | 43 |
| `question/101-ISK-mcq.md` | 640 |
| `article/101-ISK-anatomy.md` | 34 |
| `article/101-ISK-histology-2.md` | 12 |
| `article/101-ISK-histology-3.md` | 2 |
...
| EOY Anatomy cases 1st year 2025-1 (2).pdf <br>*also filed as 101 ANATOMY ASSESSMENT cases 1st year 2025-1 (2).pdf* | EOY | 8 | 44 written | read in full |
