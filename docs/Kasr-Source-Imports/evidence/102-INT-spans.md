<!--
  Article spans for 102 INT — one per claim in 102-INT-claims.md.

  A span is the join between what a student reads and what supports it: the
  exact sentence in the published article, the claim that asserts it, and the
  citation that proves it from the department book.

  Every ID here is derived from an ID that already exists. A span ID is its
  claim's ID with SPN- in place of CLM-, so the mapping is mechanical.
  No article ID, section name, claim ID or citation ID was minted here; the
  article IDs and section headings come from 102-INT-biochemistry.md and
  102-INT-physiology.md, and section_id is the `### ` heading exactly as
  written there.

  Every `text` value is copied verbatim from the named section — no
  paraphrase, no summary, and never the claim's own display_text. Where the
  article asserts a claim as an enumeration across consecutive paragraphs, as
  the book itself does, the span quotes that contiguous block whole rather
  than a single line of it; where the article's sentence carries only part of
  its claim, the span carries the part the article actually asserts and the
  shortfall is recorded in scripts/kasr/extract/102-INT/spans-report.md rather
...
## citation_ids
CIT-AMINO-ACID-CHEMICAL-AND-NUTRITIONAL-CLAS-01
...
## id
SPN-GIT-CELLULOSE-DIETARY-IMPORTANCE-01
...
## citation_ids
CIT-CELLULOSE-DIETARY-IMPORTANCE-01
...
## id
SPN-FND-GAG-SHOCK-ABSORPTION-MECHANISM-01
...
## id
SPN-FND-NUCLEOTIDE-COENZYME-HYDROGEN-CARRIERS-01
...
## citation_ids
CIT-NUCLEOTIDE-COENZYME-HYDROGEN-CARRIERS-01
...
## id
SPN-END-HBA1C-THREE-MONTH-GLYCAEMIC-WINDOW-01
...
## id
SPN-FND-EUKARYOTIC-DNA-POLYMERASES-AND-ROLES-01
...
## id
SPN-FND-FACTORS-AFFECTING-ENZYME-REACTION-RATE-01
...
## id
SPN-INF-SULFONAMIDE-COMPETITIVE-INHIBITION-OF-FO-01
...
## id
SPN-MUL-SNAKE-VENOM-PHOSPHOLIPASE-HAEMOLYSIS-01
...
## id
SPN-FND-EICOSANOID-SYNTHESIS-PATHWAY-ENZYMES-01
...
Prostaglandin H synthase makes the cyclic compounds — the prostaglandins, prostacyclins and thromboxanes. This enzyme has two catalytic activities: cyclooxygenase, abbreviated COX, and peroxidase.
...
## id
SPN-FND-EICOSANOID-PATHWAY-DRUG-TARGETS-01
...
## id
SPN-FND-POST-TRANSLATIONAL-COVALENT-MODIFICATION-01
...
## id
SPN-FND-POINT-MUTATION-TYPES-AND-CONSEQUENCES-01
...
## id
SPN-FND-MRNA-SPLICING-AND-ALTERNATIVE-SPLICING-01
...
**Four, the adrenal medulla.** It is considered a modified sympathetic ganglion, in which the postganglionic cells have lost their axons and secrete catecholamines directly into the bloodstream.
...
## id
SPN-HEM-VITAMIN-B12-ABSORPTION-INTRINSIC-FACTOR-01
...
## id
SPN-HEM-VITAMIN-B12-IMPORTANCE-AND-DEFICIENCY-01
...
## id
SPN-FND-MANNITOL-CLINICAL-APPLICATIONS-01
...
## citation_ids
CIT-MANNITOL-CLINICAL-APPLICATIONS-01
...
## id
SPN-FND-FREE-NUCLEOTIDE-BIOLOGICAL-FUNCTIONS-01
...
## id
SPN-HEM-GLOBIN-PROTEIN-PART-FUNCTIONS-01
...
## id
SPN-FND-DNA-DOUBLE-HELIX-ANTIPARALLEL-STRANDS-01
...
## id
SPN-FND-MITOCHONDRIAL-DNA-CHARACTERISTICS-01
...
## id
SPN-FND-REPLICATION-FORK-STRAND-SEPARATION-01
...
## id
SPN-FND-COMPETITIVE-ENZYME-INHIBITION-MECHANISM-01
...
## id
SPN-FND-CHOLESTEROL-IMPORTANCE-AND-DERIVATIVES-01
...
## id
SPN-FND-EUKARYOTIC-TRANSCRIPTION-ELEMENTS-AND-MR-01
...
## id
SPN-NEU-ADRENERGIC-RECEPTOR-DISTRIBUTION-AND-ACT-01
...
## id
SPN-NEU-CHOLINERGIC-AND-ADRENERGIC-FIBRE-TRANSMI-01
...
## id
SPN-HEM-THROMBOXANE-A2-AND-PROSTACYCLIN-BALANCE-01
...
## id
SPN-FND-ASPIRIN-COX-INHIBITION-MI-PREVENTION-01
...
## citation_ids
CIT-ASPIRIN-COX-INHIBITION-MI-PREVENTION-01
