...
## definition
The body has no mechanism to regulate iron excretion, so plasma iron level is regulated mainly through absorption. Hepcidin, a 25-amino-acid hormone secreted by the liver, is the main regulator of that absorption: it binds ferroportin on the basolateral membrane of enterocytes, causing its internalisation and degradation, and binds ferroportin on macrophages and hepatocytes, blocking iron release from those cells — so hepcidin promotes cellular iron storage and lowers plasma iron. The liver senses plasma iron level and adjusts hepcidin synthesis accordingly. Hepcidin production falls with iron deficiency, hypoxia and erythropoietin, and rises with excess iron intake and inflammation, which is why inflammatory disease causes anaemia.
## explicit_objective
Define hepcidin, state its site and mechanism of action, and list what raises and lowers its secretion.
## pitfalls
Treating hepcidin as only blocking new dietary iron. It also blocks the release of recycled iron from macrophages that broke down old RBCs, so inflammation-driven hepcidin excess can starve the marrow of iron even when total body iron stores are normal.
## concept_type
mechanism
## status
under review
...
direct_statement
## original_wording
[Short Essay Questions Q3, 6 marks] Define hepcidin. Outline its role in iron homeostasis. Mention the factors affecting hepcidin secretion. (6 marks)
## conflicts
[clear]
## uncertainty
[clear]
...
## definition
Iron is absorbed by enterocytes, mainly in the duodenum. At the apical membrane, ferrous iron (Fe2+) enters via divalent metal transporter 1 (DMT1) — ferric iron not reduced in the stomach is reduced to Fe2+ in the duodenum by a reductase — while haem iron enters via a separate carrier, haem carrier protein 1 (HCP1). Inside the enterocyte, if body demand is decreased, most iron is stored as ferritin and haemosiderin and lost with the sloughed enterocyte in the faeces; if demand is increased, iron crosses the basolateral membrane via the export protein ferroportin, is oxidised to Fe3+ by a ferroxidase, and binds plasma transferrin (normally 35% saturated), which delivers it to transferrin-receptor-bearing cells of marrow, liver and muscle. Iron deficiency produces microcytic hypochromic anaemia — decreased RBC mass and haemoglobin content, MCV under 80 fL and MCH under 25 pg — from three causes: dietary deficiency (low intake, more common in growing children and pregnancy), deficient absorption (partial gastrectomy, vitamin C deficiency, excess phytate/oxalate/phosphate, small-intestinal disease), and chronic blood loss (hookworm infestation, bleeding peptic ulcer or piles, excessive menstrual bleeding).
## explicit_objective
...
## pitfalls
Treating DMT1 as the only iron door into the enterocyte. Haem iron uses a separate transporter, HCP1, so a diet's absorbable iron is the sum of both routes, and this is why haem iron (meat) is absorbed more efficiently than the non-haem iron that depends on reduction and DMT1 alone.
## concept_type
mechanism
## status
under review
...
direct_statement
## original_wording
[Short Essay Questions Q3, 10 marks] Explain the mechanism of iron absorption. Mention the effect of iron deficiency and its causes. (10 marks)
## conflicts
[clear]
## uncertainty
[clear]
