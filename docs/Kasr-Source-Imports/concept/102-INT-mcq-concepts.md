...
# Item
## label
Haemophilia is a sex-linked recessive bleeding disorder carried by females and manifested in males, in three types by which factor is missing
## id
...
## explicit_objective
State the inheritance pattern of haemophilia and which factor is missing in each of its three types, and its effect on coagulation time.
## pitfalls
Confusing haemophilia's prolonged coagulation time (a clotting-factor problem) with a prolonged bleeding time (a platelet-function problem, as in thrombocytopenic purpura) — the two tests measure different stages of haemostasis and haemophilia affects only the former.
## concept_type
...
Blood
## aliases
Classic haemophilia | Factor VIII deficiency
## article_ids
ART-102-PHY-ABNORMALITIES-OF-HAEMOSTASIS
## support_mode
direct_statement
## original_wording
[asked 1x across the question books] Hemophilia, a recessive X-linked disease is
## conflicts
[clear]
## uncertainty
[clear]
...
[clear]
## related_article_ids
ART-102-PHY-PLATELETS-AND-HAEMOSTASIS | ART-102-PHY-ANTICOAGULANTS
## resource_ids
src_b1e6dc481eaf337268d0
## approved_file_resource_ids
[clear]
...
# Item
## label
Polycythemia is an increased RBC count up to 6-8 million/mm3, either primary (a marrow disorder) or secondary (tissue hypoxia)
## id
...
## explicit_objective
Distinguish primary polycythemia (a marrow disorder, raises all three cell lines) from secondary polycythemia (a hypoxic drive, raises RBCs only), and name situations that cause each.
## pitfalls
Assuming any raised RBC count implies marrow disease — living at high altitude raises the count too, through the ordinary hypoxia–erythropoietin pathway, and is secondary rather than primary polycythemia; liver disease is not a recognised cause of either.
## concept_type
classification
## status
under review
...
direct_statement
## original_wording
[asked 1x across the question books] Anemia results from all the following, EXCEPT:
## conflicts
[clear]
## uncertainty
[clear]
...
# Item
## label
The autonomic efferent pathway to the viscera is a two-neuron chain — preganglionic and postganglionic — unlike the single-neuron somatic pathway from cord to skeletal muscle
## id
...
## explicit_objective
State that the autonomic efferent pathway is a two-neuron relay, in contrast with the somatic system's single motor neuron.
## pitfalls
Describing the autonomic system as "two efferent pathways" (meaning sympathetic and parasympathetic) rather than "a two-neuron efferent pathway" (meaning each individual autonomic route is relayed through two neurons in series) — the book's point is about the number of neurons in one route, not the number of divisions.
## concept_type
structure_function_relationship
## status
under review
...
Autonomic nervous system
## aliases
Preganglionic neuron | Postganglionic neuron | Two-neuron system
## article_ids
ART-102-PHY-CHEMICAL-TRANSMISSION-AT-AUTONOMIC-JUNCTIONS-AND-AUTONOMIC-RECEPTORS
## support_mode
direct_statement
## original_wording
[asked 1x across the question books] The autonomic nervous system differs from the somatic nervous system In:
## conflicts
[clear]
## uncertainty
[clear]
...
# Item
## label
Erythropoietin, mainly renal in the adult (85%, with 15% hepatic), is stimulated chiefly by hypoxia and speeds every step of erythropoiesis
## id
...
## explicit_objective
State the renal/hepatic split of erythropoietin production in the adult, name hypoxia as its chief stimulus, and describe its mechanism (speeding every erythropoiesis step via mitosis-stimulating, apoptosis-inhibiting receptor binding).
## pitfalls
Reversing the adult renal/hepatic percentages, or forgetting that the split flips in fetal life (liver-dominant) — a question about renal failure and anaemia only makes sense once the 85%-renal figure is fixed for the adult case being asked about.
## concept_type
mechanism
## status
under review
...
Blood
## aliases
EPO | Renal erythropoietin
## article_ids
ART-102-PHY-ERYTHROPOIESIS
## support_mode
direct_statement
## original_wording
[asked 1x across the question books] Erythropoietin hormone is:
## conflicts
[clear]
## uncertainty
[clear]
...
# Item
## label
The site of erythropoiesis shifts with age - liver and spleen in the fetus, all bones after birth, then only membranous bones after age 20 - and needs healthy marrow
## id
...
## explicit_objective
State where erythropoiesis occurs at each life stage, and name the haemopoietic stem cell population that makes active marrow the site of the process.
## pitfalls
Assuming any bone can make blood cells throughout adult life — after age 20 only the membranous bones (vertebrae, skull, ribs, pelvis) retain active marrow; the long bones' shafts have converted to fatty yellow marrow by then.
## concept_type
mechanism
## status
under review
...
Blood
## aliases
Red marrow | Yellow marrow | Haemopoietic stem cells
## article_ids
ART-102-PHY-ERYTHROPOIESIS
## support_mode
direct_statement
## original_wording
[asked 1x across the question books] Erythropoiesis:
## conflicts
[clear]
## uncertainty
[clear]
...
# Item
## label
Haemoglobin undergoes four named chemical reactions - with oxygen, carbon dioxide, carbon monoxide, and strong oxidizing agents
## id
...
## explicit_objective
Name each of haemoglobin's four chemical reactions by its ligand and resulting compound, and state which one changes the iron's oxidation state.
## pitfalls
Confusing carbon dioxide's reaction (carbaminohaemoglobin, at the globin chains) with carbon monoxide's reaction (carboxyhaemoglobin, at the iron) — the two gases share a name-sounding pair of products but bind at different sites for different reasons.
## concept_type
mechanism
## status
under review
...
Blood
## aliases
Oxyhaemoglobin | Carboxyhaemoglobin | Methaemoglobin | Carbaminohaemoglobin
## article_ids
ART-102-PHY-IRON-METABOLISM
## support_mode
direct_statement
## original_wording
[asked 1x across the question books] Concerning Hermoglobin:
## conflicts
[clear]
## uncertainty
[clear]
...
[clear]
## related_article_ids
ART-102-PHY-VITAMIN-B12-AND-FOLIC-ACID | ART-102-PHY-ANAEMIA-AND-POLYCYTHEMIA
## resource_ids
src_b1e6dc481eaf337268d0
## approved_file_resource_ids
[clear]
...
# Item
## label
Enterocytes absorb ferrous iron via DMT1 and haem iron via HCP1, then either store it as ferritin or export it through ferroportin to bind plasma transferrin
## id
...
## explicit_objective
Trace iron from the intestinal lumen through DMT1/HCP1 into the enterocyte, and from there through ferroportin to plasma transferrin.
## pitfalls
Reversing which form of iron is better absorbed — the book states ferrous iron (Fe2+) is the absorbable form, and that gastric HCl and vitamin C exist specifically to reduce ferric iron (Fe3+) down to it, not the other way round.
## concept_type
mechanism
## status
under review
...
Blood
## aliases
DMT1 | HCP1 | Ferroportin | Iron absorption
## article_ids
ART-102-PHY-IRON-METABOLISM
## support_mode
direct_statement
## original_wording
[asked 1x across the question books] Iron:
## conflicts
[clear]
## uncertainty
[clear]
...
+ART-102-PHY-IRON-METABOLISM
## field_notes
canonical_key "teaching.iron-deficiency.low-intake" already has a pinned id in this module (CON-HEM-BDED630BBC87A3), and mintConceptId would derive a different one (CON-HEM-A611403600A801) — minted outside mintConceptId and not this build's to re-mint; see existingConceptIds in build-batches.ts. This row records the question books' exam evidence and teaching article only; every other field is untouched.
...
direct_statement
## original_wording
[asked 1x across the question books] One of the following is not supplied by autonomic nervous system:
## conflicts
[clear]
## uncertainty
[clear]
...
## explicit_objective
Name the four clotting factors and two anticoagulant proteins whose hepatic synthesis depends on vitamin K.
## pitfalls
Listing only the "prothrombin group" (II, VII, IX, X) and forgetting that proteins C and S — the physiological anticoagulants, not procoagulants — are also vitamin-K-dependent, which is why severe vitamin K deficiency can occasionally show relatively less protection against clotting than the pure bleeding picture suggests.
## concept_type
mechanism
## status
under review
...
Blood
## aliases
Prothrombin group factors | Vitamin K dependent factors
## article_ids
...
direct_statement
## original_wording
[asked 1x across the question books] Vitamin K dependent clotting factors include:
## conflicts
[clear]
## uncertainty
[clear]
...
[clear]
## related_article_ids
ART-102-PHY-VITAMIN-B12-AND-FOLIC-ACID | ART-102-PHY-PHYSIOLOGICAL-LIMITATIONS-OF-BLOOD-COAGULATION | ART-102-PHY-PLASMA-PROTEINS | ART-101-HIS-BLOOD-PLATELETS
## resource_ids
src_b1e6dc481eaf337268d0
## approved_file_resource_ids
[clear]
...
direct_statement
## original_wording
[asked 1x across the question books] Bigeding time is prolonged in:
## conflicts
[clear]
## uncertainty
[clear]
...
# Item
## label
Thrombocytopenic purpura follows a platelet count below 50,000/mm3 or defective platelet function, and shows as petechiae and prolonged bleeding time
## id
...
## explicit_objective
Connect a low platelet count (below 50,000/mm3) or defective platelet function to petechiae and a prolonged bleeding time, distinct from a prolonged coagulation time.
## pitfalls
Confusing thrombocytopenia's prolonged *bleeding* time (a platelet-dependent measure) with a prolonged *coagulation* time (a clotting-factor-dependent measure, as in haemophilia) — the two tests probe different stages of haemostasis.
## concept_type
clinical_correlation
## status
under review
...
direct_statement
## original_wording
[asked 1x across the question books] In thrombocytopenia there is:
## conflicts
[clear]
## uncertainty
[clear]
...
## field_notes
canonical_key "teaching.iron-deficiency.microcytic" already has a pinned id in this module (CON-HEM-7F0EF6B0D6F2FB), and mintConceptId would derive a different one (CON-HEM-4653C8CB26D623) — minted outside mintConceptId and not this build's to re-mint; see existingConceptIds in build-batches.ts. This row records the question books' exam evidence and teaching article only; every other field is untouched.
