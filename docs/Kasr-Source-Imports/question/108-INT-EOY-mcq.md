<!--
  Module 108 INT — the single-best-answer questions of both end-of-year papers,
  as sittable MCQs.

  Kasr Al Ainy, university kau, year KAU_Y1, module 108 INT. Two sittings:

    `EOY 108 exam 199 [solved] (2).pdf`, manifest src_bd1595e59d116b78436a —
    the 2025 sitting, batch 199. Section 1: EOM, 24 MCQs at 0.5 marks each.

    `EOY Exam {INT-108} 198 (Solved) (3).pdf`, manifest src_3deab75f7f81cc5f5260 —
    the 2024 sitting, batch 198. Section 1: EOM, 24 MCQs at 0.5 marks each.

  Each sitting also reaches the manifest as an unsolved copy —
  src_26907f7ae5f2763e89f0 for 2025 and src_a2e82550c5fffe1b8bfd for 2024 —
  carrying the same 24 questions with nothing marked. Those copies are cited
  nowhere here: a question is transcribed once, from the solved copy, which is
  the copy that also carries the answer.

  47 of the 48 MCQs are here. What was left out, and why, is at the bottom.

  WHERE THE ANSWERS COME FROM. Neither paper prints a letter. The solved copy of
  each marks its answer with a pink highlight drawn over the correct option —
  a drawing overlay with no text of its own, so the text layer of a solved copy
  is byte-identical to its unsolved twin and the extractor recovered no answer at
  all. The answers were recovered separately by rasterising the pages and
  attributing highlight pixels to option boxes, in
  scripts/kasr/extract/108-INT/answerkey.json, and joined to the questions on
  `questionId` rather than on the printed number — see the next paragraph for why
  that distinction matters. Of the 47 answers used here, 42 carry confidence
  1.00, 4 carry 0.95 to 0.99, and one carries 0.90. Confidence is a geometric
  measure — the share of a question's highlighted pixels falling on the winning
  option — so a value below 1.00 means some ink strayed onto a neighbouring line,
  not that the reading is doubtful. The one at 0.90 is QST-108-INT-2025-S1-14
  (2025 Section 1 Q14, volume of distribution); its `author_notes` says so, and the
  option the pixels chose is also the medically correct one. No answer in this
  file was decided by an author's judgement, and none was changed.

  THE PAPER'S OWN FAULTS ARE KEPT. The 2025 paper prints two different questions
  numbered 9 — "Under polarized light, Congo red stained amyloid shows:" and
  "Which of the following is an example of intracellular hyaline change?" — and
  then skips 10 entirely, so its Section 1 runs 1 to 24 with 24 questions and a
  gap in the middle. Nothing here renumbers it. Both are cited as printed
  question 9 and each says in `author_notes` which of the two it is. The item
  IDs are numbered by position in the section, not by the printed number, which
  is why the IDs of those two are 09 and 10 while both citations read Q9.

  WHAT WAS CHANGED IN THE WORDING, AND WHAT WAS NOT. Stems and options are the
  examiner's, transcribed. Three kinds of repair were made and each is recorded
  on the item that carries it:

    Ligature and glyph damage. The cached page text drops the fi/ff ligatures of
    the 2025 paper, so "effective" arrives as "e ective" and "differs" as
    "di ers", and it renders that paper's Roman numeral II as "Il", a capital-I
    and lower-l confusion in the source font. These are restored silently across
    the file; they are artefacts of the extractor, not the examiner's spelling.

    Scanning and transcription typos. The 2025 paper reads "absorbed trom the
    stomach", which is a scanning error for "from". The 2024 paper's own title
    page reads "(The questions might not be the most accurate)", which makes it a
    student transcription rather than the registrar's master, and it misspells
    several terms an answer turns on — "Caspeses", "protien", "Haemosidrin",
    "Russel bodies". Each is set correctly in the option and the examiner's own
    spelling is quoted verbatim in that item's `author_notes`, so a reviewer can
    check every repair against the page.

    Rewritten stems. Where a stem is ungrammatical, reads as a list heading
    rather than a question, or states its facts before asking anything, it is
    rewritten into a sittable question that asks the same thing — or, for
    QST-108-INT-2025-S1-20 and QST-108-INT-2024-S1-15, split into a vignette and
    a question. The examiner's exact wording is quoted in `author_notes` every
    time. The items this applies to are QST-108-INT-2025-S1-03, -12, -20 and -23,
    and QST-108-INT-2024-S1-03, -06, -09, -11 and -15; nothing else was touched.
    Several 2024
    stems end in a colon where a question mark would read better; that is the
    examiner's punctuation and it is left alone.

  American spellings in the stems and options are the examiner's and are left
  alone. The prose written here — explanations, learning objectives, notes — is
  British, per the manual.

  CONCEPTS AND ARTICLES. Every item names the concept it actually tests in
  `main_concept`, and `library_ids` names the article whose `related_concepts`
  lists it. Concepts a distractor genuinely makes a student tell apart are in
  `concept_ids`, which earns mastery; concepts the wording only mentions are in
  `contextual_concept_ids`, which earns none. The concepts and articles are those
  authored for this module in docs/Kasr-Source-Imports/concept/ and
  docs/Kasr-Source-Imports/article/, together with nine pharmacology concepts
  that were already live before this module was authored — apparent volume of
  distribution and its two interpretations, clearance, loading dose, maintenance
  dose, saturable tubular secretion, and biliary excretion — which
  ART-108-PHA-PHARMACOKINETICS-ADME and ART-108-PHA-KINETIC-PRINCIPLES cover.

  Many distractors here are not invented: the concept records for this module
  quote the papers' own wrong options in their `pitfalls` field, because the
  examiners and the book authors are catching the same misconceptions. Where an
  explanation names the student a distractor catches, that naming usually comes
  from the concept, not from the author.

  WHAT IS NOT HERE.

    The 2025 paper's Q22, on pharmacogenomics. No concept in this module covers
    pharmacogenetics or pharmacogenomics and no article teaches them: the
    orientation sheet ticks ILOs 51 and 52 but the department book has no section
    on either, so the concept file left the gap open rather than inventing one.
    A question may only test a concept an article covers, so this one is held
    back until the article exists. It is the single omission, and it is a gap in
    the teaching material rather than in the extraction.

    The 27 written and practical questions of the two papers. Sections 2 and 3 of
    each sitting are written, and a written question may only be derived from a
    written question — they belong in a written batch, not in this one.

    Everything in the two department question banks
    (scripts/kasr/extract/108-INT/mcq.json). Those carry "For personal use only,
    No other uses without permission. Copyright (c) 2025." Nothing from them is
    reproduced or paraphrased here; the source of this file is the two exam
    papers alone.

  MEDIA. None of the 48 MCQs depends on a picture — the extractor recorded
  `usesImage` false for every one of them, and the 28 image-dependent questions
  of these papers are all in the practical and written sections. So no item
  carries an attachment, and no URL is invented. Two items request an image that
  would improve the teaching rather than the question: the apple-green
  birefringence of Congo red, and the concentration-response curves that separate
  the two kinds of antagonist. Both are `strongly helpful`, neither is required,
  and both would be shown in an explanation rather than in the stem.

  Status is Draft throughout: assessment content lands as Draft, and a faculty
  reviewer should confirm the explanations before students sit these.

  VALIDATION. A question batch resolves its concepts and articles against live
  state, so the four sibling files have to be named:

    node --experimental-strip-types scripts/validate-content-batch.mjs \
      "docs/Kasr-Source-Imports/question/108-INT-EOY-mcq.md" \
  ...
  The output must contain four "rows treated as pending import" notes. If one is
  missing that sibling did not load, and the "is not a concept that exists"
  errors it produces are an artefact of the invocation rather than a defect in
  this file.
-->

# Item
## id
QST-108-INT-2025-S1-01
## title
The earliest change in reversible cell injury is:
## question
The earliest change in reversible cell injury is:
## vignette
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 1, 0.5 marks, page 1. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim.
Answer C from the recovered key (scripts/kasr/extract/108-INT/answerkey.json, questionId src_bd1595e59d116b78436a:s1:1), confidence 1.00 — the highlight covers "Cloudy swelling" and no other option shows any overlap.
Distractor D is the swap the concept record names in its pitfalls field: fat necrosis is cell death in adipose tissue, fatty change is triglyceride inside a living cell.
ATP depletion is in concept_ids rather than contextual because the sodium-pump failure is what the correct answer is made of. Fat necrosis is contextual: the option mentions it, this question never assesses it.

---

# Item
## id
QST-108-INT-2025-S1-02
## title
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 2, 0.5 marks, page 1. Manifest src_bd1595e59d116b78436a.
## attached_image
...
## author_notes
Stem and options are the examiner's, transcribed verbatim.
Answer B from the recovered key, questionId src_bd1595e59d116b78436a:s1:2, confidence 1.00.
Distractor D is the pitfall the concept record names: assuming restoring the blood supply can only help.
Hypoxia is contextual — the scenario needs the ischaemic period to make sense, but nothing here assesses the causes of cell injury.

---

# Item
## id
QST-108-INT-2025-S1-03
## title
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 3, 0.5 marks, page 1. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
The examiner's wording was: "Apoptosis is characterized by:". Rewritten as a question so the stem stands on its own once the options are shuffled; nothing about what is asked has changed. Options are verbatim.
Answer C from the recovered key, questionId src_bd1595e59d116b78436a:s1:3, confidence 1.00.
Distractor A is the pitfall the concept record names word for word: expecting a swollen cell.
Liquefactive necrosis is contextual — option D mentions it and this question never assesses it.

---

# Item
## id
QST-108-INT-2025-S1-04
## title
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 4, 0.5 marks, page 1. Manifest src_bd1595e59d116b78436a.
## attached_image
...
## author_notes
Stem and options are the examiner's, transcribed verbatim.
Answer A from the recovered key, questionId src_bd1595e59d116b78436a:s1:4, confidence 1.00.
The three distractors are each a different type of necrosis, so all three concepts are in concept_ids: a student cannot eliminate them without knowing where coagulative, liquefactive and caseation necrosis belong.
The 2024 paper asked the mirror image of this question — "Liquefactive necrosis occurs in:" with three infarcts against a pyogenic abscess (QST-108-INT-2024-S1-01). The extractor scored them as closely related at 0.81 similarity, and they are kept as the two separate questions the two sittings set.

---

# Item
## id
QST-108-INT-2025-S1-05
## title
Which type of necrosis has a "cheese-like" appearance?
## question
Which type of necrosis has a "cheese-like" appearance?
## subject
fnd
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 5, 0.5 marks, page 2. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim; the examiner's own curly quotation marks around "cheese-like" are kept as straight quotes.
Answer D from the recovered key, questionId src_bd1595e59d116b78436a:s1:5, confidence 1.00.
The pitfall the concept record names — describing caseation as retaining tissue architecture because it is solid — is what explanation A is built on.

---

# Item
## id
QST-108-INT-2025-S1-06
## title
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 6, 0.5 marks, page 2. Manifest src_bd1595e59d116b78436a.
## attached_image
...
## author_notes
Stem and options are the examiner's, transcribed verbatim.
Answer B from the recovered key, questionId src_bd1595e59d116b78436a:s1:6, confidence 1.00.
This question and the next one are a pair the examiner set back to back — 6 asks for dystrophic and 7 for metastatic — so each names the other's concept in concept_ids, along with the concept that contrasts them.

---

# Item
## id
QST-108-INT-2025-S1-07
## title
Hyperparathyroidism commonly causes:
## question
Hyperparathyroidism commonly causes:
## subject
fnd
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 7, 0.5 marks, page 2. Manifest src_bd1595e59d116b78436a.
## attached_image
...
## author_notes
Stem and options are the examiner's, transcribed verbatim.
Answer B from the recovered key, questionId src_bd1595e59d116b78436a:s1:7, confidence 1.00.
Amyloid is contextual, not assessed: option D mentions amyloidosis and the question tests nothing about it.
The pitfall the concept record names — reading "metastatic" as meaning cancer has spread there — is stated in the correct answer's explanation because it is the phrase that makes the term stick.

---

# Item
## id
QST-108-INT-2025-S1-08
## title
Café au lait patches in neurofibromatosis are related to deposition of:
## question
Café au lait patches in neurofibromatosis are related to deposition of:
## subject
fnd
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 8, 0.5 marks, page 2. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the accented "Café au lait".
Answer A from the recovered key, questionId src_bd1595e59d116b78436a:s1:8, confidence 1.00.
Carbon is in concept_ids rather than contextual: eliminating option D requires knowing that carbon is exogenous and where it deposits, which is mastery evidence. Amyloid and cholesterol are contextual — named in options, never assessed.
Neurofibromatosis itself has no concept in this module and is not tagged; the module's pathology book names it only as one of the five causes of increased melanin.

---

# Item
## id
QST-108-INT-2025-S1-09
## title
Under polarized light, Congo red stained amyloid shows:
## question
Under polarized light, Congo red stained amyloid shows:
## subject
fnd
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 9, 0.5 marks, page 3. Manifest src_bd1595e59d116b78436a. This is the first of the two questions the 2025 paper prints as number 9.
## attached_image

## attachments

## media_recommendations
### image · Explanation for option B
Brief: One field of Congo red-stained amyloid photographed twice — under ordinary light showing the orange-red deposit, and under polarised light showing the same deposit apple green against a dark background
Purpose: The whole point of the answer is that the two views of one deposit look completely different, and that only the second is diagnostic. Prose can assert the colour change; a student who has never seen it has no reason to believe the green is not just another stain. The paired field is what makes "Congo red alone is not enough" obvious rather than memorised.
Priority: strongly helpful
Status: needed
Source direction: openly licensed histopathology teaching collection
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, American spelling of "polarized" included.
Answer B from the recovered key, questionId src_bd1595e59d116b78436a:s1:9, confidence 1.00.
This is one of the two questions the 2025 paper numbers 9. The other, on intracellular hyaline change, is the next item in this file. The paper then skips 10 entirely. Nothing here renumbers either question; the item IDs run by position in the section, which is why this one is 09 and the other is 10 while both citations read Q9.
The pitfall the concept record names — reporting Congo red alone as diagnostic — is the second half of the correct answer's explanation.

---

# Item
## id
QST-108-INT-2025-S1-10
## title
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 9, 0.5 marks, page 3. Manifest src_bd1595e59d116b78436a. This is the second of the two questions the 2025 paper prints as number 9, and the paper skips 10.
## attached_image
...
## author_notes
Stem and options are the examiner's, transcribed verbatim.
Answer C from the recovered key, questionId src_bd1595e59d116b78436a:s1:10, confidence 1.00. Note that the questionId's trailing 10 is this question's position in the section, not the number printed on it — the paper prints 9 here and never prints 10 at all. Joining this answer key on printed number rather than on questionId collides these two questions, which is why the extractor's keyAudit records the collision and forbids that join.
Two distractors, A and B, are hyaline changes in the wrong compartment; that is the discrimination. Only D is outside the topic.
Melanin is contextual — chloasma appears as an option and this question assesses nothing about pigment.

---

# Item
## id
QST-108-INT-2025-S1-11
## title
Xanthomas are skin or tendon lesions caused by the buildup of which substance?
## question
Xanthomas are skin or tendon lesions caused by the buildup of which substance?
## subject
fnd
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 11, 0.5 marks, page 3. Manifest src_bd1595e59d116b78436a.
## attached_image
...
## author_notes
Stem and options are the examiner's, transcribed verbatim.
Answer B from the recovered key, questionId src_bd1595e59d116b78436a:s1:11, confidence 1.00.
The concept record's pitfall names this exact option set: "the 2025 paper offered calcium, uric acid and melanin against lipids; the tendon site invites the gout answer and the substance is lipid."
The 2024 paper asked the same fact from the other direction — which of four lesions is an example of abnormal lipid deposition — and both are kept, as QST-108-INT-2024-S1-11.

---

# Item
## id
QST-108-INT-2025-S1-12
## title
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 12, 0.5 marks, page 3. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
The examiner's wording was: "Which of the following is true about apoptosis?". Rewritten to name what the options are — statements — because "which of the following is true" reads oddly once the options are shuffled. Options are verbatim, including the examiner's unspaced "BCL2".
Answer D from the recovered key, questionId src_bd1595e59d116b78436a:s1:12, confidence 1.00.
Each of the three distractors is a different misconception with its own concept, so all three are tagged: A misses the physiological causes, B is the definition of necrosis, C confuses death with reversible injury. Reversible injury is contextual rather than assessed — option C names it but the question tests the apoptosis side of the contrast.

---

# Item
## id
QST-108-INT-2025-S1-13
## title
A weak acid drug is better absorbed from the stomach because:
## question
A weak acid drug is better absorbed from the stomach because:
## subject
pharm
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 13, 0.5 marks, page 4. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
The examiner's stem reads: "A weak acid drug is better absorbed trom the stomach because:". "trom" is a scanning error for "from" and is corrected; nothing else in the stem is changed. Options are verbatim once the extractor's dropped ff ligature is restored to "effective".
Answer C from the recovered key, questionId src_bd1595e59d116b78436a:s1:13, confidence 1.00.
Oral absorption is in concept_ids rather than contextual because option D cannot be eliminated without knowing where the absorbing surface actually is. Carrier-mediated transport is contextual: option A names it and the question never assesses it.
library_ids carries two articles because the surface-area fact that kills option D is taught in the ADME article, not in the membrane-passage one that covers the main concept.

---

# Item
## id
QST-108-INT-2025-S1-14
## title
A very high volume of distribution (Vd) for a drug implies that it:
## question
A very high volume of distribution (Vd) for a drug implies that it:
## subject
pharm
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 14, 0.5 marks, page 4. Manifest src_bd1595e59d116b78436a.
## attached_image
...
## author_notes
Stem and options are the examiner's, transcribed verbatim.
Answer B from the recovered key, questionId src_bd1595e59d116b78436a:s1:14, confidence 0.90 — the lowest-confidence answer in the whole key, and the only one below 0.95. The confidence is a geometric measure: it is the share of this question's highlighted pixels falling on the winning option, so 0.90 means a tenth of the ink strayed onto a neighbouring line, not that the answer is a tenth uncertain. It is worth stating plainly that the pixels and the medicine agree here: B is the standard interpretation of a high Vd, and A is the interpretation of a low one, which the 2024 paper marks correct in its own question on a Vd of 4 litres (QST-108-INT-2024-S1-15). Nothing was overridden.
The blood-brain barrier is contextual — option C names it and nothing here assesses it.

---

# Item
## id
QST-108-INT-2025-S1-15
## title
Which of the following is required for a drug to reach steady-state plasma concentration (Css)?
## question
Which of the following is required for a drug to reach steady-state plasma concentration (Css)?
## subject
pharm
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 15, 0.5 marks, page 4. Manifest src_bd1595e59d116b78436a.
## attached_image
...
## author_notes
Stem and options are the examiner's, transcribed verbatim.
Answer B from the recovered key, questionId src_bd1595e59d116b78436a:s1:15, confidence 1.00.
The four-to-five-half-lives concept is in concept_ids because options A and D both turn on it. Plasma half-life itself is contextual — option D names it as an interval, and the question does not assess what a half-life is.

---

# Item
## id
QST-108-INT-2025-S1-16
## title
Which of the following correctly distinguishes hepatic microsomal from non-microsomal drug-metabolizing enzymes?
## question
Which of the following correctly distinguishes hepatic microsomal from non-microsomal drug-metabolizing enzymes?
## subject
pharm
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 16, 0.5 marks, page 4. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim. The extractor rendered the Roman numeral II as "Il" in options B and D, a capital-I/lower-l confusion in the source font; it is set as II here.
Answer A from the recovered key, questionId src_bd1595e59d116b78436a:s1:16, confidence 1.00.
Marked Hard: all four options are statements about the same pair of enzyme groups, three of them true of the other half or true-with-an-illegitimate-"only", so nothing can be eliminated on recognition alone.

---

# Item
## id
QST-108-INT-2025-S1-17
## title
The maintenance dose of a drug is correctly calculated as:
## question
The maintenance dose of a drug is correctly calculated as:
## subject
pharm
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 17, 0.5 marks, page 5. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the examiner's own abbreviation Tm for the dosing interval.
Answer B from the recovered key, questionId src_bd1595e59d116b78436a:s1:17, confidence 1.00.
Loading dose and clearance are in concept_ids because option D is the loading-dose formula and options A and B both turn on what clearance is; both are genuinely assessed here. Half-life is contextual — option C names it and nothing assesses it.
library_ids carries the ADME article as well because clearance is taught there while the maintenance dose is taught in the kinetic-principles article.

---

# Item
## id
QST-108-INT-2025-S1-18
## title
Which of the following characterizes renal tubular secretion of drugs?
## question
Which of the following characterizes renal tubular secretion of drugs?
## subject
pharm
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 18, 0.5 marks, page 5. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the full stops the examiner put on the options and the dropped ff ligature in "effective", restored.
Answer A from the recovered key, questionId src_bd1595e59d116b78436a:s1:18, confidence 1.00.
Drug interactions are contextual rather than assessed: the probenecid distractor is an instance of a pharmacokinetic interaction, but what the question tests is the transport mechanism, and tagging interactions as assessed would credit mastery the student has not shown.
The 2024 paper asked the same mechanism from the carrier side, in QST-108-INT-2024-S1-19, and both are kept.

---

# Item
## id
QST-108-INT-2025-S1-19
## title
In a dose-response experiment, how can a non-competitive antagonist be distinguished from a competitive antagonist?
## question
In a dose-response experiment, how can a non-competitive antagonist be distinguished from a competitive antagonist?
## subject
pharm
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 19, 0.5 marks, page 5. Manifest src_bd1595e59d116b78436a.
## attached_image

## attachments

## media_recommendations
### diagram · Explanation for option A
Brief: Two panels of agonist concentration-response curves — the left showing a control curve with a competitive antagonist added, shifted right with the plateau unchanged; the right showing the same control curve with a non-competitive antagonist added, plateau lowered
Purpose: The answer is a statement about the shape of two curves, and shape is the one thing prose describes badly. A student who has never seen the pair side by side memorises "Emax falls" without ever seeing that one curve slides and the other flattens, which is what makes the rule usable in an exam figure.
Priority: strongly helpful
Status: needed
Source direction: openly licensed pharmacology teaching figure, or drawn to specification
Rights: must be CC-BY or public domain
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim; the extractor's line-break artefact "non- competitive" is closed up, and the dropped ligatures restored.
Answer A from the recovered key, questionId src_bd1595e59d116b78436a:s1:19, confidence 1.00.
A reviewer should look at option B. Under the strict textbook model a reversible non-competitive antagonist lowers Emax without moving EC50, which would make "a lower potency occurs only with competitive antagonism" arguably true and give the item two defensible answers. The paper marks A, the module's concept teaches the fall in Emax as the discriminator, and option A is the cleaner statement — so A stands, and the explanation for B says why rather than pretending B is simply false. Flagged here for the faculty reviewer, not overridden.

---

# Item
## id
QST-108-INT-2025-S1-20
## title
Two drugs acting at the same receptor produce different maximum effects
## question
Which of the following correctly describes this finding?
## vignette
In a dose-response experiment, Drug A produces a maximum effect of 80%, and Drug B produces a maximum effect of 100% at the same receptor.
## subject
pharm
## status
Draft
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 20, 0.5 marks, page 5. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
The examiner's wording was: "Drug A produces a maximum effect of 80%, and Drug B produces a maximum effect of 100% at the same receptor. Which of the following correctly describes this finding?" The experimental facts are moved into the vignette and the ask left in the question, which is the split the importer expects; the words are the examiner's and the phrase "In a dose-response experiment" is added only to say where the numbers come from. Options are verbatim once the dropped ffi ligature in "efficacy" is restored.
Answer D from the recovered key, questionId src_bd1595e59d116b78436a:s1:20, confidence 1.00.
Three of the four options are the same fact stated wrongly — A inverts efficacy, C inverts the agonist labels, B answers about potency — which is a well-built item and the reason it is worth keeping despite its plain wording. The receptor concept is contextual: the stem needs one receptor for the comparison to mean anything, and nothing here assesses what a receptor is.

---

# Item
## id
QST-108-INT-2025-S1-21
## title
An IRREVERSIBLE non-competitive antagonist differs from a reversible one in that:
## question
An IRREVERSIBLE non-competitive antagonist differs from a reversible one in that:
## subject
pharm
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 21, 0.5 marks, page 6. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, capitalised IRREVERSIBLE included — the emphasis is the examiner's and is what tells the candidate which contrast is being asked for. Dropped ff ligatures in "differs" and "affect" restored.
Answer A from the recovered key, questionId src_bd1595e59d116b78436a:s1:21, confidence 1.00.
Options B and C are both competitive-antagonist properties offered against a non-competitive stem, so the competitive concept is genuinely assessed and is tagged in concept_ids.

---

# Item
## id
QST-108-INT-2025-S1-23
## title
Which of the following is a PHARMACODYNAMIC mechanism of acquired drug tolerance?
## question
Which of the following is a PHARMACODYNAMIC mechanism of acquired drug tolerance?
## subject
pharm
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 23, 0.5 marks, page 6. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
The examiner's stem carries no terminal punctuation: "Which of the following is a PHARMACODYNAMIC mechanism of acquired drug tolerance". A question mark is added and nothing else is changed; the capitalised PHARMACODYNAMIC is the examiner's own emphasis and is kept, because it is what tells the candidate which half of the pair to look for.
Answer B from the recovered key, questionId src_bd1595e59d116b78436a:s1:23, confidence 1.00.
Item IDs in this file run 21, 23, 24 with no 22. The paper's printed question 22, on pharmacogenomics, is not in this batch: no concept in this module covers pharmacogenetics or pharmacogenomics and no article teaches them, so there is nothing for its main_concept to point at. The gap in the numbering is deliberate, so that the omission is visible rather than closed over.
Enzyme induction and bioavailability are in concept_ids because options C and D cannot be rejected without them. Oral absorption is contextual — option A names gastrointestinal motility and nothing here assesses absorption.

---

# Item
## id
QST-108-INT-2025-S1-24
## title
Which of the following correctly distinguishes drug allergy from idiosyncrasy?
## question
Which of the following correctly distinguishes drug allergy from idiosyncrasy?
## subject
pharm
...
## source_citation
EOY 108 exam 199 [solved] (2).pdf — Kasr Al Ainy, module 108 INT, end of year 2025 (batch 199), Section 1: EOM, printed question 24, 0.5 marks, page 6. Manifest src_bd1595e59d116b78436a.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the full stops on the options.
Answer B from the recovered key, questionId src_bd1595e59d116b78436a:s1:24, confidence 1.00. The concept record quotes this correct option verbatim in its original_wording field, so the concept and the question are demonstrably about the same claim.
Options A and D are the same inversion stated twice, which is a weakness in the item rather than in the transcription; both are kept as printed.
Four questions across the two sittings land on the Type B subtypes — this one, the 2024 paper's super-sensitivity and idiosyncrasy questions (QST-108-INT-2024-S1-22 and QST-108-INT-2024-S1-24), and the 2025 written definition of super-sensitivity, which belongs to a written batch. The adverse-reaction classification itself is contextual here: the question never asks the candidate to place these in the A-to-E scheme.

---

# Item
## id
QST-108-INT-2024-S1-01
## title
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 1, 0.5 marks, page 1. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the full stops on three options and their absence on the fourth, and the American "Centers".
Answer D from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:1, confidence 1.00.
The concept record's pitfall is this question: "Answering 'brain' alone. The 2024 paper's correct option was the centre of a pyogenic abscess, with three solid-organ infarcts as distractors."
The 2025 paper set the mirror image of this item — "Fat necrosis occurs in:" with an infarct list — and the extractor scored the pair as closely related at 0.81. Both are kept, as this item and QST-108-INT-2025-S1-04.

---

# Item
## id
QST-108-INT-2024-S1-02
## title
Apoptosis is brought about by a group of enzymes called:
## question
Apoptosis is brought about by a group of enzymes called:
## subject
fnd
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 2, 0.5 marks, page 1. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
The examiner's option C reads "Caspeses". That is a transcription misspelling — this paper's title page warns "(The questions might not be the most accurate)" — and the option is set here as "Caspases". The stem is verbatim.
Answer C from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:2, confidence 1.00. The key matched on the highlighted option text as printed, so the misspelling is in the source and not introduced here.
The concept record names this exact discrimination in its pitfalls field: answering "proteases" when asked which enzymes bring apoptosis about.
Free radicals and fat necrosis are contextual — options A and D borrow from those topics and neither is assessed.

---

# Item
## id
QST-108-INT-2024-S1-03
## title
Which of the following is true about fat necrosis?
## question
Which of the following is true about fat necrosis?
## subject
fnd
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 3, 0.5 marks, page 1. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
The examiner's stem reads: "The following is true about fat necrosis:". Rewritten as a question, because a list heading does not read as a stem once the options are shuffled; what is asked is unchanged. Options are verbatim, including the inconsistent full stops.
Answer C from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:3, confidence 1.00.
The concept record's pitfall names option A: "Calling fat necrosis an intracellular accumulation of fat... the 2024 paper used exactly that swap as a distractor."
library_ids carries the intracellular-accumulations article as well, because options A and D are both steatosis statements and that is where steatosis is taught.

---

# Item
## id
QST-108-INT-2024-S1-04
## title
The type of necrosis occurs in the blood vessels in autoimmune diseases:
## question
The type of necrosis occurs in the blood vessels in autoimmune diseases:
## subject
fnd
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 4, 0.5 marks, page 1. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
The stem is the examiner's, transcribed verbatim. It is ungrammatical — "The type of necrosis occurs in the blood vessels in autoimmune diseases:" — but it is unambiguous about what is being asked, so it is left as printed rather than rewritten; this paper is a student transcription and correcting its grammar would put words in the examiner's mouth for no gain in clarity.
Answer C from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:4, confidence 1.00.
All three distractors are other types of necrosis and each has to be positively excluded, so all three concepts are in concept_ids.

---

# Item
## id
QST-108-INT-2024-S1-05
## title
Karyorrhexis means:
## question
Karyorrhexis means:
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 5, 0.5 marks, page 1. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the inconsistent full stops.
Answer C from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:5, confidence 1.00.
The concept record's pitfall is this item: "Confusing pyknosis with karyorrhexis... The 2024 paper asked for karyorrhexis by definition alone."
The definition of necrosis is contextual: the term only makes sense inside necrosis, and the question asks nothing about what necrosis is.

---

# Item
## id
QST-108-INT-2024-S1-06
## title
Which of the following is true about hepatic steatosis?
## question
Which of the following is true about hepatic steatosis?
## subject
fnd
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 6, 0.5 marks, page 1. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
The examiner's stem reads: "Which is true about hepatic steatosis:". Rewritten to "Which of the following is true about hepatic steatosis?" — the same ask, in the form the rest of the file uses. Options are verbatim, lower-case "the" at the start of option B included.
Answer D from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:6, confidence 1.00.
The concept record's pitfall is option B: "Describing the fatty liver as shrunken... the 2024 paper offered 'the liver is shrunken, yellow and greasy' as a distractor and the shrinkage is what made it wrong."
Gross morphology and the definition of steatosis are in concept_ids rather than contextual: options B and C cannot be eliminated without them.

---

# Item
## id
QST-108-INT-2024-S1-07
## title
Primary amyloidosis can be found in patients with:
## question
Primary amyloidosis can be found in patients with:
## subject
fnd
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 7, 0.5 marks, page 2. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the American "tumor" and the examiner's own parenthetical gloss.
Answer C from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:7, confidence 1.00.
The concept record's pitfall is the trap in this stem: "Reading 'primary' as meaning idiopathic."
This question and the next one are a pair the examiner set back to back, approaching the AL/AA split from opposite sides; each names the other's concept in concept_ids. Renal amyloid is contextual — option D borrows the kidney association and the question assesses nothing about renal amyloidosis.

---

# Item
## id
QST-108-INT-2024-S1-08
## title
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 8, 0.5 marks, page 2. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, capitalised EXCEPT included — the emphasis is the examiner's and it is the whole instruction, so it must survive.
Answer B from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:8, confidence 1.00.
The concept record's pitfall is this question: "Assigning AA protein to multiple myeloma... the 2024 paper asked for the exception in a list of chronic inflammatory diseases and myeloma was it."
A negative stem survives option shuffling unharmed, since EXCEPT refers to the set rather than to a position, so randomise_answers stays yes.

---

# Item
## id
QST-108-INT-2024-S1-09
## title
In anthracosis, the lung accumulates:
## question
In anthracosis, the lung accumulates:
## subject
fnd
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 9, 0.5 marks, page 2. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
The examiner's stem reads: "In Anthracosis, the lung accumulate:". The subject-verb disagreement is corrected and the initial capital dropped; nothing else is changed. Option B reads "Haemosidrin pigments" in the paper — a transcription misspelling of haemosiderin — and is set correctly here. Options A, C and D are verbatim.
Answer C from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:9, confidence 1.00.
Lipofuscin and haemosiderin are in concept_ids: both are real pulmonary or systemic pigments and a student has to know what each is to reject it. Metastatic calcification is contextual — option D borrows it and the question assesses nothing about calcium.

---

# Item
## id
QST-108-INT-2024-S1-10
## title
Bronze diabetes occurs in:
## question
Bronze diabetes occurs in:
## subject
fnd
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 10, 0.5 marks, page 2. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the American "Hemochromatosis" and the unhyphenated "Alpha 1 antitrypsin".
Answer C from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:10, confidence 1.00.
The concept record's pitfall is the second half of the correct answer's explanation: "Attributing the bronze colour to iron alone."
Wilson disease and alpha-1 antitrypsin deficiency have no concept in this module — the pathology book does not cover them — so neither is tagged. Their explanations stay at the level of what is needed to reject the option.
Localised islet amyloid and melanin are contextual: option A borrows the first, and the second appears only inside the explanation of the correct answer.

---

# Item
## id
QST-108-INT-2024-S1-11
## title
Which of the following is an example of abnormal lipid deposition?
## question
Which of the following is an example of abnormal lipid deposition?
## subject
fnd
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 11, 0.5 marks, page 2. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
The examiner's stem reads: "The following are examples of abnormal lipid deposition:". It is a plural list heading with a single correct option beneath it, so it is rewritten in the singular as a question; what is asked is unchanged. The examiner's "Russel bodies" is a transcription misspelling of Russell and is set correctly; the other options are verbatim.
Answer B from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:11, confidence 1.00.
The 2025 paper asked the same fact from the other side — which substance builds up in a xanthoma — and both are kept.
Hyaline change and brown atrophy are in concept_ids: options A, C and D cannot be rejected without knowing what accumulates in each. Lipofuscin itself is contextual, named inside an explanation rather than assessed.

---

# Item
## id
QST-108-INT-2024-S1-12
## title
The pigment associated with parasitic infection:
## question
The pigment associated with parasitic infection:
## subject
fnd
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 12, 0.5 marks, page 2. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
The stem is the examiner's, transcribed verbatim; it is a noun phrase rather than a question, but it is unambiguous and is left as printed. Options are verbatim, including the American "Hemosiderin" and the plural "Hemozoins".
Answer B from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:12, confidence 1.00.
The concept record's pitfall is what explanation A turns on: "Expecting an iron-containing pigment to stain with Prussian blue."
All three distractors are other endogenous pigments the student must be able to place, so all three are in concept_ids.

---

# Item
## id
QST-108-INT-2024-S1-13
## title
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 13, 0.5 marks, page 2. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the terminal colon on the stem and the curly apostrophe in "doesn't", set here as a straight apostrophe.
Answer D from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:13, confidence 1.00.
Passive diffusion is in concept_ids rather than contextual: option B is a description of it offered as a description of active transport, so telling the two apart is what the question assesses.

---

# Item
## id
QST-108-INT-2024-S1-14
## title
Regarding the oral absorption of drugs, which of the following applies:
## question
Regarding the oral absorption of drugs, which of the following applies:
## subject
pharm
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 14, 0.5 marks, page 3. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the examiner's own parenthetical gloss on gastritis.
Answer D from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:14, confidence 1.00.
Option C is the same misconception the 2025 paper used as a distractor in its weak-acid question, so the pH-partitioning concept is genuinely assessed here and is tagged; bioavailability is tagged because option A is a first-pass claim. Site of metabolism is contextual — it is background to option A rather than the thing being tested.

---

# Item
## id
QST-108-INT-2024-S1-15
## title
Interpreting a volume of distribution of 4 litres in a 70 kg person
## question
Which of the following distribution patterns does this drug most probably have?
## vignette
A drug has a volume of distribution of 4 litres in a 70 kg person.
## subject
pharm
## status
Draft
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 15, 0.5 marks, page 3. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
The examiner's stem reads: "A drug with a volume of distribution of 4 liters in a 70 kg person most probably has which of the following distribution patterns:". The measurement is moved into the vignette and the ask left in the question, which is the split the importer expects; nothing is added. The examiner's "protien" in option C is a transcription misspelling of protein and is set correctly; the options are otherwise verbatim, including the missing full stop on option C.
Answer C from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:15, confidence 0.97 — a small share of the highlight ink fell outside the winning option's box, which lowers the geometric confidence without making the attribution doubtful. The medicine agrees: 4 litres is plasma volume, and high molecular weight or strong protein binding is the standard reason a drug stays there.
This is the mirror image of the 2025 paper's question on a very high Vd, and the two are kept as the separate questions the two sittings set.

---

# Item
## id
QST-108-INT-2024-S1-16
## title
A hepatic microsomal enzyme inducer can do which of the following:
## question
A hepatic microsomal enzyme inducer can do which of the following:
## subject
pharm
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 16, 0.5 marks, page 3. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the grammatical mismatch between the stem and options A, B and C — the stem asks what an inducer can *do* and three options are noun phrases. It is left as printed.
Answer D from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:16, confidence 0.98 — a small part of the highlight fell outside the option box; the attribution itself is not in doubt.
The concept record quotes this stem and this correct option verbatim in its original_wording, and names auto-induction in its pitfalls field.
Protein binding and drug interactions are contextual: option C borrows a distribution interaction and this question assesses metabolism.

---

# Item
## id
QST-108-INT-2024-S1-17
## title
Which of the following pharmacokinetic principles applies to plasma half-life:
## question
Which of the following pharmacokinetic principles applies to plasma half-life:
## subject
pharm
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 17, 0.5 marks, page 3. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
## author_notes
Stem and options are the examiner's, transcribed verbatim.
Answer C from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:17, confidence 1.00.
Marked Hard: all four options are statements about half-life, and three are wrong by a quantitative detail — a direction, an "always", a number — rather than by naming the wrong topic.
The irreversible antagonist is contextual: it appears in explanation B as the example that separates half-life from duration of action, and the question assesses nothing about antagonists. library_ids names the pharmacodynamics article for the same reason.

---

# Item
## id
QST-108-INT-2024-S1-18
## title
Which of the following can increase drug metabolism:
## question
Which of the following can increase drug metabolism:
## subject
pharm
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 18, 0.5 marks, page 3. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the American "Estrogen" and the bare "Grapefruit".
Answer D from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:18, confidence 1.00. The concept record quotes this correct option verbatim in original_wording.
The book names smoking, diet, age, genetics and disease as factors without ranking them, and this paper tested only smoking; the uncertainty field of the concept record says so. The explanations here name grapefruit and oestrogen as inhibitors and malnutrition as reducing enzyme synthesis, which is standard pharmacology rather than a claim taken from the paper.
Site of metabolism is in concept_ids because option B turns on gut-wall as well as hepatic enzyme; bioavailability is contextual, mentioned in that explanation rather than assessed.

---

# Item
## id
QST-108-INT-2024-S1-19
## title
Which of the following describes the renal elimination of drugs:
## question
Which of the following describes the renal elimination of drugs:
## subject
pharm
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 19, 0.5 marks, page 4. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
## author_notes
Stem and options are the examiner's, transcribed verbatim.
Answer A from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:19, confidence 1.00.
Marked Hard because each of the three wrong options is a correct principle applied in the wrong direction, so none can be eliminated by recognising a foreign term.
Saturable tubular secretion and ion trapping are both in concept_ids: option A is about the carrier and option C is an ion-trapping claim, and both are genuinely assessed. Protein binding is contextual, needed by option D rather than tested by it.
The 2025 paper asked the same mechanism from the saturability side, and both are kept.

---

# Item
## id
QST-108-INT-2024-S1-20
## title
Which of the following characterizes a competitive antagonist:
## question
Which of the following characterizes a competitive antagonist:
## subject
pharm
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 20, 0.5 marks, page 4. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the examiner's hyphenated "E-Max" and the missing full stop on option C.
Answer B from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:20, confidence 1.00 to two decimal places (0.9975) — effectively all of the highlight ink lies on the winning option.
Both sittings asked this contrast, the 2025 paper from the non-competitive side. Each of the three distractors here is a non-competitive property, so the non-competitive concept is genuinely assessed and is tagged.

---

# Item
## id
QST-108-INT-2024-S1-21
## title
The ability of a drug to fit onto a receptor to form a drug-receptor complex is termed:
## question
The ability of a drug to fit onto a receptor to form a drug-receptor complex is termed:
## subject
pharm
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 21, 0.5 marks, page 4. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the full stops on three options and their absence on the fourth.
Answer B from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:21, confidence 1.00.
The concept record carries the point explanation A rests on: affinity "is not the same as producing an effect".
Efficacy and the ligand types are in concept_ids because eliminating options A and C requires both. Bioavailability is contextual — option D imports it from pharmacokinetics and the question assesses nothing about it.

---

# Item
## id
QST-108-INT-2024-S1-22
## title
Exaggerated normal action in response to a small therapeutic dose of the drug is termed
## question
Exaggerated normal action in response to a small therapeutic dose of the drug is termed
## subject
pharm
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 22, 0.5 marks, page 4. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the absence of terminal punctuation on the stem — this one is left as printed because the sentence runs directly into its options and a colon or question mark would change how it reads.
Answer C from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:22, confidence 1.00.
The concept record's own label states the answer: "super-sensitivity is an exaggerated normal response to a small dose".
Tolerance is in concept_ids because option D is the opposite phenomenon and rejecting it is mastery evidence; the Type A/Type B classification is contextual, since the question never asks the candidate to place the term in that scheme.

---

# Item
## id
QST-108-INT-2024-S1-23
## title
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 23, 0.5 marks, page 4. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the hyphenated "E-Max" and the missing full stop on option A.
Answer B from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:23, confidence 1.00 to two decimal places (0.9986).
Potency is contextual rather than assessed: the correct answer's explanation contrasts the index with potency to make the point stick, but no option asks the candidate to judge potency.

---

# Item
## id
QST-108-INT-2024-S1-24
## title
An altered response to a drug due to genetic variation is termed…..
## question
An altered response to a drug due to genetic variation is termed…..
## subject
pharm
...
## source_citation
EOY Exam {INT-108} 198 (Solved) (3).pdf — Kasr Al Ainy, module 108 INT, end of year 2024 (batch 198), Section 1: EOM, printed question 24, 0.5 marks, page 4. Manifest src_3deab75f7f81cc5f5260.
## attached_image
...
yes
## author_notes
Stem and options are the examiner's, transcribed verbatim, including the trailing ellipsis of five dots, which is how the paper prints it.
Answer B from the recovered key, questionId src_3deab75f7f81cc5f5260:s1:24, confidence 1.00.
This is the last MCQ of the 2024 paper and the last item in the file. Note how close it sits to the 2025 paper's Q22, which asked what pharmacogenomics is: the two are adjacent ideas, and the difference is that the department book defines idiosyncrasy and does not cover pharmacogenomics — which is why this question is here and that one is not.
Type C/D/E reactions and tolerance are in concept_ids: options A, C and D come from those records and each must be positively rejected.
