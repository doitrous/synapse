<!--
  KASR-207END - Dr Kandeel MALE genital HISTOLOGY MCQ bank (Male section, pp.2-6, printed answer key p.7). NON-department doctor's bank filed under the Histology Dpt [1st priority] folder, sourceId src_3823ae2689790cc49841 (sha256 3823ae2689790cc49841c8b453e66554f09bc80f1b794f47ae74d85d9934b4da). Scanned, no text layer (OCR'd at default settings); the first set (Q1-79) is SOLVED by a printed answer-key table on p.7, read at 300 dpi and spot-verified against the stems (Q1=C testis coverings exclude tunica propria, Q4=B seminiferous tubule excludes Leydig, Q7=C type-B->primary spermatocyte, Q11=D ABP from Sertoli, Q18=C blood-testis barrier between Sertoli - all correct). Only histology-structure claims NOT already in the authored 207-END corpus (~364, incl. the Zahra male histology bank) are authored; myoid cells, epididymis stereocilia, duct pathway, prostate compound tubulo-alveolar, corpora amylacea, sperm head, residual bodies, Reinke crystals, spermatogenesis ~74 days, primary spermatocyte largest and the blood-testis barrier (already in physiology-concepts) are deduped out. Keys read from the printed p.7 table and cross-checked against each stem for a clean single-best answer. Concepts minted university-blind (CON-AND- + first 14 hex of SHA-256 of the canonical key, uppercased), collision-checked corpus-wide - all new. Doctor topic bank -> examSittingYear null.
...
## id
QST-KASR207END-KANDEELMALE-001

## title
Coverings of the testis

## question
The testis is covered with all the following EXCEPT:
...
## explanation_a
Incorrect. The tunica vaginalis is a genuine covering of the testis: a serous sac derived from the processus vaginalis of the peritoneum that clothes the anterior and lateral surfaces of the organ.

## answer_b
Tunica albuginea

## explanation_b
Incorrect. The tunica albuginea is the tough dense fibrous capsule immediately deep to the tunica vaginalis and is a true covering of the testis.

## answer_c
Tunica propria

## explanation_c
Correct. The testis has three coats from outside in — the tunica vaginalis (serous), the tunica albuginea (dense fibrous capsule) and the tunica vasculosa (inner loose vascular layer). There is no "tunica propria" among the testicular coverings; that term refers to the peritubular boundary tissue of the seminiferous tubule, not a coat of the whole organ, so it is the required exception.

## answer_d
Tunica vasculosa

## explanation_d
Incorrect. The tunica vasculosa is the innermost vascular layer lining the deep aspect of the tunica albuginea and the septa, and is a true covering of the testis.
...
## learning_objective
List the three coverings of the testis (tunica vaginalis, albuginea, vasculosa) and recognise that "tunica propria" is not among them.

## source_citation
Kasr Al Ainy 207 END - Dr Kandeel male histology MCQ bank, Male p.2 (Kandeel Q1)
...
## author_notes
keySource: printed p.7 Dr Kandeel answer table (Q1 = C)
...
## question
The seminiferous tubule contains all the following cells EXCEPT:
...
## explanation_a
Incorrect. Sertoli (sustentacular) cells are the tall supporting cells that line the seminiferous tubule and form its blood-testis barrier, so they are a true tubular cell.

## answer_b
Leydig cells

## explanation_b
Correct. The seminiferous tubule is lined by the germinal (spermatogenic) epithelium — spermatogonia, spermatocytes and spermatids — together with Sertoli cells. Leydig (interstitial) cells lie OUTSIDE the tubule, in the loose interstitial connective tissue between tubules, where they secrete testosterone. They are therefore not a cell of the seminiferous tubule and are the required exception.

## answer_c
Spermatids

## explanation_c
Incorrect. Spermatids are haploid germ cells in the adluminal compartment of the tubule and are a true tubular cell.

## answer_d
Spermatogonia

## explanation_d
Incorrect. Spermatogonia are the diploid stem cells resting on the basal lamina inside the tubule and are a true tubular cell.
...
## learning_objective
State that Leydig cells are interstitial and are not part of the seminiferous tubule epithelium.

## source_citation
Kasr Al Ainy 207 END - Dr Kandeel male histology MCQ bank, Male p.2 (Kandeel Q4)
...
## author_notes
keySource: printed p.7 Dr Kandeel answer table (Q4 = B)
kasr: Dr Kandeel male histology bank, p.2
...
## question
Androgen binding protein (ABP) is secreted by:
...
## explanation_a
Incorrect. Leydig cells secrete testosterone, not androgen-binding protein; they supply the androgen that ABP then binds.

## answer_b
Type B spermatogonia

## explanation_b
Incorrect. Type B spermatogonia are germ cells that differentiate into primary spermatocytes; they have no secretory role for ABP.

## answer_c
Type A spermatogonia

## explanation_c
Incorrect. Type A spermatogonia are the stem/reserve germ cells and do not secrete ABP.
...
## learning_objective
Identify androgen-binding protein as a Sertoli-cell secretion that concentrates testosterone in the seminiferous tubule.

## source_citation
Kasr Al Ainy 207 END - Dr Kandeel male histology MCQ bank, Male p.2 (Kandeel Q11)
