...
Factor IX:
## answer_a
ls a co-factor in the coagulation cascade
## explanation_a
...
## answer_b
Oftype-A, is caused by lack of factor Xl
## explanation_b
...
## answer_c
Characterized by prolonged biesding time
## explanation_c
...
## explanation_d
Gets "high molecular weight" right but wrongly classifies proteins as inorganic; amino acids and the peptide bonds linking them are carbon-based organic chemistry.
## correct_answer
b
## main_concept
...
Definition
## learning_objective
State that proteins are organic compounds of high molecular weight.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p25 q1. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Serine
## explanation_d
Serine is listed among the hydroxyl-containing aliphatic amino acids, an ordinary α-amino acid like the rest of the list.
## correct_answer
c
## main_concept
CON-FND-A37A5AA8733ACE
...
Definition
## learning_objective
Identify proline as the chapter's one imino acid.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p25 q4. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
## explanation_b
Amino acids are not classified pathologically anywhere in this chapter — this option borrows clinical-sounding language that has no basis in the text.
## answer_c
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p25 q5. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
## explanation_c
Branched-chain is an aliphatic subgroup (valine, leucine, isoleucine); histidine's ring structure puts it outside the aliphatic branch of the tree entirely.
## answer_d
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p25 q7. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from no source and was supplied by the author.
Answer changed from the source's: No printed key survived for this row (correctSource: "none"). The book's own note states plainly that "Histidine is a basic heterocyclic amino acid," and its chemical classification tree places histidine, with proline, under heterocyclic amino acids rather than aromatic or aliphatic — settling the answer as (b).
...
## explanation_b
Valine is specifically named as a branched-chain amino acid, not lumped with the short-chain (non-branched) pair glycine and alanine.
## answer_c
Aromatic amino acid
## explanation_c
Aromatic is reserved for phenylalanine, tyrosine and tryptophan; valine's side chain is a simple branched hydrocarbon, not a ring.
## answer_d
Heterocyclic amino acid
## explanation_d
Heterocyclic amino acids (histidine, proline) contain a ring in their structure; valine's isopropyl side chain has no ring.
## correct_answer
a
## main_concept
CON-FND-5C05062976F311
...
Classification
## learning_objective
Place valine among the branched-chain aliphatic amino acids.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p26 q9. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Charged polar group.
## explanation_c
Charged polar R groups belong to the basic and acidic amino acids (lysine, arginine, histidine, aspartate, glutamate); serine's hydroxyl group does not ionise at physiological pH.
## answer_d
Hydrophobic group.
## explanation_d
Hydrophobic describes the nonpolar group, the opposite of serine's water-soluble hydroxyl side chain.
## correct_answer
b
## main_concept
...
Classification
## learning_objective
Classify serine as an uncharged polar amino acid by side-chain polarity.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p27 q18. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
## explanation_c
Aliphatic, aromatic and heterocyclic is the chemical classification, sorting by structure rather than dietary requirement.
## answer_d
Non-polar, uncharged polar, and charged polar amino acids
## explanation_d
Non-polar, uncharged polar and charged polar is the classification by side-chain polarity, unrelated to nutritional requirement.
## correct_answer
a
## main_concept
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p27 q20. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
## explanation_c
Semi- (half-) essential describes arginine alone, the one amino acid the body makes at a rate sufficient for adults but not for growing children; valine has no such shortfall — it is essential outright.
## answer_d
Mixed amino acid
## explanation_d
"Mixed" names a metabolic-fate category (glucogenic and ketogenic together), not a nutritional one — a different classification scheme entirely.
## correct_answer
a
## main_concept
CON-FND-D0EDFFF1477094
...
Classification
## learning_objective
Identify valine as one of the nine essential amino acids.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p27 q21. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Definition
## learning_objective
State that completeness of essential amino acid content, not size, determines a protein's biological value.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p28 q23. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Aliphatic, aromatic, and heterocyclic amino acids
## explanation_c
Aliphatic, aromatic and heterocyclic is the chemical classification by structure, unrelated to what an amino acid is metabolised into.
## answer_d
Essential, non-essential, and semi-essential amino acids
## explanation_d
Essential, non-essential and semi-essential is the nutritional classification — by dietary requirement, not metabolic fate.
## correct_answer
a
## main_concept
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p28 q25. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
## explanation_b
Pure glucogenic covers every amino acid except the members of the other two groups; lysine is one of only two named exceptions, so it cannot be glucogenic.
## answer_c
...
Classification
## learning_objective
Identify lysine, with leucine, as one of the two pure ketogenic amino acids.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p28 q26. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Pure ketogenic amino acid
## explanation_c
Pure ketogenic is reserved for exactly two amino acids, leucine and lysine; phenylalanine is not one of them.
## answer_d
Glucogenic and ketogenic amino acid
## explanation_d
...
## answer_c
ls absorbed from the upper part of the small intestine
## explanation_c
...
Adrenal medulla:
## answer_a
ls a modified parasympathetic ganglion
## explanation_a
...
Asked 1 time across the question books.
Extraction confidence high; the answer came from no source and was supplied by the author.
Answer changed from the source's: The bank recorded no usable key (`correctSource: "none"`). The book's aldohexose examples — glucose, mannose and galactose (physical p.18) — settle it: option c pairs two of those three, while every other option pairs in a ketose (fructose) or a pentose (ribose).
...
Asked 1 time across the question books.
Extraction confidence high; the answer came from no source and was supplied by the author.
Answer changed from the source's: The bank recorded no usable key (`correctSource: "none"`). The book states directly, "the simplest ketose is dihydroxyacetone (C3)" (physical p.17), which is option c.
...
QM-102-C4D05539FC44
## title
Two sugars which differ from one another only in the configuration around a single carb…
## subject
fnd
## status
Draft
...
## answer_e
Releases one type of chemical transmitters only
## explanation_e
Backwards. The autonomic system releases two types of chemical transmitter (acetylcholine and noradrenaline) across its various fibre types, not one — releasing only acetylcholine describes the somatic system's single transmitter, not the autonomic system's two.
## correct_answer
a
## main_concept
...
Asked 1 time across the question books.
Extraction confidence high; the answer came from no source and was supplied by the author.
Answer changed from the source's: No printed key was recovered (correctSource: none). The book's DNA/RNA comparison table (p79) and the labeled structure figure (p73) both give RNA the sugar ribose, as opposed to DNA's 2-deoxyribose.
...
Asked 1 time across the question books.
Extraction confidence high; the answer came from no source and was supplied by the author.
Answer changed from the source's: No printed key was recovered (correctSource: none). Applying the book's own base-pairing rule (p74: adenine pairs with thymine, guanine pairs with cytosine) to 80 thymine and 80 guanine gives 80 adenine and 80 cytosine as well, for 320 nucleotides total.
...
Cofactor
## explanation_a
A cofactor is the non-protein part some enzymes need to be active (forming a holoenzyme with the apoenzyme) — it is not the substance the enzyme acts on.
## answer_b
Activator
## explanation_b
...
Product
## explanation_d
A product is what the substrate becomes after the reaction, not what the enzyme originally recognises and reacts with.
## correct_answer
c
## main_concept
...
Definition
## learning_objective
Name substrate as the substance an enzyme recognises and reacts with.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p45 q1. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Classification
## learning_objective
State that enzymes are mainly protein in nature.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p45 q2. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p45 q3. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Hexose sugars
## explanation_c
Hexose sugars are the building blocks of polysaccharides, not proteins — enzymes are not carbohydrate polymers.
## answer_d
Inorganic phosphate
## explanation_d
Inorganic phosphate can be a cofactor component for some enzymes, but it is not what the enzyme protein itself is built from.
## correct_answer
b
## main_concept
CON-FND-BA7E60E9E6800B
...
Definition
## learning_objective
State that enzymes, as proteins, are polymers of amino acids.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p45 q4. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
## explanation_b
It is the substrate, not the active site, that is converted to product; the active site itself is unchanged and available for a new substrate afterward.
## answer_c
...
Mechanism
## learning_objective
State that the active site is where the enzyme catalyses the reaction.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p45 q5. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Cofactor
## explanation_b
A cofactor is the non-protein part of a holoenzyme (metal ion or coenzyme) required for activity — not the reacting molecule the enzyme acts upon.
## answer_c
Coenzyme
## explanation_c
A coenzyme is one type of cofactor, a small organic co-substrate or prosthetic group — still part of the enzyme system, not the substrate being acted on.
## answer_d
Isozyme
## explanation_d
An isozyme is one of multiple structural forms of the same enzyme; the term has nothing to do with the reacting molecule.
## correct_answer
a
## main_concept
CON-FND-BA7E60E9E6800B
...
Definition
## learning_objective
Distinguish 'substrate' (the reacting molecule) from cofactor, coenzyme and isozyme.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p45 q6. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Decreasing pH value
## explanation_c
pH is one of the separate factors that affects the rate of an already-catalysed reaction; it is not itself the general mechanism by which an enzyme achieves catalysis.
## answer_d
...
Mechanism
## learning_objective
State that the general mechanism of enzyme action is lowering the activation energy of the reaction.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p45 q7. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Definition
## learning_objective
Define Km precisely as the substrate concentration producing half of Vmax, distinguishing it from the similar-sounding but different half-of-[S]-at-Vmax phrasing.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p46 q13. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
## explanation_a
Product formation alone does not standardise for substrate concentration or enzyme concentration, so it cannot compare catalytic efficiency the way a single Km value can.
## answer_b
Km value
## explanation_b
...
Mechanism
## learning_objective
State that Km value is used to compare the catalytic efficiency of different enzymes.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p46 q14. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Mechanism
## learning_objective
State that a competitive inhibitor increases the apparent Km while leaving Vmax unaffected.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p47 q19. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. DPT BOOK MCQ D book bio 102&103 mcq (1).pdf p48 q21. Manifest src_07f0a0ff41addf826c7f.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Mechanism
## learning_objective
State that phosphorylation/dephosphorylation is a reversible covalent modification on a hydroxyl-bearing residue that can alter an enzyme's catalytic activity.
## setting
Academic
## academic_relevance
0.9
...
As regard the iron required for hemoglobin synthesis:
## answer_a
Ferric iron (Fe**) is absorbed from the upper part of the small intestine
## explanation_a
...
Answer changed from the source's: No usable printed key survives ('none', and option (a)'s text is OCR-corrupted). The book's own structural formula for arachidonic acid, CH3.(CH2)4.(CH=CH.CH2)4.(CH2)2.COOH (p30), shows four (CH=CH) units, i.e. four double bonds.
...
Iris
## explanation_e
The iris (dilator and constrictor pupillae are smooth muscle) is autonomic territory, reached by sympathetic mydriatic and parasympathetic miotic fibres, so it is supplied and not the exception.
## correct_answer
d
## main_concept
...
QM-102-88B8A441862E
## title
Contact of the blood with sub- endothelial collagen produces:
## subject
haem
## status
Draft
...
## answer_b
Is the cell surface receptor for factor Via
## explanation_b
...
Factor VII:
## answer_a
ls a cofactor in the intrinsic pathway of coagulation.
## explanation_a
...
## explanation_c
Carbonic anhydrase in the erythrocyte is needed for CO2 transport (converting CO2 to bicarbonate for the chloride shift), not for oxygen transport, which is haemoglobin's job.
## answer_d
Make a major contribution to the protective capacity of blood
## explanation_d
Protective (immune) function belongs to the white blood cells, not the erythrocytes, whose main role is gas transport.
## correct_answer
b
## main_concept
CON-HEM-E3063003DB0FDD
...
Normal values
## learning_objective
State that RBC count is higher than the adult range in newborn infants.
## setting
Academic
## academic_relevance
0.9
...
Claude
## source_citation
Kasr Al Ainy departmental question books, module 102 INT. Physio MCQ First Year.pdf p7 q6. Manifest src_2093c80b1f9c25f9c0a4.
## author_notes
Asked 1 time across the question books.
Extraction confidence high; the answer came from a separate answer key, joined by question number.
...
Heart rate
## explanation_e
Backwards. The sympathetic response accelerates, not decreases, heart rate — part of preparing for better perfusion during the emergency.
## correct_answer
c
## main_concept
