<!--
  Kasr Al Ainy 208 INT · General pathology, healing and neoplasia basics — authored from the 208 INT EOM 2023 exam paper (120 MCQs, tranche 1 of the module's S1 paper), keys read from the printed answer table p.21, concept content grounded in the 208 INT Pathology Department Book.
...
## answer_a
Phagocytosis of infective agent

## explanation_a
Incorrect. Phagocytosis is the recognition, engulfment and killing of a particle once a leukocyte has already reached it — a separate step of leukocyte activation, not the movement that gets the leukocyte there in the first place.

## answer_b
Rolling of leukocytes on endothelial surface

## explanation_b
Incorrect. Rolling is the loose, tumbling adhesion of leukocytes to activated endothelium, mediated by selectins, and it happens while the leukocyte is still inside the vessel — chemotaxis happens afterwards, once the leukocyte is already in the tissue.

## answer_c
Adhesion of leukocytes to endothelium

## explanation_c
Incorrect. Adhesion to endothelium (pavementing) is the firm attachment step mediated by integrins, occurring before emigration — it describes a leukocyte still at the vessel wall, not one already moving through extravascular tissue.

## answer_d
Movement of extravasated neutrophils toward infective agent

## explanation_d
Correct. After extravasating from the blood, leukocytes move toward sites of infection or injury along a chemical gradient — this directed movement is chemotaxis, driven by bacterial products, chemokines, complement C5a and leukotriene B4. This ordered handoff — margination and rolling, then firm adhesion, then emigration, then chemotaxis — is what actually delivers a leukocyte to the site of injury, and chemotaxis is specifically its final, directional step.
...
## concept_ids
CON-IMM-96D7626B256F92 | CON-IMM-6047D47CEF7FE2
...
## learning_objective
Define chemotaxis as the post-extravasation, chemical-gradient-directed movement of leukocytes, distinct from rolling, adhesion and phagocytosis.
...
## author_notes
keySource: printed answer table p.21 ("1.D")
...
## id
QST-KASR208INT-2023EOM-Q02

## title
Macrophage fate after inflammation

## question
Which is FALSE about macrophages:
...
## answer_a
They influence process of repair

## explanation_a
Incorrect (this is true, not the FALSE option). Macrophages secrete growth factors — epidermal growth factor, fibroblast growth factor, transforming growth factor beta — that are important in the process of repair, so they genuinely influence healing.

## answer_b
After the end of inflammation they die and wander off into blood stream

## explanation_b
Correct — this is the FALSE statement. Once the initiating stimulus is eliminated and the inflammatory reaction ends, macrophages die or wander off into the lymphatics, not into the blood stream; only in chronic inflammatory sites, where the stimulus persists, does macrophage accumulation continue through ongoing recruitment and local proliferation. The distractor swaps "lymphatics" for "blood stream," which reverses the correct route macrophages actually take once their job is done.

## answer_c
They are derived from monocytes

## explanation_c
Incorrect (this is true, not the FALSE option). Macrophages are derived from blood monocytes, which leave the vessels at the site of inflammation and transform into active, motile, phagocytic macrophages.

## answer_d
Capable of phagocytosis

## explanation_d
Incorrect (this is true, not the FALSE option). Macrophages are capable of phagocytosis, although in most acute inflammation they play a lesser phagocytic role than neutrophils until later stages, when they predominate.
...
## learning_objective
State that macrophages die or migrate into the lymphatics, not the blood stream, once an inflammatory stimulus resolves.
...
## author_notes
keySource: printed answer table p.21 ("2.B")
...
## id
QST-KASR208INT-2023EOM-Q03

## title
Diffuse suppurative inflammation example

## question
One of the following is an example of diffuse suppurative inflammation:
...
## explanation_a
Incorrect. A carbuncle is multiple communicating deep subcutaneous abscesses opening by multiple sinuses, caused by Staphylococcus aureus's coagulase, which walls the infection off — it is a localized, not diffuse, suppurative pattern.

## answer_b
Cellulitis

## explanation_b
Correct. Cellulitis is diffuse suppurative inflammation occurring in loose tissues (subcutaneous tissue, orbit, scrotum), commonly caused by Streptococcus pyogenes, whose fibrinolysin dissolves fibrin and lets the infection spread rather than being walled off. Recognising the streptococcal-fibrinolysin mechanism behind cellulitis is what explains why it spreads through tissue planes rather than staying contained like a staphylococcal abscess.

## answer_c
Boil

## explanation_c
Incorrect. A boil (furuncle) is staphylococcal infection of a hair follicle, walled off by coagulase in the same way as an abscess or carbuncle — a localized, not diffuse, pattern.

## answer_d
Abscess

## explanation_d
Incorrect. An abscess is the defining example of localized suppurative inflammation — a discrete, walled-off collection of pus, the opposite of a spreading, diffuse process.
...
## learning_objective
Identify cellulitis as diffuse (streptococcal fibrinolysin-driven) suppurative inflammation, as opposed to the staphylococcal, coagulase-walled localized forms (abscess, boil, carbuncle).
...
## author_notes
keySource: printed answer table p.21 ("3.B")
...
## id
QST-KASR208INT-2023EOM-Q04

## title
Pseudomembranous inflammation

## question
Pseudomembranous inflammation is:
...
## answer_a
Mild form of acute suppurative inflammation

## explanation_a
Incorrect. Pseudomembranous inflammation is a severe form of acute inflammation of mucous membranes, not mild — a necrotizing toxin kills the surface epithelium outright, which is a more destructive process than ordinary suppuration.

## answer_b
Caused by toxin producing bacteria

## explanation_b
Correct. It is caused by bacteria that produce a powerful necrotizing toxin — diphtheria bacilli in the throat and larynx, and shigella bacilli in the large intestine causing bacillary dysentery — and the mucosa becomes covered by a false membrane of precipitated fibrin, necrotic epithelium and leukocytes. This toxin-driven necrosis of the surface epithelium, not simple pus formation, is what makes pseudomembranous inflammation a severe pattern in its own right.

## answer_c
Seen in serous cavities

## explanation_c
Incorrect. Involvement of serous cavities (pleura, pericardium, peritoneum) with a fibrin coating giving a 'bread and butter' appearance describes fibrinous inflammation, a different pattern from pseudomembranous inflammation, which affects mucous membranes.

## answer_d
Caused by pyogenic bacteria

## explanation_d
Incorrect. Pyogenic (pus-forming) bacteria such as staphylococci and streptococci cause suppurative inflammation; pseudomembranous inflammation is driven by a specific necrotizing toxin, not simply by pus formation.
...
## learning_objective
State that pseudomembranous inflammation is a severe, toxin-mediated mucosal pattern (diphtheria, bacillary dysentery), not a mild or pyogenic suppurative variant.
...
## author_notes
keySource: printed answer table p.21 ("4.B")
...
## explanation_a
Incorrect. Avascular scar tissue describes the late, remodelled scar, which granulation tissue matures into — granulation tissue itself is actively vascular, not avascular.

## answer_b
Occurs during early healing by regeneration

## explanation_b
Incorrect. Granulation tissue is the early stage of healing by fibrosis (scar formation), not regeneration — regeneration replaces cells with the same cell type and does not require new granulation tissue.

## answer_c
Pale and dry

## explanation_c
Incorrect. Granulation tissue is moist, red and bleeds easily, the opposite of pale and dry, which describes the mature scar after remodelling.

## answer_d
Formed of fibroblasts and proliferating new capillaries

## explanation_d
Correct. Granulation tissue is formed of proliferated capillaries and fibroblasts (some transformed into myofibroblasts) — the granular appearance of the new capillaries at the base of a healing wound gives the tissue its name. This composition is also why granulation tissue bleeds so readily on contact, a bedside sign clinicians use to recognise it in a healing wound bed.
...
## learning_objective
State that granulation tissue is vascular, moist, red tissue formed of proliferating capillaries and fibroblasts during early healing by fibrosis.
...
## author_notes
keySource: printed answer table p.21 ("6.D")
...
## id
QST-KASR208INT-2023EOM-Q07

## title
Tissues that do not heal by regeneration

## question
All of the following can heal by regeneration EXCEPT:
...
## explanation_a
Incorrect (this tissue DOES regenerate, making it not the exception). Hepatocytes are a stable population with strong regenerative capacity — injury confined to the parenchymal cells alone is followed by regeneration and complete restitution.

## answer_b
Endometrial lining

## explanation_b
Incorrect (this tissue DOES regenerate, making it not the exception). Endometrial lining is labile surface epithelium with continuous replicating activity, so it regenerates readily — it is shed and rebuilt every cycle.

## answer_c
Nerve cells

## explanation_c
Correct. Nerve cells (neurons) are permanent, terminally differentiated cells that are irreversibly post-mitotic in postnatal life — the department book states plainly that neurons do not effectively regenerate, so injury to them results in a scar rather than restitution. This is exactly why central nervous system injury, unlike injury to labile epithelium or bone marrow, always heals by scar rather than by restoring functioning neurons.

## answer_d
Hematopoietic cells

## explanation_d
Incorrect (this tissue DOES regenerate, making it not the exception). Hematopoietic cells are classic labile tissue with continuous mitotic division, giving them strong regenerative capacity.
...
## learning_objective
Identify neurons as permanent, non-regenerating cells, as opposed to labile (hematopoietic, endometrial) and regeneration-capable stable (hepatocyte) tissue.
...
## author_notes
keySource: printed answer table p.21 ("7.C")
...
## id
QST-KASR208INT-2023EOM-Q08

## title
Liver cirrhosis mechanism

## question
In liver healing by fibrosis (liver cirrhosis) occurs if:
...
## answer_a
Injury affects parenchymal cells only

## explanation_a
Incorrect. Injury confined to the parenchymal (hepatocyte) cells alone is followed by regeneration and complete restitution — the department book states this explicitly as the case that heals without scarring.

## answer_b
Injury affects portal tracts only

## explanation_b
Incorrect. Portal tract involvement alone is not the department book's stated cirrhosis mechanism — cirrhosis requires destruction of both the hepatocytes and the surrounding connective-tissue architecture together, not the portal tracts in isolation.

## answer_c
Injury affects the peritoneal covering

## explanation_c
Incorrect. The peritoneal (serosal) covering of the liver is not the site the department book names for the cirrhosis mechanism — the relevant structures are the hepatocytes and the internal tissue framework, not the outer covering.

## answer_d
Injury affects liver cells and the framework

## explanation_d
Correct. When chronic injury destroys both the hepatocytes and the connective-tissue architecture — as in chronic hepatitis — the hepatocytes regenerate but fail to reconstruct the original architecture, forming nodules surrounded by fibrous scarring: cirrhosis. This is the mechanistic reason cirrhosis is irreversible once established — the regenerated nodules can restore cell mass but never the original architecture.
...
## learning_objective
Explain that liver cirrhosis results from injury destroying both hepatocytes and the tissue framework together, not hepatocyte injury alone.
...
## author_notes
keySource: printed answer table p.21 ("8.D")
...
## id
QST-KASR208INT-2023EOM-Q11

## title
Chemotactic factors

## question
Chemotactic factors include the following:
...
## explanation_a
Incorrect. Histamine is a vasoactive amine that causes arteriolar dilation and rapidly increases vascular permeability — it is a mediator of the vascular phase of inflammation, not a chemotactic factor that directs leukocyte movement.

## answer_b
Prostaglandins

## explanation_b
Incorrect. Prostaglandins potentiate the effect of histamine and contribute to pain and fever — they are arachidonic acid metabolites with vascular and systemic effects, not chemotactic agents.

## answer_c
C5a

## explanation_c
Correct. Chemotactic factors named in the department book are bacterial products, chemokines, complement components (particularly C5a), and products of arachidonic acid metabolism (particularly leukotriene B4) — C5a is specifically listed as mediating leukocyte activation, adhesion and chemotaxis. Recognising C5a specifically (rather than histamine or prostaglandins) as chemotactic is what separates the vascular mediators of inflammation from the ones that actually summon leukocytes to the site.

## answer_d
Lysosomal enzymes

## explanation_d
Incorrect. Lysosomal enzymes (collagenase, cathepsin) destroy phagocytosed material and can cause tissue damage once released — they act after a leukocyte has already arrived, not as a signal that draws it there.
...
## learning_objective
Name C5a among the chemotactic factors for leukocytes, as distinct from vasoactive/pain mediators (histamine, prostaglandins) and post-arrival digestive enzymes.
...
## author_notes
keySource: printed answer table p.21 ("11.C")
...
## id
QST-KASR208INT-2023EOM-Q12

## title
Cellular events of acute inflammation

## question
As regard the cellular events of acute inflammation:
...
## answer_a
Neutrophils then monocytes accumulate within the extravascular space

## explanation_a
Correct. Leukocyte recruitment proceeds neutrophils first, then monocytes, accumulating within the extravascular space — this order (not the reverse) is stated directly in the department book's account of cellular events. Getting this order right also explains why a blood film taken early in acute inflammation is neutrophil-predominant, with monocytes rising only later as the reaction matures.

## answer_b
The adhesion of neutrophils to the vascular endothelium at the sites of acute inflammation is called 'rolling'

## explanation_b
Incorrect. The firm adhesion of leukocytes to the endothelium is called pavementing, mediated by integrins; rolling is the earlier, loose, tumbling adhesion mediated by selectins — the two terms name different steps, and this option applies the wrong one.

## answer_c
Integrin play a role in margination

## explanation_c
Incorrect. Margination is the physical shift of neutrophils out of the axial blood stream into the peripheral plasmatic zone, caused by slowed flow and increased plasma viscosity — it precedes any adhesion molecule engagement; integrins act at the later pavementing (firm adhesion) step, not margination.

## answer_d
Emigration of leucocytes is followed by leucopenia

## explanation_d
Incorrect. Emigration of leukocytes out of the vessel depletes the local marginating pool, not the total circulating white cell count — the systemic response to acute inflammation is typically leukocytosis (driven by cytokine-stimulated colony-stimulating factors), not leucopenia.
...
## learning_objective
Sequence the cellular events of acute inflammation correctly (neutrophils before monocytes; selectins for rolling, integrins for pavementing) and reject the leucopenia distractor.
...
## author_notes
keySource: printed answer table p.21 ("12.A")
...
## id
QST-KASR208INT-2023EOM-Q13

## title
Key cells of chronic inflammation

## question
The key cells in chronic inflammation:
...
## explanation_a
This is also textbook-correct (the department book's own formative-assessment answer names lymphocytes, plasma cells and macrophages together as the chronic-inflammation cell types), but the paper's own printed key marks (c) as the answer, and macrophages are singled out as THE key cell because they drive both the tissue damage and the fibrotic repair that define the chronic picture.

## answer_b
Plasma cells

## explanation_b
This is also textbook-correct for the same reason as (a) — plasma cells (activated B lymphocytes) are named among the chronic inflammation cell types — but the keyed answer is macrophages specifically, the cell the department book calls 'a key cell in chronic inflammation' in its own dedicated subsection.

## answer_c
Macrophages

## explanation_c
Correct. The macrophage is the key cell in chronic inflammation: it is activated by microbial products or T-cell cytokines to proliferate, persist at the site, and secrete both the proteolytic enzymes that cause ongoing tissue damage and the growth factors that drive fibrotic repair. Recognising macrophages as the single defining cell — rather than any one of the several mononuclear types present — is what lets a student distinguish chronic inflammation from the neutrophil-dominated picture of an acute process.

## answer_d
Eosinophils

## explanation_d
Incorrect. Eosinophils are characteristically found in parasitic infections and IgE-mediated allergic reactions, not as the general key cell of chronic inflammation, which is dominated by macrophages, lymphocytes and plasma cells.
...
## learning_objective
Identify the macrophage as the key cell of chronic inflammation, distinct from eosinophils, and recognise lymphocytes/plasma cells as fellow mononuclear cells rather than wrong answers.
...
## author_notes
keySource: printed answer table p.21 ("13.C")
...
## answer_a
A local defect within a surface

## explanation_a
Incorrect. A local defect within a surface, from separation of inflammatory necrotic tissue, describes an ulcer — a sinus is a tract, not a surface defect.

## answer_b
A blind-ended tract

## explanation_b
Correct. A sinus is a blind-ended tract between a deep-seated focus (typically an abscess) and the body surface — for example a peritoneal abscess tracking to the abdominal wall — with exactly one open end. This single-open-end anatomy is exactly why a chronic sinus, unlike a fistula, only ever needs one external opening explored on examination.

## answer_c
A tract communicating between two surfaces

## explanation_c
Incorrect. A tract communicating between two surfaces or hollow organs is a fistula, which has two open ends, not one — an ano-rectal fistula from a perianal abscess is the worked example.

## answer_d
Overdone repair

## explanation_d
Incorrect. Overdone repair — excessive fibroblast proliferation and collagen production after dermal injury — describes a keloid, a genetically determined complication unrelated to tract formation.
...
## learning_objective
Define a sinus as a blind-ended tract, distinguishing it from an ulcer (surface defect), a fistula (double-ended tract) and a keloid (overdone repair).
...
## author_notes
keySource: printed answer table p.21 ("14.B")
...
## explanation_a
Incorrect. Nephroblastoma (Wilms tumor) is an embryonic tumor of the kidney, not marked by PSA.

## answer_b
Squamous cell carcinoma

## explanation_b
Incorrect. Squamous cell carcinoma is not tracked by PSA; on immunohistochemistry it is marked instead by cytokeratin, a general carcinoma marker.

## answer_c
Prostatic carcinoma

## explanation_c
Correct. Prostatic specific antigen (PSA) is the department book's named antigen-class tumor marker for cancer of the prostate, used to help detect it and monitor treatment response or recurrence. PSA is elevated by benign prostatic hyperplasia too, which is why it screens for but cannot alone diagnose prostate cancer.

## answer_d
Granulosa cell tumour of ovary

## explanation_d
Incorrect. Granulosa cell tumour of the ovary is not the tumor PSA marks; the department book's table assigns PSA specifically to prostate cancer.
...
## learning_objective
Name PSA as the tumor marker for prostatic carcinoma.

## source_citation
Kasr Al Ainy 208 INT EOM 2023 exam paper, Q4
...
## author_notes
keySource: printed answer table p.21 ("15.C")
...
## id
QST-KASR208INT-2023EOM-Q16

## title
Aflatoxin and hepatocellular carcinoma

## question
Aflatoxins are carcinogen for:
...
## explanation_a
Incorrect. Bronchogenic carcinoma is linked instead to aromatic hydrocarbons such as 3,4-benzpyrene in cigarette smoke, not to aflatoxin.

## answer_b
Renal cell carcinoma

## explanation_b
Incorrect. Renal cell carcinoma is not the department book's named target of aflatoxin exposure.

## answer_c
Hepatocellular carcinoma

## explanation_c
Correct. Aflatoxins, produced by the fungus Aspergillus flavus (a food/grain contaminant), cause hepatic (hepatocellular) carcinoma — a distinct chemical route from hepatitis B virus's viral one to the same organ. Aflatoxin exposure is a recognised co-factor with chronic hepatitis B infection in regions where hepatocellular carcinoma incidence is highest.

## answer_d
Urothelial carcinoma of the bladder

## explanation_d
Incorrect. Urothelial (bladder) carcinoma is linked instead to aromatic amines such as beta-naphthylamine, not to aflatoxin.
...
## learning_objective
Name aflatoxin (Aspergillus flavus) as a chemical carcinogen for hepatocellular carcinoma, distinct from other named carcinogen-tumor pairs.
...
## author_notes
keySource: printed answer table p.21 ("16.C")
...
## id
QST-KASR208INT-2023EOM-Q17

## title
Epstein-Barr virus and Burkitt's lymphoma

## question
Epstein-Barr virus is a cause the following tumor:
...
## explanation_a
Correct. Epstein-Barr virus (EBV) is implicated in Burkitt's lymphoma, nasopharyngeal carcinoma, other B-cell lymphomas, and some Hodgkin's lymphoma. The same virus’s differing tumor associations by geography — Burkitt’s lymphoma in endemic malaria regions, nasopharyngeal carcinoma in parts of East Asia — is a well-recognised teaching point built on this same viral mechanism.

## answer_b
Lung carcinoma

## explanation_b
Incorrect. Lung carcinoma is linked to physical/chemical carcinogens (ionizing radiation, aromatic hydrocarbons), not EBV.

## answer_c
T cell lymphoma

## explanation_c
Incorrect. T-cell leukemia/lymphoma is the department book's named tumor for HTLV-1, a different virus from EBV.

## answer_d
Basal cell carcinoma

## explanation_d
Incorrect. Basal cell carcinoma is linked to ultraviolet radiation exposure as a physical carcinogen, not to EBV.
...
## learning_objective
Name Burkitt's lymphoma among the tumors caused by Epstein-Barr virus, distinguishing it from tumors caused by other named carcinogens.
...
## author_notes
keySource: printed answer table p.21 ("17.A")
...
## id
QST-KASR208INT-2023EOM-Q18

## title
Guardian of the genome

## question
The following is the guardian of the genome:
...
## explanation_a
Correct. TP53 is the prototypic 'guardian' tumor suppressor gene, sensing genomic damage and arresting the cycle for repair or triggering apoptosis if the damage cannot be repaired; its mutation does not directly transform cells but permits and accelerates further mutation. Because TP53 loss only accelerates further mutation rather than directly transforming a cell, its guardian role is functionally distinct from a governor gene like RB, even though both are tumor suppressors.

## answer_b
RB gene

## explanation_b
Incorrect. RB is a 'governor' tumor suppressor gene, whose product directly stops cell proliferation — a different functional class from the guardian TP53, even though both are tumor suppressors.

## answer_c
Bcl2 gene

## explanation_c
Incorrect. BCL2 is an anti-apoptotic gene, not a guardian of the genome — its overexpression (e.g. in follicular lymphoma) prevents cell death rather than sensing DNA damage.

## answer_d
MYC gene

## explanation_d
Incorrect. MYC is a proto-oncogene encoding a DNA transcription factor; its amplification drives cancer (e.g. in neuroblastoma) rather than guarding genomic integrity.
...
## learning_objective
Identify TP53 as the guardian of the genome, distinct from the governor tumor suppressor RB and the oncogenes BCL2/MYC.
...
## author_notes
keySource: printed answer table p.21 ("18.A")
...
## id
QST-KASR208INT-2023EOM-Q19

## title
Categories of oncogenes

## question
The following are groups of oncogenes EXCEPT:
...
## answer_a
Genes which produce growth factors

## explanation_a
Incorrect (this IS a genuine oncogene category, making it not the exception). Genes producing growth factors are one of the department book's four named oncogene categories.

## answer_b
Genes which produce the growth factor receptors

## explanation_b
Incorrect (this IS a genuine oncogene category, making it not the exception). Genes producing growth factor receptors (e.g. erbB2/HER2) are a named oncogene category.

## answer_c
Genes which encode signal transduction

## explanation_c
Incorrect (this IS a genuine oncogene category, making it not the exception). Genes encoding signal transduction proteins (e.g. RAS) are a named oncogene category.

## answer_d
Genes which encode products stop cell proliferation

## explanation_d
Correct. Genes whose products stop cell proliferation describe tumor suppressor genes, the functional opposite of oncogenes — an oncogene by definition drives proliferation, so this category cannot belong among the oncogene groups. Every genuine oncogene category instead promotes proliferation in some way — producing a growth factor, its receptor, a signal-transduction protein, or a transcription factor — which is the opposite function from stopping it.
...
## learning_objective
Recognise that 'genes that stop proliferation' describes tumor suppressor genes, not one of the four oncogene categories.
...
## author_notes
keySource: printed answer table p.21 ("19.D")
...
## id
QST-KASR208INT-2023EOM-Q20

## title
Disordered proliferation term

## question
Disordered proliferation of cells is known as:
...
## explanation_a
Incorrect. Metaplasia is replacement of one mature differentiated cell type by another, not disordered proliferation of a single cell type.

## answer_b
Hyperplasia

## explanation_b
Incorrect. Hyperplasia is increased cell number by division, but the cells remain normally organised and shaped — it is ordered, reversible growth, not disordered proliferation.

## answer_c
Dysplasia

## explanation_c
Correct. Dysplasia is non-neoplastic disordered proliferation of cells, usually induced by prolonged irritation, and is characterised by loss of normal orderly arrangement (polarity), cellular pleomorphism and nuclear hyperchromasia, and increased mitosis. Dysplasia’s hallmark loss of polarity and increased mitotic activity is also what makes it gradable as low- or high-grade, with high-grade dysplasia sitting immediately before carcinoma in situ.

## answer_d
Atrophy

## explanation_d
Incorrect. Atrophy is a decrease in organ size and weight from decreased cell size, the opposite of a proliferative process.
...
## learning_objective
Name dysplasia as disordered, non-neoplastic cellular proliferation with loss of polarity, distinct from metaplasia, hyperplasia and atrophy.
...
## author_notes
keySource: printed answer table p.21 ("20.C")
...
## id
QST-KASR208INT-2023EOM-Q21

## title
Sites of squamous metaplasia

## question
Squamous metaplasia does not occur in the following site:
...
## explanation_a
Incorrect (squamous metaplasia DOES occur here, making it not the exception). In heavy cigarette smokers, the pseudostratified columnar ciliated epithelium of the bronchi transforms into stratified squamous epithelium, protective but without cilia, so the mucociliary escalator stops working.

## answer_b
Gall bladder due to gall stones

## explanation_b
Incorrect (squamous metaplasia DOES occur here, making it not the exception). The department book names columnar epithelium of the bile duct and gall bladder undergoing squamous metaplasia due to gall stones as one of its worked examples.

## answer_c
Lower end of esophagus

## explanation_c
Correct. The lower esophagus undergoes the opposite change: normal squamous epithelium is replaced by columnar epithelium (Barrett's esophagus), which is glandular/intestinal metaplasia, not squamous metaplasia — so this is the site where squamous metaplasia does NOT occur. Recognising this direction of change also explains why Barrett’s esophagus is grouped with intestinal, not squamous, metaplasia in this teaching, even though both are adaptive responses to chronic irritation.

## answer_d
Urinary bladder epithelium in association with Bilharziasis

## explanation_d
Incorrect (squamous metaplasia DOES occur here, making it not the exception). Transitional bladder epithelium converts to squamous epithelium in the presence of Schistosoma haematobium ova, the same mechanism reused from the Year-1 concept on this metaplasia.
...
## learning_objective
Distinguish sites of squamous metaplasia (bronchus, gallbladder, bladder) from Barrett's esophagus, where the metaplastic change runs the opposite direction (squamous to columnar).

## source_citation
Kasr Al Ainy 208 INT Pathology Department Book, p.36 (Epithelial Metaplasia); Kasr Al Ainy 208 INT EOM 2023 exam paper, Q21
...
## author_notes
keySource: printed answer table p.21 ("21.C")
conceptReuse: Main concept CON-FND-5AD09BF9FC2420 is a Kasr Year-1 (101 ISK) id whose own body covers only the bronchus/bladder examples; the gallbladder and esophagus reasoning above is sourced from the 208 INT department book directly (p.36), not from editing the reused Year-1 record.
...
## id
QST-KASR208INT-2023EOM-Q22

## title
Malignant cachexia mechanism

## question
Which of the following is FALSE about malignant cachexia:
...
## answer_a
Marked decrease of body fat and lean body mass

## explanation_a
Incorrect (this is true, not the FALSE option). Marked decrease in body fat and lean body mass is a defining feature of cachexia.

## answer_b
Marked weakness and anemia

## explanation_b
Incorrect (this is true, not the FALSE option). Marked weakness and anemia accompany the wasting of malignant cachexia.

## answer_c
Cachexia results due to nutritional demands of the tumor

## explanation_c
Correct — this is the FALSE statement. Cachexia does NOT result from the tumor's nutritional demands on the host, even though there is some correlation between tumor size/spread and its severity; the department book states this exclusion explicitly. This distinction matters clinically because feeding a cachectic cancer patient more aggressively does not reverse the wasting, since the process is cytokine-driven rather than a simple calorie deficit.

## answer_d
Cachexia results from action of cytokines produced by tumor and host macrophages

## explanation_d
Incorrect (this is true, not the FALSE option). Cachexia results from the action of soluble factors — cytokines such as TNF, produced by both the tumor and host macrophages — acting on host metabolism.
...
## learning_objective
State that malignant cachexia results from cytokine action, not from the tumor's own nutritional demands.

## source_citation
Kasr Al Ainy 208 INT EOM 2023 exam paper, Q5
...
## author_notes
keySource: printed answer table p.21 ("22.C")
...
## id
QST-KASR208INT-2023EOM-Q23

## title
Proto-oncogenes definition

## question
Normal cellular genes that encode proteins that drive cell proliferation are:
...
## explanation_a
Correct. Proto-oncogenes are normal cellular genes whose products drive cell proliferation — they are present and functioning in every healthy cell, before any mutation. It is only after a gain-of-function change — point mutation, translocation or amplification — that a proto-oncogene becomes the pathological oncogene form.

## answer_b
Oncogenes

## explanation_b
Incorrect. Oncogenes are the mutated, cancer-causing form a proto-oncogene becomes after a gain-of-function change; they are not the normal, unmutated gene.

## answer_c
Tumor suppressor genes

## explanation_c
Incorrect. Tumor suppressor genes normally restrain proliferation or sense DNA damage — the functional opposite of driving it.

## answer_d
Apoptotic genes

## explanation_d
Incorrect. Genes that control apoptosis regulate programmed cell death, a distinct process from proliferation.
...
## learning_objective
Define proto-oncogenes as the normal, unmutated genes driving cell proliferation, distinct from their mutated oncogene form.
...
## author_notes
keySource: printed answer table p.21 ("23.A")
...
## id
QST-KASR208INT-2023EOM-Q25

## title
Histological differentiation of malignant tumors

## question
As regard the histological differentiation of malignant tumors:
...
## answer_a
Anaplastic cells show normal polarity

## explanation_a
Incorrect. Loss of normal polarity (architectural orientation) is a defining feature of anaplasia, not something anaplastic cells retain — this is the reverse of the true relationship.

## answer_b
Anaplastic cells show cytologic abnormalities

## explanation_b
This statement is also textbook-true — anaplastic cells do show cytologic abnormalities (pleomorphism, hyperchromatism, abnormal mitoses), which is what anaplasia means — but the paper's own printed key marks (c) as the intended answer, and grading by differentiation is the more specific fact this question is built to test.

## answer_c
Sarcomas may be graded as well differentiated, moderately differentiated, poorly differentiated and undifferentiated

## explanation_c
Correct. Malignant mesenchymal tumors (sarcomas) are, like carcinomas, graded across the same well differentiated / moderately differentiated / poorly differentiated / undifferentiated spectrum, tracking how closely the tumor still resembles its tissue of origin. This grading-by-differentiation principle applies across both major malignant tumor families, giving sarcomas the same four-tier prognostic language pathologists already use for carcinomas.

## answer_d
Better differentiated tumors tend to show great cellular anaplasia and grow faster

## explanation_d
Incorrect. The relationship runs the opposite way — better-differentiated tumors show LESS cellular anaplasia and grow SLOWER, while undifferentiated tumors show the greatest anaplasia and grow fastest.
...
## learning_objective
State that sarcomas, like carcinomas, are graded across a well-to-undifferentiated spectrum, and recognise that (b) is a true but non-keyed distractor while (a) and (d) invert the real anaplasia-grade relationship.
...
## author_notes
keySource: printed answer table p.21 ("25.C")
Option (b) is independently true per the department book's own definition of anaplasia (p.40-41), which makes this item a true-statement question with two textbook-correct options; authored on the printed key (c) as the intended answer, with (b) explained as correct-but-not-keyed rather than as a wrong distractor.
...
## id
QST-KASR208INT-2023EOM-Q27

## title
Squamous cell carcinoma immunohistochemistry marker

## question
Immunohistochemical study of squamous cell carcinoma show strong expression of which of the following tumor markers:
...
## explanation_a
Incorrect. Vimentin is the department book's named immunohistochemical marker for sarcomas (mesenchymal tumors), not carcinomas.

## answer_b
Cytokeratin

## explanation_b
Correct. Cytokeratins (CK) are present in carcinomas — squamous cell carcinoma, an epithelial malignancy, is expected to stain strongly positive for cytokeratin on immunohistochemistry. A cytokeratin-negative, vimentin-positive result on the same specimen would instead point away from carcinoma and toward a sarcoma, which is exactly why this marker pair is used to resolve ambiguous poorly differentiated tumors.

## answer_c
Alpha feto-protein

## explanation_c
Incorrect. Alpha-fetoprotein is the oncofetal-antigen marker for hepatocellular carcinoma, not for squamous cell carcinoma.

## answer_d
Calcitonin

## explanation_d
Incorrect. Calcitonin is the hormone marker for medullary carcinoma of the thyroid, not for squamous cell carcinoma.
...
## learning_objective
Name cytokeratin as the immunohistochemical marker expressed by carcinomas, including squamous cell carcinoma, versus vimentin (sarcomas), AFP (hepatocellular) and calcitonin (medullary thyroid).
...
## author_notes
keySource: printed answer table p.21 ("27.B")
...
## answer_a
Disordered atypical non-neoplastic cellular proliferation

## explanation_a
Incorrect. Disordered, atypical, non-neoplastic cellular proliferation describes dysplasia, not hypertrophy.

## answer_b
Increase in the size of the cells

## explanation_b
Correct. Hypertrophy is increased size and weight of an organ due to increase in the size of its cells, from synthesis and assembly of additional intracellular structural components — without cell division. Because no new cells are made, hypertrophy can only increase organ mass up to the limit of how much each existing cell can enlarge, which is why sustained pathological hypertrophy (e.g. in hypertensive heart disease) eventually fails.

## answer_c
Uncontrolled autonomous cell growth

## explanation_c
Incorrect. Uncontrolled, autonomous cell growth describes neoplasia, which is irreversible and independent of any ongoing stimulus, unlike hypertrophy, which is reversible and stimulus-dependent.

## answer_d
Increase in the number of the cells

## explanation_d
Incorrect. An increase in the number of cells by division describes hyperplasia, the companion adaptation to hypertrophy but mechanistically distinct from it.
...
## learning_objective
Define hypertrophy as increased cell size without division, distinct from hyperplasia (increased cell number), dysplasia and neoplasia.

## source_citation
Kasr Al Ainy 208 INT EOM 2023 exam paper, Q6
...
## author_notes
keySource: printed answer table p.21 ("29.B")
...
## id
QST-KASR208INT-2023EOM-Q30

## title
Metaplasia as a precancerous condition

## question
Metaplasia may be a precancerous condition in all EXCEPT:
...
## answer_a
Squamous metaplasia of the urinary bladder epithelium

## explanation_a
Incorrect (this IS linked to malignancy risk, making it not the exception). Squamous metaplasia of the bladder in bilharziasis is directly named as a site where squamous cell carcinoma develops on top of the metaplastic change.

## answer_b
Squamous metaplasia of the bronchial epithelium

## explanation_b
Incorrect (this IS linked to malignancy risk, making it not the exception). Squamous metaplasia of bronchial epithelium in smokers is associated with squamous cell carcinoma risk.

## answer_c
Intestinal metaplasia of the gastric mucosa

## explanation_c
Incorrect (this IS linked to malignancy risk, making it not the exception). Intestinal metaplasia of the gastric mucosa is one of the named hyperplastic/metaplastic/dysplastic precancerous lesions in the department book's non-hereditary preneoplastic disorders list.

## answer_d
Apocrine metaplasia in fibrocystic disease of the breast

## explanation_d
Correct. Apocrine metaplasia in fibrocystic disease of the breast does not carry the same premalignant association in this teaching — of the four sites tested, it is the one the department book's preneoplastic list does not name. This is why apocrine metaplasia in fibrocystic breast disease is generally treated as a benign finding on biopsy, unlike squamous or intestinal metaplasia at the other three sites, which prompt closer surveillance.
...
## learning_objective
Identify apocrine breast metaplasia as not carrying the premalignant association that bladder, bronchial and gastric metaplasia carry in this teaching.
...
## author_notes
keySource: printed answer table p.21 ("30.D")
...
## id
QST-KASR208INT-2023EOM-Q32

## title
Microscopic features of tumors

## question
As regard the microscopic Features of tumors:
...
## answer_a
The benign tumors are undifferentiated

## explanation_a
Incorrect. Benign tumors are well (perfectly) differentiated, closely mimicking the normal tissue they arose from — the opposite of undifferentiated.

## answer_b
Histologic differentiation means the degree of resemblance of the structural pattern of the tumor to that of the normal tissue

## explanation_b
Correct. Histologic differentiation is defined as the degree to which a tumor's structural pattern resembles the normal tissue it arose from — this is the department book's own working definition of the term. This resemblance-to-normal-tissue framing is exactly why a well-differentiated adenocarcinoma still forms recognisable glandular structures, while a poorly differentiated one grows as featureless sheets of cells.

## answer_c
Malignant cells always show low grade (mild) of cellular anaplasia

## explanation_c
Incorrect. Malignant cells show grades of anaplasia ranging from mild to marked, not always low grade — grade tracks with aggressiveness across a real range, not a fixed mild level.

## answer_d
All the malignant tumors are well differentiated

## explanation_d
Incorrect. Malignant tumors range from well differentiated (grade I) to undifferentiated (grade IV) — they are not all well differentiated, and undifferentiated tumors are in fact the most aggressive.
...
## learning_objective
Define histologic differentiation as structural resemblance to normal tissue, and reject the claims that benign tumors are undifferentiated or that malignant tumors are uniformly low-grade or well differentiated.
