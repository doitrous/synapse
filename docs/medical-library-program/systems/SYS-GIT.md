...
### Decided classification (`SYS-GIT-INVENTORY-001`, 2026-08-12)

All 108 nodes are classified. Evidence:
[`SYS-GIT-node-classification.json`](../evidence/SYS-GIT-node-classification.json).

| Classification | Nodes |
|---|---:|
| navigation-only hub | 27 |
| overview article | 3 |
| atomic article home | 78 |
| empty but legitimate planned destination | 0 |
| **Planned articles** | **81** |

39 of these nodes carry a local teaching signal — the corpus teaches
...
### Decided dispositions (`SYS-GIT-INVENTORY-001`, 2026-08-12)

Evidence: [`SYS-GIT-disposition-ledger.json`](../evidence/SYS-GIT-disposition-ledger.json).

| | Articles | Concepts |
|---|---:|---:|
| Touching this system | 10 | 126 |
