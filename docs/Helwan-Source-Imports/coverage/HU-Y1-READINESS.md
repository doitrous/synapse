...
- The only local question-category source, tier-9 `src_249d76e2f57b04d497a5`, is fully
  triaged across all 17 rendered pages: 66 MCQs plus 12 short essays produce 78 complete
  prompt occurrences and 78 genuinely printed study-bank answer occurrences (66 letters plus
  12 answer blocks). They are not official keys.
- Literal Q11/Q13 and Q12/Q14 repeats leave 76 retained question forms; Q12 prints `B` while
