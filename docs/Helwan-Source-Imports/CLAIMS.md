...
| checkpointed-incomplete | `HU · HU-BMS-101 · all subjects · triage` | S1 | fresh continuation worker | 260 retained question records and 260 retained printed keys checkpointed in `coverage/HU-BMS-101-TRIAGE.md`; exactly four concept dispositions have completed four-query evidence | Continue the four-query search ledger for every remaining tested-concept assignment; only then consolidate final distinct/live/pending/new totals for `/root` |
