...
| `EOM MCQs - UG Final 2 MCQ Collection.pdf` (Assessments) / `...Collection-1.pdf` (Combined Subjects, byte-identical per manifest `duplicateOf`) | 13 | ~127 | ~127 | embedded, stem-then-answer | yes, incl. many full clinical vignettes | fully read all 13 pages; richest single source — Anatomy 33, Pharma 8, Histo 12, Physio 21, Patho 28, Micro 21, Para 4; numbering has small gaps (a couple items skipped, not blank) |
