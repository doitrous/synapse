...
export function systemPrompt({ extraPrompt, student }) {
  return [
    ...
    '- Help them find a topic, station or resource inside Connect Cortex.',
    '- Explain how a Connect Cortex surface works.',
    '',
    'WHAT YOU DO NOT DO',
    ...
    '- Do not answer questions unrelated to medical study or to using Connect Cortex; say so in one sentence and name what you do cover.',
    '',
