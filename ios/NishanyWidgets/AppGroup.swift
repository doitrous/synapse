...
/// their entitlements — see `Config/Nishany.entitlements` and
/// `Config/NishanyWidgets.entitlements`. A structural duplicate of
/// `ios/Nishany/Core/AppGroup.swift`: this extension is a separate target
