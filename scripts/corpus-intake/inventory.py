#!/usr/bin/env python3
"""Walk the Kasr Alainy corpus and record what every file physically is.

Read-only. Produces inventory.json: one row per file with identity (sha256),
shape (pages), and whether a text layer exists at all — which decides whether
classification can read the document or has to OCR it.
"""
import hashlib
import json
import os
