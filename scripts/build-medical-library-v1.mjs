...
const data = {
  ...
  generatedAt,
  states: {
    'nishany-academic-universities-v1': universities,
    'nishany-course-curricula-v1': {},
    'nishany-module-schedules-v1': {},
    'nishany-taxonomy-tree-v4': CURRICULUM_CATALOG,
    'nishany-medical-library-taxonomy-v1': MEDICAL_TAXONOMY_SEED,
    'nishany-admin-content-ledger-v4': [...articleItems, ...resourceItems],
    'nishany-concept-graph-v2': { concepts, relations },
    'nishany-medical-evidence-v1': evidence,
    'nishany-medical-evidence-published-v1': publishedEvidence,
