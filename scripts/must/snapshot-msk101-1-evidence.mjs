...
const REMAINING_CHECKSUM = 'ce01144baaa0cf78a783aa8ed64cbe1cf465ea23536ab1fbffd67a34f7255a3d'
...
function runAuditLabelStaticTest() {
  ...
  const expected = { 'audit-extract-failed': 3, 'audit-not-found': 13, 'empty-text': 10, 'sparse-text': 7, 'substantive-text': 24 }
  ...
  console.log('audit-label-static-test=pass remaining_audit_debt=24-substantive/7-sparse/10-empty/13-not-found/3-extract-failed')
}
...
if (processedHashes.length !== 45 || remainingHashes.length !== 56 || processedHashes.length + remainingHashes.length !== 101) throw new Error('Processed/remaining reconciliation drift')
...
const expectedRemainingDebt = { 'audit-extract-failed': 3, 'audit-not-found': 13, 'empty-text': 10, 'sparse-text': 7, 'substantive-text': 24 }
