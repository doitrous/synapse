...
const PROCESSED_FAMILY_HASHES = ['43a8be3c091e5b7f41820f5e155711519af16ed6a5c7fa05330134cc8c5e4903']
const SELECTED_CHECKSUM = '228a5361022abbb1572c28e0795f562b3ff4de8d10326873c7cf88a5aa559b02'
const REMAINING_CHECKSUM = '1ebf718be72577c2029ed6764b3b36d551bb423fd5c1f1f6d39fdba645145ea9'
...
function runAuditLabelStaticTest() {
  ...
  const expected = { 'audit-extract-failed': 3, 'audit-not-found': 14, 'empty-text': 19, 'sparse-text': 8, 'substantive-text': 58 }
  ...
  console.log('audit-label-static-test=pass remaining_audit_debt=58-substantive/8-sparse/19-empty/14-not-found/3-extract-failed')
}
...
for (const value of [...PROCESSED_FAMILY_HASHES, SELECTED_CHECKSUM, REMAINING_CHECKSUM, '21', '12', '3']) {
...
if (processedHashes.length !== 1 || remainingHashes.length !== 100 || processedHashes.length + remainingHashes.length !== 101) throw new Error('Processed/remaining reconciliation drift')
...
const expectedRemainingDebt = { 'audit-extract-failed': 3, 'audit-not-found': 14, 'empty-text': 19, 'sparse-text': 8, 'substantive-text': 58 }
...
const provenance = {
  ...
  completedSourceCoverage: { sha256: PROCESSED_FAMILY_HASHES[0], sourcePages: 3, renderedReadPages: '1-3', printedPromptObservations: 21, printedKeyObservations: 12, namedConceptsAssigned: 3, sourceProcessed: true },
