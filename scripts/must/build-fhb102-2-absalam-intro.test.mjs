...
test('the approved Absalam introduction, Arthropoda, Mosquitoes and Sandfly slices preserve their exact Draft and hold boundaries', () => {
  ...
  assert.match(coverage, /\| Question authoring holds \| 238 \| no student-facing record authored \|/)
...
test('Absalam Part 2 Sandfly Q1-Q30 emits only nineteen safe Draft questions and eleven exact holds', () => {
  ...
  assert.match(coverage, /Governed prompt observations: 5,444 total; 219 authored; \*\*5,225 raw prompt observations remain\*\*, including 238 explicit holds/)
  assert.match(coverage, /Governed answer observations: 5,211 total; 219 clean source-keyed prompts authored; \*\*4,992 raw answer observations remain\*\*, including the 238 held printed-key observations/)
})
...
test('Mucize Parasitology core Q61-Q90 emits eighteen governed Draft questions and twelve exact holds', () => {
  ...
  assert.match(coverage, /Governed prompt observations: 5,444 total; 219 authored; \*\*5,225 raw prompt observations remain\*\*, including 238 explicit holds and two source-absent prompts/)
  assert.match(coverage, /Governed answer observations: 5,211 total; 219 clean source-keyed prompts authored; \*\*4,992 raw answer observations remain\*\*, including the 238 held printed-key observations/)
  assert.match(coverage, /\| Evidence resources \| 29 \|/)
  assert.match(coverage, /\| Claims \| 219 \|/)
  assert.match(coverage, /\| Citations \| 224 \|/)
