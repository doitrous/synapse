...
| Kind | Created | Status |
|---|---:|---|
| Evidence resources | 8 | local-only source records |
...
The first seven slices authored Q1, Q5, Q7, Q8, Q9, Q10 and Q11 with printed keys unchanged. The eighth slice authors Q12 with printed key D unchanged: the MUST flies and myiasis lecture identifies Sarcophaga larvae by their rounded incomplete/open posterior peritreme and includes Sarcophaga among traumatic wound-myiasis agents. No answer override was made in any question.
...
## Exact backlog after eight slices

- Governed prompt observations: 5,444 total; 8 authored; **5,436 raw prompt observations remain**, including the 4 explicit holds.
- Governed answer observations: 5,211 total; 8 clean source-keyed prompts authored; **5,203 raw answer observations remain**, including the 4 held printed-key observations.
- Opening 32-prompt normalized family: 8 authored, 4 held, and **20 not yet assessed for authoring**; therefore **24 prompts remain in the authoring backlog**, of which Q32 is source-absent.
...
No MUST content has been uploaded or imported. All eight student-facing articles and questions remain Draft; all eight concepts use the concept schema's non-published \`under review\` state and \`publication_status: needs_evidence\`. Q2, Q3, Q4 and Q6 exist only as authoring-ledger holds.
`
}
