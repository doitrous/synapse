...
| Kind | Created | Status |
|---|---:|---|
| Evidence resources | 18 | local-only source records; Q24–Q27 lecture records retain explicit bounded visual-read pages |
...
## Exact backlog after twenty-two slices

- Governed prompt observations: 5,444 total; 8 authored; **5,436 raw prompt observations remain**, including the 19 explicit holds.
- Governed answer observations: 5,211 total; 8 clean source-keyed prompts authored; **5,203 raw answer observations remain**, including the 19 held printed-key observations.
- Opening 32-prompt normalized family: 8 authored, 19 held, and **5 not yet assessed for authoring**; therefore **24 prompts remain in the authoring backlog**, of which Q32 is source-absent.
...
No MUST content has been uploaded or imported. All eight student-facing articles and questions remain Draft; all eight concepts use the concept schema's non-published \`under review\` state and \`publication_status: needs_evidence\`. Q2, Q3, Q4, Q6, Q13 through Q27 exist only as authoring-ledger holds.
`
}
