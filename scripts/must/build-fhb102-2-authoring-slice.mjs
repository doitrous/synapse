...
`
  return coverage()
    ...
    .replace('| Question authoring holds | 256 |', '| Question authoring holds | 257 |')
    .replace('including 256 explicit holds and two source-absent prompts', 'including 257 explicit holds and two source-absent prompts')
    .replace('including the 256 held printed-key observations', 'including the 257 held printed-key observations')
