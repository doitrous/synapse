...
const mucizeAdvancedItems = [
  ...
  {
    q: 17, bankQ: 17, conceptId: 'CON-INF-A17B2E4C9D6F81', canonicalKey: 'parasitology.myiasis.urogenital-latrine-exposure',
    label: 'Urogenital myiasis follows public-toilet or latrine exposure', aliases: ['Urogenital myiasis latrine exposure', 'Latrine-associated urogenital myiasis'], conceptType: 'clinical association',
    article: 'clinicalSiteMyiasis', primaryNode: 'DIS-PAR-T03', subtopic: 'Arthropods and vectors', microtopic: 'Clinical myiasis',
    assessmentPage: 26, answerPage: 28, teachingPage: 45, teachingResourceId: myiasisResourceId,
    teachingTitle: 'Flies and Myiasis',
    stem: 'Which type of myiasis is most likely to occur in individuals who frequently use public toilets or latrines?', key: 'B',
    options: ['Gastric myiasis', 'Urogenital myiasis', 'Aural myiasis', 'Nasopharyngeal myiasis'],
    claim: 'Urogenital myiasis is the clinically associated outcome when flies deposit eggs on the urethral opening during defecation or latrine use.',
    support: 'The official urogenital-myiasis slide states that, probably during sleep or during defecation, certain flies deposit their eggs on the urethral opening, and the larvae then creep up the urethra to the bladder and urinary tract.',
    objective: 'Identify urogenital myiasis as the type associated with public-toilet or latrine exposure.',
    pitfalls: 'Gastric, aural and nasopharyngeal myiasis are not the site linked to public-toilet or latrine exposure in the governed teaching.',
    sourceCandidates: ['concept_25a7c6c1a0f6c476622cf674'],
    rejected: ['concept_25a7c6c1a0f6c476622cf674 — the same pending raw urogenital-myiasis-manifestations identity flagged as a rejected merge candidate when Fannia\'s fly-specific association (CON-INF-3D51F420815EB7) was authored; completed here as its own exact concept because it answers which myiasis type follows the exposure route, not which fly causes it.'],
  },
  {
    q: 19, bankQ: 19, conceptId: 'CON-INF-F42C8B916A3D75', canonicalKey: 'parasitology.myiasis.nasopharyngeal-nasal-sinus',
    label: 'Nasopharyngeal myiasis invades the nasal passages and sinuses', aliases: ['Nasopharyngeal myiasis', 'Nasal and sinus myiasis'], conceptType: 'clinical feature',
    article: 'clinicalSiteMyiasis', primaryNode: 'DIS-PAR-T03', subtopic: 'Arthropods and vectors', microtopic: 'Clinical myiasis',
    assessmentPage: 26, answerPage: 28, teachingPage: 48, teachingResourceId: myiasisResourceId,
    teachingTitle: 'Flies and Myiasis',
    stem: 'Which type of myiasis is characterized by the invasion of the nasal passages or sinuses by fly larvae?', key: 'C',
    options: ['Gastric myiasis', 'Cutaneous myiasis', 'Nasopharyngeal myiasis', 'Urogenital myiasis'],
    claim: 'Nasopharyngeal myiasis involves fly larvae finding their way to the nose and invading the nasal passages, potentially reaching the sinuses.',
    support: 'The official ocular-and-nasopharyngeal-myiasis slide states that the larvae of flies find their way to the conjunctiva or nose and may cause serious damage, destroying the eyes, orbit or even the sinuses.',
    objective: 'Identify nasopharyngeal myiasis as the type invading the nasal passages or sinuses.',
    pitfalls: 'Gastric, cutaneous and urogenital myiasis are not the site linked to nasal-passage or sinus invasion in the governed teaching.',
    rejected: [],
  },
  {
    q: 26, bankQ: 26, conceptId: 'CON-INF-C9A3D62F58B417', canonicalKey: 'parasitology.mosquitoes.control-nonvolatile-oil-chemical',
    label: 'Non-volatile oils suffocate mosquito aquatic stages as chemical control', aliases: ['Non-volatile oil mosquito control', 'Oil-film larval suffocation'], conceptType: 'intervention',
    article: 'mosquitoControl', primaryNode: 'DIS-PAR-T03', subtopic: 'Arthropods and vectors', microtopic: 'Chemical mosquito control',
    assessmentPage: 27, answerPage: 28, teachingPage: 39, teachingResourceId: mosquitoResourceId,
    teachingTitle: 'Arthropod Vectors for Disease Transmission — Mosquitoes',
    stem: 'What is the primary method of chemical control for mosquito larvae?', key: 'B',
    options: ['Using light traps to attract and kill adult mosquitoes', 'Spraying non-volatile oils on water surfaces to suffocate larvae', 'Introducing bacteria like Bacillus thuringiensis to kill larvae', 'Using genetic modification to sterilize adult mosquitoes'],
    claim: 'Non-volatile oils sprayed on water surfaces form a continuous film that acts as a respiratory poison, suffocating mosquito eggs, larvae and pupae.',
    support: 'The official chemical-control slide states that non-volatile oil, such as solar, diesel or waste engine oil, forms a continuous film when sprayed on the water surface and acts as a respiratory poison that suffocates and poisons aquatic forms by inhalation.',
    objective: 'Identify non-volatile oil spraying as the chemical control method that suffocates mosquito larvae.',
    pitfalls: 'Light traps are mechanical, Bacillus thuringiensis is biological and genetic sterilization is not the governed chemical method for larvae.',
    rejected: [],
  },
  {
    q: 28, bankQ: 28, conceptId: 'CON-INF-D74B6E15A2C938', canonicalKey: 'parasitology.mosquitoes.control-nets-repellents-personal-protection',
    label: 'Mosquito nets and insect repellents are personal-protection measures in endemic areas', aliases: ['Mosquito net and repellent prevention', 'Personal mosquito-bite protection'], conceptType: 'intervention',
    article: 'mosquitoControl', primaryNode: 'DIS-PAR-T03', subtopic: 'Arthropods and vectors', microtopic: 'Personal mosquito protection',
    assessmentPage: 27, answerPage: 28, teachingPages: '41–42', teachingResourceId: mosquitoResourceId,
    teachingTitle: 'Arthropod Vectors for Disease Transmission — Mosquitoes',
    stem: 'What is the primary method of preventing mosquito-borne diseases in endemic areas?', key: 'B',
    options: ['Vaccinating all domestic animals', 'Using mosquito nets and insect repellents', 'Removing all standing water sources', 'Spraying adult mosquitoes with antibiotics'],
    claim: 'Sleeping under insecticide-impregnated mosquito nets and using insect repellents such as citronella oil, eucalyptus oil or synthetic repellents are personal-protection measures recommended for endemic areas.',
    support: 'The official adult-control slide recommends sleeping under mosquito nets in endemic areas, with nets that may be impregnated with insecticides, and the following repellents slide lists citronella oil, eucalyptus oil and synthetic repellents such as Indalone applied to bare skin or clothing.',
    objective: 'Identify mosquito nets and insect repellents as personal-protection measures against mosquito-borne disease in endemic areas.',
    pitfalls: 'Vaccinating domestic animals, removing all standing water and spraying antibiotics are not the governed personal-protection measures for endemic-area prevention.',
    rejected: [],
  },
  {
    q: 29, bankQ: 29, conceptId: 'CON-INF-F16A82C4E9D375', canonicalKey: 'parasitology.mosquitoes.aedes-small-container-breeding',
    label: 'Aedes and related mosquitoes breed in small artificial water collections', aliases: ['Aedes container breeding', 'Aedes flower-vase and bucket breeding'], conceptType: 'life cycle',
    article: 'mosquitoBiology', primaryNode: 'DIS-PAR-T03', subtopic: 'Arthropods and vectors', microtopic: 'Mosquito breeding habitat',
    assessmentPage: 27, answerPage: 28, teachingPage: 10, teachingResourceId: mosquitoResourceId,
    teachingTitle: 'Arthropod Vectors for Disease Transmission — Mosquitoes',
    stem: 'Which of the following is a key feature of the breeding habits of Aedes mosquitoes?', key: 'B',
    options: ['They breed only in large bodies of water like lakes', 'They can breed in small water collections, such as flower vases or buckets', 'They do not require water for breeding', 'They breed only in fast-flowing rivers'],
    claim: 'Aedes and some other mosquitoes can breed in very small collections of water, such as inside a flower vase, a bucket or even a bottle cover.',
    support: 'The official bionomics slide states that Aedes and some other mosquitoes can breed in a very little collection of water inside a flower vase, water inside buckets, and even in a bottle cover.',
    objective: 'Identify small artificial water collections such as flower vases and buckets as Aedes breeding sites.',
    pitfalls: 'The governed teaching does not restrict Aedes breeding to large lakes, waterless conditions or fast-flowing rivers.',
    rejected: [],
  },
].map((item) => ({
...
const mucizeAntibacterialOneItems = [
  {
    q: 19, conceptId: 'CON-INF-5170E13153A92B', canonicalKey: 'pharmacology.penicillins.therapeutic-uses-overview',
    label: 'Penicillins treat tonsillitis, are used for rheumatic-fever prophylaxis and for meningitis', aliases: ['Penicillin therapeutic uses', 'Penicillin indications overview'], conceptType: 'clinical use',
    article: 'penicillins', microtopic: 'Penicillin therapeutic uses', assessmentPage: 31, teachingPage: '21-22',
    stem: 'Penicillins are used in the treatment of:', key: 'D',
    options: ['Tonsillitis', 'Rheumatic fever prophylaxis', 'Meningitis', 'All of the above'],
    claim: 'Penicillins treat streptococcal throat infections (tonsillitis), are used for rheumatic-fever prophylaxis with benzathine penicillin, and treat meningococcal meningitis, so the printed all-of-the-above key reflects a genuine set of listed uses rather than a single indication.',
    support: 'The official B-Lactam & Vancomycin deck Therapeutic Uses slide lists acute throat infections (tonsillitis) under streptococcal infections and meningococcal meningitis treated with penicillin G or ampicillin IV; the separate Prophylaxis slide lists benzathine penicillin for recurrence of rheumatic fever.',
    objective: 'Recognise tonsillitis, rheumatic-fever prophylaxis and meningitis as genuine penicillin indications supporting the all-of-the-above key.',
    pitfalls: 'None of the three listed uses is excluded from the governed therapeutic-uses and prophylaxis slides, so no single option alone is the complete governed answer.',
    rejected: [],
  },
  {
    q: 46, conceptId: 'CON-INF-5170E13153A92B', canonicalKey: 'pharmacology.penicillins.therapeutic-uses-overview',
    label: 'Penicillins treat tonsillitis, are used for rheumatic-fever prophylaxis and for meningitis', aliases: ['Penicillin therapeutic uses', 'Penicillin indications overview'], conceptType: 'clinical use',
    article: 'penicillins', microtopic: 'Penicillin therapeutic uses', assessmentPage: 35, teachingPage: '21, 23',
    stem: 'Which of the following is a use of penicillins except?', key: 'A',
    options: ['Anaphylactic shock', 'Meningitis', 'Gonorrhea', 'Typhoid'],
    claim: 'Anaphylactic shock is an adverse hypersensitivity reaction to penicillin, not a therapeutic indication, while meningitis, gonorrhea and typhoid are each listed penicillin or aminopenicillin uses in the governed teaching.',
    support: 'The official Adverse Effects slide lists hypersensitivity up to anaphylaxis as the most important adverse effect; the separate Therapeutic Uses slide lists meningococcal meningitis (penicillin G or ampicillin), syphilis and gonorrhea, and typhoid and paratyphoid fever (amoxicillin and ampicillin) as indications.',
    objective: 'Distinguish anaphylactic shock as an adverse effect rather than a therapeutic use, among otherwise-genuine penicillin indications.',
    pitfalls: 'Meningitis, gonorrhea and typhoid are not distractors here: the governed Therapeutic Uses slide lists all three; only anaphylactic shock belongs to the separate Adverse Effects slide.',
    rejected: [],
  },
  {
    q: 21, conceptId: 'CON-INF-139E187B0495F7', canonicalKey: 'pharmacology.cephalosporins.first-generation-gram-positive-spectrum',
    label: 'First-generation cephalosporins are mainly effective against Gram-positive bacteria', aliases: ['First-generation cephalosporin spectrum', 'Cefazolin-class Gram-positive activity'], conceptType: 'classification',
    article: 'cephalosporins', microtopic: 'First-generation cephalosporin spectrum', assessmentPage: 31, teachingPage: 25,
    stem: 'Which generation of cephalosporins is mainly effective against G+ve bacteria?', key: 'A',
    options: ['1st generation', '2nd generation', '3rd generation', '4th generation'],
    claim: 'First-generation cephalosporins retain a spectrum weighted toward Gram-positive cocci and bacilli, with only some Gram-negative activity.',
    support: 'The official 1st Generation slide (cefalexin, cefradine, cefazolin) states the spectrum as Gram-positive cocci (streptococci, staphylococci) plus some Gram-negative organisms (E. coli, Klebsiella).',
    objective: 'Identify first-generation cephalosporins as the group mainly effective against Gram-positive bacteria.',
    pitfalls: "The deck's 2nd-generation slide states extended Gram-negative and reduced Gram-positive activity relative to 1st generation, and the 3rd/4th-generation slides emphasise resistant Gram-negative coverage, so the Gram-positive weighting belongs to the first generation.",
    rejected: [],
  },
  {
    q: 22, conceptId: 'CON-INF-698A578CAADCD2', canonicalKey: 'pharmacology.cephalosporins.cefoperazone-biliary-excretion',
    label: "Cefoperazone's biliary excretion route lowers its nephrotoxicity risk", aliases: ['Cefoperazone dual excretion', 'Cefoperazone biliary elimination'], conceptType: 'pharmacokinetics',
    article: 'cephalosporins', microtopic: 'Cefoperazone excretion route', assessmentPage: 32, teachingPage: '31-32',
    stem: 'Which cephalosporin is NOT nephrotoxic due to dual excretion routes?', key: 'A',
    options: ['Cefoperazone', 'Cefazolin', 'Cefradine', 'Cefadroxil'],
    claim: 'Cefoperazone is excreted mainly in bile in addition to the renal route shared by other cephalosporins, giving it a biliary escape from the class nephrotoxicity risk.',
    support: 'The official Pharmacokinetics slide states elimination is mainly renal for the class, but cefoperazone and ceftriaxone are excreted mainly in bile; the Adverse Effects slide lists nephrotoxicity, especially with aminoglycosides, as a class effect.',
    objective: "Identify cefoperazone's biliary excretion route as the basis for its reduced nephrotoxicity risk relative to the renally-eliminated class.",
    pitfalls: 'The governed deck assigns dual biliary/renal excretion only to cefoperazone and ceftriaxone among cephalosporins; the class-wide slide otherwise lists nephrotoxicity as a shared risk.',
    rejected: [],
  },
  {
    q: 23, conceptId: 'CON-INF-E5BFBA5C2B87F3', canonicalKey: 'pharmacology.cephalosporins.third-generation-cefotaxime-profile',
    label: 'Cefotaxime is a third-generation cephalosporin that crosses the blood-brain barrier', aliases: ['Cefotaxime generation and BBB crossing', 'Third-generation cefotaxime profile'], conceptType: 'drug profile',
    article: 'cephalosporins', microtopic: 'Third-generation cephalosporins', assessmentPage: 32, teachingPage: 28,
    stem: 'Which of the following is a 3rd generation cephalosporin?', key: 'A',
    options: ['Cefotaxime', 'Cefoxitin', 'Cefaclor', 'Cefamandole'],
    claim: 'Cefotaxime is one of the four named third-generation cephalosporins, with activity against resistant Gram-negative organisms including Pseudomonas and the ability to cross the blood-brain barrier.',
    support: 'The official 3rd Generation slide lists cefoperazone, cefotaxime, ceftriaxone and ceftazidime by name, states activity against resistant Gram-negative organisms such as Pseudomonas, and that most agents can cross the BBB for use in meningitis.',
    objective: 'Classify cefotaxime as a third-generation cephalosporin.',
    pitfalls: 'Cefoxitin is a second-generation cephamycin, and cefaclor and cefamandole are second-generation agents in the governed deck, not third-generation.',
    rejected: [],
  },
  {
    q: 24, conceptId: 'CON-INF-E5BFBA5C2B87F3', canonicalKey: 'pharmacology.cephalosporins.third-generation-cefotaxime-profile',
    label: 'Cefotaxime is a third-generation cephalosporin that crosses the blood-brain barrier', aliases: ['Cefotaxime generation and BBB crossing', 'Third-generation cefotaxime profile'], conceptType: 'drug profile',
    article: 'cephalosporins', microtopic: 'Third-generation cephalosporins', assessmentPage: 32, teachingPage: '28, 31',
    stem: 'Which cephalosporin can pass the blood-brain barrier (BBB)?', key: 'B',
    options: ['Cefoperazone', 'Cefotaxime', 'Cefuroxime', 'Cefoxitin'],
    claim: 'Cefotaxime is a third-generation cephalosporin, and the governed teaching states that third-generation agents can cross the BBB except cefoperazone, so cefotaxime is among those able to cross into the CNS.',
    support: 'The official Pharmacokinetics slide states that 1st- and 2nd-generation members cannot cross the BBB, while 3rd-generation agents (except cefoperazone) can cross, which is useful in meningitis; cefotaxime is named among the 3rd-generation agents on the preceding slide.',
    objective: 'Identify cefotaxime as a third-generation cephalosporin able to cross the BBB, unlike the excluded cefoperazone.',
    pitfalls: 'Cefoperazone is the named third-generation exception that cannot cross the BBB; cefuroxime and cefoxitin belong to the second generation, which the deck excludes from BBB crossing altogether.',
    rejected: [],
  },
  {
    q: 25, conceptId: 'CON-INF-30D5C43BEE183B', canonicalKey: 'pharmacology.cephalosporins.adverse-effects-overview',
    label: 'Cephalosporin adverse effects include penicillin cross-allergy, nephrotoxicity and a disulfiram-like reaction', aliases: ['Cephalosporin adverse effect profile', 'Cephalosporin side effects'], conceptType: 'adverse effect',
    article: 'cephalosporins', microtopic: 'Cephalosporin adverse effects', assessmentPage: 32, teachingPage: 32,
    stem: 'Which of the following is a common adverse effect of cephalosporins?', key: 'D',
    options: ['Allergy (cross-allergy with penicillin)', 'Nephrotoxicity', 'Disulfiram-like reaction with alcohol', 'All of the above'],
    claim: 'Cephalosporins carry hypersensitivity with penicillin cross-allergy, nephrotoxicity especially combined with aminoglycosides, and a disulfiram-like alcohol-intolerance reaction, so all three listed effects are genuine governed adverse effects.',
    support: 'The official Adverse Effects slide lists hypersensitivity with avoidance in serious penicillin allergy (cross-allergy), nephrotoxicity especially with aminoglycosides, and disulfiram-like reaction (alcohol intolerance) among the numbered cephalosporin adverse effects.',
    objective: 'Recognise allergy/cross-allergy, nephrotoxicity and the disulfiram-like reaction as governed cephalosporin adverse effects supporting the all-of-the-above key.',
    pitfalls: 'None of the three listed effects is excluded from the governed Adverse Effects slide, so no single option alone is the complete governed answer.',
    rejected: [],
  },
  {
    q: 28, conceptId: 'CON-INF-30D5C43BEE183B', canonicalKey: 'pharmacology.cephalosporins.adverse-effects-overview',
    label: 'Cephalosporin adverse effects include penicillin cross-allergy, nephrotoxicity and a disulfiram-like reaction', aliases: ['Cephalosporin adverse effect profile', 'Cephalosporin side effects'], conceptType: 'adverse effect',
    article: 'cephalosporins', microtopic: 'Cephalosporin adverse effects', assessmentPage: 32, teachingPage: 32,
    stem: 'Which of the following is NOT a side effect of cephalosporins?', key: 'D',
    options: ['Nephrotoxicity', 'Neurotoxicity', 'Hypokalemia', 'Increased appetite'],
    claim: 'The governed cephalosporin adverse-effects list covers hypersensitivity, nephrotoxicity, local irritation, hypoprothrombinemia and bleeding, a disulfiram-like reaction and cross-resistance with penicillins; increased appetite does not appear among them.',
    support: 'The official Adverse Effects slide enumerates six numbered cephalosporin adverse effects (hypersensitivity, nephrotoxicity, local irritation, hypoprothrombinemia and bleeding, disulfiram-like reaction, cross-resistance with penicillins); increased appetite is not one of the six.',
    objective: 'Identify increased appetite as the distractor that is not a governed cephalosporin adverse effect.',
    pitfalls: "Nephrotoxicity is explicitly listed; neurotoxicity and hypokalemia are not named on this slide either, but only increased appetite is offered here as the printed key's NOT-a-side-effect answer.",
    rejected: [],
  },
  {
    q: 47, conceptId: 'CON-INF-AB5DEDED904BE8', canonicalKey: 'pharmacology.penicillins.adverse-effects-overview',
    label: "Penicillin adverse effects include allergy and G.I.T. upset, distinct from its therapeutic uses", aliases: ['Penicillin adverse effect profile', 'Penicillin side effects versus uses'], conceptType: 'adverse effect',
    article: 'penicillins', microtopic: 'Penicillin adverse effects', assessmentPage: 35, teachingPage: '21, 23',
    stem: 'Which of the following is a side effect of penicillins except?', key: 'D',
    options: ['Allergy', 'Resistance', 'G.I.T upset', 'Typhoid'],
    claim: 'Allergy and G.I.T. upset are governed penicillin adverse effects, and typhoid fever is instead a listed penicillin/aminopenicillin therapeutic indication, not a side effect.',
    ...
    objective: 'Distinguish typhoid, a genuine penicillin indication, from allergy and G.I.T. upset, which are genuine penicillin adverse effects.',
    pitfalls: 'Typhoid is not merely absent from the adverse-effects list: the governed Therapeutic Uses slide explicitly lists it as a treated indication, reinforcing that it belongs with the uses rather than the side effects of penicillin.',
    rejected: [],
  },
].map((item) => ({
  idPrefix: 'ANTIBACT1', bankQ: item.q, assessmentResourceId: mucizeAssessmentResourceId,
  bankLabel: 'Mucize Antibacterial (1) MCQ', answerPage: 36, teachingResourceId: vancomycinResourceId,
  teachingTitle: 'B-Lactam & Vancomycin', topic: 'Pharmacology', subtopic: 'Antimicrobials',
  primaryNode: 'DIS-PHA-T05', secondaryNodes: ['DIS-PHA'], ...item,
}))

microItems.push(...mucizeAntibacterialOneItems)

const mucizeAntibacterialOnePrinciplesItems = [
  {
    q: 1, conceptId: 'CON-INF-262BE51D90B753', canonicalKey: 'pharmacology.antimicrobials.spectrum-classification',
    label: 'Narrow-spectrum agents cover a limited species range; broad-spectrum agents cover a wide range', aliases: ['Antimicrobial spectrum classification', 'Narrow versus broad spectrum'], conceptType: 'classification',
    article: 'antimicrobialPrinciples', microtopic: 'Spectrum of activity', assessmentPage: 29, teachingPage: 7, teachingResourceId: antibioticsIntroResourceId,
    stem: 'What is the primary action of narrow-spectrum antibiotics?', key: 'B',
    options: ['Act on both G+ve and G-ve bacteria', 'Act on either G+ve or G-ve bacteria', 'Act on fungi', 'Act on viruses'],
    claim: 'Narrow-spectrum antibiotics are effective against a limited number of species, in practice acting on either the Gram-positive or the Gram-negative group rather than both.',
    support: "The official Antibiotics Introduction deck's Principles/Definitions slide states narrow spectrum is effective against a limited number of species, contrasted with broad spectrum's wide variety of species, alongside a separate Gram-negative-agent/Gram-positive-agent/anti-anaerobic-activity classification axis.",
    objective: 'Identify narrow-spectrum activity as coverage restricted to a limited group, in this bank operationalised as either the Gram-positive or Gram-negative group.',
    pitfalls: 'Covering both Gram-positive and Gram-negative groups, or acting on fungi or viruses, is not the governed narrow-spectrum definition.',
    rejected: [],
  },
  {
    q: 2, conceptId: 'CON-INF-262BE51D90B753', canonicalKey: 'pharmacology.antimicrobials.spectrum-classification',
    label: 'Narrow-spectrum agents cover a limited species range; broad-spectrum agents cover a wide range', aliases: ['Antimicrobial spectrum classification', 'Narrow versus broad spectrum'], conceptType: 'classification',
    article: 'antimicrobialPrinciples', microtopic: 'Spectrum of activity', assessmentPage: 29, teachingPage: 7, teachingResourceId: antibioticsIntroResourceId,
    stem: 'Broad-spectrum antibiotics are effective against:', key: 'C',
    options: ['Only G+ve bacteria', 'Only G-ve bacteria', 'Both G+ve and G-ve bacteria', 'Only viruses'],
    claim: 'Broad-spectrum antibiotics are effective against a wide variety of species, in practice covering both the Gram-positive and Gram-negative groups.',
    support: 'The official Principles/Definitions slide states broad spectrum is effective against a wide variety of species, the complement of the narrow-spectrum definition on the same slide.',
    objective: 'Identify broad-spectrum activity as coverage extending across both Gram-positive and Gram-negative groups.',
    pitfalls: 'Restricting activity to only Gram-positive or only Gram-negative organisms, or to viruses alone, is the narrow-spectrum pattern, not broad-spectrum.',
    rejected: [],
  },
  {
    q: 3, conceptId: 'CON-INF-38531DB0D13F6E', canonicalKey: 'pharmacology.antimicrobials.bactericidal-bacteriostatic-classification',
    label: 'Bactericidal drugs kill bacteria; bacteriostatic drugs inhibit growth and need an intact host immune system', aliases: ['Bactericidal versus bacteriostatic', 'Antimicrobial kill kinetics'], conceptType: 'classification',
    article: 'antimicrobialPrinciples', microtopic: 'Bactericidal and bacteriostatic action', assessmentPage: 29, teachingPage: 6, teachingResourceId: antibioticsIntroResourceId,
    stem: 'Bactericidal antibiotics:', key: 'B',
    options: ['Stop bacterial growth', 'Kill and destroy bacteria', 'Inhibit bacterial reproduction', 'Prevent bacterial adhesion'],
    claim: 'Bactericidal antibiotics kill bacteria and reduce bacterial load, distinct from bacteriostatic agents that only inhibit growth.',
    support: 'The official deck states bactericidal drugs kill bacteria and reduce bacterial load, while bacteriostatic drugs inhibit growth and reproduction of bacteria.',
    objective: 'Define bactericidal action as killing bacteria and reducing bacterial load.',
    pitfalls: 'Stopping growth without killing, inhibiting reproduction alone, or preventing adhesion describe bacteriostatic or unrelated patterns, not the bactericidal definition.',
    rejected: [],
  },
  {
    q: 4, conceptId: 'CON-INF-38531DB0D13F6E', canonicalKey: 'pharmacology.antimicrobials.bactericidal-bacteriostatic-classification',
    label: 'Bactericidal drugs kill bacteria; bacteriostatic drugs inhibit growth and need an intact host immune system', aliases: ['Bactericidal versus bacteriostatic', 'Antimicrobial kill kinetics'], conceptType: 'classification',
    article: 'antimicrobialPrinciples', microtopic: 'Bactericidal and bacteriostatic action', assessmentPage: 29, teachingPage: 6, teachingResourceId: antibioticsIntroResourceId,
    stem: 'Bacteriostatic antibiotics are contraindicated in:', key: 'B',
    options: ['Mild infections', 'Severe infections', 'Healthy individuals', 'Non-immunocompromised patients'],
    claim: 'Bacteriostatic antibiotics require an intact host immune system to clear the growth-inhibited bacteria, so they are less appropriate when the host cannot be relied on to finish clearing the infection, while bactericidal drugs are the governed choice when immunity is poor.',
    support: 'The official deck states bacteriostatic drugs require an intact immune system while bactericidal drugs are appropriate in poor immunity, since all antibiotics ultimately require the immune system to work properly.',
    objective: 'Recognise that bacteriostatic antibiotics depend on host immune competence, making them less suitable when that reserve cannot be relied upon.',
    pitfalls: "The governed slide frames this as an immune-competence dependency rather than infection severity in the abstract; mild infections, healthy individuals and non-immunocompromised patients are the options the deck's logic excludes, not the printed key.",
    rejected: [],
  },
  {
    q: 6, conceptId: 'CON-INF-240CAE3484E391', canonicalKey: 'pharmacology.antimicrobials.prophylactic-therapeutic-classification',
    label: 'Prophylaxis prevents infection; treatment cures existing or suspected infection', aliases: ['Prophylactic versus therapeutic antimicrobial use', 'Antimicrobial use intent'], conceptType: 'classification',
    article: 'antimicrobialPrinciples', microtopic: 'Prophylaxis versus treatment', assessmentPage: 29, teachingPage: 7, teachingResourceId: antibioticsIntroResourceId,
    stem: 'Antimicrobials used to prevent infection are referred to as:', key: 'B',
    options: ['Therapeutic', 'Prophylactic', 'Curative', 'Diagnostic'],
    claim: 'Antimicrobial use to prevent infection is termed prophylaxis, distinct from treatment, which cures an existing or suspected infection.',
    support: 'The official Principles/Definitions slide states prophylaxis is use to prevent infection and treatment is use to cure existing or suspected infection.',
    objective: 'Identify prophylactic use as antimicrobial administration intended to prevent infection.',
    pitfalls: 'Curative and therapeutic wording describes treatment of existing infection, not prevention; diagnostic is not a governed antimicrobial-use category on this slide.',
    rejected: [],
  },
  {
    q: 10, conceptId: 'CON-INF-EF635FB877198C', canonicalKey: 'pharmacology.antimicrobials.five-general-targets',
    label: 'Antibacterial agents act through five governed targets: cell wall, membrane, protein synthesis, nucleic acid synthesis and biosynthetic pathways', aliases: ['Five targets of antibacterial agents', 'General antimicrobial mechanism list'], conceptType: 'mechanism',
    article: 'antimicrobialPrinciples', microtopic: 'General mechanisms of antimicrobial action', assessmentPage: 30, teachingPage: 27, teachingResourceId: antibioticsIntroResourceId,
    stem: 'Which of the following is NOT a mechanism of antimicrobial action?', key: 'D',
    options: ['Inhibition of cell wall synthesis', 'Inhibition of DNA replication', 'Inhibition of protein synthesis', 'Inhibition of vitamin absorption'],
    claim: 'The governed deck lists five targets of antibacterial agents: cell-wall production, bacterial membranes, protein synthesis, nucleic acid synthesis and biosynthetic (folate) pathways; inhibition of vitamin absorption is not among them.',
    support: 'The official Targets-of-antibacterial-agents slide numbers exactly five targets: inhibit cell wall production, disrupt bacterial membranes, inhibit protein synthesis, inhibit nucleic acid synthesis, and block biosynthetic pathways (folate metabolism).',
    objective: 'Identify inhibition of vitamin absorption as outside the governed five-target list of antimicrobial mechanisms.',
    pitfalls: 'Cell-wall synthesis, nucleic acid synthesis (DNA replication) and protein synthesis are each named targets on the governed slide; vitamin absorption is not.',
    rejected: [],
  },
  {
    q: 7, conceptId: 'CON-INF-27507C163E8413', canonicalKey: 'pharmacology.antimicrobials.general-adverse-effect-git-upset',
    label: 'G.I.T. upset (nausea, vomiting, diarrhea) is a numbered general antimicrobial adverse effect', aliases: ['Antimicrobial G.I.T. upset', 'General antimicrobial adverse effects'], conceptType: 'adverse effect',
    article: 'antimicrobialPrinciples', microtopic: 'General antimicrobial adverse effects', assessmentPage: 29, teachingPage: 3, teachingResourceId: antibioticsAdverseResourceId,
    stem: 'Which of the following is a general adverse effect of antimicrobials?', key: 'B',
    options: ['Increased appetite', 'G.I.T upset', 'Improved immunity', 'Enhanced vitamin absorption'],
    claim: 'G.I.T. upset, covering nausea, vomiting and diarrhea, is listed first among the general adverse effects of antimicrobials in the governed teaching.',
    support: 'The official Adverse Effects deck\'s first numbered category is GIT upset, with nausea and vomiting exemplified by erythromycin and diarrhea exemplified by ampicillin and chloramphenicol.',
    objective: 'Identify G.I.T. upset as a governed general adverse effect of antimicrobials.',
    pitfalls: 'Improved immunity and enhanced vitamin absorption are not general antimicrobial adverse effects in the governed numbered list; the deck instead numbers GIT upset first.',
    rejected: [],
  },
  {
    q: 8, conceptId: 'CON-INF-27452005C75CBA', canonicalKey: 'pharmacology.antimicrobials.candida-superinfection-broad-spectrum',
    label: 'Broad-spectrum antibiotics that kill normal flora let Candida cause superinfection', aliases: ['Candida superinfection', 'Antibiotic-associated Candida overgrowth'], conceptType: 'adverse effect',
    article: 'antimicrobialPrinciples', microtopic: 'Effect on bacterial flora', assessmentPage: 30, teachingPage: 6, teachingResourceId: antibioticsAdverseResourceId,
    stem: 'Superinfection by Candida is commonly caused by:', key: 'B',
    options: ['Narrow-spectrum antibiotics', 'Broad-spectrum antibiotics', 'Antiviral drugs', 'Antifungal drugs'],
    claim: 'Incompletely absorbed and broad-spectrum antibiotics kill normal flora and give Candida the opportunity to flourish, causing superinfection.',
    support: 'The official Adverse Effects deck\'s Effect-on-Bacterial-Flora slide states that incompletely absorbed antibiotics such as ampicillin, tetracyclines and chloramphenicol kill normal flora and give Candida the chance to flourish, listed under superinfection by Candida.',
    objective: 'Identify broad-spectrum antibiotic disruption of normal flora as the governed cause of Candida superinfection.',
    pitfalls: 'Narrow-spectrum antibiotics, antiviral drugs and antifungal drugs are not the governed cause of flora-disruption Candida superinfection; broad-spectrum antibacterial killing of normal flora is.',
    rejected: [],
  },
  {
    q: 9, conceptId: 'CON-INF-5B9C4DD48BC8E3', canonicalKey: 'pharmacology.antimicrobials.pseudomembranous-colitis-c-difficile',
    label: 'Pseudomembranous colitis is Clostridium difficile-associated diarrhea caused by antibiotic disruption of flora', aliases: ['Pseudomembranous colitis organism', 'Clostridium difficile-associated diarrhea'], conceptType: 'adverse effect',
    article: 'antimicrobialPrinciples', microtopic: 'Antibiotic-associated colitis', assessmentPage: 30, teachingPage: 7, teachingResourceId: antibioticsAdverseResourceId,
    stem: 'Pseudomembranous colitis is associated with:', key: 'A',
    options: ['Clostridium difficile', 'Candida albicans', 'Escherichia coli', 'Staphylococcus aureus'],
    claim: 'Pseudomembranous colitis is Clostridium difficile-associated diarrhea (CDAD), caused by antibiotics such as clindamycin, ampicillin, chloramphenicol and tetracyclines, and treated with metronidazole, vancomycin or cholestyramine.',
    support: 'The official Adverse Effects deck explicitly equates Clostridium Difficile Associated Diarrhoea with pseudomembranous colitis and antibiotic-associated colitis, naming clindamycin, ampicillin, chloramphenicol and tetracyclines as causative antibiotics.',
    objective: 'Identify Clostridium difficile as the organism associated with pseudomembranous colitis.',
    pitfalls: 'The governed deck names the causative antibiotics and treatment drugs separately from the causative organism; Clostridium difficile is the organism the printed key associates with pseudomembranous colitis.',
    rejected: [],
  },
].map((item) => ({
  idPrefix: 'ANTIBACT1', bankQ: item.q, assessmentResourceId: mucizeAssessmentResourceId,
  bankLabel: 'Mucize Antibacterial (1) MCQ', answerPage: 36, teachingTitle: 'Antibiotics Introduction and Adverse Effects',
...
function corpusSourceIndex() {
  return JSON.stringify({
    ...
    sources: {
      ...
      [antibioticsAdverseResourceId]: {
        sourceRelativePath: 'Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/Antibiotics Advrse effects.pdf',
        sourceRelativePaths: ['Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/Antibiotics Advrse effects.pdf'],
...
## qualification
All 47 pages were already visually governed in source triage. Physical pages 6–28 were rendered and visually re-read for the bounded Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q33 authoring audit, including every governed option and printed answer token. Core Q3, Q5, Q8, Q9, Q11, Q15, Q28, Q29, Q31, Q38, Q41–Q49, Q54, Q57–Q60, Q62, Q67–Q72, Q74–Q76, Q80, Q82–Q85, Q87–Q89 and Q91–Q94 plus Case 4 Q2, Case 6 Q1, Case 7 Q2 and Advanced Q11/Q13/Q17/Q19/Q26/Q28/Q29 are authored only where their unchanged printed keys align with direct MUST faculty teaching and safe governed local concept/article identities. Core Q1–Q2, Q4, Q6–Q7, Q10, Q12–Q14, Q16–Q24, Q26–Q27, Q30, Q32–Q37, Q39–Q40, Q50–Q53, Q55–Q56, Q61, Q63–Q66, Q73, Q77–Q79, Q81, Q86, Q90 and Q95 plus Case 1 Q1–Q2, Case 2 Q1–Q3, Case 3 Q1–Q2, Case 4 Q1, Q3–Q4, Case 5 Q1, Case 6 Q2–Q3, Case 7 Q1/Q3, Case 8 Q1–Q4 and Advanced Q1–Q10/Q12/Q14–Q16/Q18/Q20–Q25/Q27/Q30–Q33 remain explicit identity, duplicate, dependency, negative-closure, unsupported-precision, non-unique-key or authority-form holds. Advanced MCQs Q1–Q33 are now fully dispositioned. Core Q25 is source-absent: the answer row skips Q25 and visibly prints “35.B”; no answer was inferred or renumbered. The student answer lines remain source evidence rather than authenticated faculty keys.
...
`
  const mucizeAdvancedFourteenDelta = `### Mucize Doctors Advanced MCQ Q14 delta

- The governed Mucize assessment resource and official Flies and Myiasis teaching resource are reused. Physical pages 25, 26 and 28 and official page 15 were rendered and visually read for the exact Q14 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity / prior-family duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q14 A, The pathogen is transmitted to the offspring of the vector. Official page 15 directly identifies organism passage to offspring as transovarian transmission.
- Search/replay gate: existing \`CON-INF-7C2E91B4F805AD\`, reciprocal Draft article \`ART-INF-MUST-FHB1022-TRANSOVARIAN-TRANSMISSION\` and authored Absalam \`QST-MUST-FHB1022-PARA-INTRO-Q40\` already govern the exact offspring-transmission identity. No duplicate concept, evidence triplet, article or question was created.
- Mucize Advanced MCQ Q14: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q14 cumulative: **2 authored / 12 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q15 on physical page 26.

`
  const mucizeAdvancedFourteenHolds = `- **Mucize Advanced MCQ Q14 is held as an exact governed-identity and prior-family duplicate hold.** Printed A, The pathogen is transmitted to the offspring of the vector, is directly supported by official Flies and Myiasis page 15. Existing \`CON-INF-7C2E91B4F805AD\` and \`ART-INF-MUST-FHB1022-TRANSOVARIAN-TRANSMISSION\` already govern this exact identity, while \`QST-MUST-FHB1022-PARA-INTRO-Q40\` is the earlier authored occurrence. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedFifteenDelta = `### Mucize Doctors Advanced MCQ Q15 delta

- The governed Mucize assessment resource and official Flies and Myiasis teaching resource are reused. Physical pages 26 and 28 and official page 25 were rendered and visually read for the exact Q15 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 authority-form / raw-identity hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q15 B, Gastric myiasis. Official page 25 visibly identifies intestinal myiasis as an example of accidental myiasis associated with Musca; it does not establish the broader stem wording “invasion of the gastrointestinal tract” as uniquely gastric rather than intestinal.
- Search/replay gate: raw \`concept_81f780bbf4afc4cb9d4c9a30\` already represents gastric myiasis, while \`concept_8d9cafb99baef390a663df18\` and \`concept_8f98d380a95e2bd806b1f319\` represent accidental ingestion and intestinal myiasis. No ambiguous umbrella identity, duplicate concept, evidence triplet, article or question was created.
- Mucize Advanced MCQ Q15: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q15 cumulative: **2 authored / 13 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q16 on physical page 26.

`
  const mucizeAdvancedFifteenHolds = `- **Mucize Advanced MCQ Q15 is held as an authority-form and raw-identity hold.** Printed B, Gastric myiasis, is preserved unchanged. The official visible teaching identifies intestinal myiasis as an example of accidental myiasis associated with Musca but does not authenticate the stem's broad gastrointestinal-tract wording as uniquely gastric. Raw \`concept_81f780bbf4afc4cb9d4c9a30\`, \`concept_8d9cafb99baef390a663df18\` and \`concept_8f98d380a95e2bd806b1f319\` already govern the narrower gastric, accidental-ingestion and intestinal identities. No key repair, ambiguous umbrella concept, duplicate evidence or student-facing question was created.

`
  const mucizeAdvancedSixteenDelta = `### Mucize Doctors Advanced MCQ Q16 delta

- The governed Mucize assessment resource and official Flies and Myiasis teaching resource are reused. Physical pages 26 and 28 and official pages 37 and 42 were rendered and visually read for the exact Q16 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity / same-source duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q16 B, Larvae cause lesions or nodules in the skin. Official pages 37 and 42 show cutaneous myiasis as living-tissue larval invasion producing skin swellings or boils.
- Search/replay gate: existing \`CON-INF-6D13C7A920B4EF\`, reciprocal Draft article \`ART-INF-MUST-FHB1022-CUTANEOUS-MYIASIS-PHORESIS\` and authored same-source \`QST-MUST-FHB1022-PARA-MUCIZEADV-Q13\` already govern this exact lesions-or-nodules identity. No duplicate concept, evidence triplet, article or question was created.
- Mucize Advanced MCQ Q16: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q16 cumulative: **2 authored / 14 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q17 on physical page 26.

`
  const mucizeAdvancedSixteenHolds = `- **Mucize Advanced MCQ Q16 is held as an exact governed-identity and same-source duplicate hold.** Printed B, Larvae cause lesions or nodules in the skin, is directly supported by official Flies and Myiasis pages 37 and 42. Existing \`CON-INF-6D13C7A920B4EF\` and \`ART-INF-MUST-FHB1022-CUTANEOUS-MYIASIS-PHORESIS\` already govern this exact identity, while \`QST-MUST-FHB1022-PARA-MUCIZEADV-Q13\` is the earlier authored occurrence in the same Advanced family. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedSeventeenDelta = `### Mucize Doctors Advanced MCQ Q17 delta

- The governed Mucize assessment resource and official Flies and Myiasis teaching resource are reused. Physical page 26 and official page 45 were rendered and visually read for the exact Q17 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +1 claim, +1 citation, +1 article span, +1 under-review concept, +0 articles and +1 Draft question.
- +1 authored question completing a previously flagged pending raw identity.
- The printed key is preserved as source evidence and matches governed teaching: Q17 B, Urogenital myiasis. Official page 45 states that, probably during sleep or during defecation, certain flies deposit their eggs on the urethral opening and the larvae creep up the urethra to the bladder and urinary tract, matching the stem's public-toilet/latrine exposure route.
- Search/replay gate: raw \`concept_25a7c6c1a0f6c476622cf674\` was flagged as a rejected merge candidate when \`CON-INF-3D51F420815EB7\` (Fannia's fly-specific urogenital-myiasis association) was authored, because it describes urogenital-myiasis manifestations rather than the Fannia fly identity. That pending identity is completed here as new exact concept \`CON-INF-A17B2E4C9D6F81\`, reusing the existing \`ART-INF-MUST-FHB1022-CLINICAL-SITE-MYIASIS\` article by exact ID without dropping prior fields or question links. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q17: **1 authored / 0 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q17 cumulative: **3 authored / 14 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q18 on physical page 26.

`
  const mucizeAdvancedEighteenDelta = `### Mucize Doctors Advanced MCQ Q18 delta

- The governed Mucize assessment resource and official Flies and Myiasis teaching resource are reused. Physical page 26 and official page 48 were rendered and visually read for the exact Q18 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 same-source raw-identity dependency hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q18 C, Larvae invade the ear canal, potentially reaching the middle or inner ear. Official page 48 states that purulent discharge from ears attracts flies to lay their eggs or larvae, which then invade the middle or inner ear or even the mastoid sinuses.
- Search/replay gate: raw \`concept_25690ce10dd47faf309ae1f3\` already governs this exact external-ear myiasis identity and was already evaluated and left unpromoted at Mucize Parasitology core Q33 for the same reason. Authoring it now would duplicate that already-considered same-source raw identity. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q18: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q18 cumulative: **3 authored / 15 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q19 on physical page 26.

`
  const mucizeAdvancedEighteenHolds = `- **Mucize Advanced MCQ Q18 is held as a same-source raw-identity dependency hold.** Printed C, Larvae invade the ear canal, potentially reaching the middle or inner ear, is directly supported by official Flies and Myiasis page 48, which states that purulent ear discharge attracts flies to lay eggs or larvae that then invade the middle or inner ear or mastoid sinuses. Raw \`concept_25690ce10dd47faf309ae1f3\` already governs this exact external-ear myiasis identity and was already evaluated and left unpromoted at Mucize Parasitology core Q33. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedNineteenDelta = `### Mucize Doctors Advanced MCQ Q19 delta

- The governed Mucize assessment resource and official Flies and Myiasis teaching resource are reused. Physical page 26 and official page 48 were rendered and visually read for the exact Q19 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +1 claim, +1 citation, +1 article span, +1 under-review concept, +0 articles and +1 Draft question.
- +1 exact new-identity authored question with no raw-corpus candidate found.
- The printed key is preserved as source evidence and matches governed teaching: Q19 C, Nasopharyngeal myiasis. Official page 48 states that the larvae of flies find their way to the conjunctiva or nose and may cause serious damage, destroying the eyes, orbit or even the sinuses.
- Search/replay gate: searches for the nasal/sinus myiasis identity returned no existing live or pending raw concept; new exact concept \`CON-INF-F42C8B916A3D75\` reuses the existing \`ART-INF-MUST-FHB1022-CLINICAL-SITE-MYIASIS\` article by exact ID alongside the Fannia and Sarcophaga clinical-site facts, without dropping prior fields or question links. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q19: **1 authored / 0 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q19 cumulative: **4 authored / 15 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q20 on physical page 26.

`
  const mucizeAdvancedTwentyDelta = `### Mucize Doctors Advanced MCQ Q20 delta

- The governed Mucize assessment resource and official Mosquitoes teaching resource are reused. Physical page 26 and official page 10 were rendered and visually read for the exact Q20 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity and same-source duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q20 B, They require a blood meal for egg production and can transmit pathogens during feeding. Official page 10 states that a blood meal stimulates the hormone production necessary for ovulation in female mosquitoes.
- Search/replay gate: existing \`CON-INF-D40D6E6C25F7C4\` and its reciprocal Draft mosquito-biology article already govern this exact blood-meal/ovulation identity, with Absalam Mosquitoes Q10 and Mucize Parasitology core Q48 as earlier authored same-source occurrences. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q20: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q20 cumulative: **4 authored / 16 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q21 on physical page 26.

`
  const mucizeAdvancedTwentyHolds = `- **Mucize Advanced MCQ Q20 is held as an exact governed-identity and same-source duplicate hold.** Printed B, They require a blood meal for egg production and can transmit pathogens during feeding, is directly supported by official Mosquitoes page 10, which states that a blood meal stimulates the hormone production necessary for ovulation in female mosquitoes. Existing \`CON-INF-D40D6E6C25F7C4\` already governs this exact identity, while Absalam Mosquitoes Q10 and Mucize Parasitology core Q48 are earlier authored same-source occurrences. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedTwentyOneDelta = `### Mucize Doctors Advanced MCQ Q21 delta

- The governed Mucize assessment resource and official Mosquitoes teaching resource are reused. Physical page 26 and official page 7 were rendered and visually read for the exact Q21 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity and prior-family duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q21 B, Anopheles rests at a 45-degree angle, while Culex/Aedes rest parallel to the surface. Official page 7 contrasts Anopheles resting at 45 degrees with Culex and Aedes resting parallel to the surface.
- Search/replay gate: existing \`CON-INF-449076BA8EA921\` and its reciprocal Draft mosquito-biology article already govern this exact resting-position identity, with Absalam Mosquitoes Q6 as the earlier authored occurrence. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q21: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q21 cumulative: **4 authored / 17 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q22 on physical page 27.

`
  const mucizeAdvancedTwentyOneHolds = `- **Mucize Advanced MCQ Q21 is held as an exact governed-identity and prior-family duplicate hold.** Printed B, Anopheles rests at a 45-degree angle, while Culex/Aedes rest parallel to the surface, is directly supported by official Mosquitoes page 7. Existing \`CON-INF-449076BA8EA921\` already governs this exact identity, while Absalam Mosquitoes Q6 is the earlier authored occurrence. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedTwentyTwoDelta = `### Mucize Doctors Advanced MCQ Q22 delta

- The governed Mucize assessment resource and official Mosquitoes teaching resource are reused. Physical page 27 and official page 8 were rendered and visually read for the exact Q22 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity and same-source duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q22 B, Stagnant water. Official page 8 states that the mosquito life cycle is completed in stagnant water.
- Search/replay gate: existing \`CON-INF-EBC6A5A33FF6AA\` and its reciprocal Draft mosquito-biology article already govern this exact stagnant-water life-cycle identity, with Mucize Parasitology core Q45 as the earlier authored same-source occurrence. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q22: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q22 cumulative: **4 authored / 18 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q23 on physical page 27.

`
  const mucizeAdvancedTwentyTwoHolds = `- **Mucize Advanced MCQ Q22 is held as an exact governed-identity and same-source duplicate hold.** Printed B, Stagnant water, is directly supported by official Mosquitoes page 8, which states that the mosquito life cycle is completed in stagnant water. Existing \`CON-INF-EBC6A5A33FF6AA\` already governs this exact identity, while Mucize Parasitology core Q45 is the earlier authored same-source occurrence. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedTwentyThreeDelta = `### Mucize Doctors Advanced MCQ Q23 delta

- The governed Mucize assessment resource and official Mosquitoes teaching resource are reused. Physical page 27 and official page 8 were rendered and visually read for the exact Q23 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity and prior-family duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q23 B, They undergo complete metamorphosis with egg, larva, pupa, and adult stages. Official page 8 labels the mosquito cycle as complete metamorphosis through those four stages.
- Search/replay gate: existing \`CON-INF-FABEF04D8E14A7\` and its reciprocal Draft mosquito-biology article already govern this exact complete-metamorphosis identity, with Absalam Mosquitoes Q3 as the earlier authored occurrence. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q23: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q23 cumulative: **4 authored / 19 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q24 on physical page 27.

`
  const mucizeAdvancedTwentyThreeHolds = `- **Mucize Advanced MCQ Q23 is held as an exact governed-identity and prior-family duplicate hold.** Printed B, They undergo complete metamorphosis with egg, larva, pupa, and adult stages, is directly supported by official Mosquitoes page 8. Existing \`CON-INF-FABEF04D8E14A7\` already governs this exact identity, while Absalam Mosquitoes Q3 is the earlier authored occurrence. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedTwentyFourDelta = `### Mucize Doctors Advanced MCQ Q24 delta

- The governed Mucize assessment resource and official Mosquitoes teaching resource are reused. Physical page 27 and official page 38 were rendered and visually read for the exact Q24 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity and prior-family duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q24 B, Introducing natural predators like Gambusia fish. Official page 38 states that Gambusia affinis feeds on mosquito larvae and pupae as biological control.
- Search/replay gate: existing \`CON-INF-863856AB7138F8\` and its reciprocal Draft mosquito-control article already govern this exact Gambusia-biological-control identity, with Absalam Mosquitoes Q21 and Mucize Parasitology core Q60 as earlier authored occurrences. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q24: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q24 cumulative: **4 authored / 20 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q25 on physical page 27.

`
  const mucizeAdvancedTwentyFourHolds = `- **Mucize Advanced MCQ Q24 is held as an exact governed-identity and prior-family duplicate hold.** Printed B, Introducing natural predators like Gambusia fish, is directly supported by official Mosquitoes page 38. Existing \`CON-INF-863856AB7138F8\` already governs this exact identity, while Absalam Mosquitoes Q21 and Mucize Parasitology core Q60 are earlier authored occurrences. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedTwentyFiveDelta = `### Mucize Doctors Advanced MCQ Q25 delta

- The governed Mucize assessment resource and official Mosquitoes teaching resource are reused. Physical page 27 and official page 6 were rendered and visually read for the exact Q25 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity and same-source duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q25 B, Only female mosquitoes feed on blood, while males feed on plant nectar. Official page 6 states that male mosquitoes suck plant juice and feed on nectar, while females take a blood meal.
- Search/replay gate: existing \`CON-INF-2D0A5960736100\` and its reciprocal Draft mosquito-biology article already govern this exact male-nectar/female-blood feeding-habit identity, with Mucize Parasitology core Q42 as the earlier authored same-source occurrence. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q25: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q25 cumulative: **4 authored / 21 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q26 on physical page 27.

`
  const mucizeAdvancedTwentyFiveHolds = `- **Mucize Advanced MCQ Q25 is held as an exact governed-identity and same-source duplicate hold.** Printed B, Only female mosquitoes feed on blood, while males feed on plant nectar, is directly supported by official Mosquitoes page 6. Existing \`CON-INF-2D0A5960736100\` already governs this exact identity, while Mucize Parasitology core Q42 is the earlier authored same-source occurrence. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedTwentySixDelta = `### Mucize Doctors Advanced MCQ Q26 delta

- The governed Mucize assessment resource and official Mosquitoes teaching resource are reused. Physical page 27 and official page 39 were rendered and visually read for the exact Q26 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +1 claim, +1 citation, +1 article span, +1 under-review concept, +0 articles and +1 Draft question.
- +1 exact new-identity authored question with no raw-corpus candidate found.
- The printed key is preserved as source evidence and matches governed teaching: Q26 B, Spraying non-volatile oils on water surfaces to suffocate larvae. Official page 39 states that non-volatile oil forms a continuous film on the water surface and acts as a respiratory poison, suffocating and poisoning aquatic forms by inhalation.
- Search/replay gate: this exact non-volatile-oil identity previously existed only as a pitfall note inside the separate Paris-green larvicidal-only concept (\`CON-INF-DE8BA9EC7D8688\`), not as its own promoted concept; searches for a standalone non-volatile-oil chemical-control identity returned no existing live or pending record. New exact concept \`CON-INF-C9A3D62F58B417\` reuses the existing \`ART-INF-MUST-FHB1022-MOSQUITO-CONTROL\` article by exact ID alongside the Gambusia, DDT, drainage, window-screen and Paris-green facts, without dropping prior fields or question links. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q26: **1 authored / 0 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q26 cumulative: **5 authored / 21 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q27 on physical page 27.

`
  const mucizeAdvancedTwentySevenDelta = `### Mucize Doctors Advanced MCQ Q27 delta

- The governed Mucize assessment resource and official Mosquitoes teaching resource are reused. Physical page 27 and official page 9 were rendered and visually read for the exact Q27 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity and same-source duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q27 B, Mosquitoes typically fly up to 2 kilometers, but wind can extend this to 10 kilometers. Official page 9 states that flight range is 2 kilometers, increased to 10 km by the wind.
- Search/replay gate: existing \`CON-INF-E7CE29355ADA44\` and its reciprocal Draft mosquito-biology article already govern this exact flight-range identity, with Mucize Parasitology core Q49 as the earlier authored same-source occurrence using near-identical wording. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q27: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q27 cumulative: **5 authored / 22 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q28 on physical page 27.

`
  const mucizeAdvancedTwentySevenHolds = `- **Mucize Advanced MCQ Q27 is held as an exact governed-identity and same-source duplicate hold.** Printed B, Mosquitoes typically fly up to 2 kilometers, but wind can extend this to 10 kilometers, is directly supported by official Mosquitoes page 9. Existing \`CON-INF-E7CE29355ADA44\` already governs this exact identity, while Mucize Parasitology core Q49 is the earlier authored same-source occurrence with near-identical wording. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedTwentyEightDelta = `### Mucize Doctors Advanced MCQ Q28 delta

- The governed Mucize assessment resource and official Mosquitoes teaching resource are reused. Physical page 27 and official pages 41–42 were rendered and visually read for the exact Q28 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +1 claim, +1 citation, +1 article span, +1 under-review concept, +0 articles and +1 Draft question.
- +1 exact new-identity authored question with no raw-corpus candidate found.
- The printed key is preserved as source evidence and matches governed teaching: Q28 B, Using mosquito nets and insect repellents. Official page 41 recommends sleeping under mosquito nets in endemic areas, and official page 42 lists insect repellents including citronella oil, eucalyptus oil and synthetic repellents.
- Search/replay gate: the existing \`CON-INF-7DD1BECF36B7C0\` window-screens concept and the residual-insecticide concepts each cover a narrower single technique; searches for a combined nets-and-repellents personal-protection identity returned no existing live or pending record. New exact concept \`CON-INF-D74B6E15A2C938\` reuses the existing \`ART-INF-MUST-FHB1022-MOSQUITO-CONTROL\` article by exact ID, without dropping prior fields or question links. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q28: **1 authored / 0 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q28 cumulative: **6 authored / 22 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q29 on physical page 27.

`
  const mucizeAdvancedTwentyNineDelta = `### Mucize Doctors Advanced MCQ Q29 delta

- The governed Mucize assessment resource and official Mosquitoes teaching resource are reused. Physical page 27 and official page 10 were rendered and visually read for the exact Q29 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +1 claim, +1 citation, +1 article span, +1 under-review concept, +0 articles and +1 Draft question.
- +1 exact new-identity authored question with no raw-corpus candidate found.
- The printed key is preserved as source evidence and matches governed teaching: Q29 B, They can breed in small water collections, such as flower vases or buckets. Official page 10 states that Aedes and some other mosquitoes can breed in a very little collection of water inside a flower vase, water inside buckets, and even in a bottle cover.
- Search/replay gate: this Aedes small-container breeding identity is distinct from the existing general stagnant-water life-cycle concept (\`CON-INF-EBC6A5A33FF6AA\`), which covers the broader mosquito breeding-water fact from a different slide; searches for the Aedes-specific container-breeding identity returned no existing live or pending record. New exact concept \`CON-INF-F16A82C4E9D375\` reuses the existing \`ART-INF-MUST-FHB1022-MOSQUITO-BIOLOGY\` article by exact ID, without dropping prior fields or question links. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q29: **1 authored / 0 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q29 cumulative: **7 authored / 22 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q30 on physical page 28.

`
  const mucizeAdvancedThirtyDelta = `### Mucize Doctors Advanced MCQ Q30 delta

- The governed Mucize assessment resource and official Sandfly teaching resource are reused. Physical page 28 and official pages 10 and 26 were rendered and visually read for the exact Q30 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 established cyclopropagative/dependency-chain hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q30 B, They allow pathogens to develop or multiply within them before transmission. Official pages 10 and 26 describe sandfly-borne pathogens developing or multiplying within the vector before an infective bite transmits them.
- Search/replay gate: this pathogen-development-before-transmission identity falls inside the established unsafe cyclopropagative/propagative dependency chain already documented for \`CON-INF-23265735EECCA1\` and \`ART-INF-MUST-FHB1022-CYCLOPROPAGATIVE\` at Absalam Arthropoda Q36/Q42, Mucize Advanced Q12 and other occurrences; a standalone-complete article cannot satisfy the focused dependency contract without an artificial companion or unsafe external update. No partial exact-ID update, duplicate concept/article or student-facing question was created.
- Mucize Advanced MCQ Q30: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q30 cumulative: **7 authored / 23 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q31 on physical page 28.

`
  const mucizeAdvancedThirtyHolds = `- **Mucize Advanced MCQ Q30 is held as an established cyclopropagative/dependency-chain hold.** Printed B, They allow pathogens to develop or multiply within them before transmission, is directly supported by official Sandfly pages 10 and 26. This pathogen-development-before-transmission identity falls inside the established unsafe cyclopropagative/propagative dependency chain already documented for \`CON-INF-23265735EECCA1\` and \`ART-INF-MUST-FHB1022-CYCLOPROPAGATIVE\` at Absalam Arthropoda Q36/Q42, Mucize Advanced Q12 and other occurrences. The printed key was not changed; no partial exact-ID update, duplicate concept/article or student-facing question was created.

`
  const mucizeAdvancedThirtyOneDelta = `### Mucize Doctors Advanced MCQ Q31 delta

- The governed Mucize assessment resource and official Sandfly teaching resource are reused. Physical page 28 and official page 8 were rendered and visually read for the exact Q31 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity and same-source duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q31 B, Only female sandflies feed on blood, while males feed on plant nectar. Official page 8 states that female sandflies are the blood-sucking sex, as a rule.
- Search/replay gate: existing \`CON-INF-93E9B181184A6B\` and its reciprocal Draft sandfly-biology article already govern this exact female-blood-feeding identity, with Mucize Parasitology core Q75 as the earlier authored same-source occurrence. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q31: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q31 cumulative: **7 authored / 24 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q32 on physical page 28.

`
  const mucizeAdvancedThirtyOneHolds = `- **Mucize Advanced MCQ Q31 is held as an exact governed-identity and same-source duplicate hold.** Printed B, Only female sandflies feed on blood, while males feed on plant nectar, is directly supported by official Sandfly page 8, which states that female sandflies are the blood-sucking sex, as a rule. Existing \`CON-INF-93E9B181184A6B\` already governs this exact identity, while Mucize Parasitology core Q75 is the earlier authored same-source occurrence. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedThirtyTwoDelta = `### Mucize Doctors Advanced MCQ Q32 delta

- The governed Mucize assessment resource and official Sandfly teaching resource are reused. Physical page 28 and official page 8 were rendered and visually read for the exact Q32 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity and prior-family duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q32 B, They are weak fliers and tend to hop short distances. Official page 8 states that sandflies are weak fliers and characteristically move by hopping.
- Search/replay gate: existing \`CON-INF-509BF395C5EBF9\` and its reciprocal Draft sandfly-biology article already govern this exact weak-hopping-flight identity, with Sandfly Q10 and Mucize Parasitology core Q74 as earlier authored occurrences. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q32: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q32 cumulative: **7 authored / 25 held / 0 source-absent / 0 unassessed**. The exact next boundary is Mucize Advanced MCQ Q33 on physical page 28.

`
  const mucizeAdvancedThirtyTwoHolds = `- **Mucize Advanced MCQ Q32 is held as an exact governed-identity and prior-family duplicate hold.** Printed B, They are weak fliers and tend to hop short distances, is directly supported by official Sandfly page 8. Existing \`CON-INF-509BF395C5EBF9\` already governs this exact identity, while Sandfly Q10 and Mucize Parasitology core Q74 are earlier authored occurrences. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.

`
  const mucizeAdvancedThirtyThreeDelta = `### Mucize Doctors Advanced MCQ Q33 delta

- The governed Mucize assessment resource and official Sandfly teaching resource are reused. Physical page 28 and official pages 10, 15, 26 and 28 were rendered and visually read for the exact Q33 stem, all four options, printed answer token, next source boundary and direct teaching authority.
- +0 resources, +0 claims, +0 citations, +0 article spans, +0 concepts, +0 articles and +0 Draft questions.
- +1 exact governed-identity and same-source duplicate hold with no student-facing record.
- The printed key remains unchanged as source evidence: Q33 B, They are transmitted through the bite of infected sandflies. Official pages 10, 15, 26 and 28 describe sandflies transmitting governed protozoal, bacterial and viral pathogens through infective bites.
- Search/replay gate: existing \`CON-INF-F25D45A3C5F542\` and its reciprocal Draft sandfly-diseases article already govern this exact bite-transmission identity, with Mucize Parasitology core Q92 as the earlier authored same-source occurrence. No duplicate concept, article or question was created.
- Mucize Advanced MCQ Q33: **0 authored / 1 held / 0 source-absent / 0 unassessed**. Advanced Q1–Q33 cumulative: **7 authored / 26 held / 0 source-absent / 0 unassessed**. Advanced MCQs Q1–Q33 are now fully dispositioned; the next source boundary is Mucize Pharmacology — Antibacterial (1), Q1, physical page 29, pending a fresh audit.

`
  const mucizeAdvancedThirtyThreeHolds = `- **Mucize Advanced MCQ Q33 is held as an exact governed-identity and same-source duplicate hold.** Printed B, They are transmitted through the bite of infected sandflies, is directly supported by official Sandfly pages 10, 15, 26 and 28. Existing \`CON-INF-F25D45A3C5F542\` already governs this exact identity, while Mucize Parasitology core Q92 is the earlier authored same-source occurrence. The printed key was not changed; no duplicate concept, evidence triplet, article or student-facing question was created.
...
`
  return coverage()
    ...
    .replace('All 266 held prompts exist only as authoring-ledger dispositions with no student-facing record; opening-bank Q32 and Mucize Q25 exist only as source-absent ledger dispositions.', 'All 267 held prompts exist only as authoring-ledger dispositions with no student-facing record; opening-bank Q32 and Mucize Q25 exist only as source-absent ledger dispositions.')
    .replace('All 267 held prompts exist only as authoring-ledger dispositions with no student-facing record; opening-bank Q32 and Mucize Q25 exist only as source-absent ledger dispositions.', 'All 268 held prompts exist only as authoring-ledger dispositions with no student-facing record; opening-bank Q32 and Mucize Q25 exist only as source-absent ledger dispositions.')
    .replace('All 268 held prompts exist only as authoring-ledger dispositions with no student-facing record; opening-bank Q32 and Mucize Q25 exist only as source-absent ledger dispositions.', 'All 269 held prompts exist only as authoring-ledger dispositions with no student-facing record; opening-bank Q32 and Mucize Q25 exist only as source-absent ledger dispositions.')
    ...
    .replace('| Question authoring holds | 266 |', '| Question authoring holds | 267 |')
    .replace('| Question authoring holds | 267 |', '| Question authoring holds | 268 |')
    .replace('| Question authoring holds | 268 |', '| Question authoring holds | 269 |')
    ...
    .replace('Governed prompt observations: 5,444 total; 224 authored; **5,220 raw prompt observations remain**, including 266 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 224 authored; **5,220 raw prompt observations remain**, including 267 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 224 clean source-keyed prompts authored; **4,987 raw answer observations remain**, including the 266 held printed-key observations', 'Governed answer observations: 5,211 total; 224 clean source-keyed prompts authored; **4,987 raw answer observations remain**, including the 267 held printed-key observations')
    .replace('Governed prompt observations: 5,444 total; 224 authored; **5,220 raw prompt observations remain**, including 267 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 224 authored; **5,220 raw prompt observations remain**, including 268 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 224 clean source-keyed prompts authored; **4,987 raw answer observations remain**, including the 267 held printed-key observations', 'Governed answer observations: 5,211 total; 224 clean source-keyed prompts authored; **4,987 raw answer observations remain**, including the 268 held printed-key observations')
    .replace('Governed prompt observations: 5,444 total; 224 authored; **5,220 raw prompt observations remain**, including 268 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 224 authored; **5,220 raw prompt observations remain**, including 269 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 224 clean source-keyed prompts authored; **4,987 raw answer observations remain**, including the 268 held printed-key observations', 'Governed answer observations: 5,211 total; 224 clean source-keyed prompts authored; **4,987 raw answer observations remain**, including the 269 held printed-key observations')
    ...
    .replace('Its physical pages 6–25 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q13 are fully dispositioned;', 'Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q14 are fully dispositioned;')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q14 on physical page 25.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q15 on physical page 26.')
    .replace('Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q14 are fully dispositioned;', 'Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q15 are fully dispositioned;')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q15 on physical page 26.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q16 on physical page 26.')
    .replace('Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q15 are fully dispositioned;', 'Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q16 are fully dispositioned;')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q16 on physical page 26.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q17 on physical page 26.')
    .replace('| Claims | 224 |', '| Claims | 225 |')
    .replace('| Citations | 229 |', '| Citations | 230 |')
    .replace('| Article spans | 224 |', '| Article spans | 225 |')
    .replace('| Concepts | 158 |', '| Concepts | 159 |')
    .replace('| Questions | 224 |', '| Questions | 225 |')
    .replace('Governed prompt observations: 5,444 total; 224 authored; **5,220 raw prompt observations remain**, including 269 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 225 authored; **5,219 raw prompt observations remain**, including 269 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 224 clean source-keyed prompts authored; **4,987 raw answer observations remain**, including the 269 held printed-key observations', 'Governed answer observations: 5,211 total; 225 clean source-keyed prompts authored; **4,986 raw answer observations remain**, including the 269 held printed-key observations')
    .replace('All forty-four student-facing articles and all two hundred twenty-four questions remain Draft; all one hundred fifty-eight concepts', 'All forty-four student-facing articles and all two hundred twenty-five questions remain Draft; all one hundred fifty-nine concepts')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q17 on physical page 26.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q18 on physical page 26.')
    .replace('Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q16 are fully dispositioned;', 'Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q17 are fully dispositioned;')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q18 on physical page 26.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q19 on physical page 26.')
    .replace('Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q17 are fully dispositioned;', 'Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q18 are fully dispositioned;')
    .replace('| Question authoring holds | 269 |', '| Question authoring holds | 270 |')
    .replace('Governed prompt observations: 5,444 total; 225 authored; **5,219 raw prompt observations remain**, including 269 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 225 authored; **5,219 raw prompt observations remain**, including 270 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 225 clean source-keyed prompts authored; **4,986 raw answer observations remain**, including the 269 held printed-key observations', 'Governed answer observations: 5,211 total; 225 clean source-keyed prompts authored; **4,986 raw answer observations remain**, including the 270 held printed-key observations')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q19 on physical page 26.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q20 on physical page 26.')
    .replace('Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q18 are fully dispositioned;', 'Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q19 are fully dispositioned;')
    .replace('| Claims | 225 |', '| Claims | 226 |')
    .replace('| Citations | 230 |', '| Citations | 231 |')
    .replace('| Article spans | 225 |', '| Article spans | 226 |')
    .replace('| Concepts | 159 |', '| Concepts | 160 |')
    .replace('| Questions | 225 |', '| Questions | 226 |')
    .replace('Governed prompt observations: 5,444 total; 225 authored; **5,219 raw prompt observations remain**, including 270 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 270 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 225 clean source-keyed prompts authored; **4,986 raw answer observations remain**, including the 270 held printed-key observations', 'Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 270 held printed-key observations')
    .replace('All forty-four student-facing articles and all two hundred twenty-five questions remain Draft; all one hundred fifty-nine concepts', 'All forty-four student-facing articles and all two hundred twenty-six questions remain Draft; all one hundred sixty concepts')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q20 on physical page 26.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q21 on physical page 26.')
    .replace('Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q19 are fully dispositioned;', 'Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q20 are fully dispositioned;')
    .replace('| Question authoring holds | 270 |', '| Question authoring holds | 271 |')
    .replace('Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 270 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 271 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 270 held printed-key observations', 'Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 271 held printed-key observations')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q21 on physical page 26.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q22 on physical page 27.')
    .replace('Its physical pages 6–26 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q20 are fully dispositioned;', 'Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q21 are fully dispositioned;')
    .replace('| Question authoring holds | 271 |', '| Question authoring holds | 272 |')
    .replace('Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 271 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 272 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 271 held printed-key observations', 'Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 272 held printed-key observations')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q22 on physical page 27.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q23 on physical page 27.')
    .replace('Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q21 are fully dispositioned;', 'Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q22 are fully dispositioned;')
    .replace('| Question authoring holds | 272 |', '| Question authoring holds | 273 |')
    .replace('Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 272 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 273 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 272 held printed-key observations', 'Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 273 held printed-key observations')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q23 on physical page 27.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q24 on physical page 27.')
    .replace('Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q22 are fully dispositioned;', 'Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q23 are fully dispositioned;')
    .replace('| Question authoring holds | 273 |', '| Question authoring holds | 274 |')
    .replace('Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 273 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 274 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 273 held printed-key observations', 'Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 274 held printed-key observations')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q24 on physical page 27.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q25 on physical page 27.')
    .replace('Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q23 are fully dispositioned;', 'Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q24 are fully dispositioned;')
    .replace('| Question authoring holds | 274 |', '| Question authoring holds | 275 |')
    .replace('Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 274 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 275 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 274 held printed-key observations', 'Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 275 held printed-key observations')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q25 on physical page 27.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q26 on physical page 27.')
    .replace('Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q24 are fully dispositioned;', 'Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q25 are fully dispositioned;')
    .replace('| Question authoring holds | 275 |', '| Question authoring holds | 276 |')
    .replace('Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 275 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 276 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 275 held printed-key observations', 'Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 276 held printed-key observations')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q26 on physical page 27.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q27 on physical page 27.')
    .replace('Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q25 are fully dispositioned;', 'Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q26 are fully dispositioned;')
    .replace('| Claims | 226 |', '| Claims | 227 |')
    .replace('| Citations | 231 |', '| Citations | 232 |')
    .replace('| Article spans | 226 |', '| Article spans | 227 |')
    .replace('| Concepts | 160 |', '| Concepts | 161 |')
    .replace('| Questions | 226 |', '| Questions | 227 |')
    .replace('Governed prompt observations: 5,444 total; 226 authored; **5,218 raw prompt observations remain**, including 276 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 227 authored; **5,217 raw prompt observations remain**, including 276 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 226 clean source-keyed prompts authored; **4,985 raw answer observations remain**, including the 276 held printed-key observations', 'Governed answer observations: 5,211 total; 227 clean source-keyed prompts authored; **4,984 raw answer observations remain**, including the 276 held printed-key observations')
    .replace('All forty-four student-facing articles and all two hundred twenty-six questions remain Draft; all one hundred sixty concepts', 'All forty-four student-facing articles and all two hundred twenty-seven questions remain Draft; all one hundred sixty-one concepts')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q27 on physical page 27.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q28 on physical page 27.')
    .replace('Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q26 are fully dispositioned;', 'Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q27 are fully dispositioned;')
    .replace('| Question authoring holds | 276 |', '| Question authoring holds | 277 |')
    .replace('Governed prompt observations: 5,444 total; 227 authored; **5,217 raw prompt observations remain**, including 276 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 227 authored; **5,217 raw prompt observations remain**, including 277 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 227 clean source-keyed prompts authored; **4,984 raw answer observations remain**, including the 276 held printed-key observations', 'Governed answer observations: 5,211 total; 227 clean source-keyed prompts authored; **4,984 raw answer observations remain**, including the 277 held printed-key observations')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q28 on physical page 27.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q29 on physical page 27.')
    .replace('Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q27 are fully dispositioned;', 'Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q28 are fully dispositioned;')
    .replace('| Claims | 227 |', '| Claims | 228 |')
    .replace('| Citations | 232 |', '| Citations | 233 |')
    .replace('| Article spans | 227 |', '| Article spans | 228 |')
    .replace('| Concepts | 161 |', '| Concepts | 162 |')
    .replace('| Questions | 227 |', '| Questions | 228 |')
    .replace('Governed prompt observations: 5,444 total; 227 authored; **5,217 raw prompt observations remain**, including 277 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 228 authored; **5,216 raw prompt observations remain**, including 277 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 227 clean source-keyed prompts authored; **4,984 raw answer observations remain**, including the 277 held printed-key observations', 'Governed answer observations: 5,211 total; 228 clean source-keyed prompts authored; **4,983 raw answer observations remain**, including the 277 held printed-key observations')
    .replace('All forty-four student-facing articles and all two hundred twenty-seven questions remain Draft; all one hundred sixty-one concepts', 'All forty-four student-facing articles and all two hundred twenty-eight questions remain Draft; all one hundred sixty-two concepts')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q29 on physical page 27.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q30 on physical page 28.')
    .replace('Its physical pages 6–27 and 28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q28 are fully dispositioned;', 'Its physical pages 6–28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q29 are fully dispositioned;')
    .replace('| Claims | 228 |', '| Claims | 229 |')
    .replace('| Citations | 233 |', '| Citations | 234 |')
    .replace('| Article spans | 228 |', '| Article spans | 229 |')
    .replace('| Concepts | 162 |', '| Concepts | 163 |')
    .replace('| Questions | 228 |', '| Questions | 229 |')
    .replace('Governed prompt observations: 5,444 total; 228 authored; **5,216 raw prompt observations remain**, including 277 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 229 authored; **5,215 raw prompt observations remain**, including 277 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 228 clean source-keyed prompts authored; **4,983 raw answer observations remain**, including the 277 held printed-key observations', 'Governed answer observations: 5,211 total; 229 clean source-keyed prompts authored; **4,982 raw answer observations remain**, including the 277 held printed-key observations')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q30 on physical page 28.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q31 on physical page 28.')
    .replace('Its physical pages 6–28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q29 are fully dispositioned;', 'Its physical pages 6–28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q30 are fully dispositioned;')
    .replace('| Question authoring holds | 277 |', '| Question authoring holds | 278 |')
    .replace('Governed prompt observations: 5,444 total; 229 authored; **5,215 raw prompt observations remain**, including 277 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 229 authored; **5,215 raw prompt observations remain**, including 278 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 229 clean source-keyed prompts authored; **4,982 raw answer observations remain**, including the 277 held printed-key observations', 'Governed answer observations: 5,211 total; 229 clean source-keyed prompts authored; **4,982 raw answer observations remain**, including the 278 held printed-key observations')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q31 on physical page 28.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q32 on physical page 28.')
    .replace('Its physical pages 6–28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q30 are fully dispositioned;', 'Its physical pages 6–28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q31 are fully dispositioned;')
    .replace('| Question authoring holds | 278 |', '| Question authoring holds | 279 |')
    .replace('Governed prompt observations: 5,444 total; 229 authored; **5,215 raw prompt observations remain**, including 278 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 229 authored; **5,215 raw prompt observations remain**, including 279 explicit holds and two source-absent prompts')
    .replace('Governed answer observations: 5,211 total; 229 clean source-keyed prompts authored; **4,982 raw answer observations remain**, including the 278 held printed-key observations', 'Governed answer observations: 5,211 total; 229 clean source-keyed prompts authored; **4,982 raw answer observations remain**, including the 279 held printed-key observations')
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q32 on physical page 28.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q33 on physical page 28.')
    .replace('Its physical pages 6–28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q31 are fully dispositioned;', 'Its physical pages 6–28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q32 are fully dispositioned;')
    .replace('| Question authoring holds | 279 |', '| Question authoring holds | 280 |')
    .replace('Governed prompt observations: 5,444 total; 229 authored; **5,215 raw prompt observations remain**, including 279 explicit holds and two source-absent prompts', 'Governed prompt observations: 5,444 total; 229 authored; **5,215 raw prompt observations remain**, including 280 explicit holds and two source-absent prompts')
    ...
    .replace('The Absalam Part 2 source is complete. The exact next boundary is Mucize Advanced MCQ Q33 on physical page 28.', 'The Absalam Part 2 source is complete. The exact next boundary is Mucize Pharmacology — Antibacterial (1) Q1 on physical page 29, pending a fresh audit.')
    .replace('Its physical pages 6–28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q32 are fully dispositioned;', 'Its physical pages 6–28 / Parasitology core Q1–Q95, case-based learning Cases 1–8 and Advanced MCQs Q1–Q33 are fully dispositioned;')
