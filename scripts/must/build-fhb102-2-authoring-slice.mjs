...
| Articles | 8 | Draft |
| Questions | 8 | Draft |
| Question authoring holds | 9 | no student-facing record authored |

The first eight slices authored Q1, Q5, Q7, Q8, Q9, Q10, Q11 and Q12 with printed keys unchanged. The ninth slice assesses Q13 and Q14 but authors neither: Q13 is ambiguous because two offered answers are supported, while Q14's printed A is clean but its required reciprocal article update cannot pass the focused dependency contract without replacing older live links or introducing unrelated article updates. The tenth through twelfth slices confirm the printed keys for Q15, Q16 and Q17 against governed local teaching but apply dependency-contract holds because no honest, standalone-complete related-article dependency exists inside each bounded slice. No key was changed and no Q13/Q14/Q15/Q16/Q17 student-facing record was created.
...
Q2, Q3, Q4, Q6 and Q13 require an authorised medical reviewer to resolve the item disposition before authoring: retain verbatim with a formal source-key correction, rewrite and retire the source wording, or exclude the item. Q14, Q15, Q16 and Q17 may proceed only when their article dependencies can be represented honestly without clobbering governed live links, inventing unrelated content or weakening the focused validator.

## Exact backlog after twelve slices

- Governed prompt observations: 5,444 total; 8 authored; **5,436 raw prompt observations remain**, including the 9 explicit holds.
- Governed answer observations: 5,211 total; 8 clean source-keyed prompts authored; **5,203 raw answer observations remain**, including the 9 held printed-key observations.
- Opening 32-prompt normalized family: 8 authored, 9 held, and **15 not yet assessed for authoring**; therefore **24 prompts remain in the authoring backlog**, of which Q32 is source-absent.
...
No MUST content has been uploaded or imported. All eight student-facing articles and questions remain Draft; all eight concepts use the concept schema's non-published \`under review\` state and \`publication_status: needs_evidence\`. Q2, Q3, Q4, Q6, Q13, Q14, Q15, Q16 and Q17 exist only as authoring-ledger holds.
`
}
