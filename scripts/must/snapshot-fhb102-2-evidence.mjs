...
const SEVENTY_EIGHTH_SOURCE = {
  relativePath: 'Year 1/Semester 102/FHB 102-2/Pharmacology/06 EOM Exams/EOM MCQs - FHB2_Final_MCQ_40 (Macrolides, Clindamycin & Chloramphenicol).pdf',
  sha256: 'e14d492c47cf11ff3d6f9806bedb594e95221850ad36a4ba9ae50e996d169556',
  pages: 6,
  sourceProcessed: true,
}
...
const EIGHTY_THIRD_SOURCE = {
  relativePath: 'Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/Pharmacology FHB Midterm 2026.pdf',
  sha256: '0f25e60600f5d3bc2321b0a5d82c61f2651ab86f79a440a60d4165c2045a1e97',
  pages: 8,
  sourceProcessed: true,
}
const EIGHTY_FOURTH_SOURCE = {
  relativePath: 'Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/2. B-Lactam & Vancomycin.pdf',
...
const EIGHTY_SEVENTH_SOURCE = {
  relativePath: 'Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/B-Lactam and Vancomycin.pdf',
  sha256: '100c06013545f596ed39d298f3f9e8b2ec782c5dfdb42ddf8e5eb21c033c1fd4',
  pages: 29,
  sourceProcessed: true,
}
const EIGHTY_EIGHTH_SOURCE = {
  relativePath: 'Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/Chemotherapy lect 1.pdf',
  sha256: '946d9eb2059efd759a36734b923702547f2345410a78a5c6e9414f7a37cd37df',
  pages: 26,
  sourceProcessed: true,
}
const EIGHTY_NINTH_SOURCE = {
  relativePath: 'Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/General Antibacterial 1 (By Ezzeldin).pdf',
  sha256: 'e703dc230fcd16a3d4733d30b7babe17e7ff6e0f8d239d14e3f67c53b2e1ef2e',
  pages: 29,
  sourceProcessed: true,
}
...
const NINETY_SECOND_SOURCE = {
  relativePath: 'Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/cell wall.pdf',
  sha256: 'be89e24f14a2b580bbd8a4ba954f4bdfa482fa054e5ebc791e82001b60eead6e',
  pages: 9,
  sourceProcessed: true,
}
const NINETY_THIRD_SOURCE = {
  relativePath: 'Year 1/Semester 102/FHB 102-2/Pharmacology/08 Midterm Exams/general antibacterial 1.pdf',
  sha256: '160f09412500534a71cec2241c8b9d35ab03a8de5ed39409a84e529f87900c78',
  pages: 29,
  sourceProcessed: true,
}
...
const provenance = {
  ...
  completedSourceCoverage: [
    ...
    },
    {
      ...
      sectionBoundary: [
        ...
        { section: 'Aminoglycosides', pages: '7-11', teachingReferencePages: 5, assessmentPrompts: 0 },
        { section: 'Tetracyclines', pages: '12-25', teachingReferencePages: 14, assessmentPrompts: 0 },
        { section: 'Chloramphenicol', pages: '26-32', teachingReferencePages: 7, assessmentPrompts: 0 },
        { section: 'Macrolides', pages: '33-37', teachingReferencePages: 5, assessmentPrompts: 0 },
        { section: 'Linezolid', pages: '38-39', teachingReferencePages: 2, assessmentPrompts: 0 },
        { section: 'Clindamycin', pages: '40-44', teachingReferencePages: 5, assessmentPrompts: 0 },
        { section: 'Treatment pharmacokinetics, stewardship and resistance', pages: '45-48', teachingReferencePages: 4, assessmentPrompts: 0 },
        { section: 'Antifolate antimicrobials', pages: '50-58', teachingReferencePages: 9, assessmentPrompts: 0 },
        { section: 'Folate antagonists', pages: '60-70', teachingReferencePages: 11, assessmentPrompts: 0 },
        { section: 'Nucleoprotein inhibition foundations', pages: '72-74', teachingReferencePages: 3, assessmentPrompts: 0 },
        { section: 'Fluoroquinolones', pages: '75-80', teachingReferencePages: 6, assessmentPrompts: 0 },
        { section: 'Rifampicin', pages: '81-84', teachingReferencePages: 4, assessmentPrompts: 0 },
        { section: 'Metronidazole', pages: '85-89', teachingReferencePages: 5, assessmentPrompts: 0 },
        { section: 'Treatment pharmacokinetics, stewardship and resistance reprise', pages: '90-93', teachingReferencePages: 4, assessmentPrompts: 0 },
        { section: 'Nucleoprotein-inhibitor recap', pages: '95-97', teachingReferencePages: 3, assessmentPrompts: 0 },
        { section: 'Fluoroquinolones continued', pages: '98-100', teachingReferencePages: 3, assessmentPrompts: 0 },
        { section: 'Fluoroquinolones continued, second tranche', pages: '101-104', teachingReferencePages: 4, assessmentPrompts: 0 },
        { section: 'Rifampicin recap', pages: '105-109', teachingReferencePages: 5, assessmentPrompts: 0 },
        { section: 'Antimicrobial resistance recap', pages: '110', teachingReferencePages: 1, assessmentPrompts: 0 },
        { section: 'Antituberculous disease, drugs and therapy', pages: '111-120', teachingReferencePages: 10, assessmentPrompts: 0 },
        { section: 'TB-therapy problems', pages: '121', teachingReferencePages: 1, assessmentPrompts: 0 },
        { section: 'Rifamycins', pages: '122-124', teachingReferencePages: 3, assessmentPrompts: 0 },
        { section: 'Isoniazid', pages: '125-130', teachingReferencePages: 6, assessmentPrompts: 0 },
        { section: 'Pyrazinamide', pages: '131-133', teachingReferencePages: 3, assessmentPrompts: 0 },
        { section: 'Ethambutol', pages: '134-137', teachingReferencePages: 4, assessmentPrompts: 0 },
        { section: 'Antileprotic drugs', pages: '138-141', teachingReferencePages: 4, assessmentPrompts: 0 },
    ...
    {
      sha256: SEVENTY_SEVENTH_SOURCE.sha256,
      sourcePages: 8,
      renderedReadPages: '1-8',
      coverPages: 1,
      printedPromptObservations: 40,
      distinctAssessmentPrompts: 40,
      objectiveMcqPrompts: 40,
      writtenPrompts: 0,
      capturedQuestionLabels: 'Q1-Q40',
      printedKeyObservations: 40,
      sourceAbsentAnswers: 0,
      practicalOrImagePrompts: 0,
      teachingReferencePages: 0,
      ...
      sourceProcessed: true,
      sectionBoundary: [
        { section: 'Cover', pages: '1', objectiveMcqPrompts: 0, printedKeyObservations: 0 },
        { section: 'Tetracyclines and tigecycline', pages: '2-4', questionLabels: 'Q1-Q20', objectiveMcqPrompts: 20, printedKeyObservations: 0 },
        { section: 'Aminoglycosides', pages: '5-7', questionLabels: 'Q21-Q40', objectiveMcqPrompts: 20, printedKeyObservations: 0 },
        { section: 'Answer key', pages: '8', objectiveMcqPrompts: 0, printedKeyObservations: 40 },
      ],
      sourceFirstHandleLabels: ['tetracycline classification, pharmacokinetics, chelation and renal use', 'tetracycline mechanism, uses, adverse effects and tigecycline', 'aminoglycoside mechanism, pharmacokinetics, spectrum and clinical uses', 'aminoglycoside toxicity, resistant-case drugs and combination therapy'],
      replayDisposition: 'normalized stem screening against all previously processed FHB 102-2 text identified only three same-stem candidates; complete prompt-plus-option comparison rejects each candidate, so all forty physical fields survive as distinct occurrences',
      authorityDisposition: 'python-docx/LibreOffice revision handout labelled FHB2-102 Final Lecture 1 MCQ Revision and prepared from the uploaded lecture paper only; no visible author, MUST institution or platform, department, examiner, sitting, marks scheme or authenticated faculty-key declaration appears',
      boundaryDisposition: 'page 1 is a cover; pages 2-7 contain one continuous Q1-Q40 ordinary text-MCQ sequence; page 8 prints a complete forty-entry answer-letter table; the exact boundary is forty objective prompts and forty prompt-matched printed answer observations with zero absent, written, practical, image-dependent or teaching-only occurrences',
      preservedSourceDefects: ['the cover claim that answer letters are intentionally balanced and varied is retained as source wording rather than authority evidence', 'printed wording, terminology and academically questionable questions or answer letters remain source truth without correction', 'the terminal answer table is counted as author-supplied printed observations and is not promoted to an authenticated faculty key'],
    },
    {
      sha256: SEVENTY_EIGHTH_SOURCE.sha256,
      sourcePages: 6,
      renderedReadPages: '1-6',
      printedPromptObservations: 40,
      distinctAssessmentPrompts: 40,
      ...
      sourceProcessed: true,
      sectionBoundary: [
        { section: 'Macrolides, first sequence', pages: '1-3', questionLabels: 'Q1-Q17', objectiveMcqPrompts: 17, printedKeyObservations: 0 },
        { section: 'Macrolides and opening clindamycin', pages: '3-5', questionLabels: 'Q18-Q35', objectiveMcqPrompts: 18, printedKeyObservations: 0 },
        { section: 'Clindamycin and chloramphenicol', pages: '5', questionLabels: 'Q36-Q40', objectiveMcqPrompts: 5, printedKeyObservations: 0 },
        { section: 'Answer key', pages: '6', objectiveMcqPrompts: 0, printedKeyObservations: 40 },
      ],
      sourceFirstHandleLabels: ['macrolide classification, absorption, distribution, metabolism and elimination', 'macrolide mechanism, spectrum, clinical uses and adverse effects', 'macrolide drug interactions, telithromycin and newer-macrolide comparisons', 'clindamycin and chloramphenicol mechanisms, uses and toxicities'],
      replayDisposition: 'normalized stem screening of all forty fields against all previously processed FHB 102-2 text finds no same-stem assessment candidate; complete prompt-plus-option replay count is therefore zero and all forty physical fields survive as distinct occurrences',
      authorityDisposition: 'anonymous ReportLab-generated revision handout labelled FHB2-102 Final Lec 2 and 40 Exam-Level MCQs; no visible author, MUST institution or platform, department, examiner, sitting, marks scheme or authenticated faculty-key declaration appears',
    ...
    {
      sha256: EIGHTIETH_SOURCE.sha256,
      sourcePages: 33,
      renderedReadPages: '1-33',
      printedPromptObservations: 120,
      distinctAssessmentPrompts: 120,
      objectiveMcqPrompts: 120,
      writtenPrompts: 0,
      capturedQuestionLabels: 'four independent Q1-Q30 sequences',
      printedKeyObservations: 120,
      sourceAbsentAnswers: 0,
      practicalOrImagePrompts: 0,
      teachingReferencePages: 0,
      sourceFirstHandles: 8,
      ...
      exactReplayPromptObservations: 0,
      replayAnswerObservations: 0,
      sameStemCandidatesRejected: 4,
      familyQuestionDelta: 120,
      familyAnswerDelta: 120,
      liveHits: 0,
      pendingHits: 0,
      newConceptsAfterPriorFhb1022Collapse: 0,
      sourceProcessed: true,
      sectionBoundary: [
        { section: 'Protein Synthesis Inhibitors questions', pages: '1-8', questionLabels: 'Q1-Q30', objectiveMcqPrompts: 30, printedKeyObservations: 0 },
        { section: 'Protein Synthesis Inhibitors answer table', pages: '9', objectiveMcqPrompts: 0, printedKeyObservations: 30 },
        { section: 'Anti-Folates questions and answer table', pages: '10-17', questionLabels: 'Q1-Q30', objectiveMcqPrompts: 30, printedKeyObservations: 30 },
        { section: 'Nucleoprotein Inhibitors questions and answer table', pages: '18-25', questionLabels: 'Q1-Q30', objectiveMcqPrompts: 30, printedKeyObservations: 30 },
        { section: 'Anti-Fungal questions and answer table', pages: '26-33', questionLabels: 'Q1-Q30', objectiveMcqPrompts: 30, printedKeyObservations: 30 },
      ],
      sourceFirstHandleLabels: ['aminoglycoside and tetracycline pharmacology', 'chloramphenicol, macrolide, linezolid and clindamycin pharmacology', 'sulfonamide and trimethoprim mechanisms and pharmacokinetics', 'antifolate uses, adverse effects and interactions', 'fluoroquinolone and rifampicin pharmacology', 'tuberculosis and leprosy therapy', 'antifungal classes and mechanisms', 'antifungal uses, adverse effects and interactions'],
      replayDisposition: 'normalized stem screening of all one hundred twenty fields against all seventy-nine processed FHB 102-2 families yields four candidates; complete prompt-plus-option comparison rejects protein Q8 because the prior stem is a longer calcifying-tissue question, protein Q17 because the match is explanatory written-answer prose, nucleoprotein Q10 because the prior stem adds a slow-acetylator condition and uses different options, and antifungal Q28 because the prior occurrence is an unoptioned written prompt with added wording; all one hundred twenty current fields are internally unique and survive as distinct occurrences',
    ...
    {
      sha256: EIGHTY_SECOND_SOURCE.sha256,
      sourcePages: 11,
      renderedReadPages: '1-11',
      printedPromptObservations: 0,
      ...
      sourceProcessed: true,
      sectionBoundary: [
        { section: 'Antimicrobial chemotherapy foundations, spectrum, mechanisms and adverse effects', pages: '1-3', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 3 },
        { section: 'Beta-lactam foundations and penicillin classification', pages: '4-5', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 2 },
        { section: 'Penicillin pharmacology and opening cephalosporins', pages: '6-7', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 2 },
        { section: 'Cephalosporin generations and pharmacology', pages: '8-9', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 2 },
        { section: 'Carbapenems, monobactams and beta-lactamase inhibitors', pages: '10', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
        { section: 'Vancomycin pharmacology', pages: '11', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
      ],
      sourceFirstHandleLabels: [],
      replayDisposition: 'all eleven pages are declarative study-note and tabular teaching content with no assessment prompt field; no prompt replay comparison is applicable and no declarative statement is reverse-engineered into a question',
      authorityDisposition: 'Microsoft Word 2016-authored study-note carrier headed FHB-2: Pharmacology and bearing Ebedo author metadata; no authenticated MUST platform, institution, department, examiner, sitting, marks scheme or faculty-key declaration appears',
      boundaryDisposition: 'pages 1-3 contain antimicrobial chemotherapy teaching, pages 4-10 contain beta-lactam and related-drug teaching, and page 11 contains vancomycin teaching; the exact boundary is zero objective, written, practical or image-dependent prompts, zero printed or absent answers and eleven teaching-reference pages',
      preservedSourceDefects: ['printed spelling, grammar, tables, terminology and medically or academically questionable statements remain literal source truth without correction', 'headings, numbered drug classes and list items are declarative teaching structure rather than assessment prompts', 'no answer is inferred and no teaching statement is converted into a question'],
    },
    {
      sha256: EIGHTY_THIRD_SOURCE.sha256,
      sourcePages: 8,
      renderedReadPages: '1-8',
      coverPages: 1,
      printedPromptObservations: 0,
      ...
      sourceProcessed: true,
      sectionBoundary: [
        { section: 'Antimicrobial chemotherapy cover', pages: '1', coverPages: 1, objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 0 },
        { section: 'Chemotherapy foundations and antimicrobial adverse effects', pages: '2', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
        { section: 'Cell-wall inhibition and penicillins', pages: '3', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
        { section: 'Penicillin and cephalosporin pharmacology', pages: '4-5', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 2 },
        { section: 'Vancomycin, teicoplanin and telavancin', pages: '6', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
        { section: 'Daptomycin', pages: '7', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
        { section: 'FHB drug list', pages: '8', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
      ],
      sourceFirstHandleLabels: [],
      replayDisposition: 'all content after the cover is declarative teaching and drug-list reference material with no assessment prompt field; no prompt replay comparison is applicable and no declarative statement is reverse-engineered into a question',
      authorityDisposition: 'iOS Quartz PDF capture whose pages 2-8 bear the By Dr/ Mo Haitham footer and whose cover reads antimicrobial chemotherapy 6th Edition; no authenticated MUST platform, institution, department, examiner, sitting, marks scheme or faculty-key declaration appears',
      boundaryDisposition: 'page 1 is a cover, pages 2-7 contain chemotherapy, beta-lactam, vancomycin and daptomycin teaching, and page 8 is an FHB drug-list reference; the exact boundary is zero objective, written, practical or image-dependent prompts, zero printed or absent answers, seven teaching-reference pages and one non-assessment cover page',
      preservedSourceDefects: ['printed spelling, grammar, tables, terminology and medically or academically questionable statements remain literal source truth without correction', 'numbered definitions, drug classes, uses, adverse effects and drug-list items are declarative teaching structure rather than assessment prompts', 'the cover edition wording and Dr Mo Haitham footer are retained as visible provenance claims without promotion to authenticated examination authority', 'no answer is inferred and no teaching statement is converted into a question'],
    },
    {
      sha256: EIGHTY_FOURTH_SOURCE.sha256,
      sourcePages: 40,
      renderedReadPages: '1-40',
      printedPromptObservations: 0,
      distinctAssessmentPrompts: 0,
      ...
      sourceProcessed: true,
      sectionBoundary: [
        { section: 'Named lecture title, antibacterial mechanisms and cell-wall foundation', pages: '1-3', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 3 },
        { section: 'Cell-wall inhibitors and beta-lactam classification', pages: '4-7', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Penicillin mechanism, preparations, resistance and routes', pages: '8-16', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 9 },
        { section: 'Penicillin pharmacokinetics, uses and adverse effects', pages: '17-24', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 8 },
        { section: 'Cephalosporin generations, pharmacokinetics and adverse effects', pages: '25-32', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 8 },
        { section: 'Beta-lactamase inhibitors', pages: '33', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
        { section: 'Carbapenems and monobactams', pages: '34-36', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 3 },
        { section: 'Vancomycin and drug-induced pseudomembranous colitis', pages: '37-39', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 3 },
        { section: 'Thank-you closer', pages: '40', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 0, nonAssessmentCloserPages: 1 },
      ],
      sourceFirstHandleLabels: [],
      replayDisposition: 'all thirty-nine content pages are fully revealed teaching and reference slides with no assessment prompt field; no prompt replay comparison is applicable and no declarative statement, diagram, numbered list or image label is reverse-engineered into a question',
      authorityDisposition: 'named Dr Esraa Mostafa Elnahas teaching deck identifying the lecturer with the Faculty of Medicine, Ain Shams University, and carrying PowerPoint for Microsoft 365 metadata; no authenticated MUST platform, institution, module, examiner, sitting, marks scheme or faculty-key declaration appears',
    ...
    {
      sha256: EIGHTY_SIXTH_SOURCE.sha256,
      sourcePages: 46,
      renderedReadPages: '1-46',
      coverPages: 1,
      printedPromptObservations: 0,
      distinctAssessmentPrompts: 0,
      objectiveMcqPrompts: 0,
      ...
      sourceProcessed: true,
      sectionBoundary: [
        { section: 'Antibiotics word-cloud cover', pages: '1', coverPages: 1, objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 0 },
        { section: 'Antimicrobial chemotherapy, antibiotic definitions and drug-host-bacteria foundation', pages: '2-5', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Bactericidal and bacteriostatic principles, ideal-agent criteria, selection and combination therapy', pages: '6-13', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 8 },
        { section: 'Post-antibiotic effect, MIC and antimicrobial pharmacodynamics', pages: '14-24', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 11 },
        { section: 'Cell-wall structure, antibacterial targets and cell-wall-active agents', pages: '25-32', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 8 },
        { section: 'Protein-synthesis inhibitor classes and mechanisms', pages: '33-38', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 6 },
        { section: 'Nucleic-acid and folate inhibitors plus mechanism and spectrum summaries', pages: '39-45', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 7 },
        { section: 'Multilingual thank-you closer', pages: '46', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 0, nonAssessmentCloserPages: 1 },
      ],
      sourceFirstHandleLabels: [],
      replayDisposition: 'all forty-four content pages are fully revealed teaching and reference slides with no assessment prompt field; rhetorical heading questions such as What is an antibiotic and What is the ideal antibiotic are immediately answered teaching headings rather than assessment occurrences, so no prompt replay comparison is applicable and no diagram, table or labelled mechanism is reverse-engineered into a question',
      authorityDisposition: 'PowerPoint for Microsoft 365 teaching deck titled Antimicrobial Agents and carrying Jost author metadata; the visible slides contain no authenticated MUST platform, institution, department, module, lecturer, examiner, sitting, marks scheme or faculty-key declaration',
      boundaryDisposition: 'page 1 is an antibiotics word-cloud cover, pages 2-45 are declarative antimicrobial chemotherapy, pharmacodynamics and mechanism teaching/reference slides, and page 46 is a multilingual thank-you closer; the exact boundary is zero objective, written, practical or image-dependent prompts, zero printed or absent answers, forty-four teaching-reference pages, one non-assessment cover and one non-assessment closing page',
      preservedSourceDefects: ['printed spelling, grammar, diagrams, tables, terminology and medically or academically questionable statements remain literal source truth without correction', 'rhetorical headings, numbered mechanisms, arrows, graphs and labelled pathway diagrams are declarative teaching structure rather than assessment prompts', 'the Jost metadata author observation is retained without inventing lecturer identity or promoting the carrier to authenticated MUST authority', 'no answer is inferred and no teaching statement is converted into a question'],
    },
    {
      sha256: EIGHTY_SEVENTH_SOURCE.sha256,
      sourcePages: 29,
      renderedReadPages: '1-29',
      coverPages: 1,
      printedPromptObservations: 0,
      ...
      sourceProcessed: true,
      sectionBoundary: [
        { section: 'Individual Groups antibiotics word-cloud cover', pages: '1', coverPages: 1, objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 0 },
        { section: 'Cell-wall inhibitors, beta-lactam classes, mechanism, important points and spectrum', pages: '2-9', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 8 },
        { section: 'Penicillin classes, preparations, spectrum and adverse effects', pages: '10-16', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 7 },
        { section: 'Cephalosporin generations and pharmacology', pages: '17-20', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Monobactam', pages: '21-22', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 2 },
        { section: 'Carbapenems', pages: '23-24', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 2 },
        { section: 'Glycopeptides, vancomycin, pseudomembranous colitis and adverse effects', pages: '25-28', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Multilingual thank-you closer', pages: '29', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 0, nonAssessmentCloserPages: 1 },
      ],
      sourceFirstHandleLabels: [],
      replayDisposition: 'all twenty-seven content pages are fully revealed teaching and reference slides with no assessment prompt field; the What about fourth generation cephalosporins heading on page 20 is immediately answered teaching content rather than an assessment occurrence, so no prompt replay comparison is applicable and no diagram, table, product image or labelled mechanism is reverse-engineered into a question',
      authorityDisposition: 'anonymous metadata-silent PDF 1.7 teaching deck whose visible slides identify no authenticated MUST platform, institution, department, module, lecturer, examiner, sitting, marks scheme or faculty-key declaration',
      boundaryDisposition: 'page 1 is an Individual Groups antibiotics word-cloud cover, pages 2-28 are declarative beta-lactam, penicillin, cephalosporin, monobactam, carbapenem, glycopeptide and vancomycin teaching/reference slides, and page 29 is a multilingual thank-you closer; the exact boundary is zero objective, written, practical or image-dependent prompts, zero printed or absent answers, twenty-seven teaching-reference pages, one non-assessment cover and one non-assessment closing page',
      preservedSourceDefects: ['printed spelling, grammar, diagrams, tables, terminology and medically or academically questionable statements remain literal source truth without correction', 'section-title slides, rhetorical headings, numbered drug classes, diagrams, product images and highlighted facts are declarative teaching structure rather than assessment prompts', 'the absence of visible identifying provenance and metadata is retained without inventing lecturer, institution or authority', 'no answer is inferred and no teaching statement is converted into a question'],
    },
    {
      sha256: EIGHTY_EIGHTH_SOURCE.sha256,
      sourcePages: 26,
      renderedReadPages: '1-26',
      printedPromptObservations: 0,
      distinctAssessmentPrompts: 0,
      ...
      sourceProcessed: true,
      sectionBoundary: [
        { section: 'Antimicrobial chemotherapy foundations, definitions, targets and action diagram', pages: '1-4', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Bacterial cell walls and cell-wall or membrane inhibition', pages: '5-7', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 3 },
        { section: 'Protein-synthesis inhibition and antibacterial classes', pages: '8-12', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 5 },
        { section: 'Nucleic-acid synthesis inhibition', pages: '13', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
        { section: 'Folate-pathway inhibition and TMP-SMX sequential blockade', pages: '14-15', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 2 },
        { section: 'Bactericidal, bacteriostatic and spectrum summary', pages: '16', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
        { section: 'General antimicrobial-adverse-effect section title', pages: '17', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
        { section: 'Gastrointestinal, allergy and blood adverse effects', pages: '18-19', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 2 },
        { section: 'Bacterial-flora effects and superinfection', pages: '20-23', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Pseudomembranous colitis teaching and image reference', pages: '24-25', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 2 },
        { section: 'Nephrotoxicity', pages: '26', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
      ],
      sourceFirstHandleLabels: [],
      replayDisposition: 'all twenty-six pages are fully revealed teaching and reference slides with no assessment prompt field; section-title slides, numbered mechanisms, diagrams and clinical images remain teaching structure, so no prompt replay comparison is applicable and no list item, diagram or image is reverse-engineered into a question',
      authorityDisposition: 'iOS 17.6.1 Quartz PDF capture titled Chemotherapy lect 1 and passed through a pdftopdf filter; the file and visible slides identify no authenticated MUST platform, institution, department, module, lecturer, examiner, sitting, marks scheme or faculty-key declaration',
      boundaryDisposition: 'pages 1-16 contain declarative antimicrobial chemotherapy foundations, mechanisms, antibacterial classes and spectrum teaching, while pages 17-26 contain general adverse-effect, flora, superinfection, pseudomembranous-colitis and nephrotoxicity teaching; the exact boundary is zero objective, written, practical or image-dependent prompts, zero printed or absent answers and twenty-six teaching-reference pages',
      preservedSourceDefects: ['printed spelling, grammar, diagrams, clinical images, terminology and medically or academically questionable statements remain literal source truth without correction', 'numbered mechanisms, adverse-effect categories, section-title slides, diagrams and image-only teaching pages are declarative teaching structure rather than assessment prompts', 'the generic PDF title and iOS capture metadata are retained without inventing lecturer, institution or authority', 'no answer is inferred and no teaching statement is converted into a question'],
    },
    {
      sha256: EIGHTY_NINTH_SOURCE.sha256,
      sourcePages: 29,
      renderedReadPages: '1-29',
      printedPromptObservations: 0,
      distinctAssessmentPrompts: 0,
      ...
      sectionBoundary: [
        ...
        { section: 'Principles, definitions, spectrum, bactericidal and bacteriostatic concepts, uses and general adverse effects', pages: '2-9', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 8 },
        { section: 'Cell-wall synthesis inhibition and penicillin mechanism diagrams', pages: '10-13', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Penicillin preparations and beta-lactamase inhibitors', pages: '14-20', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 7 },
        { section: 'Penicillin uses, adverse effects and labelled clinical-image reference', pages: '21-25', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 5 },
        { section: 'Cephalosporin generations, resistance and adverse effects', pages: '26-29', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
      ],
      sourceFirstHandleLabels: [],
      replayDisposition: 'all twenty-eight content pages are fully revealed teaching and reference slides with no assessment prompt field; numbered definitions, classes, uses, adverse effects, diagrams and labelled clinical images remain declarative teaching structure, so no prompt replay comparison is applicable and no teaching statement is reverse-engineered into a question',
    ...
    {
      sha256: NINETY_FIRST_SOURCE.sha256,
      sourcePages: 37,
      renderedReadPages: '1-37',
      printedPromptObservations: 0,
      distinctAssessmentPrompts: 0,
      objectiveMcqPrompts: 0,
      writtenPrompts: 0,
      ...
      sectionBoundary: [
        { section: 'Antibiotics word-cloud cover', pages: '1', coverPages: 1, objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 0 },
        { section: 'Fleming, antimicrobial chemotherapy, bactericidal or bacteriostatic principles and spectrum', pages: '2-5', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Post-antibiotic effect and beta-lactam pharmacodynamics', pages: '6-9', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Antimicrobial-mechanism divider, beta-lactam structure, cell-wall classes and mechanisms', pages: '10-14', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 5 },
        { section: 'Penicillin divider, classes, combinations and adverse effects', pages: '15-21', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 7 },
        { section: 'Cephalosporin divider, five generations and classification diagram', pages: '22-28', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 7 },
        { section: 'Monobactam and carbapenem divider plus class teaching', pages: '29-31', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 3 },
        { section: 'Vancomycin divider, mechanism, uses, adverse effects and pseudomembranous-colitis teaching', pages: '32-35', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Cell-wall antibiotic summary', pages: '36', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
        { section: 'Multilingual thank-you closer', pages: '37', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 0, nonAssessmentCloserPages: 1 },
      ],
      sourceFirstHandleLabels: [],
      replayDisposition: 'all thirty-five content pages are fully revealed teaching and reference slides with no assessment prompt field; title dividers, numbered drug classes, mechanisms, uses, adverse effects, diagrams and summary lists remain declarative teaching structure, so no prompt replay comparison is applicable and no teaching statement is reverse-engineered into a question',
      authorityDisposition: 'PowerPoint for Microsoft 365 teaching deck titled Antimicrobial Agents with Jost author metadata; the visible slides identify no authenticated MUST platform, institution, department, module, lecturer, examiner, sitting, marks scheme or faculty-key declaration',
      boundaryDisposition: 'page 1 is an antibiotics word-cloud cover, pages 2-36 are declarative antimicrobial principles, pharmacodynamics, cell-wall mechanism, penicillin, cephalosporin, monobactam, carbapenem and vancomycin teaching/reference slides, and page 37 is a multilingual thank-you closer; the exact boundary is zero objective, written, practical or image-dependent prompts, zero printed or absent answers, thirty-five teaching-reference pages, one non-assessment cover and one non-assessment closing page',
      preservedSourceDefects: ['the misspelled filename Rivision is retained as literal file provenance', 'printed spelling, grammar, diagrams, clinical images, terminology and medically or academically questionable statements remain literal source truth without correction', 'title dividers, numbered drug classes, mechanisms, uses, adverse effects, diagrams and summary lists are declarative teaching structure rather than assessment prompts', 'generic title and Jost metadata are retained without inventing lecturer, institution or authority', 'no answer is inferred and no teaching statement is converted into a question'],
    },
    {
      sha256: NINETY_SECOND_SOURCE.sha256,
      sourcePages: 9,
      renderedReadPages: '1-9',
      printedPromptObservations: 0,
      distinctAssessmentPrompts: 0,
      ...
      sourceAbsentAnswers: 0,
      practicalOrImagePrompts: 0,
      teachingReferencePages: 9,
      nonAssessmentCoverPages: 0,
      nonAssessmentCloserPages: 0,
      sourceFirstHandles: 0,
      priorFhb1022CollapsedHandles: 0,
      acceptedSourceHandles: 0,
      searchesRun: 0,
      ...
      sourceProcessed: true,
      sectionBoundary: [
        { section: 'Monobactam and aztreonam pharmacology', pages: '1', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
        { section: 'Carbapenem, imipenem-cilastatin and meropenem teaching plus product references', pages: '2-4', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 3 },
        { section: 'Vancomycin mechanism, formulations, uses and adverse effects', pages: '5-8', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Bacitracin mechanism, indication and product reference', pages: '9', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 1 },
      ],
      sourceFirstHandleLabels: [],
      replayDisposition: 'all nine pages are fully revealed teaching and reference slides with no assessment prompt field; numbered drug classes, mechanisms, uses, adverse effects and product images remain declarative teaching structure, so no prompt replay comparison is applicable and no teaching statement is reverse-engineered into a question',
      authorityDisposition: 'metadata-silent PDF 1.7 teaching excerpt with creation and modification timestamps but no title or author metadata; the visible slides identify no authenticated MUST platform, institution, department, module, lecturer, examiner, sitting, marks scheme or faculty-key declaration',
      boundaryDisposition: 'pages 1-9 are declarative monobactam, carbapenem, vancomycin and bacitracin teaching/reference slides; the file begins directly with monobactam content and ends directly with bacitracin content, so there is no separate cover or closing page; the exact boundary is zero objective, written, practical or image-dependent prompts, zero printed or absent answers, and nine teaching-reference pages',
      preservedSourceDefects: ['the generic filename cell wall is retained as literal file provenance', 'printed spelling, grammar, product images, terminology and medically or academically questionable statements remain literal source truth without correction', 'numbered drug classes, mechanisms, uses, adverse effects and product images are declarative teaching structure rather than assessment prompts', 'metadata silence is retained without inventing lecturer, institution or authority', 'no answer is inferred and no teaching statement is converted into a question'],
    },
    {
      sha256: NINETY_THIRD_SOURCE.sha256,
      sourcePages: 29,
      renderedReadPages: '1-29',
      printedPromptObservations: 0,
      distinctAssessmentPrompts: 0,
      ...
      sectionBoundary: [
        ...
        { section: 'Principles, spectrum, bactericidal or bacteriostatic concepts, sources, uses and general adverse effects', pages: '2-9', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 8 },
        { section: 'Cell-wall classes and penicillin mechanism diagrams', pages: '10-13', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
        { section: 'Penicillin preparations and beta-lactamase inhibitors', pages: '14-20', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 7 },
        { section: 'Penicillin uses, adverse effects and clinical-image reference', pages: '21-25', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 5 },
        { section: 'Cephalosporin generations, resistance and adverse effects', pages: '26-29', objectiveMcqPrompts: 0, writtenPrompts: 0, printedKeyObservations: 0, teachingReferencePages: 4 },
      ],
      sourceFirstHandleLabels: [],
      replayDisposition: 'all twenty-eight content pages are fully revealed teaching and reference slides with no assessment prompt field; numbered definitions, drug classes, uses, adverse effects, diagrams and clinical images remain declarative teaching structure, so no prompt replay comparison is applicable and no teaching statement is reverse-engineered into a question',
  ...
  eightySixthSourceCandidate: EIGHTY_SIXTH_SOURCE,
