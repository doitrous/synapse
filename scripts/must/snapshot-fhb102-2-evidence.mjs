  ...
  partialSourceCoverage: [
    {
      ...
      sectionBoundary: [
        ...
        { section: 'Clindamycin introduction', pages: '40', teachingReferencePages: 1, assessmentPrompts: 0 },
      ],
      ...
      boundaryDisposition: 'pages 1-40 are fully revealed declarative teaching/reference slides; labelled diagrams, bullet lists and product or clinical images are not assessment response fields; pages 41-168 remain unread in this checkpoint',
      preservedSourceDefects: ['the carrier filename suggests a final exam but the reviewed pages contain teaching content only', 'declarative teaching statements are not reverse-engineered into questions or answers', 'the hash remains unprocessed until pages 41-168 are adjudicated'],
    },
  ],
