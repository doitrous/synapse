  ...
  partialSourceCoverage: [
    {
      ...
      sourceAbsentAnswers: 0,
      practicalOrImagePrompts: 0,
      teachingReferencePages: 77,
      nonAssessmentSeparatorPages: 3,
      separatorPages: [49, 59, 71],
      sourceFirstHandles: 0,
      acceptedSourceHandles: 0,
      searchesRun: 0,
      familyQuestionDelta: 0,
      ...
      boundaryDisposition: 'pages 1-80 contain 77 fully revealed declarative teaching/reference slides and three closing thank-you separators on pages 49, 59 and 71; labelled diagrams, bullet lists and product or clinical images are not assessment response fields; pages 81-168 remain unread in this checkpoint',
      preservedSourceDefects: ['the carrier filename suggests a final exam but the reviewed pages contain teaching content only', 'declarative teaching statements are not reverse-engineered into questions or answers', 'closing thank-you slides are retained as non-assessment separators rather than teaching or assessment prompts', 'the hash remains unprocessed until pages 81-168 are adjudicated'],
    },
  ],
