  ...
  partialSourceCoverage: [
    {
      ...
      sourceAbsentAnswers: 0,
      practicalOrImagePrompts: 0,
      teachingReferencePages: 58,
      nonAssessmentSeparatorPages: 2,
      separatorPages: [49, 59],
      sourceFirstHandles: 0,
      acceptedSourceHandles: 0,
      searchesRun: 0,
      familyQuestionDelta: 0,
      ...
      sectionBoundary: [
        ...
        { section: 'Folate antagonists title', pages: '60', teachingReferencePages: 1, assessmentPrompts: 0 },
      ],
      ...
      boundaryDisposition: 'pages 1-60 contain 58 fully revealed declarative teaching/reference slides and two closing thank-you separators on pages 49 and 59; labelled diagrams, bullet lists and product or clinical images are not assessment response fields; pages 61-168 remain unread in this checkpoint',
      preservedSourceDefects: ['the carrier filename suggests a final exam but the reviewed pages contain teaching content only', 'declarative teaching statements are not reverse-engineered into questions or answers', 'closing thank-you slides are retained as non-assessment separators rather than teaching or assessment prompts', 'the hash remains unprocessed until pages 61-168 are adjudicated'],
    },
  ],
