...
function expectedTriageState(readiness, triage) {
  ...
  const remainingChecksum = '6fc97adb7112baa380fc052f0507ef5e4f4c36d6ba80174e5ccbcd34d0f747a2'
...
if (remainingHashes.length !== 77 || processedHashes.length + remainingHashes.length !== selectedHashes.length) throw new Error('Processed and remaining hashes do not reconcile to 106')
