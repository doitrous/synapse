...
("CON-FND-22D1D9B77A768E", "Cytosine", "is a", "pyrimidine base, 2-oxy-4-amino, present in both DNA and RNA",
 ...
 "src_80f6b1121bd3b85f8886", "Cytosine is characterized by all of the following EXCEPT:", "DNA & RNA MCQ, Q20"),
("CON-FND-38857DFD506559", "Peptidyl transferase", "is triggered by", "release factors occupying the A site at a stop codon",
 ...
 "src_80f6b1121bd3b85f8886", "What causes Peptidyl transferase to hydrolyze the bond between the peptide chain and tRNA, terminating translation?", "DNA & RNA MCQ, Q34"),
("CON-FND-FE41A702648A00", "An enhancer", "is", "a regulatory DNA sequence that need not sit at a fixed location relative to the gene it regulates",
 ...
 "src_80f6b1121bd3b85f8886", "Which of the following eukaryotic DNA control sequences does not need to be in a fixed location, and is most responsible for high rates of transcription of particular genes?", "DNA & RNA MCQ, Q36"),
("CON-FND-874F418DFB12AF", "Reverse transcriptase", "is required for", "synthesising single-stranded DNA from an RNA template",
 "A reverse transcriptase must be present for the formation of single-stranded DNA from RNA.",
 "src_80f6b1121bd3b85f8886", "What is the most important condition for the formation of a Single stranded DNA from RNA?", "DNA & RNA MCQ, Q38"),
("CON-FND-21B283A2FE53C4", "Deamination of cytosine", "produces", "a point mutation (uracil) if not repaired",
 "Deamination of cytosine, if not repaired, produces a point mutation.",
 "src_80f6b1121bd3b85f8886", "Deamination of cytosine, if not repaired, produces", "DNA & RNA MCQ, Q39"),
("CON-FND-55348CAA8F9C16", "The primosome", "introduces", "positive supercoils into DNA",
 "The primosome is credited with introducing positive supercoils into DNA.",
 "src_80f6b1121bd3b85f8886", "Which of the following proteins can introduce positive supercoils into DNA?", "DNA & RNA MCQ, Q40"),
("CON-FND-FE0A89860189A5", "RNA polymerase", "adds nucleotides", "only at the 3' end of the growing chain, without a primer",
 "RNA polymerase adds nucleotides at the 3' end of the growing polynucleotide chain.",
 "src_80f6b1121bd3b85f8886", "What is the foundation of RNA polymerase?", "DNA & RNA MCQ, Q58"),
("CON-FND-6EF5C044E64C46", "Single-strand binding protein", "keeps", "the separated DNA strands from re-annealing",
 "Single-strand binding protein binds single-stranded DNA to keep the two strands from binding together again.",
 "src_80f6b1121bd3b85f8886", "Single stranded binding protein binds to single stranded DNA:", "DNA & RNA MCQ, Q82"),
("CON-FND-7CEF0F2F8C9EE1", "Insertion or deletion of bases", "causes", "a frameshift mutation",
 "Deletion or insertion of bases causes a frameshift mutation.",
 "src_80f6b1121bd3b85f8886", "What is the type of mutation when deletion or insertion of bases occurs?", "DNA & RNA MCQ, Q86"),
("CON-FND-9D5D6275474035", "Decapping", "shuts down", "translation of a processed mRNA",
 "Decapping may shut down the translation of a processed mRNA.",
 "src_80f6b1121bd3b85f8886", "What may shut down the translation of a processed mRNA?", "DNA & RNA MCQ, Q64"),
("CON-FND-60F505DFC88026", "Translocation", "moves", "the peptide-bearing tRNA from the ribosomal A site to the P site",
 ...
 "src_80f6b1121bd3b85f8886", "Translocation is the process where", "DNA & RNA MCQ, Q66"),
("CON-FND-B92EB41248D631", "eIF-1 and eIF-3", "are required for", "binding of mRNA to the 40S ribosomal subunit",
 "eIF-1 and eIF-3 in protein synthesis are required for binding of mRNA to the 40S ribosomal subunit.",
 "src_80f6b1121bd3b85f8886", "eIF-1 and elF-3 in Protein synthesis are required:", "DNA & RNA MCQ, Q69"),
("CON-FND-D6A7B168134B07", "Tetracycline", "prevents", "tRNA attachment to the ribosomal A site",
 "Tetracycline prevents tRNA from attaching to the A site of the ribosome.",
 "src_80f6b1121bd3b85f8886", "Which of the following antibiotics prevent tRNA from attaching to A site of Ribosome?", "DNA & RNA MCQ, Q70"),
("CON-FND-36FA9827A6B99C", "Base excision repair", "removes", "uracil and incorporates the correct base",
 "Base excision repair is the mechanism that removes uracil and incorporates the correct base.",
 "src_80f6b1121bd3b85f8886", "What is the mechanism that will remove Uracil and incorporate the correct base?", "DNA & RNA MCQ, Q76"),
("CON-FND-014D200ED96498", "Ciprofloxacin", "inhibits", "bacterial DNA gyrase, a topoisomerase",
 "Ciprofloxacin cures a bacterial infection by inhibiting bacterial DNA gyrase, a topoisomerase.",
 "src_413115a28d7dc9914c91", "A patient had acute bacterial infection and was given Ciprofloxacin which cured him, what is the effect of Ciprofloxacin", "long EOM/Foundation Final Egyptian paper (biochemistry section), Q24"),
("CON-FND-32433CE637CA9A", "RNA editing", "produces", "a different protein from the same gene, unlike alternative splicing",
 "The main function of RNA editing is to synthesise a different protein from the same gene.",
 "src_413115a28d7dc9914c91", "What is the main function of RNA editing?", "long EOM/Foundation Final Egyptian paper (biochemistry section), Q92"),
("CON-FND-A427EA66958B81", "A mature red blood cell", "cannot synthesise new mRNA because", "gene loss (losing its nucleus) during erythropoiesis",
 "According to the regulation of gene expression, mature red blood cells cannot form mRNA because of gene loss.",
 "src_413115a28d7dc9914c91", "According to regulation of gene expression, Which of the following explains why mature RBCs cannot form mRNA", "long EOM/Foundation Final Egyptian paper (biochemistry section), Q27"),
]
