...
# scripts/kasr/extract/eom.py — four levels up is the repo root.
REPO = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
MANIFEST = os.path.join(REPO, "docs/Kasr-Source-Imports/manifest/kasr-y1-sources.json")
HERE = os.path.dirname(os.path.abspath(__file__))
OUT = os.path.join(HERE, "eom.json")
CACHE = os.path.join(HERE, "pagetext-eom")
...
SITTINGS = {
    "2020-12-24": {
        "files": ["EOM first 2021 101 INT end of module.pdf"],
        # A different exam from the other three: `INT-101`, 24 marks, one hour.
        "moduleCode": "INT-101", "totalMarks": 24, "timeAllowed": 60, "statedQuestions": None,
    },
    "2021-12-18": {
        "files": ["EOM ISK 101 195 Answers.pdf", "EOM ISK End 101– 2021 (answers).pdf"],
        "moduleCode": "ISK-101", "totalMarks": 72, "timeAllowed": 120, "statedQuestions": 120,
    },
    "2022-12-10": {
        "files": ["EOM ISK 101 - 2023.pdf", "EOM ISK End 101 — 2022.pdf"],
        "moduleCode": "ISK-101", "totalMarks": 72, "timeAllowed": 120, "statedQuestions": 120,
    },
    "2024-12-05": {
...
def main():
    ...
    papers = [s for s in manifest["sources"]
              if s["moduleId"] == "101 ISK" and s["sourceCategory"] == "EOM"]
