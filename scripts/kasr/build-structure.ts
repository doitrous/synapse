 ...
 *
 *   node --experimental-strip-types scripts/kasr/build-structure.ts "102 INT"
 *
...
const doc = `<!--
  ...
  ../../../scripts/kasr/extract/${slug}/physio-chapters.json as \`yearBookChapters\`,
...
mkdirSync('docs/Kasr-Source-Imports/academic', { recursive: true })
const out = `docs/Kasr-Source-Imports/academic/${slug.toLowerCase()}-structure.md`
