...
export const SEEDS: Seed[] = [
  ...
  },
  {
    ...
    pitfall: 'Calling a false knot an anomaly. A false knot is a wider curve of an umbilical artery and causes no fetal stress; it is the true knot, in a long cord, that matters.',
