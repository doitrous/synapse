...
export const SEEDS: Seed[] = [
  ...
  },
  {
    ...
    pitfall: 'Stopping at "a zygote is formed". Fertilisation has four results, and the two that are easiest to omit — restoring the diploid number and starting cleavage and migration — are the two that explain what happens next.',
