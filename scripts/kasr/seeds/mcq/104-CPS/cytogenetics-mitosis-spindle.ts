  ...
  questions: [
    {
      ...
      explanations: {
        ...
        C: "Chromosomal microtubules are attached to the kinetochores, arranging the chromosomes at the metaphase plate — a discontinuous set of fibres running only from pole to kinetochore. A common trap: describing the kinetochore as the centromere itself.",
    ...
    },
    {
      ...
      explanations: {
        ...
        B: "Astral microtubules are arranged in a star-like fashion around the centrioles, establishing the axis of the spindle. A common trap: describing the kinetochore as the centromere itself.",
