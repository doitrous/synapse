...
export const LEAF: McqLeafSeed = {
  ...
  questions: [
    ...
    {
      key: "fenestrated-visceral-blood-capillaries-are-known-by-bbfeda5d",
      conceptKey: "fenestrated-capillary.structure-junctions-and-sites",
      difficulty: "Moderate",
      ...
      explanations: {},
      exclude: true,
      excludeReason: "Already flagged `editorialExcluded` by the bank's own extraction: all three surviving options (absent pericytes, non-continuous basal lamina, main capillaries of the spleen) actually describe defining features of blood sinusoids rather than fenestrated capillaries, and no answer letter survived extraction. The genuine defining feature of a fenestrated capillary — a continuous basal lamina despite the endothelial pores — was most likely in a missing option C.",
    },
    {
    ...
    {
      key: "renal-glomerular-capillaries-are-a-type-of-c122dd7c",
      conceptKey: "capillary-types.continuous-and-sinusoidal-structure-and-sites",
      difficulty: "Moderate",
      questionType: "Not sittable as extracted.",
      learningObjective: "Not sittable as extracted.",
      explanations: {},
      exclude: true,
      excludeReason: "The correct answer (fenestrated capillaries, the standard classification for glomerular capillaries built for rapid plasma filtration) is missing from the surviving options — sinusoidal, continuous and somatic are all incorrect classifications for glomerular capillaries — and options D and E have also absorbed an entirely unrelated extended-matching table about mitosis and vessel-wall structure, further corrupting this row. No answer letter survived extraction.",
    },
    {
      key: "the-blood-sinusoidal-capillaries-are-characterized-by-the-fo-768558f4",
      conceptKey: "capillary-types.continuous-and-sinusoidal-structure-and-sites",
      difficulty: "Moderate",
      questionType: "Not sittable as extracted.",
      learningObjective: "Not sittable as extracted.",
      explanations: {},
      exclude: true,
      excludeReason: "Option extraction merged two choices into one field on each side — option A carries both 'Present in bone marrow, spleen & liver' and a bled-over 'B- Irregular & wide lumen', and option C carries both 'Continuous endothelium & basement membrane' and a bled-over 'D- Surrounded by macrophage' — leaving only 2 distinguishable choices for what should be a 4-option item, the same A+B/C+D merge-corruption class documented in this module's Arteries cluster. No seed-level field exists to split merged option text back into separate letters.",
    },
    {
    ...
    {
      key: "1-ip-the-blood-capillaries-reguls-the-blood-flow-is-the-func-a390fd08",
      conceptKey: "capillary-pericyte.contractile-function-differentiation-and-position",
      difficulty: "Moderate",
      questionType: "Not sittable as extracted.",
      learningObjective: "Not sittable as extracted.",
      explanations: {},
      exclude: true,
      excludeReason: "The extracted stem is a corrupted merge of a capillary-blood-flow-regulation question with a separate, unrelated question about longitudinal smooth muscle in vessel adventitia, and the surviving lettered options (aorta, muscular arteries) answer only the second, unrelated question — the first question's own candidate answers (elastic fibres, smooth muscle fibres, fibroblasts) survive only as unlettered stem text with no way to assign a letter. The same fact this row was reaching for (pericytes regulate capillary blood flow) is already cleanly established by this concept's own duplicate-occurrence questions on the same fact.",
    },
    {
