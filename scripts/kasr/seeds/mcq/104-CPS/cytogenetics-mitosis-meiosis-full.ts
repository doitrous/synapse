...
export const LEAF: McqLeafSeed = {
  ...
  questions: [
    ...
    {
      key: "regarding-the-meiotic-cell-division-meiosis-51b08c53",
      conceptKey: "meiosis.two-successive-divisions-and-crossing-over",
      difficulty: "Moderate",
      questionType: "Recall",
      learningObjective: "State that meiosis produces daughter (germ) cells with the haploid chromosome number, against three false statements about site, division count and crossing over.",
      explanations: {
        A: "Meiosis occurs in germ cells (testis and ovary), not somatic cells — somatic cells divide by mitosis instead.",
        B: "Meiosis produces daughter cells with the haploid number of chromosomes — 23 s-chromosomes by the end of the second meiotic division, half the diploid number the parent germ cell started with. This chromosome-number reduction is what makes fertilisation, restoring the diploid number in the zygote, possible.",
        C: "Meiosis is two successive divisions without an intervening S-phase, not a single division — the single-division profile instead belongs to mitosis.",
        D: "Crossing over between non-sister chromatids at the chiasmata is a defining, essential feature of meiosis's first division, not something absent from it.",
      },
    },
    {
      key: "longitudinal-splitting-of-chromosomes-happens-in-the-followi-dd089630",
      conceptKey: "mitosis.four-stages-prophase-to-telophase",
      difficulty: "Easy",
      questionType: "Definition",
      learningObjective: "Place the longitudinal splitting of each chromosome at its centromere in anaphase.",
      explanations: {
        A: "Prophase condenses the chromosomes and builds the spindle; it does not split any chromosome's centromere.",
        B: "Metaphase aligns the still-intact d-chromosomes at the equatorial plate; the centromere has not yet split.",
        C: "In anaphase, each d-chromosome splits longitudinally at the centromere, its two sister chromatids pulled to opposite poles by the chromosomal microtubules. A common trap: describing the kinetochore as the centromere itself.",
        D: "Telophase begins only once the chromatids have already separated and reached the poles — after anaphase's splitting, not during it.",
      },
    },
    {
      key: "mitosis-is-characterized-by-the-following-a-exchange-of-gene-0099d1c3",
      conceptKey: "mitosis-vs-meiosis.comparison",
      difficulty: "Moderate",
      questionType: "Recall",
      learningObjective: "State the absence of crossing over as mitosis's defining feature, against three false statements about gene exchange and chromosome number.",
      explanations: {
        A: "Exchange of genes (crossing over) is a defining feature of meiosis, not mitosis — mitosis involves no pairing of homologous chromosomes at all.",
        B: "Mitosis is characterised by the ABSENCE of crossing over, with no exchange of genes — since no homologous pairing occurs, there is nothing for chromosomes to exchange.",
        C: "Mitotic daughter cells retain the diploid (2n) chromosome number of the parent cell, not a haploid (n) number, which is instead meiosis's outcome.",
        D: "Mitotic daughter cells are genetically identical to the mother cell, not different from it, precisely because no crossing over or independent assortment occurs.",
      },
    },
    {
      key: "regarding-mitosis-2b0b7327",
      conceptKey: "mitosis-vs-meiosis.comparison",
      difficulty: "Moderate",
      questionType: "Recall",
      learningObjective: "State that mitosis involves no exchange of genes, against three false statements about site, chromosome number and division count.",
      explanations: {
        A: "Mitosis occurs in somatic cells, not germ cells — meiosis is the division specific to germ cells for gamete formation.",
        B: "Mitotic daughter cells retain the diploid chromosome number of the parent cell, not a haploid number, which is instead meiosis's outcome.",
        C: "Mitosis is a single division, not two successive divisions — the two-division pattern (meiosis I and II) is characteristic of meiosis.",
        D: "Mitosis involves no exchange of genes, since it includes no pairing of homologous chromosomes or crossing over — each chromosome simply replicates and its identical sister chromatids separate, which is exactly why mitotic daughter cells are genetically identical to the parent.",
      },
    },
    {
      key: "the-cell-division-occurring-in-somatic-cells-is-characterize-6fcc3694",
      conceptKey: "mitosis-vs-meiosis.comparison",
      difficulty: "Moderate",
      questionType: "Recall",
      learningObjective: "State that mitosis (the division of somatic cells) has no crossing over and no gene exchange, against three false statements describing meiosis instead.",
      explanations: {
        A: "Bivalents (tetrads), formed by homologous chromosome pairing, are a meiosis-specific feature (prophase I) — mitosis pairs no homologous chromosomes and forms no bivalents.",
        B: "The cell division occurring in somatic cells (mitosis) shows a complete absence of crossing over and gene exchange, since it involves no pairing of homologous chromosomes — each chromosome simply duplicates and separates its own sister chromatids.",
        C: "Mitosis is a single division, not two successive divisions — the two-division pattern belongs to meiosis.",
        D: "Mitosis produces two diploid (2n) daughter cells, not four haploid (1n) daughter cells, which is instead meiosis's outcome.",
      },
    },
    {
      key: "the-chromosomal-microtubules-of-the-mitotic-spindle-bc625da2",
      conceptKey: "mitosis.four-stages-prophase-to-telophase",
      difficulty: "Moderate",
      questionType: "Structure and function",
      ...
      explanations: {},
      exclude: true,
      excludeReason: "Only 3 options survived extraction (A, B, D — option C is missing entirely), below the platform's 4-to-5-option import contract. Excluded as structurally unimportable rather than padded with an invented option.",
    },
  ],
}
