...
export const LEAF: McqLeafSeed = {
  ...
  questions: [
    ...
    {
      key: "a-patient-was-diagnosed-as-having-chronic-myeloid-leukemia-h-e370e170",
      conceptKey: "structural-chromosomal-aberration.deletion-inversion-translocation-duplication-isochromosome",
      difficulty: "Moderate",
      questionType: "Clinical application",
      learningObjective: "Identify a reciprocal translocation between chromosomes 22 and 9 (the Philadelphia chromosome) as the cause of chronic myeloid leukaemia, against deletion and centric-fusion distractors naming unrelated syndromes.",
      explanations: {
        A: "Correct. Chronic myeloid leukaemia is classically caused by a reciprocal translocation between chromosomes 9 and 22, which creates the Philadelphia chromosome and fuses the BCR gene (chromosome 22) with the ABL1 gene (chromosome 9), producing a constitutively active BCR-ABL tyrosine kinase that drives uncontrolled myeloid proliferation.",
        B: "Deletion of the short arm of chromosome 4 causes Wolf-Hirschhorn syndrome, an unrelated congenital disorder, not chronic myeloid leukaemia.",
        C: "Deletion of the short arm of chromosome 5 causes Cri-du-chat syndrome, an unrelated congenital disorder, not chronic myeloid leukaemia.",
        D: "Centric (Robertsonian) fusion of chromosomes 14 and 21 is associated with familial translocation Down syndrome, not chronic myeloid leukaemia.",
      },
    },
    {
      key: "it-is-absent-in-klinefelter-syndrome-9-addition-of-a-fragmen-4f0b50c3",
      conceptKey: "structural-chromosomal-aberration.deletion-inversion-translocation-duplication-isochromosome",
      difficulty: "Moderate",
      questionType: "Definition",
      learningObjective: "Name duplication as the structural aberration in which a fragmented segment of one chromosome is added to its homologous chromosome.",
      explanations: {
        A: "Correct. Duplication is the structural aberration in which a fragmented segment of one chromosome becomes added onto its homologous chromosome, so that segment is present in an extra copy.",
        B: "An isochromosome results from abnormal transverse (rather than longitudinal) division of the centromere, producing a chromosome with two identical arms — an unrelated mechanism to segment addition between homologues.",
        C: "Translocation moves a segment to a non-homologous chromosome, not addition of a segment to its own homologous chromosome.",
        D: "Inversion reverses a segment's orientation within the same chromosome, not addition of material from elsewhere.",
      },
    },
    {
      key: "may-be-due-to-47-chromosomes-xxy-15-structural-aberrations-i-304914be",
      conceptKey: "structural-chromosomal-aberration.deletion-inversion-translocation-duplication-isochromosome",
      difficulty: "Easy",
      questionType: "Classification",
      learningObjective: "Identify deletion, rather than aneuploidy or a clinical syndrome, as a category of structural chromosomal aberration.",
      explanations: {
        A: "Aneuploidy is a numerical chromosomal aberration (an abnormal chromosome count), not a structural one.",
        B: "Correct. Deletion — the loss of a chromosomal segment — is a classic structural chromosomal aberration, changing chromosome architecture rather than chromosome count.",
        C: "Turner's syndrome is a clinical condition resulting from a numerical aberration (monosomy X), not itself a category of structural aberration.",
        D: "Klinefelter's syndrome is a clinical condition resulting from a numerical aberration (an extra X chromosome), not itself a category of structural aberration.",
      },
    },
    {
      key: "philadelphia-chromosome-6245c1ec",
      conceptKey: "structural-chromosomal-aberration.deletion-inversion-translocation-duplication-isochromosome",
      difficulty: "Moderate",
      questionType: "Definition",
      learningObjective: "Confirm, against a second, independently-extracted source occurrence, that the Philadelphia chromosome is a reciprocal translocation between chromosomes 22 and 9.",
      explanations: {
        A: "Correct. The Philadelphia chromosome arises from a reciprocal translocation between chromosomes 9 and 22, fusing the BCR (chromosome 22) and ABL1 (chromosome 9) genes and driving the constitutively active tyrosine kinase seen in chronic myeloid leukaemia.",
        B: "The Philadelphia chromosome results from a translocation — an exchange of material between chromosomes 9 and 22 — not a duplication of chromosome 22.",
        C: "The Philadelphia chromosome results from a reciprocal translocation, not a terminal deletion.",
        D: "The Philadelphia chromosome results from a translocation between two different chromosomes, not an inversion within a single chromosome.",
      },
    },
    {
      key: "structural-aberrations-include-9c106da4",
      conceptKey: "structural-chromosomal-aberration.deletion-inversion-translocation-duplication-isochromosome",
      difficulty: "Easy",
      questionType: "Classification",
      learningObjective: "Confirm, against a second, independently-extracted source occurrence, that deletion is a structural (not numerical) chromosomal aberration.",
      explanations: {
        A: "Aneuploidy is a numerical, not structural, chromosomal aberration.",
        B: "Correct. Deletion — the loss of a chromosomal segment — is a classic structural chromosomal aberration, involving altered chromosome architecture rather than altered chromosome count.",
        C: "Turner's syndrome results from a numerical aberration (monosomy X), not a structural aberration category.",
        D: "Klinefelter's syndrome results from a numerical aberration (an extra X chromosome), not a structural aberration category.",
      },
    },
  ],
}
