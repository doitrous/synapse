  ...
  questions: [
    {
      ...
      explanations: {
        ...
        C: "The exception, and the answer. The book describes a muscular artery's external elastic lamina as merely 'recognisable' in many muscular arteries, not as a sharply defined, 'clear' layer — that stronger description overstates what the book says.",
    ...
    },
    {
      ...
      explanations: {
        ...
        B: "The exception, and the answer. The book states medium arteries have more smooth muscle fibres and less elastic fibres in the tunica media than elastic arteries — this option reverses that relationship.",
    ...
    },
    {
      ...
      explanations: {
        ...
        B: "The exception, and the answer. The book's comparison table gives collapsing and holding blood after death as the vein's characteristics; the medium artery's are the opposite — it does not collapse and has no blood in it after death.",
    ...
    },
    {
      ...
      explanations: {
        ...
        B: "Correct. The book describes medium-sized muscular arteries as the most common type of artery, delivering blood to organs.",
    ...
    },
    {
      ...
      explanations: {
        ...
        B: "Correct. The book describes the tunica media of a large elastic artery as the thickest layer, formed of 40 to 70 circularly arranged fenestrated elastic membranes.",
    ...
    },
    {
      ...
      explanations: {
        ...
        D: "The exception, and the answer. This describes the tunica intima, not the tunica media — the intima is loose connective tissue and, in the aorta specifically, the book states its internal elastic lamina is not prominent, the opposite of the media's own thick, elastic-membrane-dominated structure.",
      },
    },
  ],
}
