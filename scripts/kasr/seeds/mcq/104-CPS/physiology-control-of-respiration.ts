  ...
  questions: [
    {
      ...
      explanations: {
        A: "A genuine non-chemical influence. The book's 'Afferents from Higher Centers' section carries pain and emotional stimuli by the limbic system and temperature by the hypothalamus into the respiratory centre — both nervous routes, not chemical ones.",
        B: "A genuine non-chemical influence. Swallowing is one of the book's visceral reflexes: mechanoreceptors in the pharynx send a glossopharyngeal afferent that inhibits respiration (swallowing apnoea) to keep food out of the airway.",
        C: "A genuine non-chemical influence, not the exception. Coughing is the book's own first example under 'Afferents from Upper Airway Receptors' — irritant receptors in the trachea, larynx and bronchi, carried by the vagus, producing deep inspiration then forced expiration against a glottis that opens suddenly.",
        D: "The exception, and the answer. The book places a rise in arterial PCO2 (hypercapnia) under its chemical control of respiration, not under 'Non-Chemical (Nervous) Regulation' — PCO2 is stated as the major controller of ventilation acting through central and peripheral chemoreceptors, the one route on this list that is not a nervous reflex.",
      },
      answerOverride: "D",
      answerOverrideReason: "The book's own chapter structure contradicts the printed key. 'Non-Chemical (Nervous) Regulation of Respiratory Activity' (physiology department book p149-153) explicitly lists pain/limbic afferents, coughing and swallowing as nervous reflex sources of respiratory drive. Hypercapnia (raised PCO2) sits in a separate, earlier section, 'Ventilatory Response to Changes in CO2' (p148-149), stated as the major controller of respiration through chemoreceptors — the chemical route the non-chemical section is being contrasted against. It is therefore the one option that is not a non-chemical influence, not option C.",
    },
  ],
}
