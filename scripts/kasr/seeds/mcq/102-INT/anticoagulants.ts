  ...
  questions: [
    {
      ...
      explanations: {
        a: 'Protein C is one of the body\'s own limiting mechanisms on coagulation: thrombin bound to thrombomodulin on healthy endothelium activates it, and activated protein C, together with protein S, inactivates factors V and VIII and frees tissue plasminogen activator to start fibrinolysis. That whole downstream effect is why protein C counts as a major physiological anticoagulant.',
