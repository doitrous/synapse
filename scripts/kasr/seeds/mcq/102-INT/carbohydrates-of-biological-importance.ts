...
export const LEAF: McqLeafSeed = {
  ...
  concepts: [
    ...
    // pass 1 (2026-08-27) found one that does.
    {
      ...
      objective: 'Explain why cellulose escapes digestion and state the two dietary consequences the department book gives for it.',
      pitfall:
  ...
  questions: [
    ...
    // --- pass 1 additions (2026-08-27) ---
    {
      ...
      explanations: {
        ...
        c: 'Correct. Cellulose\'s glucose units are joined by β1,4-glucosidic bonds, which human amylase cannot hydrolyse, so it passes through the gut undigested, increases the bulk of food and stimulates intestinal contractions that prevent constipation.',
        d: 'Inulin is a plant fructan storage polysaccharide, not the book\'s named source of dietary bulk against constipation.',
      },
    },
    {
      ...
      explanations: {
        ...
        c: 'Correct. The book states that GAGs are mostly covalently conjugated to a protein core to form proteoglycans, roughly 95% carbohydrate and 5% protein by mass.',
