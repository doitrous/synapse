...
export const LEAF: McqLeafSeed = {
  ...
  questions: [
    // --- monosaccharide-classification-by-carbonyl-group-and-carbon-count ---
    {
      ...
      learningObjective: 'Name glyceraldehyde as the aldotriose that is the mother compound of all aldoses.',
      answerOverride: 'b',
      ...
      explanations: {
        ...
        b: 'Glyceraldehyde, the aldotriose, is the mother compound of all aldoses — every other aldose (erythrose, ribose, glucose, and so on) is structurally related to it.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Glyceraldehyde is the aldotriose — the 3-carbon aldose.',
    ...
    },
    {
      ...
      difficulty: 'Moderate',
      questionType: 'Classification',
      learningObjective: 'Identify a pair of named aldohexoses (glucose, mannose, galactose).',
      answerOverride: 'c',
      answerOverrideReason:
      ...
      explanations: {
        ...
        c: 'Glucose, mannose and galactose are the aldohexose examples; glucose and galactose are two of the three.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Ribulose is the ketopentose, carrying a ketone group, not an aldehyde.',
        b: 'Fructose is the ketohexose — the most commonly confused ketose with an aldose because it is also a hexose.',
        c: 'Erythrulose is the ketotetrose, a ketose despite the "-ulose" name pattern shared with other ketoses.',
        d: 'Glucose is the aldohexose example — an aldehyde group at C1, six carbons.',
      },
    },
    {
      ...
      explanations: {
        a: 'Glyceraldehyde is the aldotriose — the mother compound of all aldoses.',
        b: 'Ribulose is the ketopentose.',
        c: 'Erythrulose is the ketotetrose.',
        d: 'Dihydroxyacetone is the simplest ketose, the ketotriose.',
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Definition',
      learningObjective: 'Name dihydroxyacetone as the simplest ketose.',
      answerOverride: 'c',
      answerOverrideReason:
      ...
      explanations: {
        ...
        c: 'Dihydroxyacetone is the simplest ketose (C3).',
    ...
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Classification',
      learningObjective: 'Identify fructose as the ketohexose example.',
      explanations: {
        ...
        c: 'Fructose is the named example of a ketohexose.',
    ...
    },
    {
      ...
      explanations: {
        ...
        d: 'Dihydroxyacetone is the simplest ketose.',
      },
    },
    {
      ...
      learningObjective: 'State the fixed structural pattern for every ketose: two terminal CH2OH groups and one C=O.',
      explanations: {
        ...
        c: 'Every ketose has two terminal primary alcohol groups (CH2OH) and one ketone group (C=O).',
    ...
    },
    {
      ...
      difficulty: 'Moderate',
      questionType: 'Classification',
      learningObjective: 'Identify erythrulose as the ketotetrose.',
      explanations: {
        a: 'Xylose is an aldopentose (5-carbon aldose), not a ketotetrose — wrong on both the carbonyl type and the carbon count.',
        b: 'Erythrulose is the ketotetrose.',
        c: 'Fructose is the ketohexose (6 carbons), two carbons longer than a tetrose.',
        d: 'Heptoses are the 7-carbon group; a ketoheptose would have three more carbons than a ketotetrose, so this cannot be the tetrose.',
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Classification',
      learningObjective: 'Identify ribulose as the ketopentose.',
      explanations: {
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Glucose is an aldohexose and fructose a ketohexose — both are six-carbon sugars, so hexose is the classification they share.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: 'Fructose is the ketohexose — six carbons, ketone group at C2.',
        d: 'Galactose has six carbons but an aldehyde group, not a ketone — it is the aldohexose partner to glucose, not a ketose.',
      },
    },
    ...
    // --- monosaccharide-isomer-types ---
    {
      ...
      explanations: {
        a: 'Most naturally occurring monosaccharides are of the D- type.',
        b: '"C type" is not a naming convention used for sugar stereochemistry at all.',
        c: 'L-sugars are the mirror-image minority, structurally related to L-glyceraldehyde — a small contrast group set against the D-majority.',
        d: '"E type" is not a naming convention used for sugar stereochemistry.',
      },
    },
    {
      ...
      explanations: {
        a: 'This is the definition of aldose-ketose isomers, i.e. functional group isomerism — same molecular formula, different functional group.',
        ...
        c: '"Optical isomers" is not one of the four named isomer types; the four are enantiomers, anomers, epimers and functional group (aldose-ketose) isomers.',
    ...
    },
    {
      ...
      difficulty: 'Moderate',
      questionType: 'Definition',
      learningObjective: 'Recall the definition of epimers.',
      explanations: {
        a: 'Epimers are compounds with the same molecular formula that differ only in the configuration around one carbon.',
        ...
        c: '"Optical isomers" is not one of the four named isomer types here.',
        d: '"Stereoisomers" is a broader term than the specific, single-carbon definition of epimers — it would also describe enantiomers and anomers, so it is less precise than the option the question is testing for.',
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Structure and function',
      learningObjective: 'Name galactose as one of glucose\'s two epimers.',
      explanations: {
        a: 'Glucose and galactose are epimers at C4.',
        ...
        c: 'Arabinose is not one of the two named epimer partners for glucose (mannose at C2, galactose at C4).',
        d: 'Xylose, like arabinose, is not an epimer of glucose.',
      },
    },
    {
      ...
      explanations: {
        a: 'C2, not C1, is the point of difference between glucose and mannose.',
        b: 'C3 is not the carbon for the glucose-mannose epimer pair; C4 is the carbon for the glucose-galactose pair instead.',
        c: 'Glucose and mannose are epimers at C2.',
        d: 'C5 is not a configuration named for any epimer pair in this chapter.',
      },
    },
    {
      ...
      explanations: {
        a: 'C1 is not the carbon named for either epimer pair.',
        b: 'C2 is the carbon named for the glucose-mannose pair, not glucose-galactose.',
        c: 'C3 is not a configuration named for any epimer pair in this chapter.',
        d: 'Glucose and galactose are epimers at C4.',
      },
    },
    {
      ...
      explanations: {
        ...
        d: 'Enantiomers are the D- and L- forms of the same compound, mirror images of one another — D- and L-glucose are the classic example.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Fructose is the functional group isomer of glucose — fructose is a ketose, glucose an aldose, same molecular formula, different functional group.',
    ...
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Structure and function',
      learningObjective: 'Recall that fructose is the functional group isomer of glucose.',
      explanations: {
        ...
        c: 'Fructose is a functional group isomer of glucose.',
    ...
    // --- important-monosaccharides-biological-occurrence ---
    {
      ...
      difficulty: 'Easy',
      questionType: 'Definition',
      learningObjective: 'Name fructose as the sugar present in honey.',
      explanations: {
        a: 'Maltose is not among the sugars present in honey; it is the disaccharide product of starch digestion.',
        b: 'Fructose ("fruit sugar") is present in honey, fruits, semen, sucrose and inulin.',
        c: 'Ribulose is a ketopentose used as a structural example elsewhere in the chapter, not a sugar present in honey.',
        d: 'Lactose is milk sugar, formed of galactose and glucose — it is not present in honey.',
      },
    },
    {
      ...
      explanations: {
        a: 'Xylose is an aldopentose example used earlier in the chapter\'s carbon-count classification, not a nucleic-acid sugar.',
        b: 'Ribose is the RNA sugar, the other pentose in this pair — easy to swap with deoxyribose if the two nucleic acids aren\'t kept straight.',
        c: '2-deoxyribose is a component of deoxyribonucleic acid (DNA).',
    ...
    },
    {
      ...
      explanations: {
        a: 'Ribose is a component of ribonucleic acids (RNA).',
        b: 'Deoxyribose is the DNA sugar, the partner pentose in this pair.',
        c: 'Ribulose is a ketopentose from the carbonyl classification section, not the pentose assigned to RNA.',
        d: 'Erythrose is an aldotetrose (4 carbons), not the pentose assigned to RNA.',
      },
    },
    ...
    // --- monosaccharide-derivative-types ---
    {
      ...
      difficulty: 'Moderate',
      questionType: 'Structure and function',
      learningObjective: 'State that glucose is oxidised to glucuronic acid, its named sugar-acid derivative.',
      explanations: {
        ...
        d: 'Glucose is oxidised to form glucuronic acid, its sugar-acid derivative.',
      },
    },
    {
      ...
      explanations: {
        a: 'Sorbitol is glucose and fructose alcohol.',
        b: 'Inositol is not named among the sugar alcohols at all.',
        c: 'Dulcitol is galactose alcohol, not glucose\'s.',
        d: 'Mannitol is mannose alcohol, not glucose\'s.',
      },
    },
    {
      ...
      explanations: {
        ...
        d: 'Sugar alcohols are sugars in which the carbonyl group is reduced to an alcohol group.',
      },
    },
    {
      ...
      explanations: {
        a: 'Sorbitol is the sugar-alcohol derivative of glucose and fructose, listed under Monosaccharide Derivatives.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Sorbitol is the alcohol of glucose (and fructose).',
        b: 'Mannitol is the reduction product of mannose, not glucose.',
        c: 'Dulcitol is the reduction product of galactose, not glucose.',
        d: 'Ribitol is the reduction product of ribose, not glucose.',
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Classification',
      learningObjective: 'Classify glycerol as a sugar alcohol, under Monosaccharide Derivatives.',
      explanations: {
        ...
        c: 'Glycerol is listed first among the sugar alcohols: the alcohol of glyceraldehyde or dihydroxyacetone, and a component of triacylglycerol and most phospholipids.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Glucose\'s sugar alcohol is sorbitol.',
        b: 'Mannose\'s sugar alcohol is mannitol — not dulcitol.',
        c: 'Dulcitol is galactose alcohol.',
        d: 'Fructose is not named with its own separate sugar alcohol; sorbitol is described as the alcohol of both glucose and fructose.',
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Classification',
      learningObjective: 'Recognise sorbitol and dulcitol as members of the sugar-alcohol group.',
      explanations: {
        ...
        b: 'Both are named in the Sugar Alcohols section: sorbitol as the alcohol of glucose/fructose, dulcitol as the alcohol of galactose.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Amino sugars are sugars in which the hydroxyl group at C2 is replaced by an amino group (NH2).',
        c: 'C3 is not the substitution site for amino sugars — it is also not the site for deoxy sugars, which use C2 as well.',
        d: 'C4 is not a substitution site for any of the monosaccharide derivative classes here.',
      },
    },
    {
      ...
      difficulty: 'Moderate',
      questionType: 'Classification',
      learningObjective: 'Classify nucleosides as glycosides.',
      explanations: {
        ...
        d: 'Nucleosides are glycosides formed of ribose or deoxyribose connected to a nitrogenous base (aglycon), and are found in nucleic acids.',
      },
    },
    ...
    // --- mannitol-clinical-applications (reused existing concept) ---
    {
      ...
      explanations: {
        a: 'Mannitol is the sugar alcohol of mannose, formed by reducing mannose\'s carbonyl group to an alcohol group.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: 'Mannitol is mannose\'s sugar alcohol — mannose reduced at its carbonyl carbon.',
    ...
    // --- disaccharide-composition-linkage-and-reducing-property ---
    {
      ...
      explanations: {
        a: 'Neither galactose nor mannose is a component of sucrose; sucrose is built from fructose and glucose.',
        b: 'Sucrose is formed of fructose and glucose united by a glycosidic linkage, so hydrolysis returns those two monosaccharides.',
        c: 'Glucose and galactose are the hydrolysis products of lactose, not sucrose.',
        d: 'Mannose is not a component of any disaccharide named in this chapter.',
      },
    },
    {
      ...
      explanations: {
        a: 'Maltose is formed of two molecules of glucose united by a 1,4-glucosidic linkage.',
        b: 'Sucrose\'s linkage is alpha1,2-glucosidic (beta2,1-fructosidic), not 1,4-glucosidic.',
        c: 'Isomaltose appears only as a distractor sugar elsewhere; the 1,4-glucosidic linkage belongs to maltose, its structural relative, not to isomaltose.',
        d: 'Lactose\'s linkage is beta1,4-galactosidic — a galactosidic bond, not a glucosidic one.',
      },
    },
    {
      ...
      explanations: {
        a: 'Lactose hydrolyses to glucose and galactose — no fructose.',
        b: 'Cellulose is a homopolysaccharide of glucose units only; hydrolysis yields glucose, not fructose.',
        c: 'Sucrose is formed of fructose and glucose, so its hydrolysis yields fructose (along with glucose).',
    ...
    },
    {
      ...
      difficulty: 'Moderate',
      questionType: 'Structure and function',
      learningObjective: 'Identify sucrose as the non-reducing disaccharide.',
      explanations: {
        a: 'Isomaltose is not discussed as an exception to the reducing pattern; only sucrose is singled out as non-reducing.',
        b: 'Lactose is grouped with maltose as having a free carbonyl group, making it a reducing sugar.',
        c: 'In sucrose both carbonyl carbons are involved in the linkage, so it is non-reducing.',
        d: 'Maltose is reducing, alongside lactose, because it retains a free carbonyl group.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Isomaltose is not built from fructose; its structural relative maltose is two glucose units.',
        c: 'Sucrose is fructose plus glucose, so hydrolysis returns both.',
        d: 'Maltose hydrolyses to two glucose units only — no fructose.',
      },
    },
    {
      ...
      explanations: {
        a: 'Maltose hydrolyses to two glucose units only — no galactose.',
        b: 'Isomaltose, like maltose, is a glucose-based sugar, not a source of galactose.',
        c: 'Sucrose hydrolyses to glucose and fructose — no galactose.',
        d: 'Lactose is hydrolyzed into glucose and galactose.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Maltose is hydrolyzed into two molecules of D-glucose — glucose units only.',
        c: 'Lactose hydrolyses to glucose and galactose, not glucose alone.',
        d: 'Dextrin is not discussed in the disaccharide section at all; it is not one of the three named disaccharides.',
      },
    },
    {
      ...
      explanations: {
        a: '"Malt sugar" is the nickname for maltose, not lactose — lactose is "milk sugar."',
        b: 'Lactose is hydrolyzed by lactase enzyme or by acids into glucose and galactose.',
        c: 'The chemical hydrolysing agent is acids, not alkali, alongside the enzyme lactase.',
        d: 'Lactose\'s linkage is beta1,4-galactosidic, neither a 1,6 linkage nor a glucosidic one.',
      },
    },
    {
      ...
      explanations: {
        ...
        c: 'Lactose is galactose and glucose united by a beta1,4-galactosidic linkage.',
        d: 'Sucrose\'s linkage is alpha1,2-glucosidic (beta2,1-fructosidic), not a 1,4-galactosidic bond.',
      },
    },
    {
      ...
      explanations: {
        a: 'Maltose is the main product of digestion of starch by amylase.',
    ...
    // --- carbohydrate-classification-by-hydrolysis-unit-count ---
    {
      ...
      difficulty: 'Easy',
      questionType: 'Definition',
      learningObjective: 'State the unit-count boundary for oligosaccharides: 3 to 10 units.',
      explanations: {
        a: 'Oligosaccharides consist of 3 to 10 monosaccharide units per molecule.',
        b: '"More than 10 units" is the definition of a polysaccharide, not an oligosaccharide.',
        c: 'Shifts the lower bound from 3 to 5, narrowing the range actually given.',
        d: '"2 units" is the definition of a disaccharide, not an oligosaccharide.',
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Classification',
      learningObjective: 'Identify inulin as a fructan (fructose polymer).',
      explanations: {
        a: 'Starch is a glucan — a polymer of glucose, per the Glucans list.',
        b: 'Dextrin is not discussed in the homopolysaccharide classification.',
        c: 'Inulin is a fructan, formed of fructose units, present in plants.',
        d: 'Cellulose is a glucan — a polymer of glucose, per the Glucans list, alongside starch and glycogen.',
      },
    },
    {
      ...
      explanations: {
        a: 'Glucose is the building unit of the glucans (starch, glycogen, cellulose), not of inulin.',
        b: 'Inulin is classed as a fructan, formed of fructose units.',
        c: 'Mannose is not named as a homopolysaccharide building unit anywhere in this classification.',
        d: 'Galactose is not named as a homopolysaccharide building unit anywhere in this classification.',
      },
    },
    ...
    // --- starch-and-glycogen-as-storage-polysaccharides ---
    {
      ...
      explanations: {
        a: 'Starch is the chief storage form of carbohydrates in chlorophyll-containing plants.',
        b: 'Glycogen is the storage form in animals, not plants.',
        c: 'Dextrin is not discussed in the storage-polysaccharide section.',
        d: 'Cellulose is the plant cell wall\'s structural polysaccharide — a building material, not the storage form.',
      },
    },
    {
      ...
      explanations: {
        a: 'Starch is listed among the Glucans — homopolysaccharides built entirely of glucose units.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Fructose is the building unit of fructans (e.g. inulin) — not of starch or glycogen.',
        b: 'Both starch and glycogen are listed among the Glucans, polymers of glucose.',
        c: 'Mannose is not named as the building unit of any polysaccharide here.',
        d: 'Galactose is not named as the building unit of any polysaccharide here; it appears instead as a monosaccharide component of lactose.',
      },
    },
    {
      ...
      explanations: {
        a: 'Starch is the plant storage form, not the animal one.',
        b: 'Glycogen is the storage form of carbohydrates in animals.',
        c: 'Glucose is the monosaccharide that glycogen is built from and stores, not the storage form itself.',
        d: 'Inulin is a plant fructan, unrelated to animal carbohydrate storage.',
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Definition',
      learningObjective: 'Recall "animal starch" as the alternate name for glycogen.',
      explanations: {
        a: 'Glycogen is the storage form of carbohydrates in animals (animal starch).',
        b: '"Starch" itself is the plant storage form the nickname is being compared against, not the answer to what animals use.',
        c: 'Inulin is a plant fructan, unrelated to the animal-starch nickname.',
        d: 'Dextrin is not discussed in the storage-polysaccharide section.',
      },
    },
    {
      ...
      explanations: {
        a: 'Glycogen is present in most cells but especially in skeletal muscles and liver, as stores of excess glucose.',
        b: 'The brain is not named among glycogen\'s main storage sites.',
        c: 'The spleen is not named among glycogen\'s main storage sites.',
        d: 'The kidney is not named among glycogen\'s main storage sites.',
      },
    },
    ...
    // --- heteropolysaccharide-and-gag-classification ---
    {
      ...
      explanations: {
        a: 'Inulin is a fructan — a homopolysaccharide built of one monosaccharide type (fructose), per the Glucans/Fructans classification.',
        b: 'Cellulose is a glucan — a homopolysaccharide built of glucose units only.',
        c: 'Heparin is one of the sulfate-containing glycosaminoglycans — heteropolysaccharides built of repeating amino-sugar/uronic-acid disaccharide units.',
        d: 'Dextrin is not classified anywhere in this chapter, so its status as homo- or heteropolysaccharide cannot be settled from this text; it is a distractor rather than a taught example.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Hyaluronic acid is the sulfate-free GAG — a heteropolysaccharide built of repeating amino-sugar/uronic-acid units.',
        c: 'Cellulose is a glucan, a homopolysaccharide, per the Glucans list.',
        d: 'Glycogen is a glucan, a homopolysaccharide, per the Glucans list.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Cellulose is a glucan, a homopolysaccharide built of glucose units only.',
        c: 'Keratan sulfate is one of the sulfate-containing glycosaminoglycans, heteropolysaccharides built of repeating disaccharide units.',
        d: 'Dextrin is not classified anywhere in this chapter; it is a distractor rather than a taught example.',
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Classification',
      learningObjective: 'Identify hyaluronic acid as the one sulfate-free GAG.',
      explanations: {
        a: 'Heparin is listed among the sulfate-containing GAGs, not the sulfate-free group.',
        b: 'GAGs classify into sulfate-free glycosaminoglycans — hyaluronic acid is the only member of that group.',
        c: 'Inulin is not a GAG at all — it is a fructan homopolysaccharide, built of one monosaccharide type.',
        d: 'Dextrin is not classified as a GAG or discussed in this chapter at all.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Heparin is one of the sulfate-containing glycosaminoglycans.',
    ...
    // --- specific-gag-biomedical-functions ---
    {
      ...
      explanations: {
        ...
        b: 'Anticoagulant activity describes heparin (and, to a lesser extent, dermatan sulfate) — a different, easily confused GAG name.',
        c: 'Heparan sulfate is associated mainly with the plasma membrane of cells and plays an important role in cell membrane receptors and cell-cell interaction.',
        d: 'Corneal transparency describes keratan sulfate, not heparan sulfate.',
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Structure and function',
      learningObjective: 'Name heparin as the anticoagulant GAG.',
      explanations: {
        a: 'Heparin proteoglycan is an important anticoagulant, preventing thrombus formation.',
        b: 'Keratan sulfate\'s role is corneal transparency and development, not anticoagulation.',
        c: 'Cellulose is a structural plant homopolysaccharide, unrelated to blood clotting.',
        d: 'Heparan sulfate\'s role is cell membrane receptors and cell-cell interaction — a name easily confused with heparin, but a different job.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Anticoagulant activity describes heparin, not keratan sulfate.',
        c: 'Cell-cell interaction describes heparan sulfate, a different, easily confused GAG name.',
        d: 'Keratan sulfate is one of the major components of the cornea and is thought to have important roles in corneal development and maintenance of its transparency.',
      },
    },
    {
      ...
      difficulty: 'Moderate',
      questionType: 'Structure and function',
      learningObjective: 'Name hyaluronic acid as the GAG found in embryonic tissues.',
      explanations: {
        a: 'Hyaluronic acid is also found in skin, synovial fluid of joints, umbilical cord, the vitreous body of the eye, and embryonic tissues.',
        b: 'Keratan sulfate\'s named location is the cornea — not embryonic tissue.',
        c: 'Heparan sulfate\'s named location is the plasma membrane of cells — not embryonic tissue.',
        d: 'Heparin\'s named role is anticoagulation — its location is not described in terms of embryonic tissue.',
      },
    },
