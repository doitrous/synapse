...
export const LEAF: McqLeafSeed = {
  ...
  concepts: [
    ...
    },
    {
      ...
      pitfall: 'Reversing which form of iron is better absorbed — ferrous iron (Fe2+) is the absorbable form, and that gastric HCl and vitamin C exist specifically to reduce ferric iron (Fe3+) down to it, not the other way round.',
      subject: 'haem',
      primary: 'DIS-PHY-T02',
      secondary: [],
      modulePath: '102 INT > Physiology > Blood > Iron',
    ...
    },
    {
      ...
      definition: 'Deficiency of iron in the diet is one of the three named causes of iron-deficiency anaemia, due to a lower iron intake than the body needs; it is more common in growing children and during pregnancy, when demand for iron rises.',
      objective: 'Name low dietary intake as a cause of iron-deficiency anaemia, and the two life stages flagged as most at risk.',
      pitfall: 'Treating "low intake" and "malabsorption" as one cause — separated them: low intake is simply not enough iron in the diet, while malabsorption is a normal-or-adequate diet the gut fails to take up (partial gastrectomy, vitamin C deficiency, phytate/oxalate/phosphate excess, small-bowel disease).',
      subject: 'haem',
      primary: 'DIS-PHY-T02',
      secondary: [],
  ...
  questions: [
    {
      ...
      explanations: {
        ...
        c: 'Haemoglobin forms oxyhaemoglobin with oxygen, not carbon monoxide — carbon monoxide instead forms carboxyhaemoglobin, a different reaction named separately.',
        d: 'The globin (polypeptide) part of haemoglobin forms carbamino compounds with carbon dioxide — carbaminohaemoglobin — distinct from the iron-based reactions with oxygen, carbon monoxide and oxidising agents.',
      },
    },
    {
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Iron exported from enterocytes (or released from macrophage recycling of old RBCs) is oxidised to the ferric form and carried in the blood bound to the plasma transport protein transferrin.',
        ...
        d: 'Ferritin, the iron-storage protein, is concentrated mainly in the liver, spleen, intestinal enterocytes and bone marrow together — the bone marrow is not singled out as holding the greatest percentage.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Backwards. Iron absorption *increases* after acute blood loss, as the body tries to replenish lost iron — blood loss is not described as decreasing absorption.',
        ...
        d: 'Ascorbic acid (vitamin C) and other reducing substances help reduce ferric iron (Fe3+) to the absorbable ferrous form (Fe2+), assisted by gastric HCl.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Gastric HCl helps dissolve dietary iron and, with ascorbic acid, reduce ferric iron to the absorbable ferrous form.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Iron-deficiency anaemia — microcytic and hypochromic because too little haemoglobin can be built — follows from decreased dietary iron intake, among the named causes.',
        c: 'Heart disease is not one of the causes of iron-deficiency anaemia; it does not appear in the diet/absorption/blood-loss list.',
    ...
    },
    {
      ...
      explanations: {
        a: 'True, so not the exception. Antacids raise gastric pH, which works against the acid-catalysed reduction of ferric to ferrous iron described, so they do reduce absorption.',
        b: 'True, so not the exception. Plainly that heme iron (10% of dietary iron, from meat) is more absorbable than non-heme iron (90%, from plant sources).',
        c: 'True, so not the exception. Ferrous iron (Fe2+) is the form DMT1 transports; ferric iron (Fe3+) must first be reduced, which is why called ferrous the better-absorbed form.',
        d: 'The exception, and the answer. The duodenum is where most iron absorption happens, not the terminal ileum — which is instead the site of vitamin B12 absorption, a distinct chapter\'s mechanism entirely.',
      },
    },
    {
      ...
      explanations: {
        ...
        d: 'Transferrin is the plasma protein that binds ferric iron exported from enterocytes or macrophages and delivers it to cells with transferrin receptors — bone marrow, liver and muscle.',
      },
    },
    {
      ...
      explanations: {
        a: 'A healthy stomach secretes HCl, which dissolves dietary iron and — with vitamin C — reduces ferric iron to the ferrous form that DMT1 can transport, so achlorhydria (decreased HCl secretion) is associated with iron deficiency.',
        ...
        c: 'Pepsin secretion digests dietary protein; it is not connected to iron absorption.',
