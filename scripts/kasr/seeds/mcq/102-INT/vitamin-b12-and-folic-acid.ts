  ...
  questions: [
    {
      ...
      explanations: {
        ...
        c: 'Pernicious anaemia follows immune destruction of the parietal cells, which removes both their intrinsic-factor secretion (so vitamin B12 cannot be absorbed) and their gastric HCl secretion together, since the same cells make both.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Backwards. Vitamin B12 stimulates nuclear maturation by enabling DNA synthesis, not by inhibiting a nucleotide precursor — the vitamin is needed *for* DNA synthesis, the opposite direction from "inhibition".',
        ...
        d: 'Pancreatic trypsin is required for vitamin B12 absorption, so pancreatic-deficiency disease can impair absorption independently of intrinsic factor and gastric HCl.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Both vitamin B12 and folic acid are essential for DNA synthesis, which the marrow\'s dividing cells need for nuclear maturation and division.',
    ...
    },
    {
      ...
      explanations: {
        ...
        d: 'Vitamin B12 or folic acid deficiency both block DNA synthesis, failing nuclear maturation and division and leaving bigger, irregular, fragile RBCs — the macrocytic (megaloblastic) picture.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'There is no vitamin B2-dependent step in coagulation-factor synthesis; this option names an unrelated vitamin.',
        ...
        d: 'Vitamin K is fat-soluble and needs bile for its absorption; common bile duct obstruction removes that bile, causing vitamin K deficiency, decreased hepatic synthesis of factors II, VII, IX, X (and proteins C, S), and a bleeding tendency.',
      },
    },
    {
      ...
      explanations: {
        a: 'An MCV of 75 μ3 is below the normal range (< 80 μ3), which is defined as microcytic — the classification given specifically to iron-deficiency anaemia.',
        ...
        d: 'G-6PD deficiency causes a haemolytic anaemia, which is classified as normocytic normochromic — the cells are the normal size, just fewer of them, which does not match a low MCV.',
      },
    },
    {
      ...
      explanations: {
        ...
        d: 'The exception. Vitamin B12 deficiency blocks DNA synthesis and gives a macrocytic anaemia; it does not touch the coagulation factors or platelets, so it is not accompanied by a bleeding tendency the way the other three conditions are.',
      },
    },
  ],
}
