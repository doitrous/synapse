  ...
  concepts: [
    {
      ...
      pitfall: 'Assuming vagal (parasympathetic) stimulation slows the whole heart — it acts only on atrial muscle; the vagus does not supply the ventricles at all.',
      subject: 'neuro',
      primary: 'DIS-PHY-T07',
      secondary: [],
      modulePath: '102 INT > Physiology > Autonomic nervous system > Parasympathetic nervous system',
  ...
  questions: [
    {
      ...
      explanations: {
        ...
        c: 'Oculomotor (III) parasympathetic stimulation contracts the ciliary muscle, increasing lens power and preparing the eye for near vision — alongside constricting the pupil.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: 'Vagal stimulation decreases coronary blood flow and the heart\'s oxygen consumption, alongside slowing the atria.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: 'Parasympathetic (oculomotor) stimulation contracts the ciliary muscle, increasing the lens\'s power and helping the eye focus for near vision.',
    ...
    },
    {
      ...
      explanations: {
        a: 'The exception. Vagal (parasympathetic) stimulation slows, not increases, atrial activity — accelerating the heart is a sympathetic effect, the opposite of what the vagus does.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'The exception. Parasympathetic stimulation causes bronchoconstriction, the opposite of bronchodilation, which is instead a sympathetic effect on the lungs.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'The exception. The vagus does not supply the ventricles — the one chamber of the heart parasympathetic fibres do not reach.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Parasympathetic stimulation contracts intestinal smooth muscle and relaxes its sphincters, while sympathetic stimulation relaxes the muscle and contracts the sphincters — a directly opposite pairing on the same tissue.',
        ...
        d: 'Sweat glands are supplied by sympathetic (cholinergic) fibres, not parasympathetic ones — sweating is not a parasympathetic effect.',
      },
    },
    {
      ...
      explanations: {
        a: 'Backwards. Vagal stimulation *reduces* the force of ventricular contraction — but the vagus does not supply the ventricles at all, so this specific claim about ventricular force is itself unsupported, not merely a wrong-direction error.',
        ...
        d: 'Vagal stimulation evacuates the gall bladder — contraction of its wall together with relaxation of the sphincter of Oddi.',
      },
    },
    {
      ...
      explanations: {
        a: 'Cranial nerves III (oculomotor, Edinger-Westphal nucleus), VII (facial, superior salivary nucleus), IX (glossopharyngeal, inferior salivary nucleus) and X (vagus, vagal nucleus) are the four carrying preganglionic parasympathetic fibres.',
        ...
        c: 'This option keeps VII and IX correctly but drops III (oculomotor) in favour of VI, which is never a parasympathetic carrier.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: 'Parasympathetic pelvic stimulation contracts the bladder wall and relaxes the internal urethral sphincter, producing micturition.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Backwards. Parasympathetic action on the salivary glands is secretomotor *and vasodilator*, not vasoconstrictor — vasoconstriction paired with secretion is closer to a mixed pattern not seen in this division.',
        b: 'The facial and glossopharyngeal nerves\' parasympathetic function on the salivary glands is secretomotor and vasodilator — vasodilation accompanies the (large, watery) secretion they produce.',
        c: 'Backwards. Parasympathetic stimulation *causes* secretion, it does not inhibit it — inhibition of secretion is not a pattern seen in either division.',
    ...
    },
    {
      ...
      explanations: {
        ...
        d: 'Oculomotor parasympathetic stimulation contracts the ciliary muscle, increasing the lens\'s refractive power and preparing the eye for near vision, alongside constricting the pupil.',
      },
    },
    {
      ...
      explanations: {
        a: 'The facial nerve (cranial nerve VII) carries preganglionic parasympathetic fibres from the superior salivary nucleus, relaying in the sphenopalatine and submandibular ganglia to the lacrimal, nasal, submandibular and sublingual glands.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'As the best available answer among these four: the sympathetic nervous system is thoracolumbar, originating from the lateral horn cells of all thoracic segments *and* the upper two lumbar segments — of the four options offered, only "lumbar segments" names any part of that true origin; the other three (cranial nerves, sacral segments, cervical segments) are parasympathetic or unrelated locations.',
        c: 'Sacral segments (S2–S4) are the origin of the *parasympathetic* pelvic outflow, not the sympathetic system, which is thoracolumbar.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Cranial nerve III (oculomotor) carries preganglionic parasympathetic fibres from the Edinger-Westphal nucleus, relaying in the ciliary ganglion.',
