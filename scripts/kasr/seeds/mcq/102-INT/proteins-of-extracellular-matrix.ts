  ...
  questions: [
    {
      ...
      explanations: {
        a: 'Correct by the book\'s own description of collagen\'s amino acid composition: each α-chain\'s repeating Gly-X-Y triplet places glycine at every third position across roughly 1000 residues, making collagen distinctively glycine-rich.',
        b: 'Hemoglobin\'s globin chains are not described by the book in terms of glycine content; nothing in this chapter\'s text supports singling it out as glycine-rich.',
        c: 'Keratin appears in the book only as a named example of a fibrous protein and, elsewhere, of a protein with disulfide-bonded cysteines; its glycine content is not stated.',
        d: 'Fibronectin is named only once in this chapter\'s text, in a list of extracellular-matrix fibrous proteins, with no composition detail given — the book gives no basis for calling it glycine-rich.',
      },
      answerOverride: 'a',
    ...
    },
    {
      ...
      explanations: {
        a: 'Reads as "1" (garbled by OCR to "|"); a single chain could not form the triple helix the book describes as tropocollagen\'s building unit.',
        b: 'Two chains would not match the book\'s description of tropocollagen; it explicitly names three left-handed α-chains twisting together.',
        c: 'Correct. The book states tropocollagen consists of three coiled α-chains, each a left-handed helix, tightly twisted together into a right-handed superhelix.',
        d: 'Four chains overshoots the book\'s count; tropocollagen is built from three α-chains, not four.',
      },
    },
    {
      ...
      explanations: {
        a: 'Correct. The book states each turn of the collagen helix contains 3 amino acid residues, making a tighter helix than normal proteins, which have 3.6 residues per turn.',
        b: '4 residues per turn is not the figure the book gives for collagen; it states 3.',
        c: '3.6 is the book\'s own figure for normal proteins\' helix, given specifically as the contrast to collagen\'s tighter, 3-residue turn — not collagen\'s own value.',
        d: '4.6 does not match either figure the book gives — neither collagen\'s 3 residues per turn nor the ordinary protein\'s 3.6.',
      },
    },
    {
      ...
      explanations: {
        a: 'Serine is not named in the book\'s Gly-X-Y triplet at all; this option likely reflects an OCR misread of the printed key rather than a book-supported answer.',
        b: 'Proline is the book\'s X position in the Gly-X-Y triplet, not the third (repeating-Gly) position — it sits at the second position of each triplet, not the third.',
        c: 'Lysine only appears in the book as an occasional substitute for the X position (normally proline); it is not the residue occupying every third position.',
        d: 'Correct. The book states the repeating triplet is Gly-X-Y, where Gly is glycine, present in every third position of the chain.',
      },
      answerOverride: 'd',
      answerOverrideReason:
    ...
    },
    {
      ...
      explanations: {
        a: 'Correct. The book states that hydroxylation of some proline and some lysine residues, during collagen synthesis in the RER, is carried out by hydroxylase enzymes that require vitamin C as a cofactor.',
        b: 'Vitamin A is not named anywhere in this chapter\'s account of collagen synthesis.',
        c: 'Vitamin D is named elsewhere in the book only in connection with osteocalcin synthesis (induced by calcitriol), not with proline hydroxylation.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Unmodified lysine is not the attachment site the book names; lysine must first be hydroxylated to hydroxylysine before the sugars are attached.',
        b: 'Proline occupies the X position of the triplet and is not described as carrying attached sugars; hydroxylation and glycosylation in the book\'s account happen to lysine residues, not proline.',
        c: 'Correct. The book states glucose and galactose molecules are attached to hydroxylysine residues, which is why collagen is considered a glycoprotein.',
        d: 'Hydroxyproline is the hydroxylated form of proline (the Y position of the triplet); the book attaches the sugars to hydroxylysine, not hydroxyproline.',
      },
    },
    {
    ...
    },
    {
      ...
      explanations: {
        a: 'The book states elastin is a non-glycoprotein, unlike collagen, which is a glycoprotein because of its sugar-bearing hydroxylysine residues — this is a difference, not a similarity.',
        b: 'The book describes tropocollagen as three chains forming a triple helix, but tropoelastin as a monomer — a single polypeptide chain, not a helix of several chains — so this is also a difference, not a shared feature.',
        c: 'Correct. The book states tropoelastin contains little hydroxyproline (less than collagen\'s Y-position hydroxyproline content, but present nonetheless), so both proteins carry hydroxyproline residues, even though the amounts differ.',
        d: 'The book explicitly states elastin has no hydroxylysine at all, while collagen\'s hydroxylysine is what carries its attached sugars — a clear difference, not a similarity.',
      },
    },
    {
    ...
    },
    {
      ...
      explanations: {
        a: 'Vitamin A is not named in the book\'s account of bone protein carboxylation.',
        b: 'Vitamin C is the book\'s cofactor for collagen\'s proline/lysine hydroxylation, a different reaction from the glutamate carboxylation this question asks about.',
        c: 'Vitamin D (as calcitriol) is named by the book as what induces osteocalcin\'s synthesis, not as the cofactor for the carboxylation reaction itself — that is vitamin K.',
        d: 'Correct. The book states osteocalcin\'s glutamate residues are γ-carboxylated by a vitamin K-dependent enzyme, to γ-carboxyglutamate that binds hydroxyapatite.',
      },
    },
    {
      ...
      explanations: {
        a: 'Correct. The book states Type I collagen forms 90% of bone proteins, made of two α1 chains and one α2 chain.',
        b: 'Garbled by OCR to "Type Il"; read as Type II, this is the collagen type the book assigns to cartilage, not bone — bone\'s dominant type is Type I.',
        c: 'Also garbled to "Type Il", identically to option b; whichever numeral was intended, it is not Type I, the type the book states forms 90% of bone protein.',
        d: 'Type IV is named by the book only as a minor form present in bone, not the mainly-present type — bone\'s dominant collagen is Type I.',
      },
    },
    {
      ...
      explanations: {
        a: 'Garbled OCR for "Type I" ("Typel"); Type I is the book\'s dominant collagen for bone, not cartilage — cartilage\'s dominant type is Type II.',
        b: 'Correct. The book states Type II collagen forms 90–98% of the total collagen present in cartilage, made of three identical α1 chains.',
        c: 'Garbled OCR for "Type III" ("Type Ill"); the book names type III only as one of several minor collagen types, without singling it out for cartilage.',
        d: 'Type IV is not named by the book as cartilage\'s dominant collagen; the book gives Type II that role.',
      },
    },
  ],
}
