...
export const LEAF: McqLeafSeed = {
  ...
  questions: [
    ...
    // --- pass 1 additions (2026-08-27) ---
    {
      ...
      explanations: {
        a: '1 hydrogen bond is too few for either base pair the book describes; even the weaker A-T pair has two.',
        ...
        c: 'Correct. The book states guanine pairs with cytosine through three hydrogen bonds, one more than the two of adenine-thymine — which is also why G-C-rich DNA is more thermally stable.',
        d: '4 hydrogen bonds is not a count the book gives for either base pair; neither G-C (three) nor A-T (two) reaches four.',
      },
    },
    {
      ...
      explanations: {
        a: 'Correct. Watson and Crick\'s double helix has its two strands running antiparallel — one 5\' to 3\', the other 3\' to 5\' in the same physical direction — while they pair to each other and coil around a common axis.',
        b: 'Parallel strands, running in the same 5\'-to-3\' direction as each other, is not the arrangement the book describes for the double helix.',
        ...
        d: '"Horizontal" is not an orientation relationship between two strands at all, and does not describe the antiparallel arrangement the book states.',
      },
    },
    {
      ...
      explanations: {
        ...
        c: 'Correct. Because A pairs only with T and G only with C, %A = %T = 30% each, using 60% of the double strand; the remaining 40% is shared equally between G and C, so %G = 20%.',
