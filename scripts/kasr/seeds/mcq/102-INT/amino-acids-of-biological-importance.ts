...
export const LEAF: McqLeafSeed = {
  ...
  questions: [
    ...
    // --- pass 1 additions (2026-08-27): reuse amino-acid-chemical-and-nutritional-classification ---
    {
      ...
      explanations: {
        a: 'Glycine\'s side chain is a single hydrogen atom, with no ionisable amino or carboxyl group — the concept names it as the smallest neutral aliphatic amino acid for exactly that reason.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: 'Two cysteine molecules linked through their thiol (-SH) groups by an oxidative disulfide bond form cystine, the disulfide-linked dimer the concept names.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Arginine is half-essential: the body can synthesise it, but not always in amounts sufficient for the high demands of growth, so diet must supplement it at those times.',
    ...
    },
    {
      ...
      explanations: {
        ...
        d: 'Tyrosine is non-essential: the body synthesises it from the essential amino acid phenylalanine, so as long as dietary phenylalanine is adequate, tyrosine itself need not be supplied directly.',
      },
    },
  ],
}
