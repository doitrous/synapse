  ...
  questions: [
    {
      ...
      explanations: {
        a: 'Correct. The book lists epigenetic mechanisms as the first item under Pre-transcriptional regulation, alongside the amount of DNA and gene rearrangements.',
        b: 'mRNA stability relates to post-transcriptional features such as the poly(A) tail, not to pre-transcriptional regulation.',
        c: "Trimming is listed under Post-translational regulation in the book's own diagram, not pre-transcriptional.",
        d: "Covalent modification is listed under Post-translational regulation in the book's own diagram, not pre-transcriptional.",
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Classification',
      learningObjective: 'Recognise DNA methylation and histone acetylation as the book’s two epigenetic mechanisms.',
      answerOverride: 'c',
      answerOverrideReason:
      ...
      explanations: {
        ...
        b: 'Chromosomal rearrangements are large-scale structural changes to chromosomes; the book discusses methylation and acetylation under epigenetic mechanisms, a different category.',
        c: "Correct. The book's Epigenetic Mechanisms section is built around exactly these two examples: DNA methylation and chromatin remodeling by histone acetylation.",
        d: 'Translocation is a type of chromosomal rearrangement, not what the book calls DNA methylation or histone acetylation.',
      },
    },
    {
      ...
      explanations: {
        a: "The book states 'Demethylation reverses the process' — methylation is reversible, not irreversible.",
        b: 'The book places the target cytosine next to a guanine (forming a CpG island); the base that gets methylated is cytosine, not guanine.',
        c: "Correct. The book states that DNA methylation 'is associated with the silencing of the activities of certain genes.'",
        d: 'The book names DNA methyltransferase as the enzyme that methylates cytosine; DNA ligase, which joins DNA fragments, plays no part in this reaction.',
      },
    },
    {
      ...
      explanations: {
        a: 'Gene rearrangement recombines existing gene segments (as in immunoglobulin genes); the book credits methotrexate resistance to more copies of the DHFR gene, not to a rearrangement.',
        b: "DNA methylation is an epigenetic, gene-silencing mechanism; the book's methotrexate-resistance example is about increasing gene copy number, not methylating it.",
        c: 'Correct. The book states that malignant cells can develop resistance to methotrexate — a DHFR inhibitor — by amplifying the gene for this enzyme.',
        d: 'Gene diminution is a decrease in gene copies, the book’s example being genes disappearing during red blood cell maturation; methotrexate resistance works the opposite way, by increasing copies.',
      },
    },
    {
      ...
      explanations: {
        a: "Correct. The book states that the heavy and light chains of immunoglobulins are encoded by several hundred gene segments, and their rearrangement generates several million different immunoglobulins.",
        b: 'DNA methylation silences gene activity; it is not the mechanism the book credits with generating antibody diversity.',
        c: 'Gene amplification increases the number of copies of one gene (the book’s example is the DHFR gene under methotrexate); it does not recombine different gene segments the way immunoglobulin diversity requires.',
    ...
    },
    {
      ...
      explanations: {
        a: "The book never labels enhancers as transcription factors themselves, nor promoter-proximal elements as DNA sequences specifically, so this contrast can't be confirmed from the assigned pages.",
        b: 'The book states enhancers facilitate (not inhibit) initiation of transcription, but it never discusses "promoter proximal elements" as a category at all, so this option can’t be confirmed either way.',
        c: "This option is closest to what the book says about enhancers acting close to or thousands of base pairs from the promoter, but the book never introduces 'promoter proximal elements' as a term, so a student has no book-based way to confirm this is the primary difference.",
        d: 'The book describes both enhancers and silencers as DNA sequences, not proteins, but it never discusses "promoter proximal elements" at all, so this contrast can’t be confirmed.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'The CAAT box and GC box, not the TATA box, control how frequently transcription starts (its frequency); the book assigns the TATA box the job of fixing where it starts.',
        c: 'The book places the CAAT box and GC box 40-200 bp upstream; the TATA box itself is placed 20-30 bp upstream, a different location.',
        d: 'Correct. The book states that the TATA box defines where transcription is to start along the DNA.',
      },
    },
    {
      ...
      explanations: {
        ...
        c: 'Correct. The book states that alternative splicing explains why the estimated number of proteins much exceeds the number of genes, since one primary transcript can be spliced differently to yield different proteins.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Epigenetic mechanisms are listed under Pre-transcriptional regulation in the book, not post-transcriptional.',
        b: "Correct. The book's Post-transcriptional regulation section lists capping, poly-A tailing, splicing and miRNA.",
        c: 'Trimming is listed under Post-translational regulation in the book, not post-transcriptional.',
    ...
    },
    {
      ...
      explanations: {
        a: "The book describes no replacement of 'UU with CCA' anywhere in its account of mRNA processing; this option does not match any book-taught step.",
        b: 'The book describes addition, not removal, of the poly(A) tail as the polyadenylation step; this option reverses it.',
        c: 'The book never describes a "leader sequence" being removed as part of mRNA processing; this is not one of its listed steps.',
        d: "Correct. The book's Post-transcriptional regulation list includes splicing, and alternative splicing is the book's own extension of splicing to yield multiple proteins from one gene's transcript.",
      },
    },
    {
      ...
      explanations: {
        a: 'The book states miRNAs reduce expression of their target mRNA, by degrading it or blocking its translation — the opposite of initiating translation.',
        ...
        c: 'Correct. The book states that miRNAs are non-coding RNAs that reduce expression of the target mRNA, either by inducing its degradation or blocking its translation.',
    ...
    },
    {
      ...
      explanations: {
        a: "The book never states that IF-4 prevents formation of the preinitiation complex; on the contrary, IF-4 facilitates the initiation steps that build it.",
        b: 'The book states that the protein kinases that phosphorylate "some IFs" are activated under stress — it does not say that IF-4 itself is "activated" under stress; being phosphorylated is not the same as being activated, and the book does not name IF-4 specifically in this passage.',
        c: 'The book never describes IF-4 interacting with the poly(A) tail; that role belongs to poly(A) tail-binding proteins, a different set of factors.',
        d: 'This is the printed key\'s apparent intent, but it contradicts the book\'s own Protein Synthesis chapter, where IF-4\'s stated role is to facilitate initiation (bind the cap, bring mRNA to the 40S subunit) — blocking protein synthesis is not what the book says IF-4 itself does.',
      },
    },
    {
      ...
      explanations: {
        a: "Transcriptional modification is not a category the book applies to trimming; trimming acts on a finished protein chain, not on transcription.",
        ...
        d: "Correct. The book lists trimming under Post-Translational Modification of Proteins (discussed in Translation), alongside covalent modification.",
      },
    },
    {
      ...
      explanations: {
        a: 'Correct. Carboxylation, forming γ-carboxyglutamate so clotting proteins can bind calcium, is one of the book’s covalent post-translational modifications.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Correct. The book states that phosphorylation and dephosphorylation regulate the activity of many proteins, such as the enzymes of glycogen metabolism and regulators of gene transcription.',
        ...
        d: 'Deamination is not one of the book’s listed covalent protein modifications (phosphorylation, glycosylation, acetylation/methylation, hydroxylation, carboxylation); the book uses cytidine deamination only in the context of mRNA editing.',
      },
    },
  ],
}
