...
export const LEAF: McqLeafSeed = {
  ...
  concepts: [
    ...
    },
    {
      ...
      objective: "Explain that allosteric effectors act by binding a site distinct from the catalytic site and altering enzyme conformation, and give the ATP/AMP-on-PFK-1 example.",
      pitfall:
    ...
    },
    {
      ...
      objective: "Define a zymogen/proenzyme as an inactive enzyme precursor activated by proteolysis, and give pepsinogen-to-pepsin as the autocatalytic worked example.",
      pitfall:
  ...
  questions: [
    {
      ...
      explanations: {
        ...
        b: "An activator increases enzyme activity, but it is not the term for the substance an enzyme recognises and reacts with.",
        c: 'Enzymes interact with a specific substrate or inter-related substrates — this recognised substance is the substrate.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Enzymes are not lipids; placed them among the proteins, structurally built like any other protein.',
        b: "Carbohydrates play no catalytic role in the account of enzymes; enzymes are proteins.",
        c: "Phospholipids are membrane-building molecules, unrelated to the classification of enzymes as protein in nature.",
        d: 'Enzymes are mainly protein in nature (though it notes some RNAs, ribozymes, also have catalytic activity).',
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Definition',
      learningObjective: "Identify 'produced by living cells' as one of the common features of enzymes.",
      explanations: {
        a: "The list of common features opens with: all enzymes are produced by living cells and can act outside these cells.",
        b: 'Reverses a listed feature. Enzymes accelerate the reaction without affecting its equilibrium point — they do not affect the equilibrium at all.',
        c: 'Reverses a listed feature. Enzymes are not changed chemically by the end of the reaction.',
        d: 'Reverses a listed feature. Enzymes are needed in very small amounts, not large ones.',
      },
    },
    {
      ...
      explanations: {
        a: 'Fatty acids are the building blocks of lipids, not of enzymes, which is classed as protein in nature.',
        b: 'Since enzymes are mainly protein in nature, they are, like any protein, built as polymers of amino acids.',
    ...
    },
    {
      ...
      explanations: {
        a: 'The active site is where the substrate binds, not somewhere remote from it — described it as the pocket where the enzyme-substrate complex forms.',
        ...
        c: "The diagram of enzyme mechanism states the active site lowers the activation energy and speeds up the reaction — it is where catalysis happens.",
        d: "Reverses the mechanism. The enzyme lowers, not increases, the activation energy of the reaction.",
      },
    },
    {
      ...
      explanations: {
        a: "The terminology names the molecule an enzyme recognises and reacts with the substrate.",
    ...
    },
    {
      ...
      explanations: {
        a: 'The enzyme accelerates the reaction by lowering the energy of activation, without affecting the equilibrium of the reaction.',
        b: "Reverses the mechanism — the enzyme lowers, not raises, the activation energy.",
        ...
        d: 'As with decreasing pH, changing pH is a factor that modulates reaction rate, not the account of how catalysis itself works.',
      },
    },
    {
    ...
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Classification',
      learningObjective: "Name temperature, substrate concentration and pH together as factors affecting enzyme activity, among the full five-factor list.",
      explanations: {
        a: 'True but incomplete — temperature is only one of the several factors named; the question asks for the set of factors affecting enzyme activity.',
        b: 'True but incomplete on its own — substrate concentration is one factor among several (also enzyme concentration, cofactor concentration, temperature and pH) that discussed together.',
        c: 'True but incomplete — pH is one factor among several discussed together, not the sole one.',
        d: "Discussed substrate concentration, enzyme concentration, cofactor concentration, temperature and pH together as the factors affecting the rate of an enzyme-catalysed reaction; this option is the only one that groups more than one of them together, matching the multi-factor treatment.",
      },
    },
    {
      ...
      explanations: {
        a: 'Km is the substrate concentration that produces half the maximal velocity (Vmax).',
        b: "Km is never defined as a dissociation constant for the enzyme-substrate complex; its own definition is purely in terms of the substrate concentration at half-maximal velocity.",
        c: 'Km describes a substrate concentration, not an enzyme concentration — the two are separate axes in the velocity curves.',
        d: "Sounds like the correct definition but inverts it: this describes half of the substrate concentration needed to reach Vmax, not the substrate concentration that itself produces half of Vmax — the definition is the latter.",
      },
    },
    {
      ...
      explanations: {
        ...
        b: "A smaller Km reflects higher affinity of the enzyme for its substrate, and vice versa — this makes Km a direct way to compare different enzymes' catalytic efficiency.",
        c: 'Molecular size is never linked to catalytic efficiency; efficiency is discussed purely in terms of Km (affinity) and Vmax.',
        d: "Optimum pH is a separate factor affecting reaction rate, not the measure for comparing catalytic efficiency between enzymes.",
      },
    },
    {
      ...
      explanations: {
        a: "As [S] increases, velocity rises up to the point where the enzyme is saturated — beyond that point (here, substrate concentrations greater than X) enzyme concentration, held constant in this experiment, becomes the limiting factor.",
        b: "Velocity plateaus near Vmax past saturation; it does not fall toward zero — the substrate-concentration curve rises to a maximum and levels off, it does not descend.",
        c: "The account of this curve is saturation of the enzyme, not an inhibitory effect of the substrate itself — inhibition is a separate topic from ordinary substrate saturation.",
        d: 'Product inhibition is not described as part of the substrate-concentration-versus-velocity relationship; the plateau here is explained by enzyme saturation, not by products building up and acting back on the enzyme.',
      },
    },
    {
      ...
      explanations: {
        a: "'Non-competitive inhibition' is not a category this chapter names; the two reversible categories are competitive and allosteric.",
        ...
        c: 'A competitive inhibitor is one that competes with the substrate to bind reversibly at the active (catalytic) site — directly blocking it.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'A competitive inhibitor is structurally similar to the substrate, competing with it for the active site.',
        ...
        d: "'Non-competitive inhibition' is not one of the named categories.",
      },
    },
    {
      ...
      explanations: {
        a: 'A competitive inhibitor increases the apparent Km for a given substrate, since more substrate is then needed to reach half of Vmax.',
        b: "Vmax is unaffected by a competitive inhibitor — raising [S] enough always lets the reaction reach the same Vmax as without inhibitor.",
        c: 'Vmax is unchanged by a competitive inhibitor, neither raised nor lowered — only the apparent Km changes.',
        d: "Reverses the rule. A competitive inhibitor increases, not decreases, the apparent Km.",
      },
    },
    {
      ...
      explanations: {
        a: 'Covalent modification (phosphorylation/dephosphorylation) is a separate regulatory mechanism described; allosteric regulation instead works through binding at a distinct site.',
        ...
        c: 'Competing for the catalytic site is exactly what a competitive inhibitor does; allosteric effectors are binding a site away from the catalytic site instead.',
        d: 'Allosteric inhibitors and activators bind to a specific site away from the catalytic site, producing conformational changes in the protein structure.',
      },
    },
    {
      ...
      difficulty: 'Moderate',
      questionType: 'Mechanism',
      learningObjective: "Identify a heavy-metal ion such as mercury as an irreversible enzyme inhibitor, as against the reversible, competitive examples.",
      explanations: {
        a: 'Statins anywhere in this chapter is not discussed; among the options, only mercury matches a mechanism actually classed as irreversible.',
        b: "Allopurinol is the worked example of a competitive (reversible) inhibitor — a structural analogue of hypoxanthine that competes for the active site of xanthine oxidase.",
        c: 'Salts of heavy metals, such is Hg2+, as irreversible inhibitors: the positively charged metal ion combines with the negatively charged sulfur of a free SH group needed for catalytic activity.',
        d: "Sulfonamides are the other worked example of a competitive (reversible) inhibitor — structural analogues of PABA that block bacterial folate synthesis.",
      },
    },
    {
    ...
    },
    {
      ...
      explanations: {
        a: 'A zymogen is not a signalling molecule secreted by a gland; it strictly is an inactive form of an enzyme.',
        b: "Vitamins are unrelated to the account of zymogens; a zymogen is a form of the enzyme protein itself, not a dietary cofactor.",
        c: 'Many enzymes are formed in the form of proenzymes or zymogens, which are inactive — a zymogen is an enzyme precursor.',
    ...
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Classification',
      learningObjective: "Identify pepsinogen as the example of a proenzyme (zymogen).",
      explanations: {
        a: "The worked example of a zymogen is pepsinogen, which HCl converts to pepsin plus a polypeptide fragment in an autocatalytic reaction.",
    ...
    },
    {
      ...
      explanations: {
        a: "Best supported, though the wording names serine or tyrosine as the residues carrying the phosphate group (not threonine, as this option states) — of the four options, only this one describes a real, hydroxyl-residue-based covalent modification, and it is the only option not directly contradicted elsewhere in the text.",
        b: "Reverses the section heading. Phosphorylation/dephosphorylation is presented under 'Covalent Modifications' — it is specifically a covalent, not non-covalent, change.",
        c: "Reverses the account. The enzyme exists in two interconvertible forms — phosphorylated and dephosphorylated — precisely because the modification is reversible, undone by protein phosphatase.",
        d: "Reverses the account directly. Phosphorylation activates some enzymes (e.g. glycogen phosphorylase kinase) and inactivates others (e.g. glycogen synthase) — it very much affects catalytic activity.",
      },
    },
    ...
    // --- pass 1 additions (2026-08-27) ---
    {
      ...
      explanations: {
        a: '"Standard" is not the term for this pH value — it is the optimum pH, not a standard pH.',
        ...
        c: 'The pH at which an enzyme is most active is its optimum pH, one of the five factors — alongside substrate, enzyme and cofactor concentration, and temperature — that set reaction velocity.',
        d: '"Neutral" (pH 7) is not the optimum here — most enzymes\' optimum sits somewhere between pH 5 and 9, and pepsin\'s, for instance, is strongly acidic, nowhere near neutral.',
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Shifting pH changes the ionisation state of chargeable groups on both the substrate and the active site\'s amino acid residues, altering the electrostatic fit between them and so the catalytic rate.',
    ...
    },
    {
      ...
      explanations: {
        a: 'With substrate in excess, velocity rises in direct proportion to enzyme concentration — every extra enzyme molecule adds its own share of catalysis, since there is always substrate available for it to act on.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Aspirin is a cyclooxygenase inhibitor: blocking cyclooxygenase cuts production of both thromboxane A2 (platelets) and prostacyclin (endothelium) from arachidonic acid.',
