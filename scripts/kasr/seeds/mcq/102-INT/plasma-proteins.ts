  ...
  concepts: [
    {
      ...
      label: 'Plasma proteins: formation and functions',
      definition:
        '**Plasma proteins** are made mainly by the __liver__ — it produces albumin, fibrinogen, the coagulation factors and about 50% of the globulins. The __gamma globulins__ are the exception: they are made by **plasma cells** in lymphoid tissue.\n\n' +
        'Their single most important role is **osmotic**. The capillary wall is impermeable to them, so they exert the __colloidal osmotic pressure (25–28 mmHg)__ that pulls tissue fluid back into the capillary. **Albumin** dominates this pull — it is the most concentrated and the smallest, so it contributes the most particles.\n\n' +
        'The other functions in brief: they **buffer** the blood (at pH 7.4 they are negatively charged weak acids); **gamma globulins** give humoral immunity; **fibrinogen and the clotting factors** coagulate the blood; **fibrinogen** also raises viscosity through its elongated shape; plasma proteins seal the capillary pores to set permeability; **albumin and the globulins** transport hormones, vitamins, lipids and minerals and stop them being lost in urine; and they are a **reserve of amino acids** for tissue protein.\n\n' +
        'Clinically, the __albumin/globulin ratio__ is normally 1.2–1.6 and falls in liver disease, renal disease and infection. A low albumin (e.g. in liver failure) drops the colloidal osmotic pressure, so fluid leaks into the tissues as **oedema**.',
  ...
  questions: [
    {
      ...
      explanations: {
        ...
        b: 'Albumin has the greatest concentration of the plasma proteins, and since osmotic pressure depends on particle number rather than mass, it is responsible for most of the plasma proteins\' colloidal osmotic pressure.',
    ...
    },
    {
      ...
      explanations: {
        a: 'At normal plasma pH (7.4), plasma proteins are negatively charged and act as weak acids (anions), combining with bases — this is the basis of their buffering function.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: 'Albumin and the alpha (and beta) globulins act as carriers for hormones, vitamins, lipids and minerals; binding these substances to plasma proteins prevents their rapid loss in the urine and provides a usable reservoir.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Burns lose albumin directly from the circulation (through damaged capillaries) rather than reducing its production, and kidney disease loses albumin in the urine through a leaky glomerular filter — neither is described as decreased *production*.',
        b: 'Transport by binding to substances (hormones, vitamins, lipids, minerals) is albumin\'s function, but attributed this to albumin\'s abundance and binding sites, not to an "elongated shape" — elongated shape is instead named for fibrinogen, explaining its outsized contribution to blood viscosity.',
        ...
        d: 'Albumin\'s colloidal osmotic pressure holds water in the capillaries and draws tissue fluid back in, making it central to both tissue fluid formation and the regulation of circulating blood volume.',
      },
    },
    {
    ...
    },
    {
      ...
      explanations: {
        a: 'Fibrinogen and the coagulation factors are plasma proteins in their own right, and plasma proteins as a class include them alongside albumin and the globulins.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: 'Liver failure is not described as changing renal water reabsorption directly — the oedema mechanism it teaches runs through the plasma proteins\' osmotic function, not the kidney.',
        d: 'A failing liver forms less albumin; less albumin means less colloidal osmotic pressure to hold water in the capillaries and pull tissue fluid back in, so fluid accumulates in the tissues as oedema.',
      },
    },
  ],
}
