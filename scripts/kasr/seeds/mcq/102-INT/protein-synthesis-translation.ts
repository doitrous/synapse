...
export const LEAF: McqLeafSeed = {
  ...
  concepts: [
    ...
    },
    {
      ...
      objective: "Name the types of covalent post-translational modification and give an example for each.",
      pitfall:
  ...
  questions: [
    {
      ...
      explanations: {
        ...
        b: 'Protein synthesis takes place at the rough endoplasmic reticulum, which is cytoplasmic; translation cannot happen in the nucleus because the ribosomes, tRNAs and aminoacyl-tRNA synthetases it needs are cytoplasmic machinery, and the mRNA reaching them has already been exported through a nuclear pore.',
        c: "Removal of introns is splicing, one of the post-transcriptional modifications of mRNA that takes place in the nucleus — not the exception.",
    ...
    },
    {
      ...
      explanations: {
        a: "Specificity is one of the four characteristics of the genetic code — applicable, not the exception.",
        b: "Degeneracy is one of the four characteristics — applicable, not the exception.",
        c: "Universality is one of the four characteristics — applicable, not the exception.",
        d: "The reading-frame characteristic reads the code as 'a continuous uninterrupted sequence of bases taken 3 at a time' from a fixed start point — every base is used in exactly one codon, so the code is non-overlapping, not overlapping.",
      },
    },
    {
      ...
      explanations: {
        ...
        b: "This is degeneracy — an amino acid coded by more than one (synonym) codon — a real characteristic of the genetic code, so present, not lacking.",
        c: 'Universality is a real characteristic of the genetic code — present, not lacking.',
        d: "This reverses specificity: a particular codon always codes for only one amino acid. A single codon coding for more than one amino acid is exactly what the code lacks.",
      },
    },
    {
      ...
      explanations: {
        a: "Degeneracy is defined as an amino acid being coded by more than one codon, called synonym codons — exactly the feature described.",
        b: "'Duplicative' is not one of the four named characteristics of the genetic code; it is invented terminology standing in for degeneracy.",
        ...
        d: "Overlapping is not a real characteristic of the code at all — the reading frame is explicitly a continuous, non-overlapping sequence — and even if it were, it would not describe one amino acid having multiple codons.",
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'This flexibility of the third codon base — paired against the first anticodon base — is named the wobble hypothesis.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: "tRNA recognises a codon through its anticodon, but AUG is not a 'recognition site on tRNA' — the recognition site for any codon is on the mRNA itself.",
        d: 'AUG is the one codon that acts as the initiation codon for protein synthesis.',
      },
    },
    {
      ...
      explanations: {
        a: 'These three are exactly the termination (stop) codons, coding for no amino acid.',
        b: "None of UGG, UGU or AGU is one of the three stop codons; UGG in fact codes for tryptophan.",
        c: "None of AAU, AAG or GAU is a stop codon in the genetic-code table.",
    ...
    },
    {
      ...
      explanations: {
        a: 'The template strand of DNA carries the gene the codon is copied from, but the codon itself is defined as a feature of mRNA, not of DNA.',
        b: "The genetic code is defined as 'the nucleotide sequence of mRNA representing the code words for amino acids' — codons are on mRNA.",
    ...
    },
    {
      ...
      explanations: {
        ...
        c: 'In the cytosol, tRNAs carry the (activated) amino acids into the ribosomes.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: "Amino acids, activated and carried on tRNA, are explicitly one of the four requirements of translation — compulsory.",
        d: "Okazaki fragments are a feature of lagging-strand DNA replication; they play no part in what translation needs (three RNA classes, amino acids, energy, protein factors).",
      },
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Definition',
      learningObjective: "State the definition of a codon.",
      explanations: {
        a: 'This describes a protein/enzyme action, not a codon, which is defined as a sequence feature of mRNA, not a protein.',
        b: 'A codon is not a free-floating base; it is a fixed 3-base sequence within the mRNA chain.',
        c: "Each 3 successive nitrogenous bases in mRNA represents a codon representing one amino acid's code word.",
    ...
    },
    {
      ...
      explanations: {
        a: "The reaction shown — an amino acid plus aminoacyl-tRNA synthetase and ATP, releasing PPi and forming an enzyme-AMP-amino acid complex before the aminoacyl-tRNA is released — is exactly the two-step formation of aminoacyl-tRNA, i.e. activation of the amino acid.",
    ...
    },
    {
      ...
      explanations: {
        a: '20 different amino-acyl-tRNA synthetases, each specific for one amino acid and its tRNA, carry out the activation and loading of amino acids onto tRNA.',
        ...
        d: "Aminoacyl-tRNA synthetase's job is activation and attachment, not breakdown; nothing in its function involves degrading amino acids.",
      },
    },
    {
      ...
      explanations: {
        ...
        c: 'The spliceosome removes introns and joins exons during mRNA splicing, a nuclear, post-transcriptional step that happens before the finished mRNA ever reaches a ribosome — it plays no part in translation itself.',
    ...
    },
    {
      ...
      explanations: {
        a: 'During elongation, the aminoacyl-tRNA bound at each step is determined by the mRNA codon aligned with the A site, so the order amino acids are added in — the polypeptide sequence — directly follows the order of codons on the mRNA.',
    ...
    },
    {
      ...
      explanations: {
        a: "Initiation has 'the initiating methionyl tRNA (Met-tRNAi)' bind to the AUG start codon on the mRNA — methionyl-tRNA is the eukaryotic initiator.",
        b: "Formylmethionyl-tRNA does not appear anywhere in eukaryotic initiation, which names only methionyl-tRNA (Met-tRNAi).",
    ...
    },
    {
      ...
      explanations: {
        a: 'Peptidyl transferase, part of the 60S subunit, forms the peptide bond between the amino group of the new aminoacyl-tRNA in the A site and the carboxylic group of the peptidyl chain in the P site.',
        ...
        c: 'Peptidyl polymerase is not the name of a real enzyme here; peptide bond formation is credited specifically to peptidyl transferase.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Peptidyl transferase is an enzyme that is part of the 60S subunit.',
        c: 'eEF-2 is an elongation factor name, not the ribosomal subunit carrying the catalytic activity itself, and it is not credited with peptidyl transferase activity.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Trimming — the proteolytic removal of a segment from a precursor protein — is one of the two post-translational modifications, alongside covalent modification.',
    ...
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Mechanism',
      learningObjective: "Name trypsinogen activation as the classic zymogen example of trimming.",
      explanations: {
        a: 'Trypsinogen becoming activated to trypsin in the small intestine is the classic example of a zymogen (inactive enzyme precursor) activated by trimming — proteolytic removal of part of the chain.',
    ...
    },
    {
      ...
      explanations: {
        ...
        d: 'Carboxylation forms γ-carboxyglutamate, which allows clotting proteins to bind Ca2+, a step in clot formation.',
      },
    },
    {
      ...
      explanations: {
        a: 'Aligning the two sequences shows the second strand is one base shorter than the first — a base has been lost, which is a deletion.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: "Guanine and adenine are both purines, so one replacing the other is a purine-for-purine substitution — the definition of a transition.",
    ...
    },
    {
      ...
      explanations: {
        a: "'Transposition' is not one of the two named substitution types; only transition and transversion are named.",
        b: 'Thymine (a pyrimidine) replaced by adenine (a purine) crosses between the two base classes — the definition of a transversion.',
    ...
    },
    {
      ...
      explanations: {
        ...
        c: 'Inserting or deleting a number of bases that is not a multiple of three — such as one or two bases — shifts the reading frame, producing a frameshift mutation.',
    ...
    },
    {
      ...
      difficulty: 'Moderate',
      questionType: 'Mechanism',
      learningObjective: "Name sickle cell anaemia as the classic example of a missense mutation.",
      explanations: {
        a: "Nonsense mutation creates a premature stop codon and usually a non-functional truncated protein (the classic example is thalassaemia) — not the sickle cell mechanism, which changes rather than truncates the chain.",
        b: 'Sickle cell anaemia is the classic example of a missense mutation, in which glutamate is replaced by valine at position six of the β chain.',
