  ...
  questions: [
    ...
    // --- pass 1 additions (2026-08-27) ---
    {
      ...
      explanations: {
        ...
        c: 'Correct. Hydroxylation of prolyl and lysyl residues is what stabilises collagen, one of the book\'s named worked examples of covalent post-translational modification.',
        d: 'Carboxylation forms γ-carboxyglutamate, the book\'s example being clotting-factor calcium binding — a different residue (glutamate) and a different function from collagen\'s proline/lysine hydroxylation.',
      },
    },
  ],
}
