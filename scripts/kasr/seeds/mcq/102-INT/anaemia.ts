...
export const LEAF: McqLeafSeed = {
  ...
  concepts: [
    ...
    },
    {
      ...
      pitfall: 'Naming only the hematologic effect of B12 deficiency and missing the neurological one, or vice versa — both come from the one vitamin\'s two separate jobs, not from one mechanism.',
      subject: 'haem',
      primary: 'DIS-PHY-T02',
      secondary: [],
  ...
  questions: [
    {
      ...
      explanations: {
        a: 'Backwards. Chronic blood loss is more common in females than males, largely through menstrual loss — not the other way round.',
        ...
        c: 'Chronic blood loss — from hookworm infestation, peptic ulcer or piles bleeding, or excessive menstrual loss — is one of the three named causes of iron-deficiency anaemia.',
    ...
    },
    {
      ...
      explanations: {
        ...
        d: 'The bone marrow\'s rapidly dividing cells need DNA synthesis for nuclear maturation and division, and vitamin B12 is essential for that synthesis.',
      },
    },
    {
      ...
      explanations: {
        a: 'The exception. Living at high altitude raises the RBC count through the hypoxia–erythropoietin pathway (secondary polycythemia); it does not cause anaemia, which is the opposite direction of change.',
        ...
        d: 'Iron deficiency is the standard cause of microcytic hypochromic anaemia, so it is not the exception.',
      },
    },
  ],
}
