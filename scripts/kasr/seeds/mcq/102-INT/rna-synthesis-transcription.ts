  ...
  questions: [
    {
      ...
      explanations: {
        a: "Correct. The transcriptional-unit diagram shows the RNA transcript running 5' to 3'; RNA polymerase always extends the growing chain in this one direction.",
        b: "The book's pre-initiation and initiation steps have TFIID, the other transcription factors and RNA polymerase II assemble directly at the promoter and begin synthesis — nothing in this process is described as needing a primer, unlike DNA replication.",
        c: "This reverses the book's own rule: 'the sequence of RNA is complementary to the sequence of template strand,' not the coding strand — mRNA matches the coding strand instead, except for U replacing T.",
        d: 'The book names the four ribonucleoside triphosphates RNA polymerase II uses as ATP, GTP, CTP and UTP — not TTP, since RNA never contains thymine.',
      },
    },
    {
      ...
      explanations: {
        ...
        d: "Correct. The book states plainly that RNA's sequence is complementary to the template strand's sequence.",
      },
    },
    {
      ...
      explanations: {
        ...
        d: "Correct. Pairing each base of the 5'-GATCTAC-3' template with its complement, read antiparallel (RNA polymerase moves 3' to 5' along the template while extending RNA 5' to 3', with U replacing T), gives 5'-GUAGAUC-3'.",
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Correct. Pairing each DNA base with its RNA complement (A pairs with U, T pairs with A, G pairs with C, C pairs with G) across ATG TGA CAG gives UAC ACU GUC.',
        c: 'This mixes DNA and RNA bases (T alongside U) in a way that does not consistently follow the complementary-pairing rule.',
        d: "This uses T throughout, which is a DNA base; the book's own rule is that RNA takes U in place of T.",
      },
    },
    {
      ...
      explanations: {
        a: 'This is neither the coding-strand sequence nor its proper U-for-T conversion; it does not follow the book’s stated rule.',
        b: "Correct. The book states mRNA 'is the same as that of coding strand except for U replacing T'; since CAGCGC contains no T to begin with, the mRNA sequence is identical to the coding strand, CAGCGC.",
        c: 'This does not match the coding strand’s letters position for position, so it cannot be the mRNA sequence the book’s rule produces.',
        d: 'This does not match the coding strand’s letters position for position, so it cannot be the mRNA sequence the book’s rule produces.',
      },
    },
    {
      ...
      explanations: {
        a: "Relief of torsional tension is a topoisomerase's job, not what the book credits to helicase activity here.",
        b: 'Correct. The book states that TFIIH has a helicase activity that separates the two strands of DNA for initiation.',
        c: "RNA primers are not part of this book's transcription mechanism; RNA polymerase does not need a primer, unlike DNA polymerase.",
        d: "Re-annealing the strands happens after RNA polymerase passes, not as helicase's key function during transcription; the book credits TFIIH's helicase activity with separating strands, not rejoining them.",
      },
    },
    {
      ...
      explanations: {
        a: "DNA polymerase acts in DNA replication, not transcription; the book's promoter is where RNA polymerase, not DNA polymerase, begins attachment.",
        b: 'Correct. The book defines the promoter as the nucleotide sequence at which RNA polymerase begins attachment, lying upstream of the transcription region.',
    ...
    },
    {
      ...
      explanations: {
        a: 'The book describes the promoter recruiting transcription factors and RNA polymerase II to begin transcription, not binding negative regulators to inhibit expression.',
        b: "The book's promoter recruits RNA polymerase II and transcription factors, not DNA polymerase — DNA polymerase belongs to DNA replication, not transcription.",
        c: "Splicing and recombination are separate post-transcriptional/gene-rearrangement processes; the promoter's role, per the book, is initiating transcription, not enabling splicing.",
        d: "Correct. The book describes the promoter's basal expression elements (TATA box, CAAT/GC box) as the site where TFIID and the other transcription factors bind and assemble, which is how the promoter region influences gene expression.",
      },
    },
    {
      ...
      explanations: {
        ...
        b: 'Topoisomerase relieves DNA supercoiling; it is not what the book associates with the TATA box.',
        c: "Correct. The TATA box is part of the promoter, the nucleotide sequence at which — per the book's own terminology — RNA polymerase begins attachment; TFIID binds it first as the entry point for the RNA polymerase II pre-initiation complex.",
    ...
    },
    {
      ...
      explanations: {
        a: "RNA polymerase I is for rRNA synthesis mainly, per the book's classification, not mRNA.",
        b: 'Correct. The book states directly that RNA polymerase II is responsible for synthesis of mRNAs.',
        c: "RNA polymerase III is for tRNA synthesis mainly, per the book's classification, not mRNA.",
    ...
    },
    {
      ...
      explanations: {
        a: 'The book groups RNA polymerase III with polymerase I for rRNA/tRNA synthesis generally, but the large 18S/28S ribosomal RNAs specifically belong to polymerase I among the two.',
        b: "'RNA-dependent RNA polymerase' is not one of the book's three nuclear RNA polymerases; the book's three are RNA polymerase I, II and III.",
        c: 'Correct. The book assigns rRNA synthesis mainly to RNA polymerase I (together with III for tRNA); the large 18S and 28S ribosomal RNA genes are transcribed by RNA polymerase I.',
    ...
    },
    {
      ...
      explanations: {
        a: 'The TATA box belongs to transcription, not DNA replication; the book never assigns it a role in marking a replication start point.',
        b: "Correct. The book states the TATA box 'defines where transcription is to start along the DNA.'",
        c: 'The book assigns the terminator, not the TATA box, to marking where transcription ends.',
    ...
    },
    {
      ...
      difficulty: 'Easy',
      questionType: 'Classification',
      learningObjective: "Recognise trimming as absent from the book's list of mRNA processing steps.",
      explanations: {
        a: "Capping is one of the book's four listed post-transcriptional modifications of mRNA — present, not lacking.",
        b: "Polyadenylation is one of the book's four listed modifications — present, not lacking.",
        c: "Splicing is one of the book's four listed modifications — present, not lacking.",
        d: "Correct. The book's post-transcriptional modifications of mRNA are capping, polyadenylation, splicing and editing; trimming is a post-translational modification of proteins, not something mRNA processing includes.",
      },
    },
    {
      ...
      explanations: {
        a: "The book does not describe the bond linking the cap to the transcript in enough chemical detail to confirm or rule out a 3'-5' phosphodiester bridge.",
        b: "The book does not describe the bond linking the cap to the transcript in enough chemical detail to confirm or rule out a 5'-5' triphosphate bridge, even though this is the printed key.",
        c: "The book does not describe the bond linking the cap to the transcript in enough chemical detail to confirm or rule out a 3'-3' triphosphate bridge.",
        d: "The book does not describe the bond linking the cap to the transcript in enough chemical detail to confirm or rule out a 3'-5' triphosphate bridge.",
      },
    },
    {
      ...
      explanations: {
        a: 'Telomeres protect the ends of chromosomal DNA, not mRNA; they play no part in this book’s mRNA-processing discussion.',
        b: "Correct. The book states that polyadenylation 'stabilizes the mRNA and protects it against the attack by ribonucleases.'",
        ...
        d: 'Exons are the coding sequence retained in the mature mRNA, but the book credits the poly(A) tail, not exons themselves, with ribonuclease protection.',
      },
    },
    {
      ...
      explanations: {
        a: 'This reverses the book’s own description: splicing cuts out introns and joins together the exons, not the other way round.',
        ...
        d: 'Correct. The book states that splicing removes introns (non-expressed regions) and joins exons (expressed regions) to form functional mRNA.',
      },
    },
    {
      ...
      explanations: {
        ...
        c: 'Plain splicing removes introns to give one mature mRNA; the figure’s two different protein products from the same exons is specifically what the book calls alternative splicing.',
        d: 'Correct. The book states that the primary transcript of some genes may be spliced differently to yield different proteins from the same gene — exactly what the figure of one transcript producing Protein A and Protein B shows.',
      },
    },
    {
      ...
      explanations: {
        ...
        d: 'Correct. Splicing removes introns and joins exons to form the functional, mature mRNA, so an intron is exactly what mature mRNA is least likely to still contain.',
      },
    },
    {
      ...
      explanations: {
        a: "1750 would only follow from including the intron in the coding count, which the book's own account of splicing rules out — introns are removed before translation.",
        b: "750 would follow from adding both untranslated regions to the coding sequence, but the book never introduces untranslated regions as part of this chapter's teaching, so this can't be confirmed from the assigned pages.",
        c: "650 does not correspond to any combination of the given numbers that the book's splicing/coding-sequence teaching would produce.",
        d: "450 matches 150 amino acids at 3 bases per codon, and is the printed key, but the book never teaches the 5'/3' untranslated-region concept this question's option set requires to rule out the other three answers.",
      },
    },
    {
      ...
      explanations: {
        a: "'Splicer' is not the book's name for this machinery; the book names the spliceosome specifically.",
        b: 'Ribosomes carry out translation, not splicing; they play no part in intron removal.',
        c: "'Nuclear body' is not the book's term for the splicing machinery; the book is specific that it is called a spliceosome.",
        d: 'Correct. The book states that splicing requires a spliceosome, made of small nuclear ribonucleoproteins (snRNPs) built of special proteins and small nuclear RNAs.',
      },
    },
    {
      ...
      explanations: {
        a: "The book's clinical correlation names snRNPs, the spliceosome's components, as the antibody target in SLE — not a capping-related complex.",
        b: "The book's clinical correlation names snRNPs as the antibody target in SLE, not any polyadenylation-related component.",
        c: "Correct. The book's own clinical correlation states that in SLE, autoantibodies target small nuclear ribonucleoproteins (snRNPs) — the components of the spliceosome that carries out splicing — so defective splicing is the mechanism.",
        d: "The book's clinical correlation concerns snRNPs and ordinary splicing, not the choice between alternative splice patterns.",
      },
    },
    {
      ...
      explanations: {
        ...
        c: "Correct. Splicing works by the spliceosome recognising the boundary between an intron and an exon in order to remove the intron and join the exons; a mutation exactly at that junction disrupts the recognition the book's own description of splicing depends on.",
    ...
    },
    {
      ...
      explanations: {
        ...
        d: 'Correct. The book’s own ApoB example is exactly this: a cytidine deaminase converts a CAA codon to the UAA stop codon in intestinal mRNA, producing the truncated Apo B-48 protein — this is mRNA editing.',
      },
    },
  ],
}
