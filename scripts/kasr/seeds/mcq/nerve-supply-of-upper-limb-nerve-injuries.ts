  ...
  questions: [
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'The median nerve is endangered by a supracondylar fracture at the lower end. This copy has the OCR watermark "ViP Ac" trailing the option text; the option itself reads "Median nerve".',
