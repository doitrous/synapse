  ...
  concepts: [
    {
      ...
      pitfall: 'Using striation alone to mean voluntary. Cardiac muscle is striated and involuntary at once, which is why the muscle types are tabulated across four columns rather than one.',
    ...
    },
    {
      ...
      objective: 'Classify a named muscle by the arrangement of its fibres, and give an example of each class.',
    ...
    },
    {
      ...
      objective: 'Name the role a muscle is playing in a described movement, and give the defined role of each of the four types.',
  ...
  questions: [
    {
      ...
      explanations: {
        ...
        D: 'Skeletal muscle is defined by its attachment to the skeleton, and it is the only one of the three with that attachment.',
      },
    },
    {
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Smooth muscle is in the wall of blood vessels and of the viscera, has no striations, and is supplied by autonomic nerves.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Deltoid is the multipennate example: a series of bipennate units side by side, separated by tendinous septa, which is what lets a muscle of that size abduct the whole limb.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'The printed answer, and the reason for the override. The antagonist opposes the prime mover; it is the exact opposite of a muscle assisting it, and choosing it inverts the chapter\'s definition.',
        C: 'The override. The synergist contracts to eliminate unwanted movements at joints the prime mover crosses, so that the prime mover\'s action on the joint that matters becomes maximal — assistance by subtraction.',
    ...
    },
    {
      ...
      explanations: {},
      exclude: true,
      excludeReason: 'Three faults at once. Option D is missing. The printed key is B, "between bone and skin", which describes a bursa rather than a synovial sheath. And no definition of a synovial sheath exists in the course material to test that key against — its ILO list asks the student to define the term and its text never does. The surviving option C, "around the tendons of the muscles", is what a synovial sheath is in every other source, but resolving the key from outside the course\'s own material would be inventing a position rather than recording one. The gap is noted on the concept.',
    },
    {
