  ...
  questions: [
    {
      ...
      explanations: {
        ...
        D: 'Before folding the connecting stalk, carrying the allantois, is the most caudal structure; the tail fold then swings it cranially and ventrally, leaving the cloacal membrane the most caudal.',
      },
    },
    {
      ...
      answerOverrideReason:
        'The books key this to the connecting stalk, which is the answer to the paired question about the position *before* folding — the two questions are printed together and their keys appear to have been carried across. The reversal is explicit: in the tail fold the connecting stalk with the allantois becomes more cranial and ventral, and the cloacal membrane becomes the most caudal. After folding the answer is therefore the cloacal membrane, option B.',
      explanations: {
        ...
        B: 'The tail fold carries the connecting stalk cranially and ventrally, and the cloacal membrane is left as the most caudal structure of the folded embryo.',
        C: 'The connecting stalk is the answer to the same question asked about the position before folding, and it is the keyed option as well. After the fold it has moved cranially and ventrally to lie in the ventral body wall at the umbilical ring, which is the opposite end of the reversal.',
    ...
    },
    {
      ...
      explanations: {
        A: 'The notochord limits the head fold, not the tail fold. The two limits are paired deliberately, and swapping them is the error the question is set to find.',
        B: 'The relatively firm primitive streak limits the tail fold, as the notochord limits the head fold.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'The prenotochordal process is a solid cord of epiblast cells from the wall of the primitive pit, which invaginates and grows cranially in the midline.',
      },
    },
    {
      ...
      explanations: {
        A: 'The floor of the notochordal canal, fused with the endoderm beneath it, degenerates — which opens the amniotic cavity into the yolk sac through the canal.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Most of the notochord degenerates; the part inside the intervertebral disc persists as the nucleus pulposus, which is the only piece of it a person keeps.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Gastrulation is the transformation of the bilaminar embryonic disc into a trilaminar one.',
    ...
    },
    {
      ...
      answerOverride: 'C',
      answerOverrideReason:
        'The books key this to the first week. Gastrulation, beginning with the formation of the primitive streak in the epiblast, is one of the two characteristic events of the third gestational week — and the epiblast the streak forms in does not exist until the eighth day. The first week is fertilisation, cleavage and blastocyst formation. Set to C.',
      explanations: {
        A: 'The first week is fertilisation, cleavage and the blastocyst. There is no epiblast yet, so there is nothing for a primitive streak to form in. This is the keyed option, and it is a week and a half too early.',
        ...
        C: 'The primitive streak appears at the beginning of the third week, and its appearance is the beginning of gastrulation.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'The intra-embryonic mesoderm lies between ectoderm and endoderm on both sides of the notochord and the neural tube.',
        D: 'The median region between the primitive node and the bucco-pharyngeal membrane is occupied by the notochord and the neural tube, so mesoderm is absent there too. All three wrong options name one of the three exceptions, which is why this question is harder than it looks: a student who has learnt only the exceptions still has to notice that none of them is the answer.',
      },
    },
    {
      ...
      answerOverride: 'C',
      answerOverrideReason:
        'None of the three printings of this question carries a key. The neural plate is a median thickening of the ectoderm, and the central nervous system is one of the ectodermal derivatives. Set to C.',
      explanations: {
        ...
        C: 'The neural plate is a thickening of the ectoderm in the median plane, overlying the notochord.',
    ...
    },
    {
      ...
      answerOverride: 'A',
      answerOverrideReason:
        'The books print no key. Only A is true: the central nervous system is a derivative of ectoderm, which is the one statement of the four confirmed in the list of ectodermal derivatives. B, C and D are each false, and the reasons are given in their explanations.',
      explanations: {
        A: 'The central nervous system develops from ectoderm, by way of the neural plate and the neural tube.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'The epidermis comes from the surface ectoderm, the part of the layer that is left once the neural plate has sunk away from it.',
    ...
    },
    {
      ...
      answerOverride: 'A',
      answerOverrideReason:
        'None of the three printings of this question carries a key. The parenchyma of the liver, pancreas, thyroid, thymus, tonsils and parathyroid are derivatives of endoderm, as glandular epithelium. Set to A.',
      explanations: {
        A: 'The liver parenchyma is endodermal — it grows as a diverticulum from the foregut, whose lining is endoderm.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Trilaminar — two electron-dense layers with an electron-lucent layer between them — the unit membrane.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Osmium and other heavy metals deposit in the hydrophilic heads at both surfaces and not in the hydrophobic tails between them, so two dense lines appear with a pale line between.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Two dark, electron-dense lines — the stained hydrophilic heads at the two surfaces — with one light, electron-lucent line between them.',
    ...
    },
    {
      ...
      answerOverride: 'a',
      answerOverrideReason: 'The 2020 paper printed no key and the recovered answer sheet does not cover this source, so the answer given here is: somites are counted in pairs throughout \u2014 4 occipital, 8 cervical, 12 thoracic, 5 lumbar, 5 sacral and 8 to 10 coccygeal pairs, three pairs separating each day \u2014 because the paraxial mesoderm lies on both sides of the notochord and neural tube and segments on each side. The other three options are single median structures.',
      explanations: {
        a: 'The paraxial mesoderm lies on both sides of the midline, so its segments come in pairs; somites are counted in pairs from the first pair of occipital somites on the twentieth day onwards.',
    ...
    },
    {
      ...
      answerOverride: 'c',
      answerOverrideReason: 'The 2020 paper printed no key and the recovered answer sheet does not cover this source, so the answer given here is: the whole nervous system derives from the neural plate, a thickened median region of the ectoderm overlying the notochord, which folds into the neural tube; the endoderm and the two mesoderms make no part of it.',
      explanations: {
        ...
        c: 'The neural plate is a thickened median region of ectoderm; its edges rise as neural folds, meet and fuse to make the neural tube, and that tube becomes the brain and the spinal cord.',
