  ...
  questions: [
    {
      ...
      explanations: {
        A: 'The modification runs the other way. This option makes the cell a nerve cell first, which would put the tissue in the nervous system; the book classes neuro-epithelium among the four types of *epithelial* tissue.',
        B: 'Correct. Neuro-epithelium is epithelium whose cells are modified to act as receptors and receive the stimulus of a sensation — the book\'s own definition, and the taste bud is its example.',
        C: 'A statement about embryology rather than about structure. Some epithelia are ectodermal, as the nervous system is, but shared origin is not what the term neuro-epithelium asserts, and the book makes no such claim.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Correct. The taste bud is the book\'s single example of neuro-epithelium: epithelial cells modified as receptors for the sensation of taste.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Absorptive epithelium is not one of the book\'s four classes at all. It is a description of what simple columnar epithelium does in the gut, borrowed here as a plausible-sounding category.',
        C: 'Correct. Neuro-epithelium is epithelium modified as a receptor, and the taste bud is the example the book gives.',
