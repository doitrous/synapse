  ...
  questions: [
    // --- The three fibres, told apart -------------------------------------
    {
      ...
      explanations: {
        ...
        D: 'Not a connective tissue fibre at all. Purkinje fibres are modified cardiac muscle cells conducting the impulse through the ventricle; the word "fibre" in histology names a thread of protein in some places and a whole cell in others, and this option is built on that ambiguity.',
      },
    },
    {
      ...
      explanations: {
        A: 'Collagen is the most abundant fibre in connective tissue and the most abundant protein in the body — tendon, dermis, bone matrix and organ capsules are all collagen.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Elastin lets the fibre stretch and spring back, which is why it is concentrated in the aorta, the lung and the skin.',
    ...
    },
    {
      ...
      explanations: {
        A: 'This is the exception. The wording is exact: collagen forms "wavy branching bundles formed of non-branching fibres". The bundle divides; the individual type I fibre inside it does not.',
    ...
    },
    {
      ...
      explanations: {
        A: 'The dermis is dense irregular connective tissue, and its bulk is collagen bundles interweaving in every plane so that skin resists pull from any direction.',
    ...
    // --- Fibre stains -------------------------------------------------------
    {
      ...
      explanations: {
        A: 'True. Orcein browns elastic fibres, and that is the standard stain for them.',
        B: 'This is the exception. Reticular fibres are not visible in H&E; that invisibility is the whole reason silver impregnation exists for them, and PAS reddens them because of their sugar.',
    ...
    },
    {
      ...
      explanations: {
        A: 'This is the keyed answer. Collagen and elastic fibres are both acidophilic and both take eosin pink — which is why H&E cannot tell them apart by colour and the student must use bundling and outline instead.',
    ...
    // --- Reticular fibres ---------------------------------------------------
    {
      ...
      explanations: {
        ...
        D: 'This is the keyed answer. All three statements hold together, and the reason they do is one fact: a sugar-rich type III collagen takes both a silver and a carbohydrate stain.',
      },
    },
    {
      ...
      explanations: {
        ...
        C: 'Reticular fibres are type III collagen, and their sugar content is what makes them argyrophilic and PAS-positive.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Chondroblasts make type II collagen, in cartilage. Reticular fibres come from fibroblasts, reticular cells and smooth muscle cells — the chondroblast is borrowed from the row above in the same table.',
        C: 'Reticular fibres are type III collagen; that identity is what explains both their staining and their fineness.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Reticular fibres branch and anastomose into a loose flexible network — the stroma — and the reticular cell that secretes them lives in it.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Reticular fibres are type III collagen, and their high sugar content is what separates them from type I in staining.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Type III is the reticular fibre.',
        C: 'Type V is outside the five types tabulated here.',
    ...
    // --- Collagen types -----------------------------------------------------
    {
      ...
      explanations: {
        A: 'Type I is the collagen of connective tissue proper, tendon, bone and organ capsules, and those tissues are most of the body\'s bulk.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Type I, arranged in bundles, is the commonest collagen in the body.',
    ...
    },
    {
      ...
      explanations: {
        A: 'This is the keyed answer. Type I is the strongest, and it is strongest because it is bundled — many parallel fibres sharing one line of pull, which is what a tendon is.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Dense collagenous connective tissue — tendon, ligament, dermis, capsule — is bundled type I collagen and little else.',
    ...
    },
    {
      ...
      explanations: {
        A: 'This is the keyed answer. Type IV is granular — a sheet of granules in the basal lamina, not a thread.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'This is the exception. Type II collagen is cartilage collagen and comes from the chondroblast; the reticular cell never makes it.',
    ...
    // --- Basement membrane, filed here because of its collagens -------------
    {
      ...
      explanations: {
        ...
        B: 'The basal lamina is an electron-dense sheet of type IV collagen and glycoproteins, and the epithelium itself makes it.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'This is the keyed answer. Type IV collagen is the main constituent of the basal lamina.',
      },
    },
    {
      ...
      explanations: {
        ...
        B: 'Type IV is the granular collagen of the basal lamina, made by the epithelial cells that sit on it.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'This is the keyed answer. Type IV, in granular form — exactly this pairing.',
      },
    },
    {
      ...
      explanations: {
        ...
        C: 'The reticular lamina is the connective-tissue component: type III collagen, which is reticular fibre, together with ground substance.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'A and B name one layer under two names, so both are right and the combined option is the answer.',
      },
    },
    {
      ...
      explanations: {
        ...
        D: 'Type VII collagen forms the anchoring fibrils.',
      },
    },
    {
      ...
      explanations: {
        ...
        E: 'C and D together — type VII collagen in the form of anchoring fibrils is what attaches the basement membrane to the connective tissue.',
      },
    },
    {
      ...
      explanations: {
        ...
        B: 'This is the keyed answer. The reticular lamina is the connective-tissue component — reticular fibres, which are type III collagen, plus ground substance.',
    ...
    // --- Dense connective tissue, filed here because its bundles are collagen
    {
      ...
      explanations: {
        A: 'A tendon transmits pull along one line, so its collagen bundles all run that way — the definition of regular.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'An organ capsule is stressed from all directions, so its collagen bundles interweave in different planes — dense irregular.',
      },
    },
    {
      ...
      explanations: {
        ...
        C: 'This is the keyed answer. Collagen is the main fibre of dense white fibrous connective tissue in both its regular and irregular forms.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Dense regular tissue comes in a white fibrous form, whose parallel bundles are collagen and which makes tendons and ligaments, and a yellow elastic form, whose parallel fibres are elastin and which makes the ligamenta flava and the vocal ligament.',
        ...
        D: '"None of the above" is only defensible if A is wrong, and A is the standard division.',
      },
    },
    ...
    // --- Cells that were filed here by a collagen distractor ----------------
    {
      ...
      explanations: {
        ...
        B: 'This is the keyed answer. The fibroblast synthesises the connective tissue fibres — collagen, elastic and reticular — and the ground substance they lie in.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'In bone marrow the undifferentiated mesenchymal cell is the life-long source of the blood cells — an example of why the cell stays undifferentiated into adult life.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Heparin is the anticoagulant of the mast cell granule, and it is also what makes the granule metachromatic with toluidine blue.',
    ...
    // --- Clinical ----------------------------------------------------------
    {
      ...
      explanations: {
        ...
        B: 'This is the keyed answer. Vitamin C deficiency blocks collagen synthesis, and the wound that will not close and the gum that bleeds are collagen failing.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Scurvy is defective collagen synthesis, and this stem hands the student the diagnosis and asks only for the molecule.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'The aorta\'s wall is packed with elastic laminae; when they are destroyed the vessel dilates and cannot spring back, which is what a CT scan shows as an aneurysm.',
    ...
    },
    {
      ...
      explanations: {
        a: 'Type IV collagen is granular rather than fibrillar, is secreted by the epithelial cells themselves, and is the collagen of the basal lamina — the epithelial half of the basement membrane.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Orcein is the elastic fibre stain and turns them brown; it is paired with van Gieson, which turns the same fibres yellow.',
    ...
    },
    {
      ...
      explanations: {
        ...
        b: 'Reticular fibres are argyrophilic — silver-loving — and silver blackens them, which is the only way to see the stroma of a lymph node, spleen or liver as a network.',
        c: 'H&E is the option that makes the question worth asking: reticular fibres are not visible in it, which is why a special stain is needed at all.',
