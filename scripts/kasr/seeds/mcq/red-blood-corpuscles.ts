...
export const LEAF: McqLeafSeed = {
  ...
  concepts: [
    ...
    },
    {
      ...
      definition:
        'Vitamin C deficiency — scurvy — is due to defective collagen synthesis, and it presents with unhealed wounds and bleeding gums. Collagen is the fibre of repair: the fibroblast becomes active in injury and lays it down, so when it cannot be made properly the wound stays open and the tissue holding teeth and vessel walls together fails. One other collagen disorder is named alongside it, keloid, where healing goes the other way and collagen is deposited to excess in a skin scar.',
  ...
  questions: [
    // ---- light-microscopic identification -----------------------------------
    {
      ...
      explanations: {
        A: 'Oval red cells — ovalocytes — are one of the abnormal shapes, alongside spherocytes, sickle cells and poikilocytes.',
        ...
        C: 'Non-nucleated biconcave discs — the two facts that between them define the cell.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Haemoglobin is a basic protein, so it binds the acidic dye eosin, and the corpuscle is acidophilic.',
    ...
    },
    {
      ...
      answerOverrideReason:
        'The source printed no key. B is the correct account — the corpuscle is acidophilic because haemoglobin is a basic protein — and each of the other three is contradicted: normal corpuscles are uniform in size (variation is anisocytosis, an abnormality), they have no nuclei, and the centre is pale rather than dark.',
      explanations: {
        A: 'Variation in size is anisocytosis, and it is one of the abnormalities of size, along with microcytes and macrocytes. A normal film is uniform.',
        B: 'The cell is acidophilic, because haemoglobin is a basic protein and binds the acidic dye.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Keyed. The pale centre is about one third of the diameter, and a normochromic film is judged against that figure.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'The corpuscle is rounded seen face on and biconcave seen edge on.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'True. The diameter is 6–9 µm, with an average of 7.5.',
        C: 'True. The colour is haemoglobin, and it is why the cell is acidophilic.',
        D: 'The exception. The mature red corpuscle is the least active cell in the body: no nucleus, no organelles, no division and no protein synthesis — it is a bag of haemoglobin with a membrane.',
      },
    },
    {
      ...
      explanations: {
        ...
        B: 'The exception. Immunity is the leukocyte\'s work. The red corpuscle carries gases and buffers acid, and it has neither the organelles nor the receptors for a defensive role.',
    ...
    },
    {
      ...
      answerOverride: 'A',
      answerOverrideReason:
        'The source printed no key. A is the accurate description; the other three are each contradicted, since the life span is about 120 days rather than three weeks, the mature cell is non-nucleated, and the oxygen-binding pigment of the red corpuscle is haemoglobin — myoglobin belongs to muscle.',
      explanations: {
        A: 'Flexible biconcave discs: the flexibility lets them through the capillaries and the biconcavity gives them their surface area.',
    ...
    },
    {
      ...
      explanations: {
        A: 'The average diameter is 7.5 µm, within a range of 6 to 9.',
    ...
    },
    {
      ...
      explanations: {
        A: 'The only option in a plausible unit. 7.5 µm is the average within a 6–9 µm range, so the printed 7.0 is a rounding of it; what this question is really testing is the micrometre.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'True on its own. Thrombocytes — platelets — are the third element, even though they are not true cells.',
        D: 'All three are formed elements of blood, suspended in the fluid matrix that is plasma.',
      },
    },
    ...
    // ---- adaptation to gas transport ---------------------------------------
    {
      ...
      explanations: {
        ...
        C: 'The cell membrane is the only membranous structure left; everything inside is homogeneous electron-dense haemoglobin.',
    ...
    },
    {
      ...
      conceptKey: 'red-corpuscle-adaptation-to-gas-transport',
      difficulty: 'Moderate', questionType: 'Negative stem',
      learningObjective: 'Identify the false statement in the adaptation table.',
      explanations: {
        ...
        D: 'The exception. The biconcave shape exists precisely to give a large surface area for the volume; a low surface area would defeat the whole design.',
      },
    },
    {
      ...
      explanations: {
        ...
        D: 'The exception, on one word. There is no nucleus at all, small or otherwise; the space for haemoglobin comes from having lost it entirely.',
      },
    },
    {
      ...
      explanations: {
        ...
        D: 'All three contribute, and together they are the "content" row of the adaptation table.',
      },
    },
    {
      ...
      explanations: {
        ...
        B: 'Cholesterol does sit among the fatty acid tails and stabilise the membrane, but the selectivity for gas exchange comes from the membrane\'s lipoprotein nature.',
        ...
        D: 'The plasmalemma is lipoprotein and therefore highly selective — permeable to the gases and not to the haemoglobin.',
      },
    },
    {
      ...
      explanations: {
        ...
        D: 'Gas transport and buffering are both red corpuscle functions; phagocytosis is the leukocyte\'s.',
      },
    },
    {
      ...
      explanations: {
        ...
        D: 'And swapped again: the biconcave surface gives surface area for gas exchange, while the rounded edges account for passage through branched vessels.',
      },
    },
    ...
    // ---- the two faces of the membrane -------------------------------------
    {
      ...
      explanations: {
        A: 'The glycocalyx on the outer surface carries the antigenic sites of the ABO groups and the Rh factor.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Spectrin and actin maintain the biconcave shape and give the membrane the elasticity and stability it needs to be deformed thousands of times.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'Actin and spectrin together are the peripheral protein network beneath the inner surface.',
      },
    },
    {
      ...
      explanations: {
        ...
        D: 'A primary defect in spectrin gene expression leaves the cytoskeleton unable to hold the biconcavity, so the cell rounds up into a sphere and is destroyed early.',
      },
    },
    ...
    // ---- rouleaux ----------------------------------------------------------
    {
      ...
      explanations: {
        A: 'Only red corpuscles stack like coins, and the reason is their biconcave surfaces meeting face to face.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'True: the surface tension of the biconcave surfaces is what makes them stick.',
        D: 'The false statement. It is high surface tension, not low, that causes the stacking — this option is C with one word inverted, which is the whole item.',
      },
    },
    {
      ...
      explanations: {
        ...
        B: 'Keyed. Rouleaux is reversible: the stacks separate again when the circulation speeds up, and no cell is harmed.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'Rouleaux forms in slow circulation, reversibly and without damage.',
      },
    },
    ...
    // ---- osmotic fragility --------------------------------------------------
    {
      ...
      explanations: {
        A: 'The corpuscle keeps its normal shape in an isotonic medium, and plasma is isotonic — equal in osmotic pressure to 0.9% saline.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Water leaves the cell, it shrinks, and its edge takes on the notches that give crenation its name.',
    ...
    // ---- the named anaemias ------------------------------------------------
    {
      ...
      explanations: {
        ...
        B: 'Aplastic anaemia is depression or destruction of the bone marrow itself, by irradiation or chemotherapy, and because the whole marrow fails all three cell lines fall together.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Pernicious anaemia is vitamin B12 deficiency, and the deficiency arises because the stomach fails to make the intrinsic factor B12 needs to be absorbed.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'HbS is rigid and accumulates at one side of the cell, pulling it into the crescent that names sickle cell anaemia.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'Keyed. A mutation in the DNA encoding the globin chain produces HbS, and everything else about the disease follows from that molecule.',
      },
    },
    ...
    // ---- count and polycythaemia -------------------------------------------
    {
      ...
      explanations: {
        ...
        B: 'The average count is 5 million per cubic millimetre — 4.5–5.5 in the male, 4–5 in the female.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'A hundred days is close enough to be tempting, which is why it is here; that is not the correct figure.',
        C: 'About 120 days, after which macrophages in liver, spleen and marrow remove the cell.',
    ...
    },
    {
      ...
      explanations: {
        A: 'The difference is attributed to the male hormones, not to oestrogen driving the marrow.',
        B: 'An inhibitory effect of oestrogen would give the same arithmetic by a different route, but that is not the case.',
        C: 'The higher male count is the stimulatory effect of the male hormones — androgens — on the bone marrow.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Polycythaemia is an increased number of red corpuscles, above six million per cubic millimetre, driven by hypoxia stimulating the marrow.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'The exception. Chronic lung disease raises the count by the same hypoxic mechanism, but it is filed under pathological polycythaemia because the hypoxia is disease rather than circumstance.',
      },
    },
    {
      ...
      explanations: {
        ...
        D: 'Chronic lung disease causes hypoxia, hypoxia drives the marrow, and the count rises — a standard example of pathological polycythaemia.',
      },
    },
    ...
    // ---- rows filed here because a red corpuscle was one of the options -----
    {
      ...
      explanations: {
        ...
        B: 'Immature white cells outnumber immature red cells about five to one, because most white cells are shorter-lived and need replacing faster.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'About five immature white cells to every immature red one.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'The basophil nucleus is irregular and S-shaped, usually half hidden under the coarse granules lying over it.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'The monocyte\'s pale basophilic cytoplasm is finely stippled with lysosomes, and that gives the frosted-glass or ground-glass look.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Lipofuscin is undigested residue left in residual bodies, and in cells that never divide — cardiac muscle, nerve cells — it accumulates year on year, which is why it is called the age pigment.',
    ...
    },
    {
      ...
      answerOverride: 'A',
      answerOverrideReason:
        'The source printed no key. The endogenous pigments are haemoglobin, melanin and lipofuscin, and the exogenous ones are carbon and dust, carotene and tattoo dyes, which places three of these four options on the exogenous side and leaves haemoglobin.',
      explanations: {
        A: 'Haemoglobin is made by the body — the standard example of an endogenous pigment.',
        ...
        D: 'Tattoo marks are dye injected under the skin — a standard example of an exogenous pigment, and the most obviously so of the four.',
      },
    },
    {
      ...
      explanations: {
        ...
        B: 'The multilocular fat cell is packed with mitochondria, and their cytochrome pigment — with the tissue\'s richer blood supply — is what makes brown fat brown.',
        C: 'Haemosiderin is iron stored after red cells break down, and it is brown, which is why it is offered here.',
        D: 'Haemoglobin colours the blood in the tissue rather than the cells; the colour is attributed to the cytochromes of the mitochondria.',
      },
    },
    {
      ...
      answerOverride: 'D',
      answerOverrideReason:
        'The source printed no key. Vitamin C deficiency — scurvy — is due to defective collagen synthesis and is characterised by unhealed wounds and bleeding gums, which is the stem\'s own description, and the stem adds that the resident suspected a connective tissue disease.',
      explanations: {
        ...
        D: 'Bleeding gums, loss of teeth and non-healing wounds together are scurvy, and the underlying lesion is collagen that cannot be made properly.',
      },
    },
    {
      ...
      explanations: {
        A: 'Keyed. The cell is already acidophilic from its haemoglobin, and what a supravital stain adds is a basophilic reticulum precipitated from its remaining ribosomes.',
    ...
    },
    {
      ...
      explanations: {},
      exclude: true,
      excludeReason: 'The correct option has been absorbed into another. The candidate\'s pen crossed the letter of option c on this 2022 script, so the bank holds option b as "Neutrophi oath Reticulocytes." — the false option run together with the true one. Brilliant cresyl blue is the supravital stain that shows the reticulum of ribosomal remnants in the reticulocyte, so the answer is the second half of that entry. The stem has also lost its blank to the scanner. Recoverable by rescanning page 4 of the 2022 paper.',
    },
    {
    ...
    },
    {
      ...
      answerOverride: 'b',
      answerOverrideReason:
        'One of the strays the extractor could not file to a leaf; it is authored here because it names a red cell disease. The 2021 paper carried no key and the highlight recovery does not cover that sitting, so the answer given here is: sickle cell anaemia is the condition in which an abnormal rigid haemoglobin, HbS, distorts the corpuscle into a sickle.',
      explanations: {
        ...
        b: 'HbS is rigid and deforms the corpuscle into a sickle shape, which makes it fragile and unable to squeeze through a capillary — the two adaptations the normal red cell depends on.',
