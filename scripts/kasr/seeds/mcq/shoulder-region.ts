  ...
  questions: [
    {
      ...
      explanations: {
        A: 'Its posterior fibres extend and laterally rotate the arm. Deltoid is the only muscle on this list that rotates the humerus laterally at all.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'Deltoid gives the shoulder its rounded contour, so when it wastes the acromion stands out and the shoulder looks flat — the sign of an axillary nerve lesion.',
      },
    },
    {
      ...
      explanations: {
        ...
        B: 'All three sets of fibres converge on the deltoid tuberosity, on the lateral surface of the middle of the humeral shaft.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Supraspinatus takes the arm through the first fifteen degrees, at which point deltoid\'s line of pull becomes effective.',
    ...
    },
    {
      ...
      answerOverride: 'B',
      answerOverrideReason: 'The source printed no key. There are three gleno-humeral ligaments, so B is true; they are weak, attach to the anterior margin of the glenoid only, and the dislocation they fail to prevent is anterior and inferior, not posterior.',
      explanations: {
        A: 'All three are weak, and their weakness is the point: it is why the shoulder is the most commonly dislocated joint in the body.',
        B: 'Three gleno-humeral ligaments — superior, middle and inferior — thicken the front of the capsule.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Latissimus dorsi is the principal extensor of the arm, and also adducts and medially rotates it.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Infraspinatus is one of the four — subscapularis, supraspinatus, infraspinatus and teres minor — whose tendons blend with the capsule.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Rotation of the radius on the ulna happens at the superior and inferior radio-ulnar joints, both pivot joints, working together.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'The axillary nerve supplies deltoid and teres minor, and nothing else.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'Roofing the groove converts it into a canal through which the biceps tendon runs, and that is the ligament\'s whole purpose.',
      },
    },
    {
      ...
      explanations: {
        ...
        B: 'Deltoid and teres minor are the axillary nerve\'s two muscles.',
    ...
    },
    {
      ...
      learningObjective: 'Give an example of a bipennate muscle.',
      explanations: {
        ...
        B: 'Rectus femoris has a central tendon with fibres running into it from both sides, which is what bipennate means.',
    ...
    },
    {
      ...
      conceptKey: 'skeletal-muscle-form-classification-by-fibre-direction',
      difficulty: 'Easy', questionType: 'Classification',
      learningObjective: 'Give an example of a multipennate muscle.',
      explanations: {
        A: 'Deltoid has several tendinous septa with fibres passing obliquely to each, which packs the greatest number of fibres into the muscle and makes it powerful.',
    ...
    },
    {
      ...
      conceptKey: 'skeletal-muscle-form-classification-by-fibre-direction',
      difficulty: 'Easy', questionType: 'Classification',
      learningObjective: 'Give an example of a strap-like muscle.',
      explanations: {
        A: 'Rectus abdominis is a strap muscle too, but the standard example of a *plain* strap muscle is sartorius; rectus abdominis is the one with tendinous intersections, and that is the distinction the pair of questions is testing.',
        B: 'Sartorius runs uninterrupted from the anterior superior iliac spine to the tibia, its fibres parallel throughout.',
        C: 'Deltoid is multipennate, the opposite extreme — built for power rather than range.',
        D: 'Supinator is a short, flat muscle wrapped round the radius and is not the example of anything here.',
      },
    },
    {
      ...
      conceptKey: 'skeletal-muscle-form-classification-by-fibre-direction',
      difficulty: 'Easy', questionType: 'Classification',
      learningObjective: 'Give an example of a strap muscle with tendinous intersections.',
      explanations: {
        ...
        C: 'Rectus abdominis is a strap muscle crossed by three or more tendinous intersections, which is what makes the "six-pack" visible.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Teres major adducts, extends and medially rotates the arm, going to the medial lip of the intertubercular groove.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Latissimus dorsi is the principal extensor, and it also adducts and medially rotates.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'Biceps crosses the elbow and flexes it — its most obvious action, and the only true statement here.',
    ...
    },
    {
      ...
      explanations: {
        ...
        B: 'The surgical neck closes the space laterally, which is why the axillary nerve winding through it is torn by a fracture there.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Supraspinatus initiates abduction and the middle fibres of deltoid carry it to ninety degrees; between them they abduct the joint.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'Deltoid and teres minor are its two muscles, which is why its injury flattens the shoulder and weakens lateral rotation.',
      },
    },
    {
      ...
      explanations: {
        ...
        B: 'The joint takes its nerve supply from the axillary and suprascapular nerves, with the lateral pectoral nerve — the nerves of the muscles that cross it, following Hilton\'s law.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Only about a third of the head is in contact with the glenoid at any time, so the head can roll and spin through a very wide arc before it runs out of socket.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Teres minor takes the lowest of the three impressions on the greater tuberosity, below supraspinatus and infraspinatus.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'Latissimus dorsi extends, adducts and medially rotates the arm, and is the principal muscle of the first of those.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Pectoralis major, running from the front of the chest to the lateral lip of the intertubercular groove, adducts and medially rotates the arm powerfully.',
    ...
    },
    {
      ...
      explanations: {
        ...
        D: 'Pronator teres is supplied by the median nerve, which is formed by a medial root from the medial cord and a lateral root from the lateral cord — so the medial cord does contribute to it, and it is the only flexor here.',
      },
    },
    {
      ...
      explanations: {
        ...
        B: 'Teres minor takes the lowest impression on the greater tuberosity, with supraspinatus and infraspinatus above it.',
    ...
    },
    {
      ...
      explanations: {
        A: 'It crosses the head of the humerus inside the capsule, wrapped in its own synovial sheath, and leaves the joint through the intertubercular groove.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Serratus anterior holds the medial border of the scapula against the chest wall; when it goes, the border stands off and the scapula wings.',
    ...
    },
    {
      ...
      explanations: {
        A: 'The lower subscapular nerve, from the posterior cord, supplies the lower part of subscapularis and teres major — a medial rotator and an adductor — and teres major arises from the lateral border of the scapula, which is the bone that broke.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Teres major arises from the lateral border of the scapula, and it and subscapularis share the lower subscapular nerve — the one branch whose loss weakens medial rotation and adduction together.',
    ...
    },
    {
      ...
      explanations: {
        ...
        C: 'The printed key. The three gleno-humeral ligaments are anterior thickenings of the capsule and lie deep to subscapularis, not against a tendon that moves beneath them.',
        D: 'With the coracoid and the acromion the coraco-acromial ligament forms the coraco-acromial arch, and the supraspinatus tendon with the subacromial bursa slides beneath it every time the arm is raised.',
      },
    },
    {
      ...
      explanations: {
        ...
        D: 'Deltoid is the only muscle that abducts from fifteen to ninety degrees, so abduction fails at once and unambiguously — which makes it the movement to test.',
      },
    },
    {
      ...
      explanations: {
        ...
        d: 'Deltoid is the sole abductor between fifteen and ninety degrees, so its paralysis shows there first.',
      },
    },
    {
      ...
      explanations: {
        ...
        B: 'Pectoralis major on the lateral lip, latissimus dorsi on the floor and teres major on the medial lip all adduct the arm, and all three also rotate it medially.',
    ...
    },
    {
      ...
      explanations: {
        A: 'Deltoid\'s several tendinous septa with obliquely set fibres make it multipennate, which is what gives it its power.',
    ...
    {
      key: 'the-serratus-anterior-muscle-mark-the-wrong-answer-f47d4b21',
      conceptKey: 'long-thoracic-nerve-serratus-anterior-winging',
      difficulty: 'Moderate', questionType: 'Structure and function',
      learningObjective: 'Give the origin, nerve and actions of serratus anterior, and say which direction it moves the shoulder.',
      answerOverride: 'c',
      answerOverrideReason: 'The 2022 paper printed no key and the recovered answer sheet has no entry for this source, so the answer given here is: serratus anterior has eight digitations from the upper eight ribs (option a), is supplied by the long thoracic nerve (option b), and fixes the scapula to the chest wall (option d) \u2014 and it is "the main and powerful protractor of the shoulder", which makes option c, retractor, the one wrong statement the stem asks for.',
      explanations: {
        a: 'True. There are eight digitations from the outer surfaces of the upper eight ribs, the first arising from the 1st and 2nd ribs and being the largest, and the lower five converging on the inferior angle of the scapula.',
        b: 'True, and the nerve that makes this muscle clinically famous. The long thoracic nerve, C5 to C7, runs down the outer surface of the muscle in the mid-axillary line, which is exactly where an axillary clearance can divide it.',
        c: 'This is the wrong statement, and the answer. Serratus anterior is the main and powerful protractor of the shoulder: it pulls the scapula forwards round the chest wall, which is the movement of a punch or a push. Retraction is the opposite movement and belongs to the rhomboids and the middle fibres of trapezius. A student who has learnt only that this muscle is powerful and that it holds the scapula down will accept either direction.',
        d: 'True, and the fact behind the winged scapula. Serratus anterior holds the medial border of the scapula against the chest wall; when it is paralysed the border stands off as the patient pushes against resistance.',
      },
    },
    {
      key: 'the-trapez-pezius-muscle-is-supplied-b-7-55eb7de6',
      conceptKey: 'scapular-muscle-nerve-supply-accessory-dorsal-scapular-thoracodorsal',
      difficulty: 'Easy', questionType: 'Structure and function',
      learningObjective: 'Not sittable as extracted.',
      explanations: {},
      exclude: true,
      excludeReason: 'The four options have been captured as two fields, each holding a pair: option a reads "Cranial accessory nerve. iis ty Padliecessory nerve." and option c reads "Dorsal scapular nerve. ds Thoracodorsal nerve." A student cannot choose between two options printed as one, and the pair in field a is the pair the whole question turns on \u2014 cranial against spinal accessory. The recovered answer sheet keys this question A, which is consistent with the spinal accessory nerve being the second half of that merged field rather than the first, and is another reason the row cannot be sat as it stands. Trapezius is supplied from the spinal root of the accessory nerve. A rescan separates the fields.',
    },
    {
      key: 'the-trapezius-muscle-is-supplied-by-the-sceccvssseeereees-me-34b771b0',
      conceptKey: 'scapular-muscle-nerve-supply-accessory-dorsal-scapular-thoracodorsal',
      difficulty: 'Easy', questionType: 'Structure and function',
      learningObjective: 'Not sittable as extracted.',
      explanations: {},
      exclude: true,
      excludeReason: 'From the ringed 2024 script: the candidate\u2019s pen crossed the option letters, so `options` is empty and the four nerves survive only inside the stem \u2014 cranial accessory, spinal accessory, long thoracic, dorsal scapular. The seeds cannot put options back into a bank row. The same question is sittable elsewhere in this bank from the question books, and the answer is the spinal root of the accessory nerve.',
    },
    {
      key: 'whi-a-py-of-the-following-muscles-does-not-extend-to-the-wri-37779ca6',
      conceptKey: 'scapular-muscle-nerve-supply-accessory-dorsal-scapular-thoracodorsal',
      difficulty: 'Moderate', questionType: 'Structure and function',
      learningObjective: 'Not sittable as extracted.',
      explanations: {},
      exclude: true,
      excludeReason: 'Two questions in one row, with `options` empty. The stem is question 113, "Which of the following muscles does NOT extend to the wrist?", whose four options \u2014 brachioradialis, extensor carpi radialis longus, extensor carpi ulnaris, extensor digitorum \u2014 are inside it, and it then runs straight on into question 114, "The trapezius muscle is supplied by the", with its own four. Neither half can be sat while they share a stem, and no seed can split a bank stem. Brachioradialis is the answer to the first, since it inserts on the styloid process of the radius and never reaches the wrist joint; the spinal accessory nerve is the answer to the second. Both are worth a rescan.',
    },
    {
      key: 'javic-ath-a-dislocation-of-en-seg-joint-several-structures-c-6f3f5352',
      conceptKey: 'shoulder-joint-type-ligaments-movements',
      difficulty: 'Hard', questionType: 'Clinical application',
      learningObjective: 'Not sittable as extracted.',
      explanations: {},
      exclude: true,
      excludeReason: 'From the ringed 2024 script, with `options` empty and the stem itself broken open at both ends \u2014 it begins mid-word ("javic ath a dislocation of en Seg joint") and the four ligaments are inside it: acromioclavicular, coracoacromial, coracoclavicular and the supraspinatus tendon. The question is about the acromioclavicular joint, whose greatest strength comes from the coracoclavicular ligament, and it is the only sat question in this leaf on that joint. A rescan of an unringed copy recovers it.',
    },
    {
      key: 'a-person-has-a-fracture-of-the-upper-end-of-humerus-eee-spac-4e4e9ee0',
      conceptKey: 'intermuscular-spaces-quadrangular-triangular-boundaries-contents',
      difficulty: 'Hard', questionType: 'Clinical application',
      learningObjective: 'Not sittable as extracted.',
      explanations: {},
      exclude: true,
      excludeReason: 'From the ringed 2024 script, with `options` empty: the stem has been shuffled by the OCR into an unreadable order ("the ties off the artery traveling through the quadrangU fe hemorrhage") and it then runs on into question 72 about serratus anterior. The five artery names inside it \u2014 anterior circumflex humeral, dorsal scapular, posterior circumflex humeral, scapular circumflex, subscapular \u2014 have no usable letters. The posterior circumflex humeral artery is what passes through the quadrangular space with the axillary nerve; the item needs a rescan before a student can say so.',
    },
    {
      key: 'which-one-of-the-fotiowing-muscles-canpextend-the-arm-29a06e5c',
      conceptKey: 'shoulder-joint-movements-and-their-muscles',
      difficulty: 'Easy', questionType: 'Structure and function',
      learningObjective: 'Name the principal extensor of the arm at the shoulder, and say what the other three muscles offered do instead.',
      answerOverride: 'a',
      answerOverrideReason: 'The 2022 paper printed no key and the recovered answer sheet has no entry for this source, so the answer given here is: extension of the arm belongs to the posterior fibres of deltoid, teres major and latissimus dorsi. Latissimus dorsi is the only one of the four options on that list; the other three \u2014 the clavicular fibres of pectoralis major, the anterior fibres of deltoid and coracobrachialis \u2014 are the three flexors.',
      explanations: {
        a: 'Latissimus dorsi is the principal extensor of the arm at the shoulder; it also adducts and medially rotates, which is the combination that drives the arm down and back in swimming and climbing.',
        b: 'The clavicular head of pectoralis major is a flexor \u2014 it is the sternocostal head that extends the flexed arm, and the option names the wrong half of the muscle. This is the sharpest distractor of the four because half the muscle would have been right.',
        c: 'The anterior fibres of deltoid flex and medially rotate. It is the posterior fibres that extend, so deltoid too is a correct answer only if the option names the right fibres.',
        d: 'Coracobrachialis runs from the coracoid process down the medial side of the humerus and assists flexion and adduction. It cannot extend, because it lies in front of the joint\u2019s axis.',
      },
    },
    {
      key: 'what-muscles-are-hecessary-to-rais-the-arm-above-the-shoulde-57cef8bf',
      conceptKey: 'scapular-rotation-abduction-beyond-90-muscles',
      difficulty: 'Moderate', questionType: 'Structure and function',
      learningObjective: 'Put supraspinatus, deltoid and serratus anterior in the order in which they act as the arm is raised above the head.',
      answerOverride: 'a',
      answerOverrideReason: 'The 2022 paper printed no key and the recovered answer sheet has no entry for this source, so the answer given here is: supraspinatus abducts from 0 to 15 degrees, initiating it; the middle fibres of deltoid carry it from 15 to 90; and beyond 90 the greater tuberosity meets the coraco-acromial ligament and further elevation is upward rotation of the scapula, produced by trapezius with the lower five digitations of serratus anterior. That is supraspinatus, then deltoid, then serratus anterior \u2014 option a\u2019s order.',
      explanations: {
        a: 'Supraspinatus starts the movement over the first fifteen degrees, deltoid carries it to ninety, and past ninety the shoulder joint is out of range \u2014 the scapula rotates instead, turning the glenoid cavity upwards, and serratus anterior with trapezius does that.',
        b: 'Deltoid first is the intuitive answer, because deltoid is the muscle a student can see and feel. It cannot start abduction: with the arm at the side its pull is almost vertical along the shaft of the humerus, so it needs supraspinatus to swing the arm out first.',
        c: 'Right first and right last, wrong in the middle. Serratus anterior does not act on the glenohumeral joint at all, and putting it before deltoid asks the scapula to rotate before the arm has left the side.',
        d: 'Exactly reversed. This is the order a student gives who has learnt that serratus anterior is needed to get the arm above the head and has taken "needed" to mean "first"; it is needed last.',
      },
    },
    {
      key: 'which-muscle-is-the-strongest-medial-rotator-of-the-arm-aa-s-62539bc3',
      conceptKey: 'shoulder-joint-movements-and-their-muscles',
      difficulty: 'Moderate', questionType: 'Structure and function',
      learningObjective: 'Not sittable as extracted.',
      explanations: {},
      exclude: true,
      excludeReason: 'From the ringed 2024 script, with `options` empty: the muscle names are inside the stem \u2014 supraspinatus, teres minor, subscapularis \u2014 and the fourth has been lost entirely, the stem trailing off into the next question ("as Disease f oe subscapularis repair th 7 the \u00a9 Surgeo"). Subscapularis is the strongest medial rotator and is among the survivors, but a question whose fourth option cannot be read is not a question. A rescan of an unringed copy recovers it.',
    },
    {
      key: 'the-rotator-cuff-muscles-attached-to-the-greater-tuberosity-e8e650f5',
      conceptKey: 'humeral-tuberosity-attachments-and-the-cuff-insertions',
      difficulty: 'Easy', questionType: 'Structure and function',
      learningObjective: 'Not sittable as extracted.',
      explanations: {},
      exclude: true,
      excludeReason: 'From the ringed 2024 script, with `options` empty: the four cuff muscles are inside the stem with their letters struck through, and subscapularis appears twice in the wreckage ("bscapularis a\u201d supraspinatus \u2026 ac sul P"). The stem is also truncated \u2014 "the greater tuberosity of th include the following except". Subscapularis is the exception, being the one cuff muscle that goes to the lesser tuberosity, and that is exactly the option the pen has damaged. A rescan recovers it.',
    },
  ],
}
