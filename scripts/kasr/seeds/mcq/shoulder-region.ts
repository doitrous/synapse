...
export const LEAF: McqLeafSeed = {
  ...
  questions: [
    ...
    },
    {
      ...
      answerOverride: 'c',
      answerOverrideReason: 'The 2022 paper printed no key and the recovered answer sheet has no entry for this source, so the answer comes from the department book. The book gives serratus anterior eight digitations from the upper eight ribs (option a), the long thoracic nerve (option b), and fixation of the scapula to the chest wall (option d) \u2014 and calls it "the main and powerful protractor of the shoulder", which makes option c, retractor, the one wrong statement the stem asks for.',
      explanations: {
        a: 'True. The book gives eight digitations from the outer surfaces of the upper eight ribs, the first arising from the 1st and 2nd ribs and being the largest, and the lower five converging on the inferior angle of the scapula.',
    ...
    },
    {
      ...
      explanations: {},
      exclude: true,
      excludeReason: 'From the ringed 2024 script: the candidate\u2019s pen crossed the option letters, so `options` is empty and the four nerves survive only inside the stem \u2014 cranial accessory, spinal accessory, long thoracic, dorsal scapular. The seeds cannot put options back into a bank row. The same question is sittable elsewhere in this bank from the question books, and the department book\u2019s answer is the spinal root of the accessory nerve.',
    },
    {
    ...
    },
    {
      ...
      answerOverride: 'a',
      answerOverrideReason: 'The 2022 paper printed no key and the recovered answer sheet has no entry for this source, so the answer comes from the department book, which gives extension of the arm to the posterior fibres of deltoid, teres major and latissimus dorsi. Latissimus dorsi is the only one of the four options on that list; the other three \u2014 the clavicular fibres of pectoralis major, the anterior fibres of deltoid and coracobrachialis \u2014 are the book\u2019s three flexors.',
      explanations: {
        a: 'Correct. Latissimus dorsi is the principal extensor of the arm at the shoulder; it also adducts and medially rotates, which is the combination that drives the arm down and back in swimming and climbing.',
    ...
    },
    {
      ...
      answerOverride: 'a',
      answerOverrideReason: 'The 2022 paper printed no key and the recovered answer sheet has no entry for this source, so the answer comes from the department book. The book gives supraspinatus abduction from 0 to 15 degrees, initiating it; the middle fibres of deltoid from 15 to 90; and beyond 90 it says the greater tuberosity meets the coraco-acromial ligament and further elevation is upward rotation of the scapula, produced by trapezius with the lower five digitations of serratus anterior. That is supraspinatus, then deltoid, then serratus anterior \u2014 option a\u2019s order.',
      explanations: {
        a: 'Correct. Supraspinatus starts the movement over the first fifteen degrees, deltoid carries it to ninety, and past ninety the shoulder joint is out of range \u2014 the scapula rotates instead, turning the glenoid cavity upwards, and serratus anterior with trapezius does that.',
