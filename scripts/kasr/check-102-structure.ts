...
const md = readFileSync('docs/Kasr-Source-Imports/academic/102-int-structure.md', 'utf8')
...
for (const top of tree) {
  ...
  console.log(`  ${top.name} — ${kids.length} children, ${walkSubjects([top]).length - 1} nodes beneath`)
}
