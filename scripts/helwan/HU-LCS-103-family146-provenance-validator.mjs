...
const basePath = resolve(root, 'docs/Helwan-Source-Imports/question/HU-LCS-103-family97-muscle-physiology-mcq.md')
...
const expectedKeys = 'BCCDCCACDCBCCCDCABDCDCBBDDDADA'
...
assert.equal((updateText.match(/^## explanation_[a-f]$/gm) ?? []).length, 180, 'six option-specific explanation fields per row must be preserved')
