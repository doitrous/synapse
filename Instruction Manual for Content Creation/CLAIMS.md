...
|---|---|---|---|---|
| — | — | — | — | — |
| 2026-08-22 | W1-102-BIOC-C | `AU · AU-MED-102 · Biochemistry (sub-lane C: vitamin/heme/blood biochemistry, per AU-MED-102-biochemistry-triage.md §9) · concepts` | `docs/Alexandria-Source-Imports/concept/AU-MED-102-biochem-nitrogen-blood-concepts.md` (+ pending-live equivalent for HIT-PENDING ids) | sub-lane A's `evidence/AU-MED-102-biochemistry-resources.md` for resource ids |
| 2026-08-22 | W1-102-BIOC-C | `AU · AU-MED-102 · Biochemistry (sub-lane C) · articles` | `docs/Alexandria-Source-Imports/article/AU-MED-102-biochem-nitrogen-blood-articles.md` | own concepts above |
| 2026-08-22 | W1-102-BIOC-C | `AU · AU-MED-102 · Biochemistry (sub-lane C) · questions` | `docs/Alexandria-Source-Imports/question/AU-MED-102-biochem-nitrogen-blood-mcq.md` | own concepts/articles above |
| 2026-08-22 | W1-102-BIOC-C | `AU · AU-MED-102 · Biochemistry (sub-lane C) · evidence` | `docs/Alexandria-Source-Imports/evidence/AU-MED-102-biochem-nitrogen-blood-claims.md`, `-citations.md`, `-spans.md` | sub-lane A's resources |
| 2026-08-22 | W1-102-BIOC-A | `AU · AU-MED-102 · Biochemistry (sub-lane A: structural CHO/lipid/protein chemistry + enzymes, per AU-MED-102-biochemistry-triage.md §9) · concepts` | `docs/Alexandria-Source-Imports/concept/AU-MED-102-biochem-structural-concepts.md` (+ pending-live equivalent for any HIT-PENDING ids) | own resources file (Done, below) |
